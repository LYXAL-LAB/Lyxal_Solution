...
//! kept narrow on purpose — lyxal-booking only exercises a small slice of the EWS
//! surface.
...
///
/// `SendMeetingInvitations="SendToNone"` keeps the call non-disruptive — lyxal-booking
...
"#,
    ...
    post_soap(endpoint, username, password, &body, false).await?;
    Ok(())
}
