...
pub fn generate_api_key() -> (String, String, String) {
    let raw = format!("lyxal_{}", Uuid::new_v4().as_simple());
...
/// only the hash is persisted. Used by invitations (`lyxal_inv_`),
/// password resets (`lyxal_pwr_`), and personal access tokens
/// (`lyxal_pat_`, PR-A4).
