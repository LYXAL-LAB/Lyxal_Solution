//! Unified diff between two Lyxalfile sources.

use similar::TextDiff;

/// Generate a unified diff between two Lyxalfile sources.
...
/// Returns true if two Lyxalfile sources are semantically equivalent
