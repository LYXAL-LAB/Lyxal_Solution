//! Lyxal generic shell / exec runner.
//!
//! Picks up the `__runner_exec` payload stamped by the Lyxalfile compiler
//! ([`lyxal_config::compile::RunnerExec`]) from the work-assignment metadata
...
//! # Trust model
//!
//! Anyone with write access to the Lyxalfile (or to the JobConfig metadata
