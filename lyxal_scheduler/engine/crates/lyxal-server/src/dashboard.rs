...
//! `lyxal-scheduler` so both surfaces produce identical bucketing.

use serde::Deserialize;

pub use lyxal_scheduler::forecast::{ForecastBucket, ForecastResponse, compute_forecast};
