...
mod tests {
    use super::*;
    use lyxal_auth::context::{AuthMethod, CallerType};
    use lyxal_runner::AppState;
    use lyxal_store::models::JobDefinition;
    use lyxal_store::traits::JobDefinitionStore;
    ...
    fn state_with_jobs(_jobs: Vec<JobDefinition>) -> Arc<ServerState> {
