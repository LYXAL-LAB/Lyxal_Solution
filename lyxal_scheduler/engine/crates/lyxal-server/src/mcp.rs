...
//!   [`lyxal_mcp::MUTATION_TOOL_NAMES`] (`enqueue_job`, `cancel_execution`,
...
use lyxal_mcp::{MUTATION_TOOL_NAMES, streamable_http_service};
...
/// top of the loopback defaults (see [`lyxal_mcp::streamable_http_service`]
...
/// in [`lyxal_mcp::MUTATION_TOOL_NAMES`], require `mcp:write` scope; otherwise
