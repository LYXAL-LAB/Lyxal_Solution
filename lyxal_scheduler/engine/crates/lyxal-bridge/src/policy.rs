...
//!
//! The DSL (`lyxal-config`) uses string-based, human-friendly config structs.
//! The runtime (`lyxal-execution`) uses strongly-typed policy structs with
//! `std::time::Duration` values. This module bridges the two.

use std::time::Duration;

use lyxal_config::compile::{DeadLetterConfig, RetryConfig};
use lyxal_execution::{
