...
//! 2. State file `${LYXAL_RUNNER_DATA_DIR:-/var/lib/lyxal-runner}/runner-id`
//!    — read if it exists.
...
const DEFAULT_DATA_DIR: &str = "/var/lib/lyxal-runner";
...
pub fn resolve_runner_id(prefix: &str) -> String {
    ...
    let data_dir = std::env::var("LYXAL_RUNNER_DATA_DIR")
        .ok()
...
mod tests {
    ...
    fn falls_back_to_volatile_id_when_dir_not_writable() {
        ...
        let unwritable = Path::new("/proc/lyxal-runner-test-unwritable");
