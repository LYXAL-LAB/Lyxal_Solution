//! Lyxal Runner SDK — build job execution runners in Rust.
//!
//! # Quick start
//!
//! ```rust,no_run
//! use lyxal_runner_sdk::{LyxalRunner, ExecutionContext};
//!
//! #[tokio::main]
//! async fn main() {
//!     let runner = LyxalRunner::builder("http://localhost:4000", "my-runner")
//!         .api_key("lyxal_abc123")
//!         .max_inflight(5)
//!         .build();
//!
...
//! is registered — see [`examples/catch_all.rs`](https://github.com/nuetzliches/croniq/blob/main/crates/lyxal-runner-sdk/examples/catch_all.rs):
//!
//! ```rust,no_run
//! # use lyxal_runner_sdk::{LyxalRunner, ExecutionContext};
//! # async fn demo() {
//! # let runner = LyxalRunner::builder("http://localhost:4000", "r").build();
...
//! response to an application event, in addition to the Lyxalfile schedule —
