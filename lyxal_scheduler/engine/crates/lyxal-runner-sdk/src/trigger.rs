...
//!
//! The runner (consumer) side of the protocol — [`LyxalRunner`](crate::LyxalRunner)
...
//! .NET SDK's `ILyxalTriggerClient`. It is deliberately **independent of the
...
/// `LyxalClientOptions.RequestTimeout`.
...
/// Producer-side client for firing Lyxal jobs on demand.
///
...
impl TriggerClient {
    /// Start building a trigger client for the given Lyxal server base URL
