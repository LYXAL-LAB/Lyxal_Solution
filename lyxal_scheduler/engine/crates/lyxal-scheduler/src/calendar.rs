...
use lyxal_config::calendar_args::{self, AnnualArg};
...
impl Calendar {
    ...
    pub fn from_config(
        cfg: &lyxal_config::compile::CalendarConfig,
...
// Argument parsing is shared with lyxal-config's `validate` via
...
mod tests {
    ...
    fn compile_from_config() {
        use lyxal_config::compile::{CalendarConfig, CalendarRuleConfig};
    ...
    fn weekly_config(args: Vec<String>) -> lyxal_config::compile::CalendarConfig {
        lyxal_config::compile::CalendarConfig {
            name: "biz".into(),
            timezone: None,
            rules: vec![lyxal_config::compile::CalendarRuleConfig {
                kind: "include".into(),
                rule_type: "weekly".into(),
                args,
            }],
