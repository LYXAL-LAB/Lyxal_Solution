...
describe("Pattern", () => {
    test("should handle Pattern ColorSpace and operators", async () => {
...
%%EOF`;
        ...
        // Should contain setFillColorSpace and setFillColorN
        expect(opList.fnArray).toContain(OPS.setFillColorSpace);
        expect(opList.fnArray).toContain(OPS.setFillColorN);
    });
});
