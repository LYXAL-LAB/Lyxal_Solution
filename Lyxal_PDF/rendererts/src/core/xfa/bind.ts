...
class Binder {
  ...
  _bindValue(formNode: any, data: any, picture: any) {
  ...
  _findDataByNameToConsume(name: string, isValue: boolean, dataNode: any, global: boolean) {
    if (!name) {
      return null;
    }
  ...
  _setProperties(formNode: any, dataNode: any) {
    // For example:
    // <field name="LastName" ...>
  ...
  _bindItems(formNode: any, dataNode: any) {
    // For example:
    // <field name="CardName"...>
  ...
  _bindOccurrences(formNode: any, matches: any, picture: any) {
  ...
  _createOccurrences(formNode: any) {
    if (!this.emptyMerge) {
      return;
    }
  ...
  _setAndBind(formNode: any, dataNode: any) {
    this._setProperties(formNode, dataNode);
    this._bindItems(formNode, dataNode);
    this._bindElement(formNode, dataNode);
  }

  _bindElement(formNode: any, dataNode: any) {
      ...
      if (ref) {
        ...
        if (match === null) {
          ...
          if (this._isConsumeData()) {
            ...
            match = match.filter((node: any) => !node[$consumed]);
          }
          if (match.length > max) {
