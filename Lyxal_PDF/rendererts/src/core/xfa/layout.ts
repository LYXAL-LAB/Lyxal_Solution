...
function createLine(node: any, children: any[]) {
  return {
    name: "div",
    attributes: {
...
function addHTML(node: any, html: any, bbox: any) {
...
function getAvailableSpace(node: any) {
...
function getTransformedBBox(node: any) {
 ...
 */
function checkDimensions(node: any, space: any) {
