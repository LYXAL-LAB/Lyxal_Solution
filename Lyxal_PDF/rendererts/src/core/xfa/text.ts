...
class FontInfo {
  ...
  constructor(xfaFont: any, margin: any, lineHeight: number | null, fontFinder: any) {
...
class FontSelector {
  ...
  pushData(xfaFont: any, margin: any, lineHeight: any) {
...
class TextMeasure {
  ...
  constructor(defaultXfaFont: any, defaultParaMargin: any, defaultLineHeight: any, fonts: any) {
    this.glyphs = [];
