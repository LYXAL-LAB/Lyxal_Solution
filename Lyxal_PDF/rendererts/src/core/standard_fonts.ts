 ...
 */
export const getStdFontMap = getLookupTableFactory(function (t: any) {
...
export const getFontNameToFileMap = getLookupTableFactory(function (t: any) {
 ...
 */
export const getNonStdFontMap = getLookupTableFactory(function (t: any) {
  t.Calibri = "Helvetica";
...
export const getSerifFonts = getLookupTableFactory(function (t: any) {
  t["Adobe Jenson"] = true;
  t["Adobe Text"] = true;
  t.Albertus = true;
  t.Aldus = true;
...
export const getSymbolsFonts = getLookupTableFactory(function (t: any) {
  t.Dingbats = true;
  t.Symbol = true;
  t.ZapfDingbats = true;
  t.Wingdings = true;
...
export const getGlyphMapForStandardFonts = getLookupTableFactory(function (t: any) {
  t[2] = 10;
  t[3] = 32;
  t[4] = 33;
  t[5] = 34;
...
export const getSupplementalGlyphMapForCalibri = getLookupTableFactory(function (t: any) {
  t[1] = 32;
  t[4] = 65;
  t[5] = 192;
  t[6] = 193;
...
export function getStandardFontName(name: string): string {
  const fontName = normalizeFontName(name);
  const stdFontMap = getStdFontMap();
  return stdFontMap[fontName];
}

export function isKnownFontName(name: string): boolean {
  const fontName = normalizeFontName(name);
  return !!(
