...
export function calculateSHA512(data: Uint8Array, offset: number, length: number, mode384: boolean = false): Uint8Array {
  // initial hash values
...
export function calculateSHA384(data: Uint8Array, offset: number, length: number): Uint8Array {
