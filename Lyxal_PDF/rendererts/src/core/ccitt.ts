...
export interface CCITTFaxDecoderSource {
    next(): number;
}
 ...
 * @param {CCITTFaxDecoderOptions} [options] - Decoding options.
 */
export class CCITTFaxDecoder {
   ...
   * @private
   */
  _addPixels(a1: number, blackPixels: number) {
    const codingLine = this.codingLine;
   ...
   * @private
   */
  _addPixelsNeg(a1: number, blackPixels: number) {
    const codingLine = this.codingLine;
    let codingPos = this.codingPos;
