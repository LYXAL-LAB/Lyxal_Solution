...
import { convertToRGBA } from "../shared/image_utils";
import { MAX_INT_32 } from "./core_utils";
...
export class ImageResizer {
  ...
  constructor(imgData: any, isMask: boolean) {
  ...
  static getReducePowerForJPX(width: number, height: number, componentsCount: number) {
    const area = width * height;
  ...
  static async createImage(imgData: any, isMask = false) {
