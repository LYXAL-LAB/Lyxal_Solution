...
function mayHaveChildren(value: any) {
  return (
...
function addChildren(node: any, nodesToVisit: any[]) {
...
export class ObjectLoader {
  refSet: RefSet | null = new RefSet();
  dict: any;
  keys: any;
  xref: any;

  constructor(dict: any, keys: any, xref: any) {
    this.dict = dict;
    this.keys = keys;
    this.xref = xref;
  }
  ...
  static async load(obj: any, keys: any, xref: any) {
