...
const Demo: React.FC = () => {
  return (
    <div className="rounded-box bg-base-100 border-base-content/5 text-base-content not-prose grid gap-3 border p-6 max-w-2xl mx-auto my-6">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-3 md:flex-row">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 md:w-1/2">
            <div className="radial-progress" style={{ '--value': 60, '--size': '3.5rem' } as React.CSSProperties}>60%</div>
            <div className="radial-progress" style={{ '--value': 75, '--size': '3.5rem' } as React.CSSProperties}>75%</div>
            <div className="radial-progress" style={{ '--value': 90, '--size': '3.5rem' } as React.CSSProperties}>90%</div>
          </div>
        </div>
      </div>
      <div className="flex flex-col gap-3">
        ...
        <div className="navbar bg-neutral text-neutral-content rounded-box">
          ...
          <div className="flex-1">
            <button className="btn btn-ghost text-xl normal-case">Lyxal UI</button>
          </div>
        </div>
