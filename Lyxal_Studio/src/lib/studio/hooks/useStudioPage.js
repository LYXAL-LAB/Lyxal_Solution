 ...
 * ```
 */
export const useStudioPage = (code) => {
    ...
    const loadPage = async () => {
      ...
      `;
            ...
            const result = await SurrealClient.queryWithParams(config, query, { code });
            ...
            if (result && Array.isArray(result) && result.length > 0) {
                ...
                const debugResult = await SurrealClient.query(config, debugQuery);
