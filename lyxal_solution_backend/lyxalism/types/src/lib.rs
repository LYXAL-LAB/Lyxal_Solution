...
//! }
//! ```
/// Wrapper type for function arguments that implement [`lyxal_types::LyxalValue`].
pub mod arg;

/// Traits for marshalling function arguments to and from [`lyxal_types::Value`] vectors.
pub mod args;
