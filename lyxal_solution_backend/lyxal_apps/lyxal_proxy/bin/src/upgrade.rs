...
pub enum UpgradeError {
    ...
    #[error(
        "Could not block the fork confirmation channel: {0}. This is not normal, you may need to restart lyxal_proxy"
    )]
...
/// - Child: calls Sōzu's executable path with `lyxal_proxy main [...]`
///
