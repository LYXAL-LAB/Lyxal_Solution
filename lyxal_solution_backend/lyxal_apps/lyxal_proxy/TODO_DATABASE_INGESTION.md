# TODO: Architecture Data-Driven pour Lyxal Proxy (Sōzu + Lyxal)

Ce document définit la structure des tables et des événements Lyxal nécessaires pour piloter le moteur Sōzu de manière persistante et via SQL.
...
---
*Note: Ce schéma garantit que Sōzu reste ultra-rapide (RAM) tout en devenant totalement pilotable par l'IA via LyxalQL.*
