...
mod tests {
    ...
    fn multiple_children_on_a_wildcard() {
        ...
        println!("{:#?}", router.tree);
        assert_eq!(
            router.lookup("www.lyxal_proxy.io", "/api", &Method::Get),
        ...
        println!("{:#?}", router.tree);
        assert_eq!(
            router.lookup("www.lyxal_proxy.io", "/ap", &Method::Get),
            Ok(Route::ClusterId("base".to_string()))
        );
        assert_eq!(
            router.lookup("www.lyxal_proxy.io", "/api", &Method::Get),
    ...
    ///  [io]
    ///      \
    ///       [lyxal_proxy]  <- this node has multiple children including a wildcard
    ///      /      \
    ...
    fn multiple_children_including_one_with_wildcard() {
        ...
        assert_eq!(
            router.lookup("api.lyxal_proxy.io", "/api", &Method::Get),
            Ok(Route::ClusterId("api".to_string()))
        );
    }
    ...
    fn router_insert_remove_through_regex() {
        ...
        println!("{:#?}", router.tree);
        assert_eq!(
            router.lookup("www.lyxal_proxy.io", "/", &Method::Get),
            Ok(Route::ClusterId("base".to_string()))
        );
        assert_eq!(
            router.lookup("www.doc.lyxal_proxy.io", "/", &Method::Get),
        ...
        println!("{:#?}", router.tree);
        assert!(router.lookup("www.lyxal_proxy.io", "/", &Method::Get).is_err());
        assert_eq!(
            router.lookup("www.doc.lyxal_proxy.io", "/", &Method::Get),
            Ok(Route::ClusterId("doc".to_string()))
        );
