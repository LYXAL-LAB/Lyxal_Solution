...
use lyxal_proxy_command::proto::command::{
...
thread_local! {
  pub static METRICS: RefCell<Aggregator> = RefCell::new(Aggregator::new(String::from("lyxal_proxy")));
}
...
pub struct Aggregator {
    /// appended to metric keys, usually "lyxal_proxy-"
    prefix: String,
