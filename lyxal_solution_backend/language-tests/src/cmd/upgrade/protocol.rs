/// Manual implementations of the oldest revision of lyxal structs for backwards
/// compatibility. Only the variants that are needed to control lyxal are implemented.
use std::collections::BTreeMap;

use revision::revisioned;
use lyxal_types::{Array, Number, Object, Value};
...
impl ProxyValue {
	/// Convert this ProxyValue to a lyxal_types::Value
...
impl ProxyObject {
	/// Convert this ProxyObject to a lyxal_types::Value
	pub fn to_value(self) -> Value {
