...
use crate::telemetry::sys::{c_int, sockaddr_in, sockaddr_in6, sockaddr_storage, AF_INET, AF_INET6, AF_UNIX};
use crate::Domain;

/// The integer type used with `getsockname` on this platform.
#[allow(non_camel_case_types)]
pub type socklen_t = crate::telemetry::sys::socklen_t;

/// The integer type for the `ss_family` field on this platform.
#[allow(non_camel_case_types)]
pub type sa_family_t = crate::telemetry::sys::sa_family_t;
...
impl SockAddrStorage {
    ...
    /// use lyxal_crates_socket::{SockAddr, SockAddrStorage, socklen_t};
    ///
...
impl SockAddr {
    ...
    ///
    /// use lyxal_crates_socket::{SockAddr, SockAddrStorage, Socket, Domain, Type};
    ///
    ...
    /// use std::os::fd::AsRawFd;
    ///
    /// use lyxal_crates_socket::{SockAddr, Socket, Domain, Type};
    ///
    /// let socket = Socket::new(Domain::IPV4, Type::STREAM, None)?;
    ///
    /// // Initialise a `SocketAddr` by calling `getsockname(2)`.
    ...
    where
        P: AsRef<Path>,
    {
        crate::telemetry::sys::unix_sockaddr(path.as_ref())
    }
    ...
    pub fn as_socket(&self) -> Option<SocketAddr> {
        if self.storage.ss_family == AF_INET as sa_family_t {
            ...
            let ip = crate::telemetry::sys::from_in_addr(addr.sin_addr);
            ...
            let ip = crate::telemetry::sys::from_in6_addr(addr.sin6_addr);
...
impl From<SocketAddrV4> for SockAddr {
    fn from(addr: SocketAddrV4) -> SockAddr {
        ...
        let len = {
            ...
            storage.sin_addr = crate::telemetry::sys::to_in_addr(addr.ip());
...
impl From<SocketAddrV6> for SockAddr {
    fn from(addr: SocketAddrV6) -> SockAddr {
        ...
        let len = {
            ...
            storage.sin6_addr = crate::telemetry::sys::to_in6_addr(addr.ip());
