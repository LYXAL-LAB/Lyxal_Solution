...
impl super::Routine for Create {
	fn setup(&self, _client: &'static Lyxal<Any>, _num_ops: usize) {}

	fn run(&self, client: &'static Lyxal<Any>, num_ops: usize) {
	...
	fn cleanup(&self, client: &'static Lyxal<Any>, _num_ops: usize) {
		self.runtime.block_on(async {
			client
