...
use lyxal_core::lazy_env_parse;

/// The logo of the Lyxal server
pub const LOGO: &str = r"
 888      Y88b   d88P  Y88b   d88P         db         888 
 888       Y88b d88P    Y88b d88P         d88b        888 
 888        Y88o88P      Y88o88P         d8888b       888 
 888         Y888P        Y888P         d8P  Y8b      888 
 888          888         d888b        d8P    Y8b     888 
 888          888        d88888b      d8888888888b    888 
 888          888       d88P Y88b    d88P      Y88b   888
 888888888    888      d88P   Y88b  d88P        Y88b  888888888
...
pub static WEBSOCKET_MAX_MESSAGE_SIZE: LazyLock<usize> =
	lazy_env_parse!(bytes, "LYXAL_WEBSOCKET_MAX_MESSAGE_SIZE", usize, 128 << 20);
...
/// `LYXAL_WEBSOCKET_READ_BUFFER_SIZE` environment variable.
pub static WEBSOCKET_READ_BUFFER_SIZE: LazyLock<usize> =
	lazy_env_parse!(bytes, "LYXAL_WEBSOCKET_READ_BUFFER_SIZE", usize, 128 * 1024);
...
/// Larger values can improve performance for high-throughput connections but consume
/// more memory per connection. The value can be configured via the
/// `LYXAL_WEBSOCKET_WRITE_BUFFER_SIZE` environment variable.
pub static WEBSOCKET_WRITE_BUFFER_SIZE: LazyLock<usize> =
	lazy_env_parse!(bytes, "LYXAL_WEBSOCKET_WRITE_BUFFER_SIZE", usize, 128 * 1024);
...
/// `LYXAL_WEBSOCKET_MAX_WRITE_BUFFER_SIZE` environment variable.
///
/// # Environment Variable
///
/// Set `LYXAL_WEBSOCKET_MAX_WRITE_BUFFER_SIZE` to configure this value. The value
...
pub static WEBSOCKET_MAX_WRITE_BUFFER_SIZE: LazyLock<usize> = LazyLock::new(|| {
	let buffer_size = || {
		let var = env::var("LYXAL_WEBSOCKET_MAX_WRITE_BUFFER_SIZE").ok()?;
...
pub static WEBSOCKET_RESPONSE_CHANNEL_SIZE: LazyLock<usize> =
	lazy_env_parse!("LYXAL_WEBSOCKET_RESPONSE_CHANNEL_SIZE", usize, 100);
...
pub static WEBSOCKET_RESPONSE_BUFFER_SIZE: LazyLock<usize> =
	lazy_env_parse!("LYXAL_WEBSOCKET_RESPONSE_BUFFER_SIZE", usize, 0);
...
pub static WEBSOCKET_RESPONSE_FLUSH_PERIOD: LazyLock<u64> =
	lazy_env_parse!("LYXAL_WEBSOCKET_RESPONSE_FLUSH_PERIOD", u64, 3);
...
pub static RUNTIME_STACK_SIZE: LazyLock<usize> =
	lazy_env_parse!("LYXAL_RUNTIME_STACK_SIZE", usize, || {
...
pub static TELEMETRY_NAMESPACE: LazyLock<Option<String>> =
	lazy_env_parse!("LYXAL_TELEMETRY_NAMESPACE", Option<String>);
...
pub static TELEMETRY_DISABLE_TRACING: LazyLock<bool> =
	lazy_env_parse!("LYXAL_TELEMETRY_DISABLE_TRACING", bool);
...
pub static TELEMETRY_DISABLE_METRICS: LazyLock<bool> =
	lazy_env_parse!("LYXAL_TELEMETRY_DISABLE_METRICS", bool);

/// The version identifier of this build
pub static PKG_VERSION: LazyLock<String> = LazyLock::new(|| {
	// Use LYXAL_BUILD_VERSION if set, otherwise fall back to CARGO_PKG_VERSION
	let version = option_env!("LYXAL_BUILD_VERSION")
		.filter(|v| !v.trim().is_empty())
		.unwrap_or(env!("CARGO_PKG_VERSION"));
	// Append build metadata if set
	match option_env!("LYXAL_BUILD_METADATA") {
