...
pub(crate) struct AuthArguments {
	...
	#[arg(env = "LYXAL_AUTH_LEVEL", long = "auth-level", default_value = "root", requires_all = ["username", "password"])]
...
pub struct DatabaseSelectionArguments {
	...
	#[arg(env = "LYXAL_NAMESPACE", long = "namespace", visible_alias = "ns")]
	pub(crate) namespace: String,
	#[arg(help = "The database selected for the operation")]
	#[arg(env = "LYXAL_DATABASE", long = "database", visible_alias = "db")]
