...
use lyxal::Connection;
use lyxal::engine::any::{self, connect};
use lyxal::method::{Export, ExportConfig};
use lyxal_core::kvs::export::TableConfig;
...
pub struct ExportCommandArguments {
	#[arg(help = "Path to the LyxalQL file to export. Use dash - to write into stdout.")]
	#[arg(default_value = "-")]
	#[arg(index = 1)]
	file: String,
	#[command(flatten)]
...
pub async fn init(
	...
	info!("The LyxalQL file was exported successfully");
	// Everything OK
	Ok(())
}
