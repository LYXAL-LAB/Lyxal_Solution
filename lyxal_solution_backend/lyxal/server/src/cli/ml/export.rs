...
pub struct ModelArguments {
	...
	#[arg(env = "LYXAL_ML_EXPORT_MODEL_NAME", long = "name")]
	pub(crate) name: String,
	#[arg(help = "The version of the model")]
	#[arg(env = "LYXAL_ML_EXPORT_MODEL_VERSION", long = "version")]
	pub(crate) version: String,
}

#[derive(Args, Debug)]
pub struct ExportCommandArguments {
	#[arg(help = "Path to the LyxalML file to export. Use dash - to write into stdout.")]
	#[arg(default_value = "-")]
	#[arg(index = 1)]
	file: String,
...
pub async fn init(
	...
	info!("The LyxalML file was exported successfully");
	// All ok
	Ok(())
}
