...
use crate::types::{
	Action, Notification as CoreNotification, RecordId, LyxalValue, Value, Variables,
};
use crate::{Connection, Error, ExtraFeatures, Result, Lyxal};
...
pub(crate) fn kill<Client>(client: &Lyxal<Client>, uuid: Uuid)
where
	Client: Connection,
{
