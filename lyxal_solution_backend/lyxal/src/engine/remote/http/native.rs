...
use lyxal_core::config::cnf::LYXAL_USER_AGENT;
...
use crate::{Error, ExtraFeatures, Result, SessionClone, SessionId, Lyxal, conn};
...
pub(crate) async fn create_client(
	...
	for addr in addrs {
		...
		let req = client
			...
			.header(reqwest::header::USER_AGENT, &*LYXAL_USER_AGENT);
