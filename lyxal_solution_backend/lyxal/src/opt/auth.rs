...
use crate::types::{Kind, Object, LyxalValue, Value, kind};
...
pub trait Credentials<Action>: LyxalValue {}

/// Credentials for the root user
#[derive(Debug, Clone, LyxalValue)]
...
#[derive(Debug)]
pub struct Record<P: LyxalValue> {
	/// The namespace the user has access to
	pub namespace: String,
	/// The database the user has access to
	pub database: String,
...
impl<P: LyxalValue> LyxalValue for Record<P> {
	fn kind_of() -> Kind {
...
impl<T, P> Credentials<T> for Record<P> where P: LyxalValue {}
...
/// Lyxal's signin and signup operations. It contains an access token
...
///
/// ```rust
/// use Lyxal::opt::auth::{Token, AccessToken, RefreshToken};
///
...
#[derive(Debug, Clone, Serialize, Deserialize, LyxalValue)]
#[lyxal(crate = "crate::types")]
...
///
/// ```rust
/// use Lyxal::opt::auth::RefreshToken;
///
...
#[derive(Clone, Serialize, Deserialize, LyxalValue)]
#[lyxal(crate = "crate::types")]
