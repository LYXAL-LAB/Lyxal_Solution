...
use lyxal_core::rpc::DbResultStats;

use crate::method::live::Stream;
use crate::notification::Notification;
use crate::types::{LyxalValue, Value};
...
impl<T> QueryResult<Option<T>> for usize where T: LyxalValue {}
...
impl<T> QueryResult<Option<T>> for (usize, &str) where T: LyxalValue {}
...
impl<T> QueryResult<Vec<T>> for usize where T: LyxalValue {}
...
impl<T> QueryResult<Vec<T>> for (usize, &str) where T: LyxalValue {}
...
impl<T> QueryResult<LinkedList<T>> for usize where T: LyxalValue {}
...
impl<T> QueryResult<LinkedList<T>> for (usize, &str) where T: LyxalValue {}
...
impl<T> QueryResult<HashSet<T>> for usize where T: LyxalValue + Hash + Eq {}
impl<T> query_result::Sealed<HashSet<T>> for usize
where
	T: LyxalValue + Hash + Eq,
{
...
impl<T> QueryResult<HashSet<T>> for (usize, &str) where T: LyxalValue + Hash + Eq {}
...
impl<T> QueryResult<Option<T>> for &str where T: LyxalValue {}
...
impl<T> QueryResult<Vec<T>> for &str where T: LyxalValue {}
...
impl<T> QueryResult<LinkedList<T>> for &str where T: LyxalValue {}
...
impl<T> QueryResult<HashSet<T>> for &str where T: LyxalValue + Hash + Eq {}
...
impl<R> QueryStream<Notification<R>> for usize where R: LyxalValue + Unpin {}
...
impl<R> QueryStream<Notification<R>> for () where R: LyxalValue + Unpin {}
