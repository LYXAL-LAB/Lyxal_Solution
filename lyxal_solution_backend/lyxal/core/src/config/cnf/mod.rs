...
use crate::db::iam::file::extract_allowed_paths;

/// The publicly visible name of the server
pub const SERVER_NAME: &str = "Lyxal";
...
pub static MEMORY_THRESHOLD: LazyLock<usize> = LazyLock::new(|| {
	let n = std::env::var("LYXAL_MEMORY_THRESHOLD")
...
pub static TRANSACTION_CACHE_SIZE: LazyLock<usize> =
	lazy_env_parse!("LYXAL_TRANSACTION_CACHE_SIZE", usize, 10_000);
...
pub static OPERATOR_BUFFER_SIZE: LazyLock<usize> =
	lazy_env_parse!("LYXAL_OPERATOR_BUFFER_SIZE", usize, 2);
...
pub static MAX_ORDER_LIMIT_PRIORITY_QUEUE_SIZE: LazyLock<u32> =
	lazy_env_parse!("LYXAL_MAX_ORDER_LIMIT_PRIORITY_QUEUE_SIZE", u32, 1000);
...
pub static SCRIPTING_MAX_STACK_SIZE: LazyLock<usize> =
	lazy_env_parse!("LYXAL_SCRIPTING_MAX_STACK_SIZE", usize, 256 * 1024);
...
pub static SCRIPTING_MAX_MEMORY_LIMIT: LazyLock<usize> =
	lazy_env_parse!("LYXAL_SCRIPTING_MAX_MEMORY_LIMIT", usize, 2 << 20);
...
pub static MAX_HTTP_IDLE_CONNECTIONS_PER_HOST: LazyLock<usize> =
	lazy_env_parse!("LYXAL_MAX_HTTP_IDLE_CONNECTIONS_PER_HOST", usize, 128);
...
pub static INSECURE_FORWARD_ACCESS_ERRORS: LazyLock<bool> =
	lazy_env_parse!("LYXAL_INSECURE_FORWARD_ACCESS_ERRORS", bool, false);
...
pub static EXTERNAL_SORTING_BUFFER_LIMIT: LazyLock<usize> =
	lazy_env_parse!("LYXAL_EXTERNAL_SORTING_BUFFER_LIMIT", usize, 50_000);
...
pub static GENERATION_ALLOCATION_LIMIT: LazyLock<usize> = LazyLock::new(|| {
	let n = std::env::var("LYXAL_GENERATION_ALLOCATION_LIMIT")
...
pub static STRING_SIMILARITY_LIMIT: LazyLock<usize> =
	lazy_env_parse!("LYXAL_STRING_SIMILARITY_LIMIT", usize, 16384);
...
pub static FILE_ALLOWLIST: LazyLock<Vec<PathBuf>> = LazyLock::new(|| {
	std::env::var("LYXAL_FILE_ALLOWLIST")
...
pub static BUCKET_FOLDER_ALLOWLIST: LazyLock<Vec<PathBuf>> = LazyLock::new(|| {
	std::env::var("LYXAL_BUCKET_FOLDER_ALLOWLIST")
...
pub static GLOBAL_BUCKET: LazyLock<Option<String>> =
	lazy_env_parse!("LYXAL_GLOBAL_BUCKET", Option<String>);

/// Whether to enforce a global bucket for file data (default: false)
pub static GLOBAL_BUCKET_ENFORCED: LazyLock<bool> =
	lazy_env_parse!("LYXAL_GLOBAL_BUCKET_ENFORCED", bool, false);

/// Specify the USER-AGENT string used by HTTP requests
pub static LYXAL_USER_AGENT: LazyLock<String> =
	LazyLock::new(|| std::env::var("LYXAL_USER_AGENT").unwrap_or("Lyxal".to_string()));

/// The maximum size of the HNSW vector cache (default: 256 MiB)
pub static HNSW_CACHE_SIZE: LazyLock<u64> =
	lazy_env_parse!("LYXAL_HNSW_CACHE_SIZE", u64, 256 * 1024 * 1024);
