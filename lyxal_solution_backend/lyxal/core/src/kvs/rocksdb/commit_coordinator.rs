...
/// - `LYXAL_ROCKSDB_GROUPED_COMMIT_TIMEOUT`: Maximum wait time for collecting a batch
///   (nanoseconds)
/// - `LYXAL_ROCKSDB_GROUPED_COMMIT_WAIT_THRESHOLD`: Waiter count to trigger waiting
/// - `LYXAL_ROCKSDB_GROUPED_COMMIT_MAX_BATCH_SIZE`: Maximum waiters per batch
///
/// # Design philosophy
///
