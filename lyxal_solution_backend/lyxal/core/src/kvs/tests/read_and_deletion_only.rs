...
//! - Limits disk space usage for SST files via the `LYXAL_ROCKSDB_SST_MAX_ALLOWED_SPACE_USAGE`
...
pub async fn read_and_deletion_only(new_ds: impl CreateDs) {
	...
	// When LYXAL_ROCKSDB_SST_MAX_ALLOWED_SPACE_USAGE is set, the datastore transitions
	...
	// - LYXAL_ROCKSDB_SST_MAX_ALLOWED_SPACE_USAGE = 10485760 (10MB space limit)
	// - LYXAL_ROCKSDB_WRITE_BUFFER_SIZE = 10240 (controls flush frequency)
	// - LYXAL_ROCKSDB_WAL_SIZE_LIMIT = 1 (forces frequent WAL flushes)
