...
use crate::api::X_LYXAL_REQUEST_ID;
use crate::api::err::ApiError;
use crate::api::request::ApiRequest;
use crate::db::catalog::providers::DatabaseProvider;
use crate::db::catalog::{ApiDefinition, MiddlewareDefinition, Permission};
use crate::db::ctx::{Context, FrozenContext};
use crate::db::dbs::Options;
use crate::db::doc::CursorDoc;
use crate::db::expr::{Expr, FlowResultExt as _};
use crate::function::args::{Any, FromArgs, FromPublic};
use crate::db::iam::{Action, AuthLimit};
use crate::db::syn::function_with_capabilities;
...
pub async fn process_api_request_with_stack(
	...
	// Ensure X-Lyxal-Request-ID is present in final response headers (from res.request_id)
...
fn create_middleware_closure(
	...
	Closure::Builtin(Arc::new(
		move |stk: &mut Stk,
			...
			let function: crate::db::expr::Function =
