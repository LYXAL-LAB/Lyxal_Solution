...
impl ToSql for PrefixOperator {
	fn fmt_sql(&self, f: &mut String, sql_fmt: SqlFormat) {
		let prefix_operator: crate::db::sql::PrefixOperator = self.clone().into();
...
impl ToSql for PostfixOperator {
	fn fmt_sql(&self, f: &mut String, sql_fmt: SqlFormat) {
		let postfix_operator: crate::db::sql::PostfixOperator = self.clone().into();
...
impl ToSql for MatchesOperator {
	fn fmt_sql(&self, f: &mut String, sql_fmt: SqlFormat) {
		let matches_operator: crate::db::sql::operator::MatchesOperator = self.clone().into();
...
impl ToSql for NearestNeighbor {
	fn fmt_sql(&self, f: &mut String, sql_fmt: SqlFormat) {
		let nn: crate::db::sql::operator::NearestNeighbor = self.clone().into();
...
impl ToSql for BinaryOperator {
	fn fmt_sql(&self, f: &mut String, sql_fmt: SqlFormat) {
		let binary_operator: crate::db::sql::BinaryOperator = self.clone().into();
...
impl ToSql for AssignOperator {
	fn fmt_sql(&self, f: &mut String, sql_fmt: SqlFormat) {
		let op: crate::db::sql::AssignOperator = self.clone().into();
