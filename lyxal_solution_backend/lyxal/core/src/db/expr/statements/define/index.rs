...
use crate::db::catalog::{Index, IndexDefinition, TableDefinition, TableId};
use crate::db::ctx::FrozenContext;
use crate::db::dbs::Options;
use crate::db::doc::CursorDoc;
use crate::error::Error;
use crate::db::expr::parameterize::{expr_to_ident, exprs_to_fields};
use crate::db::expr::{Base, Expr, FlowResultExt, Literal, Part};
...
pub(in crate::db::expr::statements) async fn run_indexing(
	ctx: &FrozenContext,
	opt: &Options,
	tb: TableId,
