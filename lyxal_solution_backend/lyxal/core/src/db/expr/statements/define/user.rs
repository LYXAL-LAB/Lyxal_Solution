...
use crate::db::catalog::providers::{CatalogProvider, NamespaceProvider, UserProvider};
use crate::db::catalog::{self, UserDefinition};
...
use crate::db::expr::user::UserDuration;
use crate::db::expr::{Base, Expr, FlowResultExt, Idiom, Literal};
...
impl ToSql for DefineUserStatement {
	fn fmt_sql(&self, f: &mut String, fmt: SqlFormat) {
		let stmt: crate::db::sql::statements::define::DefineUserStatement = self.clone().into();
		stmt.fmt_sql(f, fmt);
	}
}
