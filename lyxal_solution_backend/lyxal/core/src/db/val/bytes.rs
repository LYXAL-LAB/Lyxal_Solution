...
impl From<lyxal_types::Bytes> for Bytes {
	fn from(v: lyxal_types::Bytes) -> Self {
		Bytes(v.into_inner())
	}
}

impl From<Bytes> for lyxal_types::Bytes {
	fn from(v: Bytes) -> Self {
		lyxal_types::Bytes::from(v.into_inner())
	}
}
