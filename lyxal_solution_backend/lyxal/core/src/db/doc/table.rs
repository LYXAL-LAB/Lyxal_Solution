...
use crate::db::catalog::aggregation::{self, AggregateFields, AggregationAnalysis, AggregationStat};
use crate::db::catalog::providers::TableProvider;
use crate::db::catalog::{Metadata, Record, RecordType, ViewDefinition};
use crate::db::ctx::FrozenContext;
use crate::db::dbs::{Options, Statement, Workable};
use crate::db::doc::{Action, CursorDoc, Document, DocumentContext, NsDbTbCtx};
...
use crate::db::idx::planner::RecordStrategy;

use crate::db::val::{Array, Number, RecordId, RecordIdKey, TableName, TryAdd, TryMul, TryPow, Value};
...
impl Document {
	...
	async fn process_view_record_create(
		...
		let k = crate::db::key::record::new(db.namespace_id, db.database_id, view_table_name, &key);
