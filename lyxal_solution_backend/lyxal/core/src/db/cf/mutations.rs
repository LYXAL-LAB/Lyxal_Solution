...
impl TableMutations {
	...
	pub(crate) fn push_record_change(
		&mut self,
		id: RecordId,
...
impl TableMutation {
	...
	pub(crate) fn into_value(self) -> Value {
		...
		let o = crate::db::val::Object::from(h);
		Value::Object(o)
	}
}
...
mod tests {
	...
	use super::*;
	use crate::db::catalog::{DatabaseId, NamespaceId, TableId};
