...
impl From<TableType> for crate::db::catalog::TableType {
...
impl From<crate::db::catalog::TableType> for TableType {
	fn from(v: crate::db::catalog::TableType) -> Self {
		match v {
			crate::db::catalog::TableType::Any => Self::Any,
			crate::db::catalog::TableType::Normal => Self::Normal,
			crate::db::catalog::TableType::Relation(rel) => Self::Relation(rel.into()),
		}
	}
}
...
impl From<Relation> for crate::db::catalog::Relation {
...
impl From<crate::db::catalog::Relation> for Relation {
	fn from(v: crate::db::catalog::Relation) -> Self {
		Self {
			from: v.from,
			to: v.to,
			enforced: v.enforced,
