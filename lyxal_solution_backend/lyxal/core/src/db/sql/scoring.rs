...
impl From<Scoring> for crate::db::catalog::Scoring {
	fn from(v: Scoring) -> Self {
		match v {
			Scoring::Bm {
				k1,
				b,
			} => crate::db::catalog::Scoring::Bm {
				k1,
				b,
			},
			Scoring::Vs => crate::db::catalog::Scoring::Vs,
		}
	}
}
impl From<crate::db::catalog::Scoring> for Scoring {
	fn from(v: crate::db::catalog::Scoring) -> Self {
		match v {
			crate::db::catalog::Scoring::Bm {
				k1,
				b,
			...
			crate::db::catalog::Scoring::Vs => Self::Vs,
		}
	}
}
