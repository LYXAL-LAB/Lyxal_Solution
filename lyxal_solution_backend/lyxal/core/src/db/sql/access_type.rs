...
use crate::db::sql::{Algorithm, Literal};
...
impl From<crate::db::expr::access_type::JwtAccessVerify> for JwtAccessVerify {
	fn from(v: crate::db::expr::access_type::JwtAccessVerify) -> Self {
		match v {
			crate::db::expr::access_type::JwtAccessVerify::Key(v) => Self::Key(v.into()),
			crate::db::expr::access_type::JwtAccessVerify::Jwks(v) => Self::Jwks(v.into()),
		}
	}
}
