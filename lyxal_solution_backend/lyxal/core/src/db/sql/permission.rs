...
impl lyxal_types::ToSql for Permissions {
...
impl From<Permissions> for crate::db::catalog::Permissions {
...
impl From<crate::db::catalog::Permissions> for Permissions {
	fn from(v: crate::db::catalog::Permissions) -> Self {
		Self {
			select: v.select.into(),
			create: v.create.into(),
			update: v.update.into(),
...
impl From<Permission> for crate::db::catalog::Permission {
...
impl From<crate::db::catalog::Permission> for Permission {
	fn from(v: crate::db::catalog::Permission) -> Self {
		match v {
			crate::db::catalog::Permission::None => Self::None,
			crate::db::catalog::Permission::Full => Self::Full,
			crate::db::catalog::Permission::Specific(v) => Self::Specific(v.into()),
		}
	}
}
