...
impl From<Constant> for crate::db::expr::Constant {
...
impl From<crate::db::expr::Constant> for Constant {
	fn from(value: crate::db::expr::Constant) -> Self {
		match value {
			crate::db::expr::Constant::MathE => Self::MathE,
			crate::db::expr::Constant::MathFrac1Pi => Self::MathFrac1Pi,
			crate::db::expr::Constant::MathFrac1Sqrt2 => Self::MathFrac1Sqrt2,
			crate::db::expr::Constant::MathFrac2Pi => Self::MathFrac2Pi,
			crate::db::expr::Constant::MathFrac2SqrtPi => Self::MathFrac2SqrtPi,
			crate::db::expr::Constant::MathFracPi2 => Self::MathFracPi2,
			crate::db::expr::Constant::MathFracPi3 => Self::MathFracPi3,
			crate::db::expr::Constant::MathFracPi4 => Self::MathFracPi4,
			crate::db::expr::Constant::MathFracPi6 => Self::MathFracPi6,
			crate::db::expr::Constant::MathFracPi8 => Self::MathFracPi8,
			crate::db::expr::Constant::MathInf => Self::MathInf,
			crate::db::expr::Constant::MathLn10 => Self::MathLn10,
			crate::db::expr::Constant::MathLn2 => Self::MathLn2,
			crate::db::expr::Constant::MathLog102 => Self::MathLog102,
			crate::db::expr::Constant::MathLog10E => Self::MathLog10E,
			crate::db::expr::Constant::MathLog210 => Self::MathLog210,
			crate::db::expr::Constant::MathLog2E => Self::MathLog2E,
			crate::db::expr::Constant::MathNegInf => Self::MathNegInf,
			crate::db::expr::Constant::MathPi => Self::MathPi,
			crate::db::expr::Constant::MathSqrt2 => Self::MathSqrt2,
			crate::db::expr::Constant::MathTau => Self::MathTau,
			crate::db::expr::Constant::TimeEpoch => Self::TimeEpoch,
			crate::db::expr::Constant::TimeMin => Self::TimeMin,
			crate::db::expr::Constant::TimeMax => Self::TimeMax,
			crate::db::expr::Constant::DurationMax => Self::DurationMax,
		}
	}
}
