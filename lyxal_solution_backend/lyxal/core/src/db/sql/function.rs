...
use crate::utils::fmt::{CoverStmts, EscapeIdent, EscapeKwFreeIdent, Fmt};
use crate::db::sql::{Expr, Idiom, Model, Script};
...
impl From<Function> for crate::db::expr::Function {
	fn from(v: Function) -> Self {
		match v {
			Function::Normal(s) => crate::db::expr::Function::Normal(s),
			Function::Custom(s) => crate::db::expr::Function::Custom(s),
			Function::Script(s) => crate::db::expr::Function::Script(s.into()),
			Function::Model(m) => crate::db::expr::Function::Model(m.into()),
			Function::Module(m, s) => crate::db::expr::Function::Module(m, s),
			Function::Silo {
				org,
				pkg,
				major,
...
impl From<crate::db::expr::Function> for Function {
	fn from(v: crate::db::expr::Function) -> Self {
		match v {
			crate::db::expr::Function::Normal(s) => Self::Normal(s),
			crate::db::expr::Function::Custom(s) => Self::Custom(s),
			crate::db::expr::Function::Script(s) => Self::Script(s.into()),
			crate::db::expr::Function::Model(m) => Self::Model(m.into()),
			crate::db::expr::Function::Module(m, s) => Self::Module(m, s),
			crate::db::expr::Function::Silo {
				org,
				pkg,
				major,
...
impl From<FunctionCall> for crate::db::expr::FunctionCall {
	fn from(value: FunctionCall) -> Self {
		crate::db::expr::FunctionCall {
...
impl From<crate::db::expr::FunctionCall> for FunctionCall {
	fn from(value: crate::db::expr::FunctionCall) -> Self {
		FunctionCall {
			receiver: value.receiver.into(),
			arguments: value.arguments.into_iter().map(Into::into).collect(),
		}
