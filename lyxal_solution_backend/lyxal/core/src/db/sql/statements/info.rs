...
impl From<InfoStatement> for crate::db::expr::statements::InfoStatement {
...
impl From<crate::db::expr::statements::InfoStatement> for InfoStatement {
	fn from(v: crate::db::expr::statements::InfoStatement) -> Self {
		match v {
			crate::db::expr::statements::InfoStatement::Root(v) => Self::Root(v),
			crate::db::expr::statements::InfoStatement::Ns(v) => Self::Ns(v),
			crate::db::expr::statements::InfoStatement::Db(v, ver) => Self::Db(v, ver.map(From::from)),
			crate::db::expr::statements::InfoStatement::Tb(t, v, ver) => {
				Self::Tb(t.into(), v, ver.map(From::from))
			}
			crate::db::expr::statements::InfoStatement::User(u, b, v) => {
				Self::User(u.into(), b.map(Into::into), v)
			}
			crate::db::expr::statements::InfoStatement::Index(i, t, v) => {
