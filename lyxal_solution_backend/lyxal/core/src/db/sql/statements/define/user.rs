...
impl From<DefineUserStatement> for crate::db::expr::statements::DefineUserStatement {
	fn from(v: DefineUserStatement) -> Self {
		...
		Self {
			...
			code,
			roles: v.roles,
			duration: crate::db::expr::user::UserDuration {
...
impl From<crate::db::expr::statements::DefineUserStatement> for DefineUserStatement {
	fn from(v: crate::db::expr::statements::DefineUserStatement) -> Self {
		Self {
			kind: v.kind.into(),
			name: v.name.into(),
			base: v.base.into(),
