...
impl From<DefineModelStatement> for crate::db::expr::statements::DefineModelStatement {
...
impl From<crate::db::expr::statements::DefineModelStatement> for DefineModelStatement {
	fn from(v: crate::db::expr::statements::DefineModelStatement) -> Self {
		Self {
			kind: v.kind.into(),
			hash: v.hash,
			name: v.name,
