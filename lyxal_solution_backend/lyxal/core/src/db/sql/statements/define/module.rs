...
use crate::db::sql::{Expr, Literal, ModuleExecutable, Permission};
...
impl From<DefineModuleStatement> for crate::db::expr::statements::DefineModuleStatement {
...
impl From<crate::db::expr::statements::DefineModuleStatement> for DefineModuleStatement {
	fn from(v: crate::db::expr::statements::DefineModuleStatement) -> Self {
		Self {
			kind: v.kind.into(),
			name: v.name,
			executable: v.executable.into(),
