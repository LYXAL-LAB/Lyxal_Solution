...
use crate::db::sql::{Expr, Literal, Permissions, TableType, View};
...
impl From<DefineTableStatement> for crate::db::expr::statements::DefineTableStatement {
	fn from(v: DefineTableStatement) -> Self {
		crate::db::expr::statements::DefineTableStatement {
			kind: v.kind.into(),
			id: v.id,
			name: v.name.into(),
			drop: v.drop,
...
impl From<crate::db::expr::statements::DefineTableStatement> for DefineTableStatement {
	fn from(v: crate::db::expr::statements::DefineTableStatement) -> Self {
