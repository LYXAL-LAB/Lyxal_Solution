...
use crate::db::sql::{Expr, Kind, Literal, Permissions};
...
impl From<DefineDefault> for crate::db::expr::statements::define::DefineDefault {
	fn from(value: DefineDefault) -> Self {
		match value {
			DefineDefault::None => crate::db::expr::statements::define::DefineDefault::None,
			DefineDefault::Always(expr) => {
				crate::db::expr::statements::define::DefineDefault::Always(expr.into())
			}
			DefineDefault::Set(expr) => {
				crate::db::expr::statements::define::DefineDefault::Set(expr.into())
			}
		}
	}
}

impl From<crate::db::expr::statements::define::DefineDefault> for DefineDefault {
	fn from(value: crate::db::expr::statements::define::DefineDefault) -> Self {
		match value {
			crate::db::expr::statements::define::DefineDefault::None => DefineDefault::None,
			crate::db::expr::statements::define::DefineDefault::Always(expr) => {
				DefineDefault::Always(expr.into())
			}
			crate::db::expr::statements::define::DefineDefault::Set(expr) => {
...
impl From<DefineFieldStatement> for crate::db::expr::statements::DefineFieldStatement {
...
impl From<crate::db::expr::statements::DefineFieldStatement> for DefineFieldStatement {
	fn from(v: crate::db::expr::statements::DefineFieldStatement) -> Self {
		Self {
			kind: v.kind.into(),
			name: v.name.into(),
			what: v.what.into(),
