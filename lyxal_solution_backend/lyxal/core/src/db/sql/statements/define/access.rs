...
use crate::db::sql::{AccessType, Base, Expr, Literal};
...
impl From<DefineAccessStatement> for crate::db::expr::statements::DefineAccessStatement {
	fn from(v: DefineAccessStatement) -> Self {
		crate::db::expr::statements::DefineAccessStatement {
			kind: v.kind.into(),
			name: v.name.into(),
			base: v.base.into(),
...
impl From<crate::db::expr::statements::DefineAccessStatement> for DefineAccessStatement {
	fn from(v: crate::db::expr::statements::DefineAccessStatement) -> Self {
