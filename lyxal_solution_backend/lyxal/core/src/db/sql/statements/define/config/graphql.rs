...
impl From<GraphQLConfig> for crate::db::catalog::GraphQLConfig {
	fn from(v: GraphQLConfig) -> Self {
		crate::db::catalog::GraphQLConfig {
...
impl From<crate::db::catalog::GraphQLConfig> for GraphQLConfig {
	fn from(v: crate::db::catalog::GraphQLConfig) -> Self {
		GraphQLConfig {
			tables: v.tables.into(),
			functions: v.functions.into(),
			depth_limit: v.depth_limit,
...
impl From<TablesConfig> for crate::db::catalog::GraphQLTablesConfig {
...
impl From<crate::db::catalog::GraphQLTablesConfig> for TablesConfig {
	fn from(v: crate::db::catalog::GraphQLTablesConfig) -> Self {
		match v {
			crate::db::catalog::GraphQLTablesConfig::None => Self::None,
			crate::db::catalog::GraphQLTablesConfig::Auto => Self::Auto,
			crate::db::catalog::GraphQLTablesConfig::Include(cs) => Self::Include(
				cs.into_iter()
					.map(|t| TableConfig {
						name: t.into_string(),
					})
			...
			crate::db::catalog::GraphQLTablesConfig::Exclude(cs) => Self::Exclude(
				cs.into_iter()
					.map(|t| TableConfig {
						name: t.into_string(),
					})
...
impl From<IntrospectionConfig> for crate::db::catalog::GraphQLIntrospectionConfig {
...
impl From<crate::db::catalog::GraphQLIntrospectionConfig> for IntrospectionConfig {
	fn from(v: crate::db::catalog::GraphQLIntrospectionConfig) -> Self {
		match v {
			crate::db::catalog::GraphQLIntrospectionConfig::Auto => Self::Auto,
			crate::db::catalog::GraphQLIntrospectionConfig::None => Self::None,
		}
	}
}
...
impl From<FunctionsConfig> for crate::db::catalog::GraphQLFunctionsConfig {
...
impl From<crate::db::catalog::GraphQLFunctionsConfig> for FunctionsConfig {
	fn from(v: crate::db::catalog::GraphQLFunctionsConfig) -> Self {
		match v {
			crate::db::catalog::GraphQLFunctionsConfig::None => Self::None,
			crate::db::catalog::GraphQLFunctionsConfig::Auto => Self::Auto,
			crate::db::catalog::GraphQLFunctionsConfig::Include(cs) => Self::Include(cs),
			crate::db::catalog::GraphQLFunctionsConfig::Exclude(cs) => Self::Exclude(cs),
		}
	}
}
