...
use crate::db::sql::{Expr, Index, Literal};
...
impl From<DefineIndexStatement> for crate::db::expr::statements::DefineIndexStatement {
...
impl From<crate::db::expr::statements::DefineIndexStatement> for DefineIndexStatement {
	fn from(v: crate::db::expr::statements::DefineIndexStatement) -> Self {
		Self {
			kind: v.kind.into(),
			name: v.name.into(),
			what: v.what.into(),
