...
impl From<DefineNamespaceStatement> for crate::db::expr::statements::DefineNamespaceStatement {
...
impl From<crate::db::expr::statements::DefineNamespaceStatement> for DefineNamespaceStatement {
	fn from(v: crate::db::expr::statements::DefineNamespaceStatement) -> Self {
		Self {
			kind: v.kind.into(),
			id: v.id,
			name: v.name.into(),
