...
impl From<DefineParamStatement> for crate::db::expr::statements::DefineParamStatement {
...
impl From<crate::db::expr::statements::DefineParamStatement> for DefineParamStatement {
	fn from(v: crate::db::expr::statements::DefineParamStatement) -> Self {
