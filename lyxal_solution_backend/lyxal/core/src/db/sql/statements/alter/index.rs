...
impl From<AlterIndexStatement> for crate::db::expr::statements::alter::AlterIndexStatement {
	fn from(v: AlterIndexStatement) -> Self {
		crate::db::expr::statements::alter::AlterIndexStatement {
			name: v.name,
			table: v.table.into(),
...
impl From<crate::db::expr::statements::alter::AlterIndexStatement> for AlterIndexStatement {
	fn from(v: crate::db::expr::statements::alter::AlterIndexStatement) -> Self {
		AlterIndexStatement {
			name: v.name,
