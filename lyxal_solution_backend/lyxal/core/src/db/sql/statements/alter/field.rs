...
use super::AlterKind;
use crate::utils::fmt::{CoverStmts, EscapeKwFreeIdent, QuoteStr};
use crate::db::sql::reference::Reference;
use crate::db::sql::{Expr, Idiom, Kind, Permissions};
...
impl From<crate::db::expr::statements::alter::AlterDefault> for AlterDefault {
	fn from(value: crate::db::expr::statements::alter::AlterDefault) -> Self {
		match value {
			crate::db::expr::statements::alter::AlterDefault::None => AlterDefault::None,
			crate::db::expr::statements::alter::AlterDefault::Drop => AlterDefault::Drop,
			crate::db::expr::statements::alter::AlterDefault::Always(expr) => {
				AlterDefault::Always(expr.into())
			}
			crate::db::expr::statements::alter::AlterDefault::Set(expr) => {
...
impl From<AlterDefault> for crate::db::expr::statements::alter::AlterDefault {
	fn from(value: AlterDefault) -> Self {
		match value {
			AlterDefault::None => crate::db::expr::statements::alter::AlterDefault::None,
			AlterDefault::Drop => crate::db::expr::statements::alter::AlterDefault::Drop,
			AlterDefault::Always(expr) => {
				crate::db::expr::statements::alter::AlterDefault::Always(expr.into())
			}
			AlterDefault::Set(expr) => {
				crate::db::expr::statements::alter::AlterDefault::Set(expr.into())
			}
		}
	}
}
...
pub struct AlterFieldStatement {
	#[cfg_attr(feature = "arbitrary", arbitrary(with = crate::db::sql::arbitrary::local_idiom))]
	pub name: Idiom,
	pub what: String,
	pub if_exists: bool,
...
impl From<AlterFieldStatement> for crate::db::expr::statements::alter::AlterFieldStatement {
	fn from(v: AlterFieldStatement) -> Self {
		crate::db::expr::statements::alter::AlterFieldStatement {
			name: v.name.into(),
			what: v.what.into(),
...
impl From<crate::db::expr::statements::alter::AlterFieldStatement> for AlterFieldStatement {
	fn from(v: crate::db::expr::statements::alter::AlterFieldStatement) -> Self {
		AlterFieldStatement {
			name: v.name.into(),
