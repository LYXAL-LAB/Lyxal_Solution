...
impl From<AlterDatabaseStatement> for crate::db::expr::statements::alter::AlterDatabaseStatement {
	fn from(v: AlterDatabaseStatement) -> Self {
		crate::db::expr::statements::alter::AlterDatabaseStatement {
			compact: v.compact,
		}
	}
}
impl From<crate::db::expr::statements::alter::AlterDatabaseStatement> for AlterDatabaseStatement {
	fn from(v: crate::db::expr::statements::alter::AlterDatabaseStatement) -> Self {
