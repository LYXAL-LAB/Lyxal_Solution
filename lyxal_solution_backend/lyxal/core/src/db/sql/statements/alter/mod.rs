...
impl<A, B> From<AlterKind<A>> for crate::db::expr::statements::alter::AlterKind<B>
where
	B: From<A>,
{
	fn from(value: AlterKind<A>) -> Self {
		match value {
			AlterKind::Set(a) => crate::db::expr::statements::alter::AlterKind::Set(a.into()),
			AlterKind::Drop => crate::db::expr::statements::alter::AlterKind::Drop,
			AlterKind::None => crate::db::expr::statements::alter::AlterKind::None,
		}
	}
}

impl<A, B> From<crate::db::expr::statements::alter::AlterKind<A>> for AlterKind<B>
where
	B: From<A>,
{
	fn from(value: crate::db::expr::statements::alter::AlterKind<A>) -> Self {
		match value {
			crate::db::expr::statements::alter::AlterKind::Set(a) => AlterKind::Set(a.into()),
			crate::db::expr::statements::alter::AlterKind::Drop => AlterKind::Drop,
			crate::db::expr::statements::alter::AlterKind::None => AlterKind::None,
		}
	}
}
...
impl From<AlterStatement> for crate::db::expr::statements::AlterStatement {
...
impl From<crate::db::expr::statements::AlterStatement> for AlterStatement {
	fn from(v: crate::db::expr::statements::AlterStatement) -> Self {
		match v {
			crate::db::expr::statements::AlterStatement::System(v) => Self::System(v.into()),
			crate::db::expr::statements::AlterStatement::Namespace(v) => Self::Namespace(v.into()),
			crate::db::expr::statements::AlterStatement::Database(v) => Self::Database(v.into()),
			crate::db::expr::statements::AlterStatement::Table(v) => Self::Table(v.into()),
			crate::db::expr::statements::AlterStatement::Index(v) => Self::Index(v.into()),
			crate::db::expr::statements::AlterStatement::Sequence(v) => Self::Sequence(v.into()),
			crate::db::expr::statements::AlterStatement::Field(v) => Self::Field(v.into()),
		}
	}
}
