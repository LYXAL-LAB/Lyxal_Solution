...
use super::AlterKind;
use crate::utils::fmt::{EscapeKwFreeIdent, EscapeKwIdent, QuoteStr};
use crate::db::sql::{ChangeFeed, Permissions, TableType};
...
impl From<AlterTableStatement> for crate::db::expr::statements::alter::AlterTableStatement {
	fn from(v: AlterTableStatement) -> Self {
		crate::db::expr::statements::alter::AlterTableStatement {
			name: v.name.into(),
...
impl From<crate::db::expr::statements::alter::AlterTableStatement> for AlterTableStatement {
	fn from(v: crate::db::expr::statements::alter::AlterTableStatement) -> Self {
		AlterTableStatement {
