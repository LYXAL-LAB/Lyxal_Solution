...
impl From<AlterNamespaceStatement> for crate::db::expr::statements::alter::AlterNamespaceStatement {
	fn from(v: AlterNamespaceStatement) -> Self {
		crate::db::expr::statements::alter::AlterNamespaceStatement {
			compact: v.compact,
		}
	}
}
impl From<crate::db::expr::statements::alter::AlterNamespaceStatement> for AlterNamespaceStatement {
	fn from(v: crate::db::expr::statements::alter::AlterNamespaceStatement) -> Self {
