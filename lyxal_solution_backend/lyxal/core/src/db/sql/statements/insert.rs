...
impl From<InsertStatement> for crate::db::expr::statements::InsertStatement {
	fn from(v: InsertStatement) -> Self {
		crate::db::expr::statements::InsertStatement {
...
impl From<crate::db::expr::statements::InsertStatement> for InsertStatement {
	fn from(v: crate::db::expr::statements::InsertStatement) -> Self {
		InsertStatement {
			into: v.into.map(Into::into),
			data: v.data.into(),
			ignore: v.ignore,
