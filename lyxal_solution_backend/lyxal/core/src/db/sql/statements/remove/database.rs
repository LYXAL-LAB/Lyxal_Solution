...
impl From<RemoveDatabaseStatement> for crate::db::expr::statements::RemoveDatabaseStatement {
	fn from(v: RemoveDatabaseStatement) -> Self {
		crate::db::expr::statements::RemoveDatabaseStatement {
			name: v.name.into(),
...
impl From<crate::db::expr::statements::RemoveDatabaseStatement> for RemoveDatabaseStatement {
	fn from(v: crate::db::expr::statements::RemoveDatabaseStatement) -> Self {
