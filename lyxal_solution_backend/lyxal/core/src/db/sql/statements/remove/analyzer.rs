...
impl From<RemoveAnalyzerStatement> for crate::db::expr::statements::RemoveAnalyzerStatement {
	fn from(v: RemoveAnalyzerStatement) -> Self {
		crate::db::expr::statements::RemoveAnalyzerStatement {
			name: v.name.into(),
...
impl From<crate::db::expr::statements::RemoveAnalyzerStatement> for RemoveAnalyzerStatement {
	fn from(v: crate::db::expr::statements::RemoveAnalyzerStatement) -> Self {
