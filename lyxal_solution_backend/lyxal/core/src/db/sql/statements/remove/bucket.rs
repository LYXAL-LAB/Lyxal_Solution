...
impl From<RemoveBucketStatement> for crate::db::expr::statements::remove::RemoveBucketStatement {
	fn from(v: RemoveBucketStatement) -> Self {
		crate::db::expr::statements::remove::RemoveBucketStatement {
			name: v.name.into(),
...
impl From<crate::db::expr::statements::remove::RemoveBucketStatement> for RemoveBucketStatement {
	fn from(v: crate::db::expr::statements::remove::RemoveBucketStatement) -> Self {
