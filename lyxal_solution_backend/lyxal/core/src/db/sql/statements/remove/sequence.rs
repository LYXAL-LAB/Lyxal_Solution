...
impl From<RemoveSequenceStatement> for crate::db::expr::statements::remove::RemoveSequenceStatement {
	fn from(v: RemoveSequenceStatement) -> Self {
		crate::db::expr::statements::remove::RemoveSequenceStatement {
			name: v.name.into(),
...
impl From<crate::db::expr::statements::remove::RemoveSequenceStatement> for RemoveSequenceStatement {
	fn from(v: crate::db::expr::statements::remove::RemoveSequenceStatement) -> Self {
