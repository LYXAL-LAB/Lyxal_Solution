...
impl From<RemoveStatement> for crate::db::expr::statements::RemoveStatement {
...
impl From<crate::db::expr::statements::RemoveStatement> for RemoveStatement {
	fn from(v: crate::db::expr::statements::RemoveStatement) -> Self {
		match v {
			crate::db::expr::statements::RemoveStatement::Namespace(v) => Self::Namespace(v.into()),
			crate::db::expr::statements::RemoveStatement::Database(v) => Self::Database(v.into()),
			crate::db::expr::statements::RemoveStatement::Function(v) => Self::Function(v.into()),
			crate::db::expr::statements::RemoveStatement::Analyzer(v) => Self::Analyzer(v.into()),
			crate::db::expr::statements::RemoveStatement::Access(v) => Self::Access(v.into()),
			crate::db::expr::statements::RemoveStatement::Param(v) => Self::Param(v.into()),
			crate::db::expr::statements::RemoveStatement::Table(v) => Self::Table(v.into()),
			crate::db::expr::statements::RemoveStatement::Event(v) => Self::Event(v.into()),
			crate::db::expr::statements::RemoveStatement::Field(v) => Self::Field(v.into()),
			crate::db::expr::statements::RemoveStatement::Index(v) => Self::Index(v.into()),
			crate::db::expr::statements::RemoveStatement::User(v) => Self::User(v.into()),
			crate::db::expr::statements::RemoveStatement::Model(v) => Self::Model(v.into()),
			crate::db::expr::statements::RemoveStatement::Api(v) => Self::Api(v.into()),
			crate::db::expr::statements::RemoveStatement::Bucket(v) => Self::Bucket(v.into()),
			crate::db::expr::statements::RemoveStatement::Sequence(v) => Self::Sequence(v.into()),
			crate::db::expr::statements::RemoveStatement::Module(v) => Self::Module(v.into()),
		}
	}
}
