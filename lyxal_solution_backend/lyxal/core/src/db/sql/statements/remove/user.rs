...
impl From<RemoveUserStatement> for crate::db::expr::statements::RemoveUserStatement {
	fn from(v: RemoveUserStatement) -> Self {
		crate::db::expr::statements::RemoveUserStatement {
			name: v.name.into(),
...
impl From<crate::db::expr::statements::RemoveUserStatement> for RemoveUserStatement {
	fn from(v: crate::db::expr::statements::RemoveUserStatement) -> Self {
		RemoveUserStatement {
			name: v.name.into(),
			if_exists: v.if_exists,
			base: v.base.into(),
