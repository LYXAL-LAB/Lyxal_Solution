...
impl From<RemoveApiStatement> for crate::db::expr::statements::remove::RemoveApiStatement {
	fn from(v: RemoveApiStatement) -> Self {
		crate::db::expr::statements::remove::RemoveApiStatement {
			name: v.name.into(),
...
impl From<crate::db::expr::statements::remove::RemoveApiStatement> for RemoveApiStatement {
	fn from(v: crate::db::expr::statements::remove::RemoveApiStatement) -> Self {
		RemoveApiStatement {
			name: v.name.into(),
			if_exists: v.if_exists,
		}
