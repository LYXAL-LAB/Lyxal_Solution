...
impl From<RemoveTableStatement> for crate::db::expr::statements::RemoveTableStatement {
	fn from(v: RemoveTableStatement) -> Self {
		crate::db::expr::statements::RemoveTableStatement {
			name: v.name.into(),
...
impl From<crate::db::expr::statements::RemoveTableStatement> for RemoveTableStatement {
	fn from(v: crate::db::expr::statements::RemoveTableStatement) -> Self {
