...
impl From<RemoveNamespaceStatement> for crate::db::expr::statements::RemoveNamespaceStatement {
	fn from(v: RemoveNamespaceStatement) -> Self {
		crate::db::expr::statements::RemoveNamespaceStatement {
			name: v.name.into(),
...
impl From<crate::db::expr::statements::RemoveNamespaceStatement> for RemoveNamespaceStatement {
	fn from(v: crate::db::expr::statements::RemoveNamespaceStatement) -> Self {
