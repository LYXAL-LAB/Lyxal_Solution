...
impl From<RemoveModelStatement> for crate::db::expr::statements::RemoveModelStatement {
	fn from(v: RemoveModelStatement) -> Self {
		crate::db::expr::statements::RemoveModelStatement {
			name: v.name,
...
impl From<crate::db::expr::statements::RemoveModelStatement> for RemoveModelStatement {
	fn from(v: crate::db::expr::statements::RemoveModelStatement) -> Self {
