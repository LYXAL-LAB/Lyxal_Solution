...
impl From<RecordIdKeyRangeLit> for crate::db::expr::RecordIdKeyRangeLit {
	fn from(value: RecordIdKeyRangeLit) -> Self {
		crate::db::expr::RecordIdKeyRangeLit {
...
impl From<crate::db::expr::RecordIdKeyRangeLit> for RecordIdKeyRangeLit {
	fn from(value: crate::db::expr::RecordIdKeyRangeLit) -> Self {
		RecordIdKeyRangeLit {
			start: value.start.map(|x| x.into()),
			end: value.end.map(|x| x.into()),
		}
