...
use crate::db::sql::{Expr, Idiom, Lookup};
...
impl From<Part> for crate::db::expr::Part {
	fn from(v: Part) -> Self {
		match v {
			Part::All => Self::All,
			...
			Part::Recurse(recurse, idiom, instructions) => {
				...
				crate::db::expr::Part::Recurse(recurse.into(), idiom, instructions)
			}
			Part::Doc => crate::db::expr::Part::Doc,
			Part::RepeatRecurse => crate::db::expr::Part::RepeatRecurse,
		}
	}
}

impl From<crate::db::expr::Part> for Part {
	fn from(v: crate::db::expr::Part) -> Self {
		match v {
			crate::db::expr::Part::All => Self::All,
			crate::db::expr::Part::Flatten => Self::Flatten,
			crate::db::expr::Part::Last => Self::Last,
			crate::db::expr::Part::First => Self::First,
			crate::db::expr::Part::Field(ident) => Self::Field(ident),
			crate::db::expr::Part::Where(value) => Self::Where(value.into()),
			crate::db::expr::Part::Lookup(graph) => Self::Graph(graph.into()),
			crate::db::expr::Part::Value(value) => Self::Value(value.into()),
			crate::db::expr::Part::Start(value) => Self::Start(value.into()),
			crate::db::expr::Part::Method(method, values) => {
				Self::Method(method, values.into_iter().map(Into::into).collect())
			}
			crate::db::expr::Part::Destructure(parts) => {
				Self::Destructure(parts.into_iter().map(Into::<DestructurePart>::into).collect())
			}
			crate::db::expr::Part::Optional => Self::Optional,
			crate::db::expr::Part::Recurse(recurse, idiom, instructions) => Self::Recurse(
				recurse.into(),
				idiom.map(|idiom| idiom.into()),
				instructions.map(Into::into),
			),
			crate::db::expr::Part::Doc => Self::Doc,
			crate::db::expr::Part::RepeatRecurse => Self::RepeatRecurse,
		}
	}
}
...
impl From<DestructurePart> for crate::db::expr::part::DestructurePart {
...
impl From<crate::db::expr::part::DestructurePart> for DestructurePart {
	fn from(v: crate::db::expr::part::DestructurePart) -> Self {
		match v {
			crate::db::expr::part::DestructurePart::All(v) => Self::All(v),
			crate::db::expr::part::DestructurePart::Field(v) => Self::Field(v),
			crate::db::expr::part::DestructurePart::Aliased(v, idiom) => Self::Aliased(v, idiom.into()),
			crate::db::expr::part::DestructurePart::Destructure(v, d) => {
...
impl From<Recurse> for crate::db::expr::part::Recurse {
...
impl From<crate::db::expr::part::Recurse> for Recurse {
	fn from(v: crate::db::expr::part::Recurse) -> Self {
		match v {
			crate::db::expr::part::Recurse::Fixed(v) => Self::Fixed(v),
			crate::db::expr::part::Recurse::Range(min, max) => Self::Range(min, max),
		}
	}
}
// ------------------------------
...
impl From<RecurseInstruction> for crate::db::expr::part::RecurseInstruction {
...
impl From<crate::db::expr::part::RecurseInstruction> for RecurseInstruction {
	fn from(v: crate::db::expr::part::RecurseInstruction) -> Self {
		match v {
			crate::db::expr::part::RecurseInstruction::Path {
				inclusive,
			} => Self::Path {
				inclusive,
			},
			crate::db::expr::part::RecurseInstruction::Collect {
				inclusive,
			} => Self::Collect {
				inclusive,
			},
			crate::db::expr::part::RecurseInstruction::Shortest {
				expects,
				inclusive,
			} => Self::Shortest {
				expects: expects.into(),
