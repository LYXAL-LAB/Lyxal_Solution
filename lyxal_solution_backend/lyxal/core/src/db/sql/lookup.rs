...
use crate::db::sql::order::Ordering;
use crate::db::sql::{Cond, Dir, Fields, Groups, Idiom, Limit, RecordIdKeyRangeLit, Splits, Start};
...
impl From<Lookup> for crate::db::expr::Lookup {
...
impl From<crate::db::expr::Lookup> for Lookup {
	fn from(v: crate::db::expr::Lookup) -> Self {
		Lookup {
			kind: v.kind.into(),
...
impl From<LookupKind> for crate::db::expr::lookup::LookupKind {
...
impl From<crate::db::expr::lookup::LookupKind> for LookupKind {
	fn from(v: crate::db::expr::lookup::LookupKind) -> Self {
		match v {
			crate::db::expr::lookup::LookupKind::Graph(dir) => Self::Graph(dir.into()),
			crate::db::expr::lookup::LookupKind::Reference => Self::Reference,
		}
	}
}
...
impl From<LookupSubject> for crate::db::expr::lookup::LookupSubject {
...
impl From<crate::db::expr::lookup::LookupSubject> for LookupSubject {
	fn from(v: crate::db::expr::lookup::LookupSubject) -> Self {
		match v {
