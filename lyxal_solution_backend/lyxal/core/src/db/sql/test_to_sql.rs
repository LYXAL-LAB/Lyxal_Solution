...
use crate::db::sql::statements::access::{AccessStatementGrant, Subject};
use crate::db::sql::statements::alter::AlterKind;
use crate::db::sql::statements::live::LiveFields;
use crate::db::sql::statements::rebuild::RebuildIndexStatement;
use crate::db::sql::statements::show::ShowSince;
...
use crate::db::val::{Bytes, Duration, File, Geometry, Number, Object, RecordId, Set, Value};
                ...
                exprs: vec![(
                    Expr::Binary {
                        left: Box::new(Expr::Idiom(Idiom(vec![
                            crate::db::sql::Part::Field("user".to_string()),
                            crate::db::sql::Part::Field("active".to_string())
                        ]))),
