...
use super::*;
use crate::db::catalog::auth::AuthLimit;
use crate::db::catalog::crate::db::key::record::Record;
...
use crate::db::val::{Datetime, TableName, Value};
...
#[case::table(TableDefinition {
	...
	view: Some(ViewDefinition::Select {
		fields: Fields::Select(vec![Field::All, Field::Single (crate::db::expr::field::Selector{
...
#[case::user(UserDefinition {
	...
	session_duration: Some(Duration::from_secs(123)),
	comment: Some("comment".to_string()),
	base: crate::db::catalog::schema::base::Base::Root,
}, 40)]
