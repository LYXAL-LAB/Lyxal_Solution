...
use crate::db::catalog::schema::base::Base;
...
impl AccessDefinition {
	fn to_sql_definition(&self) -> sql::statements::define::DefineAccessStatement {
		...
		sql::statements::define::DefineAccessStatement {
			...
			access_type: sql::AccessType::from(crate::db::expr::AccessType::from(redacted_access_type)),
			...
			comment: self
				...
				.unwrap_or(sql::Expr::Literal(sql::Literal::None)),
			base: sql::Base::from(crate::db::expr::Base::from(self.base.clone())),
		}
	}
}
...
impl From<AccessType> for crate::db::expr::AccessType {
...
impl From<crate::db::expr::AccessType> for AccessType {
	fn from(v: crate::db::expr::AccessType) -> Self {
		match v {
			crate::db::expr::AccessType::Record(v) => AccessType::Record(v.into()),
			crate::db::expr::AccessType::Jwt(v) => AccessType::Jwt(v.into()),
			crate::db::expr::AccessType::Bearer(v) => AccessType::Bearer(v.into()),
		}
	}
}

impl From<RecordAccess> for crate::db::expr::RecordAccess {
...
impl From<crate::db::expr::RecordAccess> for RecordAccess {
	fn from(v: crate::db::expr::RecordAccess) -> Self {
		Self {
			signup: v.signup,
			signin: v.signin,
			jwt: v.jwt.into(),
...
impl From<JwtAccess> for crate::db::expr::JwtAccess {
...
impl From<crate::db::expr::JwtAccess> for JwtAccess {
	fn from(v: crate::db::expr::JwtAccess) -> Self {
		Self {
			verify: v.verify.into(),
			issue: v.issue.map(|i| i.into()),
		}
...
impl From<JwtAccessVerify> for crate::db::expr::access_type::JwtAccessVerify {
...
impl From<crate::db::expr::access_type::JwtAccessVerify> for JwtAccessVerify {
	fn from(v: crate::db::expr::access_type::JwtAccessVerify) -> Self {
		match v {
			crate::db::expr::access_type::JwtAccessVerify::Key(k) => JwtAccessVerify::Key(k.into()),
			crate::db::expr::access_type::JwtAccessVerify::Jwks(j) => JwtAccessVerify::Jwks(j.into()),
		}
	}
}

impl From<JwtAccessVerifyKey> for crate::db::expr::access_type::JwtAccessVerifyKey {
	fn from(v: JwtAccessVerifyKey) -> Self {
		Self {
			alg: v.alg.into(),
			key: crate::db::expr::Expr::Literal(crate::db::expr::Literal::String(v.key)),
		}
	}
}

impl From<crate::db::expr::access_type::JwtAccessVerifyKey> for JwtAccessVerifyKey {
	fn from(v: crate::db::expr::access_type::JwtAccessVerifyKey) -> Self {
		Self {
			alg: v.alg.into(),
			key: match v.key {
				crate::db::expr::Expr::Literal(crate::db::expr::Literal::String(s)) => s,
				_ => v.key.to_sql(),
			},
		}
	}
...
impl From<JwtAccessVerifyJwks> for crate::db::expr::access_type::JwtAccessVerifyJwks {
	fn from(v: JwtAccessVerifyJwks) -> Self {
		Self {
			url: crate::db::expr::Expr::Literal(crate::db::expr::Literal::String(v.url)),
		}
	}
}

impl From<crate::db::expr::access_type::JwtAccessVerifyJwks> for JwtAccessVerifyJwks {
	fn from(v: crate::db::expr::access_type::JwtAccessVerifyJwks) -> Self {
		Self {
			url: match v.url {
				crate::db::expr::Expr::Literal(crate::db::expr::Literal::String(s)) => s,
				_ => v.url.to_sql(),
...
impl From<JwtAccessIssue> for crate::db::expr::access_type::JwtAccessIssue {
...
impl From<crate::db::expr::access_type::JwtAccessIssue> for JwtAccessIssue {
	fn from(v: crate::db::expr::access_type::JwtAccessIssue) -> Self {
		Self {
			alg: v.alg.into(),
			key: match v.key {
				crate::db::expr::Expr::Literal(crate::db::expr::Literal::String(s)) => s,
...
impl From<BearerAccess> for crate::db::expr::access_type::BearerAccess {
...
impl From<crate::db::expr::access_type::BearerAccess> for BearerAccess {
	fn from(v: crate::db::expr::access_type::BearerAccess) -> Self {
		Self {
			kind: v.kind.into(),
			subject: v.subject.into(),
			jwt: v.jwt.into(),
...
impl From<BearerAccessType> for crate::db::expr::access_type::BearerAccessType {
...
impl From<crate::db::expr::access_type::BearerAccessType> for BearerAccessType {
	fn from(v: crate::db::expr::access_type::BearerAccessType) -> Self {
		match v {
			crate::db::expr::access_type::BearerAccessType::Bearer => Self::Bearer,
			crate::db::expr::access_type::BearerAccessType::Refresh => Self::Refresh,
		}
	}
}

impl From<BearerAccessSubject> for crate::db::expr::access_type::BearerAccessSubject {
...
impl From<crate::db::expr::access_type::BearerAccessSubject> for BearerAccessSubject {
	fn from(v: crate::db::expr::access_type::BearerAccessSubject) -> Self {
		match v {
			crate::db::expr::access_type::BearerAccessSubject::Record => Self::Record,
			crate::db::expr::access_type::BearerAccessSubject::User => Self::User,
		}
	}
}

impl From<Algorithm> for crate::db::expr::Algorithm {
...
impl From<crate::db::expr::Algorithm> for Algorithm {
	fn from(v: crate::db::expr::Algorithm) -> Self {
		match v {
			crate::db::expr::Algorithm::EdDSA => Self::EdDSA,
			crate::db::expr::Algorithm::Es256 => Self::Es256,
			crate::db::expr::Algorithm::Es384 => Self::Es384,
			crate::db::expr::Algorithm::Es512 => Self::Es512,
			crate::db::expr::Algorithm::Hs256 => Self::Hs256,
			crate::db::expr::Algorithm::Hs384 => Self::Hs384,
			crate::db::expr::Algorithm::Hs512 => Self::Hs512,
			crate::db::expr::Algorithm::Ps256 => Self::Ps256,
			crate::db::expr::Algorithm::Ps384 => Self::Ps384,
			crate::db::expr::Algorithm::Ps512 => Self::Ps512,
			crate::db::expr::Algorithm::Rs256 => Self::Rs256,
			crate::db::expr::Algorithm::Rs384 => Self::Rs384,
			crate::db::expr::Algorithm::Rs512 => Self::Rs512,
		}
	}
}
