...
impl Permission {
	...
	fn to_sql_definition(&self) -> crate::db::sql::Permission {
		match self {
			Permission::None => crate::db::sql::Permission::None,
			Permission::Full => crate::db::sql::Permission::Full,
			Permission::Specific(v) => crate::db::sql::Permission::Specific(v.clone().into()),
		}
	}
}
...
impl ToSql for Permission {
	fn fmt_sql(&self, f: &mut String, sql_fmt: lyxal_types::SqlFormat) {
...
impl Permissions {
	...
	pub fn to_sql_definition(&self) -> crate::db::sql::Permissions {
		self.clone().into()
	}
}
