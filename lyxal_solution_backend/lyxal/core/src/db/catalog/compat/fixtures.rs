...
use super::super::*;
use crate::db::catalog::auth::{AuthLevel, AuthLimit};
use crate::db::catalog::crate::db::key::record::{Record, RecordType};
...
use crate::db::catalog::{
	...
	ModuleExecutable, NamespaceId, NodeLiveQuery, SiloExecutable, LyxalismExecutable, TableId,
};
use crate::db::cf::mutations::{TableMutation, TableMutations};
...
use crate::db::iam::Auth;
use crate::db::idx::ft::fulltext::{DocLengthAndCount, TermDocument};
...
/// Module with Lyxalism executable
pub fn module_lyxalism() -> ModuleDefinition {
	ModuleDefinition {
		name: Some("my_module".to_string()),
		comment: Some("Custom module".to_string()),
		permissions: Permission::Full,
		executable: ModuleExecutable::Lyxalism(LyxalismExecutable {
