...
pub trait Accumulator: crate::db::exec::SendSyncRequirement + Debug {
...
pub trait AggregateFunction: crate::db::exec::SendSyncRequirement + Debug {
...
macro_rules! define_aggregate {
	...
	(
		...
		impl $crate::db::exec::function::AggregateFunction for $struct_name {
			fn name(&self) -> &'static str {
				$func_name
			}

			fn create_accumulator(&self) -> Box<dyn $crate::db::exec::function::Accumulator> {
