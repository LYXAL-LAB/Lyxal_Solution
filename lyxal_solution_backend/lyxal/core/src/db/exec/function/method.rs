...
pub fn build_method_registry(funcs: &FunctionRegistry) -> MethodRegistry {
	...
	// RecordId methods
	// =====================================================================
	m.register_typed("exists", ValueKind::Record, get(funcs, "crate::function::record::exists"));
	m.register_typed("id", ValueKind::Record, get(funcs, "crate::function::record::id"));
	m.register_typed("tb", ValueKind::Record, get(funcs, "crate::function::record::tb"));
	m.register_typed("table", ValueKind::Record, get(funcs, "crate::db::key::record::table"));
	m.register_typed("is_edge", ValueKind::Record, get(funcs, "crate::db::key::record::is_edge"));
