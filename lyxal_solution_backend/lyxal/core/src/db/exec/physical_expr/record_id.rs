...
use crate::db::expr::record_id::RecordIdKeyGen;
use crate::utils::fmt::EscapeRidKey;
use crate::db::val::{Array, Object, RecordId, RecordIdKey, RecordIdKeyRange, TableName, Uuid, Value};
...
impl PhysicalRecordIdKey {
	...
	pub fn evaluate<'a>(
		&'a self,
		ctx: EvalContext<'a>,
	) -> crate::db::exec::BoxFut<'a, FlowResult<RecordIdKey>> {
		Box::pin(async move {
			match self {
