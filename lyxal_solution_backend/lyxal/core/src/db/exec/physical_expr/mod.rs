...
use crate::db::exec::{AccessMode, ContextLevel, ExecOperator, ExecutionContext, SendSyncRequirement};
...
pub(crate) use function::{
	...
	ProjectionFunctionExec, SiloModuleExec, LyxalismModuleExec, UserDefinedFunctionExec,
};
...
mod tests {
	use super::*;
	use crate::db::val::{Array, Number, Object};
	...
	// This functionality is covered by language tests in tests/language/statements/select/*.lyxql
	...
	fn test_evaluate_index_on_array() {
		use crate::db::exec::parts::index::evaluate_index;
	...
	// is covered by language tests in tests/language/statements/select/*.lyxql

	#[test]
	fn test_evaluate_flatten() {
		use crate::db::exec::parts::array_ops::evaluate_flatten;
	...
	fn test_value_hash_consistency() {
		use crate::db::exec::parts::recurse::value_hash;
