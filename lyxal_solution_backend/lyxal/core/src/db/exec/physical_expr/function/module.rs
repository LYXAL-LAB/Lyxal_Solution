//! Module function expressions - Lyxalism WASM and Silo packages.
...
// =============================================================================
// LyxalismModuleExec - for Function::Module
// =============================================================================

/// Lyxalism WASM module function expression.
#[derive(Debug, Clone)]
pub struct LyxalismModuleExec {
...
impl PhysicalExpr for LyxalismModuleExec {
	...
	async fn evaluate(&self, ctx: EvalContext<'_>) -> FlowResult<Value> {
		...
		use crate::db::expr::module::ModuleExecutable;
	...
	async fn evaluate(&self, _ctx: EvalContext<'_>) -> FlowResult<Value> {
		...
		Err(anyhow::anyhow!(
			"Module function '{}' requires the 'lyxalism' feature to be enabled",
			name
		)
		.into())
	}
...
impl ToSql for LyxalismModuleExec {
