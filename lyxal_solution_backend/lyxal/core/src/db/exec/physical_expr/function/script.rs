...
use crate::db::expr::{FlowResult, Script};
...
impl PhysicalExpr for JsFunctionExec {
	...
	async fn evaluate(&self, ctx: EvalContext<'_>) -> FlowResult<Value> {
		...
		// This is required because JavaScript can call back into Lyxal functions
		// via lyxal.functions.* which need TreeStack for recursive computation
	...
	async fn evaluate(&self, _ctx: EvalContext<'_>) -> FlowResult<Value> {
		Err(crate::error::Error::InvalidScript {
