...
use crate::db::idx::trees::graph::UndirectedGraph;
...
use crate::db::idx::trees::hnsw::{ElementId, HnswElements, HnswSearch};
use crate::db::idx::trees::knn::{DoublePriorityQueue, Ids64};
use crate::db::idx::trees::vector::SharedVector;
...
where
	S: DynamicSet,
{
	pub(in crate::db::idx::trees::hnsw) async fn check_props(&self, elements: &HnswElements) {
