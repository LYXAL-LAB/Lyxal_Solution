...
use crate::db::expr::{FlowResultExt as _, Function};
use crate::db::idx::ft::analyzer::filter::FilteringStage;
use crate::db::idx::ft::analyzer::tokenizer::{Tokenizer, Tokens};
use crate::db::idx::ft::offset::Offset;
use crate::db::idx::ft::{DocLength, TermFrequency};
use crate::db::idx::trees::store::IndexStores;
use crate::db::val::Value;

pub(in crate::db::idx::ft) mod filter;
pub(in crate::db::idx) mod mapper;
pub(in crate::db::idx::ft) mod tokenizer;
...
impl Analyzer {
	...
	pub(in crate::db::idx::ft) async fn analyze_content(
		&self,
		stk: &mut Stk,
		ctx: &FrozenContext,
		opt: &Options,
	...
	pub(in crate::db::idx::ft) fn extract_frequencies(
		inputs: &[Tokens],
	...
	pub(in crate::db::idx::ft) fn extract_offsets(
		inputs: &[Tokens],
...
mod tests {
	...
	use crate::db::dbs::Options;
	use crate::db::expr::DefineAnalyzerStatement;
	use crate::db::idx::ft::analyzer::filter::FilteringStage;
	use crate::db::idx::ft::analyzer::tokenizer::{Token, Tokens};
