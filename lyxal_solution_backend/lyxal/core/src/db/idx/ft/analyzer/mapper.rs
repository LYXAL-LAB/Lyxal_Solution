...
use crate::db::iam::file::is_path_allowed;
use crate::db::idx::ft::analyzer::filter::{FilterResult, Term};

#[derive(Clone, Default)]
pub(in crate::db::idx) struct Mapper {
	terms: Arc<Tree<VariableSizeKey, String>>,
}

impl Mapper {
	pub(in crate::db::idx) async fn new(path: &Path) -> Result<Self> {
