//! Module implementing the LyxalQL parser.
//!
//! The LyxalQL parse is a relatively simple recursive decent parser.
//! Most of the functions of the LyxalQL parser peek a token from the lexer
...
//!
//! LyxalQL has a bunch of tokens which have complex rules for when they are
...
use crate::db::sql;
use crate::db::syn::error::{SyntaxError, bail};
use crate::db::syn::lexer::Lexer;
use crate::db::syn::lexer::compound::CompoundToken;
use crate::db::syn::token::{Span, Token, TokenKind, t};
...
pub struct ParserSettings {
	...
	/// Whether the lyxalism feature is enabled
	pub lyxalism_enabled: bool,
}
