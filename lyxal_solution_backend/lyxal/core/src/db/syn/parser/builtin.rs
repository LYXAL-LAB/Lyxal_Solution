...
use crate::db::sql::{Constant, Expr, Function, FunctionCall};
use crate::db::syn::error::MessageKind;
use crate::db::syn::parser::mac::expected;
use crate::db::syn::parser::{SyntaxError, unexpected};
use crate::db::syn::token::{Span, t};
...
> = phf_map! {
		...
		UniCase::ascii("duration::from::string") => (PathKind::Function, None),
		...
		//
		UniCase::ascii("list::aggregate") => (PathKind::Function, None),
		UniCase::ascii("list::dedupe") => (PathKind::Function, None),
		UniCase::ascii("list::diff") => (PathKind::Function, None),
		UniCase::ascii("list::split_out") => (PathKind::Function, None),
		//
		...
		//
		UniCase::ascii("parse::datetime::from_str") => (PathKind::Function, None),
		UniCase::ascii("parse::datetime::iso") => (PathKind::Function, None),
		...
		//
		UniCase::ascii("crate::function::record::exists") => (PathKind::Function, None),
		UniCase::ascii("crate::function::record::id") => (PathKind::Function, None),
		UniCase::ascii("crate::db::key::record::is_edge") => (PathKind::Function, None),
		UniCase::ascii("crate::db::key::record::table") => (PathKind::Function, None),
		UniCase::ascii("crate::function::record::tb") => (PathKind::Function, None),
		//
		...
		//
		UniCase::ascii("time::add") => (PathKind::Function, None),
		UniCase::ascii("time::add_business_days") => (PathKind::Function, None),
		UniCase::ascii("time::ceil") => (PathKind::Function, None),
		UniCase::ascii("time::day") => (PathKind::Function, None),
		UniCase::ascii("time::diff") => (PathKind::Function, None),
		...
		UniCase::ascii("time::humanize") => (PathKind::Function, None),
		...
		UniCase::ascii("time::with_timezone") => (PathKind::Function, None),
		...
		UniCase::ascii("time::sub") => (PathKind::Function, None),
		//
