...
use crate::db::sql::statements::remove::{
...
use crate::db::sql::{ModuleName, Param};
use crate::db::syn::error::bail;
use crate::db::syn::parser::mac::{expected, expected_whitespace, unexpected};
use crate::db::syn::parser::{ParseResult, Parser};
use crate::db::syn::token::t;
	...
	pub(crate) async fn parse_remove_stmt(
		...
		let res = match next.kind {
			...
			t!("TABLE") => {
				...
				RemoveStatement::Table(crate::db::sql::statements::RemoveTableStatement {
					name,
					if_exists,
					expunge,
				})
