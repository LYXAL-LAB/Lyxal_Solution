...
pub(crate) fn entries((object,): (Object,)) -> Result<Value> {
...
pub(crate) fn from_entries((array,): (Array,)) -> Result<Value> {
...
pub(crate) fn extend((mut object, other): (Object, Object)) -> Result<Value> {
	object.0.extend(other.0);
	Ok(Value::Object(object))
}

pub(crate) fn is_empty((object,): (Object,)) -> Result<Value> {
	Ok(Value::Bool(object.0.is_empty()))
}

pub(crate) fn len((object,): (Object,)) -> Result<Value> {
	Ok(Value::from(object.len()))
}

pub(crate) fn keys((object,): (Object,)) -> Result<Value> {
	Ok(Value::Array(Array(
		object
			.keys()
			.map(|v| {
...
pub(crate) fn remove((mut object, targets): (Object, Value)) -> Result<Value> {
	match targets {
		Value::String(target) => {
...
pub(crate) fn values((object,): (Object,)) -> Result<Value> {
