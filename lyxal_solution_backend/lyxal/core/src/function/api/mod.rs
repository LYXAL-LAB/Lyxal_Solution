...
use crate::db::catalog::ApiDefinition;
...
use crate::function::args::FromPublic;
use crate::db::val::{Closure, Duration, Value};

pub mod req;
pub mod res;

/// Invokes an API endpoint programmatically from within LyxalQL.
///
/// This function allows you to call a defined API endpoint from within LyxalQL code,
...
///
/// # Returns
/// * `Ok(response)` - The API response as a LyxalQL value
