...
#[js::function]
pub(crate) fn log(args: Rest<Coerced<String>>) {
	info!("{}", Printer(&args.0));
}
/// Log the input values as INFO
#[js::function]
pub(crate) fn info(args: Rest<Coerced<String>>) {
	info!("{}", Printer(&args.0));
}
/// Log the input values as WARN
#[js::function]
pub(crate) fn warn(args: Rest<Coerced<String>>) {
	warn!("{}", Printer(&args.0));
}
/// Log the input values as ERROR
#[js::function]
pub(crate) fn error(args: Rest<Coerced<String>>) {
	error!("{}", Printer(&args.0));
}
/// Log the input values as DEBUG
#[js::function]
pub(crate) fn debug(args: Rest<Coerced<String>>) {
	debug!("{}", Printer(&args.0));
}
/// Log the input values as TRACE
#[js::function]
pub(crate) fn trace(args: Rest<Coerced<String>>) {
	trace!("{}", Printer(&args.0));
}

pub(crate) fn console<'js>(ctx: &Ctx<'js>) -> Result<Object<'js>> {
