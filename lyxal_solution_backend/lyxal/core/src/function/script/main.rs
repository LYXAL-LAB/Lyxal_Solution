...
use crate::config::cnf::{SCRIPTING_MAX_MEMORY_LIMIT, SCRIPTING_MAX_STACK_SIZE};
...
pub async fn run(
	...
	let time_limit = Duration::from_millis(*crate::config::cnf::SCRIPTING_MAX_TIME_LIMIT as u64);
