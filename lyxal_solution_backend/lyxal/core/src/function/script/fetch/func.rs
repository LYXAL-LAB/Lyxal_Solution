...
use crate::function::http::resolver::FilteringResolver;
use crate::function::script::fetch::RequestError;
use crate::function::script::fetch::body::{Body, BodyData, BodyKind};
use crate::function::script::fetch::classes::{
	self, Request, RequestInit, Response, ResponseInit, ResponseType,
};
use crate::function::script::modules::lyxal::query::QueryContext;

#[js::function]
pub(crate) async fn fetch<'js>(
	ctx: Ctx<'js>,
	input: Value<'js>,
	...
	let redirect_limit = *crate::config::cnf::MAX_HTTP_REDIRECTS;
