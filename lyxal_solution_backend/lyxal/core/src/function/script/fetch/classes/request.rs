...
use crate::function::script::fetch::RequestError;
use crate::function::script::fetch::body::Body;
...
impl<'js> RequestInit<'js> {
	pub(crate) fn default(ctx: Ctx<'js>) -> Result<Self> {
	...
	pub(crate) fn clone_js(&self, ctx: Ctx<'js>) -> Result<Self> {
...
impl<'js> Request<'js> {
	...
	#[qjs(constructor)]
	pub(crate) fn new(ctx: Ctx<'js>, input: Value<'js>, init: Opt<RequestInit<'js>>) -> Result<Self> {
