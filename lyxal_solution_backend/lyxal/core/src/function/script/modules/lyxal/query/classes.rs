...
use crate::db::dbs::Variables;
use crate::db::expr::Expr;
use crate::db::syn;
use crate::db::val::Value as SurValue;
...
impl QueryVariables {
	...
	pub(crate) fn from_value<'js>(ctx: &Ctx<'js>, val: Value<'js>) -> Result<Self> {
...
impl Query {
	#[qjs(constructor)]
	pub(crate) fn new(ctx: Ctx<'_>, text: String, variables: Opt<QueryVariables>) -> Result<Self> {
	...
	pub(crate) fn bind(&mut self, key: Coerced<String>, value: SurValue) {
