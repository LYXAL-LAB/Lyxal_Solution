...
impl js::module::ModuleDef for Package {
	...
	fn evaluate<'js>(ctx: &js::Ctx<'js>, exports: &js::module::Exports<'js>) -> js::Result<()> {
		...
		.with_name("uuid")?;
		let value = crate::function::script::modules::impl_module_def!(ctx, "rand::uuid", "v4", run,);
		exports.export("v4", value.clone())?;
		default.set("v4", value)?;
		let value = crate::function::script::modules::impl_module_def!(ctx, "rand::uuid", "v7", run,);
