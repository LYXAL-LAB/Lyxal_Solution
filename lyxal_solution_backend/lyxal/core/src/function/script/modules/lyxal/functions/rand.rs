...
impl js::module::ModuleDef for Package {
	...
	fn evaluate<'js>(ctx: &js::Ctx<'js>, exports: &js::module::Exports<'js>) -> js::Result<()> {
		...
		.with_name("rand")?;
		let value = crate::function::script::modules::impl_module_def!(ctx, "rand", "bool", run,);
		exports.export("bool", value.clone())?;
		default.set("bool", value)?;
		let value = crate::function::script::modules::impl_module_def!(ctx, "rand", "duration", run,);
		exports.export("duration", value.clone())?;
		default.set("duration", value)?;
		let value = crate::function::script::modules::impl_module_def!(ctx, "rand", "enum", run,);
		exports.export("enum", value.clone())?;
		default.set("enum", value)?;
		let value = crate::function::script::modules::impl_module_def!(ctx, "rand", "float", run,);
		exports.export("float", value.clone())?;
		default.set("float", value)?;
		let value = crate::function::script::modules::impl_module_def!(ctx, "rand", "id", run,);
		exports.export("id", value.clone())?;
		default.set("id", value)?;
		let value = crate::function::script::modules::impl_module_def!(ctx, "rand", "int", run,);
		exports.export("int", value.clone())?;
		default.set("int", value)?;
		let value = crate::function::script::modules::impl_module_def!(ctx, "rand", "string", run,);
		exports.export("string", value.clone())?;
		default.set("string", value)?;
		let value = crate::function::script::modules::impl_module_def!(ctx, "rand", "time", run,);
		exports.export("time", value.clone())?;
		default.set("time", value)?;
		let value = crate::function::script::modules::impl_module_def!(ctx, "rand", "ulid", run,);
		exports.export("ulid", value.clone())?;
		default.set("ulid", value)?;
		let value =
			crate::function::script::modules::impl_module_def!(ctx, "rand", "uuid", (uuid::Package),);
