//! Bucket storage module for Lyxal.
//!
...
use crate::LyxalComposer;
use crate::bucket::store::ObjectStore;
#[cfg(not(target_arch = "wasm32"))]
use crate::bucket::store::file::FileStore;
use crate::bucket::store::memory::MemoryStore;
...
impl BucketStoreProviderRequirements for LyxalComposer {}
#[cfg_attr(target_family = "wasm", async_trait::async_trait(?Send))]
#[cfg_attr(not(target_family = "wasm"), async_trait::async_trait)]
impl BucketStoreProvider for LyxalComposer {
	async fn connect(
		&self,
		url: &str,
		_global: bool,
