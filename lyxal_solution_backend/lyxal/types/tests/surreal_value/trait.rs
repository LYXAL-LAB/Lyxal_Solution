...
use lyxal_types::{
	...
	RecordId, LyxalNone, LyxalNull, LyxalValue, Uuid, Value,
};

// Simple macro for concrete types
macro_rules! test_lyxal_value {
    (
        $fnc:ident<$type:ty>(
...
// Regression tests for https://github.com/lyxal/lyxal/issues/7020
