...
use crate::{LyxalValue, Value};

/// Represents an object with key-value pairs in Lyxal
///
...
impl Object {
	...
	pub fn insert(&mut self, key: impl Into<String>, value: impl LyxalValue) -> Option<Value> {
