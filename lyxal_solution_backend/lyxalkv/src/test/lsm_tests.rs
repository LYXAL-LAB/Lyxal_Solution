...
/// This tests Lyxal-like namespace patterns where table records and index records
...
#[test(tokio::test)]
async fn test_vlog_gc_non_versioned_lyxal_style_keys() {
	// This test tries to mimics the Lyxal bug scenario:
	//
	// https://github.com/lyxal/lyxal/issues/6872
	//
	//
	...
	// Lyxal-style: 50 records, each with 4 fields
