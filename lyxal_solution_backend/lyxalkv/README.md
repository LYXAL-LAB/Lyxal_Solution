...
Built as a specialized fork of SurrealKV, LyxalKV introduces **Chaos Engineering** and **Quality of Service (QoS)** controls directly into the storage engine, making it suitable for distributed systems and financial workloads.
