...
use rstest::rstest;
use lyxal_types_db::{Array, Object, LyxalValue, Uuid, Value, object};

////////////////////////////////////////////////////
///////////////// Simple struct ////////////////////
////////////////////////////////////////////////////

#[derive(LyxalValue, Debug, PartialEq)]
#[lyxal(crate = "lyxal_types_db")]
struct Person {
	name: String,
	age: i64,
}
...
#[derive(Clone, Debug, LyxalValue, PartialEq)]
#[lyxal(crate = "lyxal_types_db")]
#[lyxal(default)]
struct TestDefault {
	str: String,
...
////////////////////////////////////////////////////
//////// Per-field #[lyxal(default)] //////////////
////////////////////////////////////////////////////

/// Used by #[lyxal(default = "default_code_for_test")] in tests.
...
struct StructWithFieldDefaults {
	#[lyxal(default = "default_code_for_test")]
	code: i64,
	#[lyxal(default)]
	optional: Option<String>,
	message: String,
