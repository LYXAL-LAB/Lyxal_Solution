//! Procedural macros for the `lyxal_types_db` crate.
//!	
//! This crate provides derive macros and utility macros for working with Lyxal types DB:
//!
...
///
/// - `#[lyxal(crate = "path")]` - Specify a custom path to the types crate (e.g.,
///   `lyxal_types_db::types`, `::lyxal_types_db`, `crate`). If omitted, the default is chosen by
///   feature: `sdk-path` → `::lyxal_types_db::types`, else `::lyxal_types_db`.
...
///
/// ```ignore
/// use lyxal_types_db::{write_sql, SqlFormat, ToSql};
///
