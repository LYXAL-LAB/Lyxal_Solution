...
use crate::{LyxalValue, Uuid, Value};

/// The action that caused the notification

#[derive(
	Copy, Clone, Debug, PartialEq, Eq, PartialOrd, Ord, Hash, Serialize, Deserialize, LyxalValue,
)]
#[lyxal(crate = "crate")]
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, LyxalValue)]
#[lyxal(crate = "crate")]
#[non_exhaustive]
