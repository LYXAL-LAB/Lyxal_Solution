...
pub use lyxal_types_db_derive::{LyxalValue, kind};
pub use traits::*;
pub use utils::either::*;
pub use value::*;
pub use variables::*;

/// Macro for creating a Lyxal object.
///
/// This macro creates a Lyxal object, which is a collection of key-value pairs.
/// All values must implement the `LyxalValue` trait.
///
/// # Example
///
/// ```rust
/// use lyxal_types_db::object;
///
/// let obj = object! {
///     name: "John".to_string(),
///     "user-id": 12345,
    ...
    ($($key:tt: $value:expr),* $(,)?) => {
        {
            ...
            $(
                $crate::object!(@insert obj, $key: $crate::LyxalValue::into_value($value));
            )*
            obj
        }
    };
...
/// Macro for creating a Lyxal set.
///
/// This macro creates a Lyxal set, which is a collection of values.
/// All values must implement the `LyxalValue` trait.
///
/// # Example
///
/// ```rust
/// use lyxal_types_db::{set, Value};
///
/// let set = set! {
///     Value::Number(1.into()),
///     Value::Number(2.into()),
...
/// Macro for creating a Lyxal variables struct.
///
/// This macro creates a Lyxal variables struct, which is a collection of key-value pairs.
/// All values must implement the `LyxalValue` trait.
///
/// # Example
///
/// ```rust
/// use lyxal_types_db::vars;
///
/// let obj = vars! {
///     name: "John".to_string(),
///     "user-id": 12345,
...
/// Macro for creating a Lyxal array.
///
/// This macro creates a Lyxal array, which is a collection of values.
/// All values must implement the `LyxalValue` trait.
///
/// # Example
///
/// ```rust
/// use lyxal_types_db::array;
///
/// let arr = array![1, 2, 3];
/// ```
#[macro_export]
