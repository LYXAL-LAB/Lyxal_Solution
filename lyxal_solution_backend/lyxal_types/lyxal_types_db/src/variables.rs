...
use crate::{Object, LyxalValue, Value};

/// Represents a set of variables that can be used in a query.
#[derive(Clone, Debug, Default, Eq, PartialEq, LyxalValue, Serialize, Deserialize)]
#[lyxal(crate = "crate")]
#[serde(transparent)]
...
impl Variables {
	...
	pub fn insert(&mut self, key: impl Into<String>, value: impl LyxalValue) {
