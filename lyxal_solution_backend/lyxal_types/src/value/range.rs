...
/// Represents a range of values in Lyxal
///
...
impl<T: LyxalValue> From<std::ops::Range<T>> for Range {
...
impl<T: LyxalValue> From<std::ops::RangeInclusive<T>> for Range {
...
impl<T: LyxalValue> From<std::ops::RangeFrom<T>> for Range {
...
impl<T: LyxalValue> From<std::ops::RangeTo<T>> for Range {
