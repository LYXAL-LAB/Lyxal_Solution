...
use crate::{GeometryKind, Object, LyxalValue, Value, array, object};

/// Represents geometric shapes in Lyxal
///
...
impl Geometry {
	...
	/// Converts a lyxal value to a MultiPolygon if the array matches to a MultiPolygon.
	...
	/// Converts a lyxal value to a MultiLine if the array matches to a MultiLine.
	...
	/// Converts a lyxal value to a MultiPoint if the array matches to a MultiPoint.
	...
	/// Converts a lyxal value to a LineString if the array matches to a LineString.
