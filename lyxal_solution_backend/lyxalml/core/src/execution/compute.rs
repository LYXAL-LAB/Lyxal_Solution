...
use crate::storage::lyxml_file::LyxMlFile;
...
pub struct ModelComputation<'a> {
	pub surml_file: &'a mut LyxMlFile,
}
...
impl ModelComputation<'_> {
	...
	pub fn raw_compute(
		...
		let outputs = safe_eject!(session.run(x), LyxalErrorStatus::Unknown);
...
mod tests {
	...
	fn test_raw_compute_linear_sklearn() {
		let mut file = LyxMlFile::from_file("./model_stash/sklearn/surml/linear.surml").unwrap();
	...
	fn test_raw_compute_linear_onnx() {
		let mut file = LyxMlFile::from_file("./model_stash/onnx/surml/linear.surml").unwrap();
		let model_computation = ModelComputation {
			surml_file: &mut file,
		};
	...
	fn test_raw_compute_linear_torch() {
		let mut file = LyxMlFile::from_file("./model_stash/torch/surml/linear.surml").unwrap();
		let model_computation = ModelComputation {
			surml_file: &mut file,
		};
	...
	fn test_raw_compute_linear_tensorflow() {
		let mut file = LyxMlFile::from_file("./model_stash/tensorflow/surml/linear.surml").unwrap();
		let model_computation = ModelComputation {
			surml_file: &mut file,
		};
