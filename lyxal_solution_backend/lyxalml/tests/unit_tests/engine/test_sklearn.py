...
from lyxalml.engine.sklearn import SklearnOnnxAdapter
from lyxalml.model_templates.sklearn.sklearn_linear import train_model
from lyxalml.model_templates.datasets.house_linear import HOUSE_LINEAR
