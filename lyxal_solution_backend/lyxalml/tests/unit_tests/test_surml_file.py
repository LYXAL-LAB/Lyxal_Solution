...
class TestLyxMlFile(TestCase):
    ...
    def setUp(self):
        ...
        self.file = LyxMlFile(model=self.model, name="House Price Prediction", inputs=self.x[:1], engine=Engine.PYTORCH)
    ...
    def test_full_torch_run(self):
        ...
        new_file = LyxMlFile.load("./test.surml", Engine.PYTORCH)
