...
impl SerializeLyxalRevisioned for Bytes {
	#[inline]
...
impl DeserializeLyxalRevisioned for Bytes {
	#[inline]
...
impl LyxalRevisioned for Bytes {
	#[inline]
...
mod tests {
	...
	#[test]
	fn test_lyxal_revision_specialised_vec_u8_serialization_single() {
	...
	#[test]
	fn test_lyxal_revision_specialised_vec_u8_serialization_multiple() {
	...
	#[test]
	fn test_lyxal_revision_specialised_vec_u8_serialization_large() {
	...
	#[test]
	fn test_lyxal_revision_specialised_vec_u8_conversion() {
	...
	#[test]
	fn test_lyxal_revision_specialised_vec_u8_as_ref() {
