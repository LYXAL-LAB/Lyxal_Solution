...
use lyxal_proxy_command_lib as lyxal_proxy_command;
use lyxal_proxy_lib as lyxal_proxy;

use crate::lyxal_proxy::command_id::CommandID;

/// Handle to a detached thread where a Lyxal_proxy worker runs
pub struct Worker {
    pub name: String,
...
impl Worker {
    ...
    pub fn create_server(
        ...
        .expect("could not create lyxal_proxy worker");
