...
//!
//! ```ignore
//! use lyxal_proxy_command_lib::config::{FileConfig, ConfigBuilder};
//!
...
//!
//! ```ignore
//! use lyxal_proxy_command_lib::config::Config;
//!
...
/// a name applied to sticky sessions ("LYXAL_PROXYBALANCEID")
pub const DEFAULT_STICKY_NAME: &str = "LYXAL_PROXYBALANCEID";
...
pub enum ConfigError {
    ...
    #[error("Can not determine path to lyxal_proxy socket: {0}")]
...
impl Config {
    ...
    pub fn command_socket_path(&self) -> Result<String, ConfigError> {
        ...
        let mut socket_parent_dir = match socket_path.parent() {
            // if the socket path is of the form "./lyxal_proxy.sock",
    ...
    fn serialize() {
        ...
        let config = FileConfig {
            ...
            metrics: Some(MetricsConfig {
                ...
                prefix: Some(String::from("lyxal_proxy-metrics")),
            }),
