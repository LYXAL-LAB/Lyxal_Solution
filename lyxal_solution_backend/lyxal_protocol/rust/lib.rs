...
pub mod proto {
    ...
    mod generated {
        ...
        pub mod lyxal {
            pub mod protocol {
                pub mod v1 {
                    include!("../gen/rust/proto/lyxal/protocol/v1/lyxal.protocol.v1.rs");
                }
                ...
                pub mod rpc {
                    pub mod v1 {
                        include!(
                            "../gen/rust/proto/lyxal/protocol/rpc/v1/lyxal.protocol.rpc.v1.rs"
                        );
                    }
                }
            }
    ...
    pub use generated::lyxal::protocol::*;
}
...
pub mod fb {
    ...
    pub use generated::lyxal::protocol::v_1 as v1;
}
...
mod tests {
    ...
    #[rstest]
    #[case(Value::default(), "lyxal.protocol.v1.Value")]
    #[case(
        proto::rpc::v1::QueryRequest::default(),
        "lyxal.protocol.rpc.v1.QueryRequest"
    )]
