...
pub struct AppState {
	...
	pub sync_controller: Option<lyxal_net::control::SyncController>,
    // P20.6: Expose Kernel for Realm Management API
    pub kernel: Option<Arc<RwLock<lyxal_os::kernel::Kernel>>>,
}
...
pub async fn init<F: RouterFactory>(
	...
	sync_controller: Option<lyxal_net::control::SyncController>,
    kernel: Option<Arc<RwLock<lyxal_os::kernel::Kernel>>>,
) -> Result<()> {
