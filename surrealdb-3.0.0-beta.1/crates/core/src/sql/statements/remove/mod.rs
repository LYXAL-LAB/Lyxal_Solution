...
pub(crate) use scheduler::RemoveSchedulerStatement;
pub(crate) use table::RemoveTableStatement;
pub(crate) use user::RemoveUserStatement;
pub(crate) use webhook::RemoveWebhookStatement;
pub use credential::RemoveCredentialStatement;
...
pub(crate) enum RemoveStatement {
	...
	Scheduler(RemoveSchedulerStatement),
    ...
    Webhook(RemoveWebhookStatement),
    Credential(RemoveCredentialStatement),
}
...
impl From<RemoveStatement> for crate::expr::statements::RemoveStatement {
	fn from(v: RemoveStatement) -> Self {
		match v {
			...
			RemoveStatement::Scheduler(v) => Self::Scheduler(v.into()),
            ...
            RemoveStatement::Webhook(v) => Self::Webhook(v.into()),
            RemoveStatement::Credential(v) => Self::Credential(v.into()),
		}
	}
}
...
impl From<crate::expr::statements::RemoveStatement> for RemoveStatement {
	fn from(v: crate::expr::statements::RemoveStatement) -> Self {
		match v {
			...
			crate::expr::statements::RemoveStatement::Scheduler(v) => Self::Scheduler(v.into()),
            ...
            crate::expr::statements::RemoveStatement::Webhook(v) => Self::Webhook(v.into()),
            crate::expr::statements::RemoveStatement::Credential(v) => Self::Credential(v.into()),
		}
	}
}
