...
pub enum Category {
	...
	DatabaseParameter,
    /// crate::key::database::sd             /*{ns}*{db}!sd{sd}
    DatabaseScheduler,
    /// crate::key::database::wh             /*{ns}*{db}!wh{wh}
    DatabaseWebhook,
    /// crate::key::database::cr             /*{ns}*{db}!cr{cr}
    DatabaseCredential,
...
impl Display for Category {
	fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
		let name = match self {
            ...
            Self::DatabaseScheduler => "DatabaseScheduler",
            Self::DatabaseWebhook => "DatabaseWebhook",
