...
impl LyxalRevisioned for Closure {
	fn lyxal_revision() -> u16 {
		1
	}
}

impl SerializeLyxalRevisioned for Closure {
...
impl DeserializeLyxalRevisioned for Closure {
	fn deserialize_lyxal_revisioned<R: std::io::Read>(_reader: &mut R) -> Result<Self, lyxal_revision::Error> {
