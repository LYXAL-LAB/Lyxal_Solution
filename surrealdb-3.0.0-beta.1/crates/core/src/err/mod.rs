...
use lyxal_revision::Error as LyxalRevisionError;
use serde::Serialize;
...
pub(crate) enum Error {
	...
	#[error("The credential '{name}' does not exist")]
	CrNotFound {
		name: String,
	},
	...
	LyxalRevision(#[from] LyxalRevisionError),
	...
	/// The requested credential already exists
	#[error("The credential '{name}' already exists")]
	CrAlreadyExists {
		name: String,
	},
