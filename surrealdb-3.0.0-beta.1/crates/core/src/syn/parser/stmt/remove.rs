...
use crate::sql::statements::remove::{
	...
	RemoveSchedulerStatement, RemoveSequenceStatement, RemoveWebhookStatement,
};
	...
	pub(crate) async fn parse_remove_stmt(
		...
		let res = match next.kind {
			...
			t!("SCHEDULER") => {
				...
				RemoveStatement::Scheduler(RemoveSchedulerStatement {
					name,
					if_exists,
				})
			}
            ...
            t!("WEBHOOK") => {
                ...
                RemoveStatement::Webhook(RemoveWebhookStatement {
                    name,
                    if_exists,
                })
            }
            t!("CREDENTIAL") => {
                ...
                RemoveStatement::Credential(crate::sql::statements::remove::RemoveCredentialStatement {
                    name,
                    if_exists,
                })
            }
