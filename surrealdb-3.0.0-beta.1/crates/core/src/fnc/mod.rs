...
pub async fn asynchronous(
	...
	dispatch!(
		...
		//
		"schedule::add" => schedule::add((stk, ctx, Some(opt), doc)).await,
		"schedule::add_many" => schedule::add_many((stk, ctx, Some(opt), doc)).await,
		"schedule::once" => schedule::once((stk, ctx, Some(opt), doc)).await,
		"schedule::retry" => schedule::retry((stk, ctx, Some(opt), doc)).await,
		"schedule::discard" => schedule::discard((stk, ctx, Some(opt), doc)).await,
		"schedule::pause" => schedule::pause((stk, ctx, Some(opt), doc)).await,
		"schedule::progress" => schedule::progress((stk, ctx, Some(opt), doc)).await,
		"schedule::resume" => schedule::resume((stk, ctx, Some(opt), doc)).await,
		"schedule::test" => schedule::test((stk, ctx, Some(opt), doc)).await,
		"schedule::remove" => schedule::remove((stk, ctx, Some(opt), doc)).await,
		"schedule::list" => schedule::list((stk, ctx, Some(opt), doc)).await,
		"schedule::history" => schedule::history((stk, ctx, Some(opt), doc)).await,
		"schedule::explain" => schedule::explain((stk, ctx, Some(opt), doc)).await,
		"schedule::reset_circuit" => schedule::reset_circuit((stk, ctx, Some(opt), doc)).await,
		"schedule::checkpoint" => schedule::checkpoint((stk, ctx, Some(opt), doc)).await,
		"schedule::stats" => schedule::stats((stk, ctx, Some(opt), doc)).await,
		//
