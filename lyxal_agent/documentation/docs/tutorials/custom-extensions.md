...
description: Create your own custom MCP Server to use as a lyxal extension
---
...
:::info
lyxal supports Tools, Resources, and Prompts from the [Model Context Protocol](https://modelcontextprotocol.io/). See [`mcp_client.rs`](https://github.com/block/lyxal/blob/main/crates/lyxal/src/agents/mcp_client.rs) for the supported protocol version and client capabilities.
:::
...
## Step 5: Integrate with lyxal

To add your MCP server as an extension in lyxal:
...
2. Open lyxal Desktop and click the <PanelLeft className="inline" size={16} /> button in the top-left to open the sidebar
...
To see any changes you make to your MCP server code after integrating with lyxal, re-run `uv pip install .` and then restart lyxal Desktop.
:::
...
## Step 6: Use Your Extension in lyxal

Once integrated, you can start using your extension in lyxal. Open the lyxal chat interface and call your tool as needed.

You can verify that lyxal has picked up the tools from your custom extension by asking it "what tools do you have?"

![lyxal Chat - Ask about tools](../assets/guides/custom-extension-tools.png)

Then, you can try asking questions that require using the extension you added.

![lyxal Chat - Use custom extension](../assets/guides/custom-extension-chat.png)

🎉 **Congratulations!** You’ve successfully built and integrated a custom MCP server with lyxal.

---

## Advanced Features for MCP Extensions

lyxal supports advanced MCP features that can enhance your extensions.

### MCP Sampling: AI-Powered Tools

**[MCP Sampling](/docs/guides/mcp-sampling)** allows your MCP servers to request AI completions from lyxal's LLM, transforming simple tools into intelligent agents.
...
- [lyxal's implementation](https://github.com/block/lyxal/blob/main/crates/lyxal/src/agents/mcp_client.rs) currently supports text and image content types
- lyxal automatically advertises sampling capability to all MCP servers
...
- Components render securely in isolated sandboxes within lyxal Desktop
...
:::note
lyxal also supports [MCP-UI](/docs/guides/interactive-chat/mcp-ui), but MCP Apps is the recommended path for new extensions.
:::
