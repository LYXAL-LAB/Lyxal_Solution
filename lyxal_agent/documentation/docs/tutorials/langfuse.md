---
description: Integrate lyxal with Langfuse to observe performance
---

# Observability with Langfuse

This tutorial covers how to integrate lyxal with Langfuse to monitor your lyxal requests and understand how the agent is performing.
...
## Configure lyxal to Connect to Langfuse

Set the environment variables so that lyxal (written in Rust) can connect to the Langfuse server.
...
## Run lyxal with Langfuse Integration

Now, you can run lyxal and monitor your AI requests and actions through Langfuse.

With lyxal running and the environment variables set, Langfuse will start capturing traces of your lyxal activities.
...
![lyxal trace in Langfuse](https://langfuse.com//images/docs/lyxal-integration/lyxal-example-trace.png)
