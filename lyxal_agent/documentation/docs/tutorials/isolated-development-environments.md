...
This guide shows you how to set up isolated development environments using the **[Container Use MCP](https://github.com/dagger/container-use)** with lyxal. With this setup, your development work will be isolated to both git branches and containers, allowing you to experiment freely without affecting your main system state.
...
The **[Container Use MCP](https://github.com/dagger/container-use)** server provides containerized development environments that integrate seamlessly with lyxal. This allows you to:
...
- lyxal installed and configured
...
Click this link to automatically add the extension to lyxal:
...
<Tabs groupId="interface">
  ...
  1. Click `...` in the top right corner of the lyxal Desktop.
...
Add the following configuration to your `~/.config/lyxal/config.yaml` file:
...
Once the extension is enabled in lyxal, you can:

### Starting Isolated Development

Simply mention in your conversation with lyxal that you want to work in an isolated environment:
...
1. Start a conversation with lyxal about a new feature
2. Request isolated development environment
3. lyxal creates branch and container
4. Develop and test the feature
5. If successful, merge the branch; if not, discard it

### Dependency Exploration

1. Ask lyxal to explore a new library or tool
...
3. Join our [Discord community](https://discord.gg/lyxal-oss) for support

## Next Steps

With container-use enabled in lyxal, you're ready to develop with confidence. Try starting a conversation about a project you've been hesitant to experiment with, and let lyxal set up a safe, isolated environment for your exploration.
