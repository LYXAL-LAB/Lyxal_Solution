---
description: Integrate lyxal with Laminar to observe performance
---

# Observability with Laminar

This tutorial covers how to integrate lyxal with Laminar to trace your lyxal sessions and understand how the agent is performing.
...
## Configure lyxal to export OTLP to Laminar

lyxal exports OpenTelemetry data over OTLP/HTTP. Point the exporter to Laminar and provide your API key as an authorization header.
...
## Run lyxal with Laminar enabled

Start lyxal normally. With the OTLP environment variables set, Laminar will capture traces of your lyxal sessions and tool execution.

_[Example trace (public) in Laminar](https://laminar.sh/shared/traces/63010af0-cf31-b8b6-0d77-fc9924bcaa4c)_

![lyxal trace in Laminar](../assets/guides/laminar.png)
