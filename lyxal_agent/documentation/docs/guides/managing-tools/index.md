...
hide_title: true
description: Control and configure the tools and extensions that power your lyxal workflows
---
...
<p className={styles.pageDescription}>
  Tools are specific functions within <a href="/lyxal/docs/getting-started/using-extensions">extensions</a> that give lyxal its capabilities. Learn to control and customize how these tools work for you.
</p>
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    <Card 
      ...
      description="Configure fine-grained permissions to control which tools lyxal can use and when, ensuring secure and controlled automation."
