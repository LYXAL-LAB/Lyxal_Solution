...
Response Styles customize how tool interactions are displayed in the lyxal Desktop chat window. 
...
- **Concise** (Default)
    ...
    - Shows only which tool lyxal used
...
- **Detailed**
    ...
    - Best for debugging or learning how lyxal works
...
When working with the lyxal CLI, you can control the verbosity of tool output.
