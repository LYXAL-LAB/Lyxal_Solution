...
```bash
export LYXAL_EDITOR_API_KEY="your-api-key-here"
...
export LYXAL_EDITOR_MODEL="claude-3-5-sonnet-20241022"
```

**Morph:**
```bash
export LYXAL_EDITOR_API_KEY="sk-..."
export LYXAL_EDITOR_HOST="https://api.morphllm.com/v1"
export LYXAL_EDITOR_MODEL="morph-v0"
```

**Relace:**
```bash
export LYXAL_EDITOR_API_KEY="rlc-..."
export LYXAL_EDITOR_HOST="https://instantapply.endpoint.relace.run/v1/apply"
export LYXAL_EDITOR_MODEL="auto"
```
...
1. **Configuration Check**: lyxal checks if all three environment variables are properly set and non-empty.

2. **With AI Enabled**: If configured, lyxal sends the original code and your requested change to the configured AI model for processing.
