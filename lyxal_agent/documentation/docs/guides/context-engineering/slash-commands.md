...
description: "Create custom shortcuts to quickly apply reusable instructions in any lyxal chat session"
---
...
<Tabs groupId="interface">
  ...
  The command appears under the recipe in your `Recipes` menu. For recipes that aren't in your Recipe Library, follow the `lyxal CLI` steps.
...
slash_commands:
  ...
  - command: "daily-report"
    recipe_path: "/Users/me/.local/share/lyxal/recipes/report.yaml"
```
...
Typing `/` in lyxal Desktop shows a popup menu with the available slash commands.
:::
...
- You cannot use names that conflict with [built-in CLI slash commands](/docs/guides/lyxal-cli-commands#slash-commands) like `/recipe`, `/compact`, or `/help`.
  ...
  items={[
    {
      type: 'topic',
      title: 'Recipes',
      description: 'Check out the Recipes guide for more docs, tools, and resources to help you master lyxal recipes.',
      linkUrl: '/lyxal/docs/guides/recipes'
    },
    {
      type: 'topic',
      ...
      linkUrl: '/lyxal/docs/tutorials/rpi'
    }
  ]}
/>
