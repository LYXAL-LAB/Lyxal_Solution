...
description: Learn how lyxal renders interactive UI components from MCP Apps and MCP-UI extensions
---
...
Extensions built with MCP Apps or MCP-UI allow lyxal Desktop to provide interactive and engaging user experiences. Imagine using a graphical, clickable UI instead of reading text responses and typing all your prompts. These extensions return content that lyxal can render as embedded UI elements for rich, dynamic, and streamlined interactions.

:::info MCP Apps is the official specification
[MCP Apps](/docs/tutorials/building-mcp-apps) is now the official MCP specification for interactive UIs. MCP-UI extensions still work in lyxal, but MCP Apps is the recommended path for new extensions.
:::
...
See how interactive responses work in lyxal. For this exercise, we'll add an extension that connects to [MCP-UI Demos](https://mcp-aharvard.netlify.app/) provided by Andrew Harvard.
