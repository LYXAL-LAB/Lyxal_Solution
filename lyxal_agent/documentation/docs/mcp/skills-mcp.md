...
description: Load reusable instruction sets that teach lyxal specific workflows
---
...
The Skills extension loads *skills* &mdash; reusable sets of instructions that teach lyxal how to perform specific tasks or follow particular workflows.

lyxal automatically discovers skills at startup and uses them when relevant to your request. lyxal loads skills from `.agents/skills/` in your project directory and `~/.config/agents/skills/` globally, making skills portable across different AI coding agents. To learn about creating skills and how lyxal uses them, see [Using Skills](/docs/guides/context-engineering/using-skills).
...
Let's say you have a skill that lyxal discovers on startup in `~/.config/agents/skills/deploy/SKILL.md`:
