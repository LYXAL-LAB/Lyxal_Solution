...
description: Add I Ching MCP Server as a lyxal Extension
---

This tutorial covers how to add the [I Ching MCP Server](https://github.com/threemachines/i-ching) as a lyxal extension to enable traditional I Ching divination readings.

:::tip TLDR
1. Install: `cargo install i-ching`
2. Configure: [Add I Ching Extension](lyxal://extension?cmd=i-ching-mcp-server&id=i-ching&name=I%20Ching&description=I%20Ching%20divination%20readings)
:::
...
:::tip Use lyxal to Help!
If you're unsure about any of these steps, you can ask lyxal to help you check your system and guide you through the Rust installation process.
:::
...
Then click the link above to configure it in lyxal.
