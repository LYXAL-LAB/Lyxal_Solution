---
title: lyxal Docs Extension

description: Add lyxal Docs MCP Server as a lyxal Extension
---
...
This tutorial covers how to add the [lyxal Docs MCP Server](https://github.com/idosal/git-mcp) as a lyxal extension to enable lyxal to answer questions about itself.

:::tip TLDR
<Tabs groupId="interface">
  <TabItem value="ui" label="lyxal Desktop" default>
  [Launch the installer](lyxal://extension?cmd=npx&arg=mcp-remote&arg=https%3A%2F%2Fblock.gitmcp.io%2Flyxal%2F&id=lyxal-docs&name=lyxal%20Docs&description=gitmcp%20for%20lyxal%20documentation)
  </TabItem>
  <TabItem value="cli" label="lyxal CLI">
  **Command**
  ```sh
  npx mcp-remote https://block.gitmcp.io/lyxal/
  ```
  </TabItem>
</Tabs>
:::
...
<Tabs groupId="interface">
  <TabItem value="ui" label="lyxal Desktop" default>
    <LyxalDesktopInstaller
      extensionId="lyxal-docs"
      extensionName="lyxal Docs"
      description="GitMCP for lyxal documentation"
      command="npx"
      args={["mcp-remote", "https://block.gitmcp.io/lyxal/"]}
      cliCommand="npx mcp-remote https://block.gitmcp.io/lyxal/"
      timeout={300}
  ...
  <TabItem value="cli" label="lyxal CLI">
      <CLIExtensionInstructions
        name="lyxal Docs"
        description="GitMCP for lyxal documentation"
        command="npx mcp-remote https://block.gitmcp.io/lyxal/"
        timeout={300}
      />
  </TabItem>
</Tabs>
...
## Example Usage
GitMCP allows you to convert any Git repository into a lyxal extension. The lyxal Docs MCP Server is a great example of this, as it provides a way for lyxal to answer questions about itself.

Let's ask lyxal to create a recipe for us! It will use the lyxal Docs MCP Server to find the relevant information.


### lyxal Prompt

```
hey lyxal, I want to create a recipe for automated code review that my development team can use. Can you look at the lyxal documentation to understand the recipe format, then create a recipe that:
...
Please research the recipe format first using the lyxal Docs extension, then create a complete recipe file with proper YAML structure, parameters, and any needed extensions. 
...
Perfect! I've created a comprehensive automated code review recipe based on the lyxal documentation research. Here's what I've built for your development team:
...
#### Basic Usage:
```bash
lyxal run automated-code-review.yaml \
...
- Proper YAML structure following lyxal recipe format
    ...
    properties:
      ...
      ci_cd_metadata:
        ...
        properties:
          ...
          reviewer:
            type: string
            description: "lyxal automated code review"
          language:
            type: string
