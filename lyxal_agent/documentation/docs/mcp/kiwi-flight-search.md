...
description: Add Kiwi Flight Search MCP Server as a lyxal Extension
unlisted: true
---
...
This tutorial covers how to add the [Kiwi Flight Search MCP Server](https://mcp.kiwi.com) as a lyxal extension to enable flight search and price comparison.
