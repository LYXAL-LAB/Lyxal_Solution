...
description: Learn how to use lyxal's built-in Tutorial extension for guided learning
---
...
The Tutorial extension is a built-in feature of lyxal that provides interactive, step-by-step guidance for learning various aspects of lyxal and its capabilities. It's designed to help users get comfortable with lyxal's features through hands-on practice.

The Tutorial extension serves as an interactive learning tool that:
- Provides structured, step-by-step tutorials
- Allows hands-on practice with lyxal features
...
- **first-game**: Create your first game with lyxal
...
1. **Ask lyxal directly**: You can simply ask about a topic you're interested in, and lyxal will suggest relevant tutorials.

```
( O)> I'd like to learn how to build an extension for lyxal
```
...
1. lyxal will guide you step-by-step through the process
...
- **Ask questions**: If something isn't clear, ask lyxal to explain it further.
...
### lyxal Prompt
```
I'd like to learn how to build an extension for lyxal
```
...
- Contribute to the lyxal community by sharing your experiences
