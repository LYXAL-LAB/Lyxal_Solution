...
description: Use Computer Controller MCP Server as a lyxal Extension
---
...
This tutorial covers enabling and using the Computer Controller MCP Server, which is a built-in lyxal extension.

:::tip
Let lyxal complete its tasks without interruption - avoid using your mouse or keyboard until it's done.
:::
...
In this example, I'll show you how lyxal can multitask, handling everything from system controls and music playback to web research and data organization.
...
### lyxal Prompt
```
lyxal, I need to decompress while researching AI models for tomorrow's meeting. Can you create a relaxing environment and help me research?
