...
description: Add Playwright MCP Server as a lyxal Extension for Modern Web Testing
---
...
This tutorial covers how to add the Playwright MCP Server as a lyxal extension, to enable cross-browser testing and web automation across Chromium and Webkit.

:::tip TLDR
<Tabs groupId="interface">
  <TabItem value="ui" label="lyxal Desktop" default>
  [Launch the installer](lyxal://extension?cmd=npx&arg=-y&arg=@playwright/mcp@latest&id=playwright&name=Playwright&description=Modern%20web%20testing%20and%20automation)
  </TabItem>
...
Let's use lyxal with the Playwright extension to create a cross-browser testing suite. In this example, we'll demonstrate how lyxal can help you:
