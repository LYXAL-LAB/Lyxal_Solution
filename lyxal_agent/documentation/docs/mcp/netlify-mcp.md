...
description: Add Netlify MCP Server as a lyxal Extension
---
...
This tutorial covers how to add the [Netlify MCP Server](https://github.com/netlify/netlify-mcp) as a lyxal extension to build, deploy, and manage Netlify sites.

:::tip TLDR
<Tabs groupId="interface">
  <TabItem value="ui" label="lyxal Desktop" default>
  [Launch the installer](lyxal://extension?cmd=npx&arg=-y&arg=%40netlify%2Fmcp&id=netlify&name=Netlify&description=Build%2C%20deploy%2C%20and%20manage%20sites%20with%20Netlify%27s%20official%20MCP%20server.)
  </TabItem>
...
In this example, I’ll show you how to use lyxal with the Netlify Extension to deploy a web application.
