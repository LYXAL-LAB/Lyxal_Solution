...
description: Add GitHub MCP Server as a lyxal Extension
---
...
This tutorial covers how to add the [GitHub MCP Server](https://github.com/github/github-mcp-server) as a lyxal extension to enable file operations, repository management, search functionality, and more.

:::tip TLDR
<Tabs groupId="interface">
  <TabItem value="ui" label="lyxal Desktop" default>
   [Launch the installer](lyxal://extension?type=streamable_http&url=https%3A%2F%2Fapi.githubcopilot.com%2Fmcp%2F&id=github&name=GitHub&description=GitHub%20repository%20management%20and%20operations&header=Authorization%3DBearer%20YOUR_GITHUB_PERSONAL_ACCESS_TOKEN)
  </TabItem>
...
* Repository: [lyxal-demo](https://github.com/angiejones/lyxal-demo)
* Read access to metadata
* Read and Write access to code, commit status, issues, and pull requests

### lyxal Prompt
```
create a new branch called hello-world in my angiejones/lyxal-demo repository. Update the README.md file to say "this was written by lyxal" and commit it. Open a pull request with your changes.
```
...
branch: hello-world
content: this was written by lyxal
message: Update README.md with lyxal message
owner: angiejones
path: README.md
repo: lyxal-demo
...
2. Updated the README.md file with the text "this was written by lyxal"
3. Created a pull request to merge these changes into the main branch

You can view the pull request at: https://github.com/angiejones/lyxal-demo/pull/1
