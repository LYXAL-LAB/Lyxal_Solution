...
description: Add Cognee MCP Server as a lyxal Extension
---
...
This tutorial covers how to add the [Cognee MCP Server](https://github.com/topoteretes/cognee/tree/main/cognee-mcp) as a lyxal extension to enable knowledge graph memory capabilities, connecting to over 30 data sources for enhanced context and retrieval.
...
Cognee provides knowledge graph memory capabilities for lyxal, allowing it to remember and connect information across conversations and documents.
...
> _lyxal, please cognify this information: "I prefer Python for data analysis and use pandas extensively. My current project involves analyzing customer behavior data." Then search for information about my programming preferences._
