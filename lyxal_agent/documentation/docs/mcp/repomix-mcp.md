...
description: Add Repomix MCP Server as a lyxal Extension
---
...
<Tabs groupId="interface">
  ...
  <LyxalDesktopInstaller
    ...
    description="Pack repositories into AI-friendly formats for lyxal"
    command="npx"
    args={["-y", "repomix", "--mcp"]}
  />
</TabItem>
...
In this example, I’ll show you how to use lyxal with the Repomix Extension to analyze the compressed Axios repository. lyxal will focus on the `lib/core/Axios.js` file, explain its role in the architecture, spot missing tests, write new unit tests, and suggest improvements to the testing strategy and code maintainability. 

By compressing the entire codebase into an AI-friendly format, Repomix helps lyxal stay within token limits while providing detailed, file-specific insights.
