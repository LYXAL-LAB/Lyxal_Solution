...
description: Add Dev.to MCP Server as a lyxal Extension
---
...
This tutorial covers how to add the [Dev.to MCP Server](https://github.com/nickytonline/dev-to-mcp) as a lyxal extension to enable access to the Dev.to public API. With this extension, lyxal can fetch articles, tags, user info, comments, and more—without requiring authentication.

:::tip TLDR
<Tabs groupId="interface">
  <TabItem value="ui" label="lyxal Desktop" default>
  [Launch the installer](lyxal://extension?type=streamable_http&url=http%3A%2F%2Flocalhost%3A3000%2Fmcp&id=dev-to&name=Dev.to&description=Access%20Dev.to%20articles%20and%20content)
  </TabItem>
...
In this example, lyxal uses the `Dev.to MCP` extension to fetch the 5 most recent JavaScript articles and instantly turn them into a personalized learning hub.

### lyxal Prompt
```
Hey lyxal, fetch the 5 most recent JavaScript articles from Dev.to
