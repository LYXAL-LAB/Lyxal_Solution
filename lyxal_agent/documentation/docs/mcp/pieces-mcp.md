...
description: Add Pieces for Developers MCP Server as a lyxal Extension
---
...
This tutorial covers how to add the [Pieces for Developers MCP Server](https://docs.pieces.app/products/mcp/get-started?utm_source=lyxal&utm_medium=collab&utm_campaign=mcp) as a lyxal extension to enable interaction with your Pieces Long-Term Memory.
...
1. Code Development with lyxal:

    Activity: You worked on integrating MCP servers into the lyxal CLI, making enhancements to handle extensions via schema URLs.
    Description: This task involved modifying code and testing new integrations to support advanced functionalities. It also included interactions with the lyxal community on Discord for feedback and troubleshooting.

2. Documentation Updates:

    Activity: You updated and managed documentation related to the lyxal project and MCP integrations.
...
4. Managing and Testing Extensions:
    ...
    Activity: You focused on testing and managing various extensions through the lyxal platform.
...
:::tip
For more examples of prompts you can use with the Pieces for Developers MCP Server, see the [Pieces MCP prompting guide](https://docs.pieces.app/products/mcp/prompting?utm_source=lyxal&utm_medium=collab&utm_campaign=mcp).
:::
