...
description: Use JetBrains MCP Server as a lyxal Extension
---
...
This tutorial covers how to add the JetBrains extension to integrate with any JetBrains IDE. While lyxal can use the [Developer extension](/docs/mcp/developer-mcp) for developer-centric tasks, the JetBrains extension provides a more integrated and project-aware way to work with code.
...
<Tabs groupId="ideVersion">
  <TabItem value="later" label="2025.2 and later" default>
    ...
    <Tabs groupId="interface">
      ...
      Use `lyxal configure` with the command from `Copy Stdio Config` in your IDE.
      </TabItem>
    </Tabs>
    :::
    -->
    ...
    2. Add the JetBrains extension to lyxal using the command from the config:

       :::info 
       If the lyxal Desktop or lyxal CLI configuration steps aren't successful, follow the `Config File` steps.
       :::
       ...
       <Tabs groupId="interface">
         <TabItem value="ui" label="lyxal Desktop" default>
           ...
           4. On the `Add custom extension` modal, enter the following:
              ...
              - **Type**: STDIO
              - **Description**: Integrate lyxal with any JetBrains IDE
         ...
         <TabItem value="config" label="Config File">
           1. Open your lyxal [`config.yaml`](/docs/guides/config-files) file
  ...
  <TabItem value="earlier" label="2025.1 and earlier">
    ...
    <Tabs groupId="interface">
      <TabItem value="ui" label="lyxal Desktop" default>
      [Launch the installer](lyxal://extension?cmd=npx&arg=-y&arg=%40jetbrains%2Fmcp-proxy&id=jetbrains&name=JetBrains&description=Integrate%20lyxal%20with%20any%20JetBrains%20IDE)
      </TabItem>
      <TabItem value="cli" label="lyxal CLI">
      **Command**
      ```sh
    ...
    **Required Setup**
    ...
    2. Add the JetBrains extension to lyxal:
...
<Tabs groupId="interface">
  <TabItem value="ui" label="lyxal Desktop" default>
   ...
   2. Open a new session in lyxal Desktop
   :::note
   You will interact with two separate apps: the lyxal Desktop app and the IntelliJ IDE.
   :::
  ...
  1. Open [IntelliJ](https://www.jetbrains.com/idea/download) (JetBrains' Java and Kotlin IDE)
  2. Open a terminal within your IDE and start a new lyxal session:
...
:::tip
When using lyxal to refactor code, it's recommended to commit your code to version control _before_ making changes. This way, you have a clean snapshot to compare against, making it easy to review lyxal's modifications, revert if needed, and track improvements.
:::
...
After 2 minutes, lyxal was done with the upgrade! 🎉
...
Using the JetBrains extension provided several advantages and made it easier for lyxal to:
