...
description: Add Fetch MCP Server as a lyxal Extension
---
...
The Fetch extension [does not work](https://github.com/block/lyxal/issues/1184) with Google models (e.g. gemini-2.0-flash) because this extension uses `format: uri` in its JSON schema which Google doesn't support.
:::

This tutorial covers how to add the [Fetch MCP Server](https://github.com/modelcontextprotocol/servers/tree/main/src/fetch) as a lyxal extension to retrieve and process content from the web.

:::tip TLDR
<Tabs groupId="interface">
  <TabItem value="ui" label="lyxal Desktop" default>
  [Launch the installer](lyxal://extension?cmd=uvx&arg=mcp-server-fetch&id=fetch&name=Fetch&description=Web%20content%20fetching%20and%20processing%20capabilities)
  </TabItem>
...
![website lyxal built](../assets/guides/programmer-jokes-fetch-mcp.png)
