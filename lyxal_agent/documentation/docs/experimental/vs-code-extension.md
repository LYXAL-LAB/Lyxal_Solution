...
import IconLyxal from "@site/src/components/icons/lyxal";

The [lyxal for VS Code extension](https://marketplace.visualstudio.com/items?itemName=block.vscode-lyxal) lets you interact with lyxal directly within VS Code.

:::warning Experimental Feature
lyxal for VS Code is in active development. Behavior and configuration may change in future releases.
:::

The extension uses the [Agent Client Protocol (ACP)](/docs/guides/acp-clients) to communicate with lyxal.

## Install the Extension

:::info Prerequisites
- [VS Code](https://code.visualstudio.com/) version 1.95.0 or higher
- [lyxal CLI](/docs/getting-started/installation) version 1.16.0 or higher
:::

1. Go to [Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=block.vscode-lyxal)
2. Click `Install`
3. On the popup window, click `Open Visual Studio Code`
4. In Visual Studio Code, click `Install`
5. Click the <IconLyxal className="inline" size={16} /> icon in the Activity Bar to open the side panel and start chatting with lyxal

## Share Context with lyxal

There are two ways to provide context to lyxal.

### Send Selected Code

1. Select the code you want to discuss in your editor
2. Send the selection to lyxal:
   - macOS: `Cmd+Shift+G`
   - Windows/Linux: `Ctrl+Shift+G`
   - Right-click and choose `Send to lyxal`
...
The lyxal for VS Code extension connects directly to your editor, letting you manage files, projects, and workflows with AI. It includes the following features:

- Interactive chat UI with streaming responses
- Access to lyxal's AI capabilities and enabled extensions
...
```
Update the contributing guide at /lyxal/CONTRIBUTING.md with instructions on how to start docusaurus dev server
```
