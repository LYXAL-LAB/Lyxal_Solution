---
title: "How to Choose Between Subagents and Subrecipes in lyxal"
...
When you're working on complex projects with lyxal, you'll often need to break work into multiple tasks and run them with AI agents. Lyxal gives you two powerful ways to do this: [subagents](/docs/guides/subagents/) and [subrecipes](/docs/tutorials/subrecipes-in-parallel/). Both can run multiple AI instances in parallel, but they work  differently. Picking which one to use can be confusing, so we're going to guide you to a decision.
...
Subagents excel when you're in a lyxal session and just want task delegation without setup overhead. Here's how simple they are to use:
...
Lyxal automatically spawns three independent AI instances, and each works on a different component. You get real-time progress tracking and they all work in parallel from that prompt. You're off and running: no setup, no configuration files, just natural language instructions.
...
For detailed subrecipe examples and implementation guides, check out our [subrecipes blog post](/blog/2025/09/15/subrecipes-in-lyxal) and [advanced recipe tips](https://www.youtube.com/watch?v=1szmJSKInnU) video on YouTube.
...
* **Full tool access** -- Subrecipes can use any extensions and tools available to lyxal.
...
Share your subagent prompts or subrecipe ideas with us on our [Discord community](https://discord.gg/lyxal-oss) or [GitHub discussions](https://github.com/block/lyxal/discussions).



<head>
  <meta property="og:title" content="How to Choose Between Subagents and Subrecipes in lyxal" />
  <meta property="og:type" content="article" />
  <meta property="og:url" content="https://block.github.io/lyxal/blog/2025-09-26-subagents-vs-subrecipes" />
  ...
  <meta property="og:image" content="https://block.github.io/lyxal/assets/images/subrecipes-vs-subagents-19bca16b86a951e4618be8ab6ce90fb2.png" />
  <meta name="twitter:card" content="summary_large_image" />
  <meta property="twitter:domain" content="block.github.io/lyxal" />
  <meta name="twitter:title" content="How to Choose Between Subagents and Subrecipes in lyxal" />
  ...
  <meta name="twitter:image" content="https://block.github.io/lyxal/assets/images/subrecipes-vs-subagents-19bca16b86a951e4618be8ab6ce90fb2.png" />
</head>
