...
When an MCP client like lyxal connects to an MCP server, it establishes a two-way channel. The server can expose tools for the AI to call, but it can also *request* that the AI generate text on its behalf.
...
If you want to see sampling in action, [Council of Mine](/docs/mcp/council-of-mine-mcp) is a great playground. Ask lyxal to start a council debate on any topic and watch as nine distinct perspectives emerge, vote on each other, and synthesize into a conclusion all powered by sampling.
...
<head>
  ...
  <meta property="og:url" content="https://block.github.io/lyxal/blog/2025/12/04/mcp-sampling" />
  <meta property="og:description" content="Learn how MCP Sampling lets your tools call the AI instead of the other way around." />
  <meta property="og:image" content="https://block.github.io/lyxal/assets/images/mcp-sampling-4e857d422eb4fcbfbf474003069ba732.png" />
  ...
  <meta name="twitter:image" content="https://block.github.io/lyxal/assets/images/mcp-sampling-4e857d422eb4fcbfbf474003069ba732.png" />
</head>