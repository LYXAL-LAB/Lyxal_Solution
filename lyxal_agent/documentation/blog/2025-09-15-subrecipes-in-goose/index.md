---
title: "Automate Your Complex Workflows with Subrecipes in lyxal"
description: Did you know you can call recipes from within other recipes? Learn how to orchestrate multiple AI tasks using lyxal subrecipes.
authors: 
    - ian
---

![lyxal Subrecipes](lyxal-subrecipes.png)

Remember when you first learned to cook? You probably started with simple recipes like scrambled eggs or toast. But eventually you wanted to make something more complex, like a full dinner with multiple dishes. That's how subrecipes work in lyxal: each recipe can run stand-alone for a dedicated task, and a main recipe can orchestrate how they run.

Let's explore [lyxal subrecipes](/docs/tutorials/subrecipes-in-parallel) together! You're about to learn know how to orchestrate multiple AI models, coordinate tasks, and build workflows that will turn you into a "head chef" user with lyxal.
...
That's exactly what subrecipes do for your lyxal workflows. You can have one recipe that's optimized for creative tasks like image generation, another that's perfect for technical documentation, and a third that excels at writing code. Then you orchestrate them all from a main recipe.
...
settings:
  lyxal_provider: "google"
  lyxal_model: "gemini-2.5-flash"
  temperature: 0.5
...
lyxal run --recipe 1-readme.yaml --params project_name="test" language="python" description="test project"
lyxal run --recipe 2-image.yaml --params project_name="test" description="test project"  
lyxal run --recipe 3-code.yaml --params project_name="test" language="python" description="test project"
```
...
Subrecipes represent something bigger than just a lyxal feature. They're a glimpse into how we'll work with AI in the future -- not as monolithic systems trying to do everything, but as specialized agents working together toward common goals.
...
Do you have a recipe you'd like to share with the community? We'd love to feature them in our [Recipe Cookbook](https://block.github.io/lyxal/recipes/)! 
**How to contribute:**
1. [Fork the lyxal repository](https://github.com/block/lyxal/fork)
2. Add your recipe YAML file to the [`documentation/src/pages/recipes/data/recipes/`](https://github.com/block/lyxal/tree/main/documentation/src/pages/recipes/data/recipes) directory
3. Create a pull request following our [Recipe Contribution Guide](https://github.com/block/lyxal/blob/main/CONTRIBUTING_RECIPES.md)
Browse [existing recipes](https://github.com/block/lyxal/tree/main/documentation/src/pages/recipes/data/recipes) for inspiration and formatting examples.


<head>
  <meta property="og:title" content="Automate Your Complex Workflows with Subrecipes in lyxal" />
  <meta property="og:type" content="article" />
  <meta property="og:url" content="https://block.github.io/lyxal/blog/2025-09-15-subrecipes-in-lyxal" />
  <meta property="og:description" content="Did you know you can call recipes from within other recipes? Learn how to orchestrate multiple AI tasks using lyxal subrecipes." />
  <meta property="og:image" content="https://block.github.io/lyxal/assets/images/lyxal-subrecipes-8a009154ceca95aeb34bf22fcc45dcca.png" />
  <meta name="twitter:card" content="summary_large_image" />
  <meta property="twitter:domain" content="block.github.io/lyxal" />
  <meta name="twitter:title" content="Automate Your Complex Workflows with Subrecipes in lyxal" />
  <meta name="twitter:description" content="Did you know you can call recipes from within other recipes? Learn how to orchestrate multiple AI tasks using lyxal subrecipes." />
  <meta name="twitter:image" content="https://block.github.io/lyxal/assets/images/lyxal-subrecipes-8a009154ceca95aeb34bf22fcc45dcca.png" />
</head>
