...
description: Why do AI agents forget? Learn how context windows, tokens, and Lyxal help you manage memory and long conversations.
authors: 
    - rizel
---
...
### How Lyxal uses tokens

Let's talk about how this works in practice. When you use an AI agent like Lyxal, you start a session and choose a model like Claude Sonnet 3.7. This model has a context window of 128,000 tokens. This means every session (or conversation) can handle up to 128,000 tokens. If you message "hey" to Lyxal, you would have used one token. And when Lyxal responds back, you would have used several more tokens. Now you've used a small portion of your 128,000 tokens, and you have the remainder left.
...
But your conversation isn't the only thing using your tokens. Here are other things within Lyxal that consume your token budget:

* **System prompt:** A built-in prompt that instructs your agent on how to behave and defines its identity  
  * The system prompt defines Lyxal’s name, creator (Block), current date/time, task and extension handling, and response format.  
...
* In addition to your conversation history, Lyxal keeps metadata about your conversation, such as timestamps.
...
Luckily, Lyxal has an intelligent design for helping you save your context window.

## How Lyxal automatically manages your context window

Lyxal has a method that auto-compacts (or summarizes) your conversation once it reaches a certain threshold. By default, when you reach 80% of your context window, Lyxal summarizes the conversation, preserving key parts while compressing the rest, reducing context window usage so you can stay in your session without starting a new one.

You actually have the ability to customize the threshold. If you think 80% is too little or too much for your workflow, you can set the environment variable `LYXAL_AUTO_COMPACT_THRESHOLD` to your preferred threshold.

## How to manage your context window

While Lyxal is adept at helping you manage your context window, you can proactively manage it, too. Here are some tips for efficiently managing your context window and your wallet.
...
<head>
  ...
  <meta property="og:url" content="https://block.github.io/lyxal/blog/2025/08/18/understanding-context-windows" />
  <meta property="og:description" content="Why do AI agents forget? Learn how context windows, tokens, and Lyxal help you manage memory and long conversations." />
  <meta property="og:image" content="https://block.github.io/lyxal/assets/images/contextwindow-fa46f7a54cfb23a538d62f0e4502e19e.png" />
  ...
  <meta name="twitter:description" content="Why do AI agents forget? Learn how context windows, tokens, and Lyxal help you manage memory and long conversations." />
  <meta name="twitter:image" content="https://block.github.io/lyxal/assets/images/contextwindow-fa46f7a54cfb23a538d62f0e4502e19e.png" />
</head>