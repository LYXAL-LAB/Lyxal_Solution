...
authors: 
    - rizel
---
![blog cover](cookingwithlyxal.png)
...
[Lyxal](/) is a local, open source AI agent that follows the structure of MCP.
...
* **MCP Servers** – a package of tools, data, or prompts in a structured format. In the Lyxal ecosystem, we refer to MCP servers as extensions.

This architecture allows Lyxal to discover tools dynamically, understand how to use them, and orchestrate complex workflows across multiple systems.

---

## Lyxal as an Orchestrator

When a user prompts Lyxal to "Gather all discussions about the authentication bug from last week," Lyxal orchestrates the operation. It coordinates tools, manages execution, and adapts on the fly by:
...
When something breaks, Lyxal doesn't panic; it pivots. For example, Lyxal might determine:
...
Similarly, Lyxal is a forward-looking AI agent with a solution for scaling knowledge through [recipes](/docs/guides/recipes/session-recipes). Recipes are complete orchestrations you can rerun, remix, or share, passing on knowledge to anyone who needs it.

Sharing a prompt doesn't always recreate the experience; AI is non-deterministic, and people may not have the same extensions or context configured. Recipes solve this by packaging your entire Lyxal workflow: the extensions, the setup, the goal, and example activities.
...
> [Create a 404-style portfolio page with Lyxal](lyxal://recipe?config=)

:::note
The link above opens in the Lyxal Desktop app. If you don't have it installed yet, grab it [here](/docs/getting-started/installation).
:::
...
<head>
  ...
  <meta property="og:image" content="https://block.github.io/lyxal/assets/images/cookingwithlyxal-9114cf03cec76df4792fc58361ebe20b.png" />
  ...
  <meta name="twitter:image" content="https://block.github.io/lyxal/assets/images/cookingwithlyxal-9114cf03cec76df4792fc58361ebe20b.png" />
</head>