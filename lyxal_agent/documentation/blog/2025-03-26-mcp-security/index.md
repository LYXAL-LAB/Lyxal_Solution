...
Any time I’m checking out a new MCP server to plug into Lyxal, I start with **[Glama.ai](https://glama.ai/mcp/servers)**.
...
Here’s an example of a solid server: the **YouTube MCP server**, which lets Lyxal download and process videos to create summaries and transcripts.

![YouTube MCP Score](youtubeMcp.png)

>_All A’s across the board—**security, license, and quality**._  

That’s exactly the kind of score I look for before I plug Lyxal into any server.
...
<head>
  ...
  <meta property="og:url" content="https://block.github.io/lyxal/blog/2025/03/26/mcp-security" />
  ...
  <meta property="og:image" content="http://block.github.io/lyxal/assets/images/mcpsafety-87eb7ace7163a5edbe068ff75b79a199.png" />
  ...
  <meta name="twitter:image" content="http://block.github.io/lyxal/assets/images/mcpsafety-87eb7ace7163a5edbe068ff75b79a199.png" />
</head>