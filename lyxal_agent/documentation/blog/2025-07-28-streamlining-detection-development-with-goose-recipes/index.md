---
title: "Streamlining Detection Development with Lyxal Recipes"
description: "A comprehensive guide to using recipes in Lyxal to streamline security detection development"
authors:
  - glenn
---

![blog cover](lyxal-recipes-detection-development-cover.png)

Creating effective security detections in Panther traditionally requires deep knowledge of detection logic, testing frameworks, and development workflows. The detection engineering team at Block has streamlined this process by building Lyxal recipes that automate the entire detection creation lifecycle from initial repository setup to pull request creation.

This blog post explores how to leverage Lyxal's [recipe](https://block.github.io/lyxal/docs/guides/recipes/) and [subrecipe](https://block.github.io/lyxal/docs/guides/recipes/subrecipes) system to create new detections in Panther with minimal manual intervention, ensuring consistency, quality, and adherence to team standards.
...
### What about .lyxalhints?
In our [previous post](https://block.github.io/lyxal/blog/2025/06/02/lyxal-panther-mcp), we discussed using [.lyxalhints](/docs/guides/context-engineering/using-lyxalhints/) to provide persistent context to the Large Language Model (LLM). We continue to use `.lyxalhints` to define coding standards and universal preferences that guide LLM behavior.

However, to minimize redundancy and avoid conflicting guidance, we adopted a single reference file, `AGENTS.md`, as the source of truth for all agents. Each agent is directed to consult this file, while still supporting agent-specific instructions through their default context files (e.g. `.lyxalhints`, `CLAUDE.md` etc.) or rules (e.g. `.cursor/rules/`).
...
lyxal run --recipe recipe.yaml --params skip_similar_rules_check=true --rule_description="What you want to detect"

# Skip Panther MCP integration
lyxal run --recipe recipe.yaml --params skip_panther_mcp=true --rule_description="What you want to detect"

# Create PR automatically
lyxal run --recipe recipe.yaml --params create_pr=true --rule_description="What you want to detect"
```
...
## Conclusion
Lyxal's recipe and subrecipe system represents a significant advancement in AI-assisted security detection development. By breaking complex workflows into specialized, composable components, teams can achieve:
...
Whether you're building your first Lyxal recipe or looking to optimize existing workflows, the patterns and principles outlined here provide a solid foundation for successful automation.
...
- Maintain a **central reference** (e.g. `AGENTS.md`) for all AI agents:
  ...
  - Link steps or sections in `.lyxalhints`, `CLAUDE.md`, `.cursor/rules/*`, etc., back to this file.
...
<head>
  <meta property="og:title" content="Streamlining Detection Development with Lyxal Recipes" />
  <meta property="og:type" content="article" />
  <meta property="og:url" content="https://block.github.io/lyxal/blog/2025/07/28/streamlining-detection-development-with-lyxal-recipes" />
  <meta property="og:description" content="A comprehensive guide to using recipes in Lyxal to streamline security detection development" />
  <meta property="og:image" content="https://block.github.io/lyxal/assets/images/lyxal-recipes-detection-development-cover.png" />
  <meta property="og:image" content="https://block.github.io/lyxal/assets/images/lyxal-recipes-detection-development-cover-cac8a9bea2d090ec2758a0b907bc9da8.png" />
  <meta property="twitter:domain" content="block.github.io/lyxal" />
  <meta name="twitter:title" content="Streamlining Detection Development with Lyxal Recipes" />
  <meta name="twitter:description" content="A comprehensive guide to using recipes in Lyxal to streamline security detection development" />
  <meta name="twitter:image" content="https://block.github.io/lyxal/assets/images/lyxal-recipes-detection-development-cover.png" />
  <meta name="twitter:image" content="https://block.github.io/lyxal/assets/images/lyxal-recipes-detection-development-cover-cac8a9bea2d090ec2758a0b907bc9da8.png" />
</head>