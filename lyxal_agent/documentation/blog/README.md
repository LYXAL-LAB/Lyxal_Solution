...
unlisted: true
---
# Writing Blog Posts for lyxal

This guide explains how to write and structure blog posts for the lyxal documentation site.

## Getting Started

1. Clone the lyxal repository:
```bash
...
<head>
  ...
  <meta property="og:url" content="https://block.github.io/lyxal/blog/YYYY/MM/DD/post-slug" />
  <meta property="og:description" content="Your blog post description" />
  <meta property="og:image" content="https://block.github.io/lyxal/assets/images/your-image.png" />
  ...
  <meta name="twitter:image" content="https://block.github.io/lyxal/assets/images/your-image.png" />
</head>
```
...
```
http://localhost:3000/lyxal/blog
```
