...
I spoke to Lyxal instead of typing, using my voice as input to write code or run tasks.
...
I gave Lyxal a YouTube video of a guest's conference talk. Then, I prompted Lyxal to create a transcript and generate thoughtful interview questions.
...
Speaker management platforms often have different image requirements for headshots. I used to spend an embarrassingly amount of time trying to resize my photo without ruining the aspect ratio. Now, I just ask Lyxal to do it.
...
I've asked Lyxal to explain idioms or references that I didn't understand.  

### Why It's Useful

Because I wasn't born in America and I'm neurodivergent, I sometimes take idioms literally or misinterpret them. Instead of risking embarrassment at work, I quietly ask Lyxal to translate.
...
I asked Lyxal for insights about my data using natural language, and it wrote a Common Table Expression for me.

### Why It's Useful

SQL can get complex with joins, stored procedures, and subqueries. Lyxal helps me move faster and avoid errors by handling the query logic for me. 
...
I've used Lyxal to analyze historical conference data so I could plan smarter for upcoming CFP deadlines.

### Why It's Useful

I tend to overbook myself or get anxious that I won't get accepted, so I apply to everything. Then I end up getting accepted to all of them and say yes without thinking, which leads to poor planning and rushed talks. With Lyxal, I can analyze patterns in CFP timelines and make more intentional choices.
...
A feature broke, but I had made so many commits, I couldn't tell which one introduced the bug. I asked Lyxal to help me run `git bisect`, so we could identify the problematic code.

### Why It's Useful

The hardest part of debugging is often just figuring out where to look. Git bisect makes that faster, and Lyxal walked me through the process without needing to memorize the steps.
...
I like to keep up with the latest technologies. Since MCP servers are popular, I used Lyxal's tutorial extension to walk through building my own MCP server.

### Why It's Useful

In addition to generating code, AI agents can help you learn how to code. Lyxal includes a built-in tutorial extension designed to walk users through technical concepts in a hands-on way.

### How to Try It

1. Follow [this tutorial](/docs/mcp/tutorial-mcp)
3. Prompt Lyxal:
   > I'd like to learn how to build an extension or MCP server for Lyxal
...
I didn't do this myself, but I was impressed to learn that a community member used Lyxal to compare proposed and final versions of regulatory documents.

### Why It's Useful

Legal documents are often dense and repetitive. Lyxal can highlight what actually changed, helping users quickly spot how updates impact compliance or obligations.
...
I used Lyxal to build a working prototype and see the full application live in action.
...
🎥 **See it live:**  
Watch The Great Lyxal Off where we challenged Lyxal to create creative apps from scratch, like:  
- A Lyxal-shaped drawing tool  
...
This blog post included just a few of the ways I use Lyxal. If you're curious about what else it can do, check out the [Prompt Library](/prompt-library) or just ask:

What are 5 useful things you can help me with today?

Let lyxal surprise you. ✨


<head>
  <meta property="og:title" content="11 Practical Ways I Use AI Agents Without Losing My Authenticity" />
  <meta property="og:type" content="article" />
  <meta property="og:url" content="https://block.github.io/lyxal/blog/2025/04/21/practical-use-cases-of-ai" />
  ...
  <meta property="og:image" content="https://block.github.io/lyxal/assets/images/mcp-use-cases-758ecc959d6334783257fc9d6329e1f2.png" />
  ...
  <meta name="twitter:image" content="https://block.github.io/lyxal/assets/images/mcp-use-cases-758ecc959d6334783257fc9d6329e1f2.png" />
</head>