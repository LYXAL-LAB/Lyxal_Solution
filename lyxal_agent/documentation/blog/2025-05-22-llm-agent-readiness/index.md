...
```bash
Create a file at ~/workspace/loose-lyxal/tool-test.txt with the contents "Hello World".
...
path: ~/workspace/loose-lyxal/tool-test.txt
command: write
...
<head>
  ...
  <meta property="og:url" content="https://block.github.io/lyxal/blog/2025/05/22/llm-agent-readiness" />
  <meta property="og:description" content="A series of prompts to test an LLM's capabilities to be used with AI agents" />
  <meta property="og:image" content="https://block.github.io/lyxal/assets/images/llm-agent-test-86ce2379ce4dde48ae1448f0f9d75c1f.png" />
  ...
  <meta name="twitter:image" content="https://block.github.io/lyxal/assets/images/llm-agent-test-86ce2379ce4dde48ae1448f0f9d75c1f.png" />
</head>