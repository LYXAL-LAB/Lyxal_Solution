...
use super::github_recipe::{
    ...
    LYXAL_RECIPE_GITHUB_REPO_CONFIG_KEY,
};
use lyxal::recipe::local_recipes::{list_local_recipes, load_local_recipe_file};
...
fn configured_github_recipe_repo() -> Option<String> {
    ...
    match config.get_param(LYXAL_RECIPE_GITHUB_REPO_CONFIG_KEY) {
