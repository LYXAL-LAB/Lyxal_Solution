...
use lyxal::execution::manager::AgentManager;
...
use lyxal::agents::ExtensionLoadResult;
...
impl AppState {
    ...
    pub async fn get_agent(&self, session_id: String) -> anyhow::Result<Arc<lyxal::agents::Agent>> {
    ...
    pub async fn get_agent_for_route(
        &self,
        session_id: String,
    ) -> Result<Arc<lyxal::agents::Agent>, StatusCode> {
