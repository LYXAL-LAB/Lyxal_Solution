...
mod tests {
    ...
    fn test_env_var_conversion() {
        assert_eq!(to_env_var("type"), "LYXAL_PROVIDER__TYPE");
        assert_eq!(to_env_var("api_key"), "LYXAL_PROVIDER__API_KEY");
        assert_eq!(to_env_var("provider.host"), "LYXAL_PROVIDER__HOST");
        assert_eq!(to_env_var("provider.api_key"), "LYXAL_PROVIDER__API_KEY");
    }
}
