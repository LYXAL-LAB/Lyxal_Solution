use lyxal::agents::extension::Envs;
use lyxal::agents::extension::ToolInfo;
use lyxal::agents::ExtensionConfig;
use lyxal::config::permission::PermissionLevel;
use lyxal::config::ExtensionEntry;
use lyxal::conversation::Conversation;
use lyxal::dictation::download_manager::{DownloadProgress, DownloadStatus};
use lyxal::model::ModelConfig;
use lyxal::permission::permission_confirmation::PrincipalType;
use lyxal::providers::base::{ConfigKey, ModelInfo, ProviderMetadata, ProviderType};
use lyxal::session::{Session, SessionInsights, SessionType, SystemInfo};
use rmcp::model::{
...
use lyxal::conversation::message::{
...
#[openapi(
    ...
    components(schemas(
        ...
        lyxal::prompt_template::Template,
        ...
        Conversation,
        IconSchema,
        lyxal::session::extension_data::ExtensionData,
        ...
        lyxal::recipe::Recipe,
        lyxal::recipe::Author,
        lyxal::recipe::Settings,
        lyxal::recipe::RecipeParameter,
        lyxal::recipe::RecipeParameterInputType,
        lyxal::recipe::RecipeParameterRequirement,
        lyxal::recipe::Response,
        lyxal::recipe::SubRecipe,
        lyxal::agents::types::RetryConfig,
        lyxal::agents::types::SuccessCheck,
        ...
        lyxal::agents::ExtensionLoadResult,
        super::routes::setup::SetupResponse,
        super::tunnel::TunnelInfo,
        super::tunnel::TunnelState,
        super::routes::telemetry::TelemetryEventRequest,
        lyxal::lyxal_apps::LyxalApp,
        lyxal::lyxal_apps::WindowProps,
        lyxal::lyxal_apps::McpAppResource,
        lyxal::lyxal_apps::CspMetadata,
        lyxal::lyxal_apps::UiMetadata,
        lyxal::lyxal_apps::ResourceMetadata,
        super::routes::dictation::TranscribeRequest,
        super::routes::dictation::TranscribeResponse,
        lyxal::dictation::providers::DictationProvider,
