...
use lyxal::agents::{AgentEvent, SessionConfig};
use lyxal::conversation::message::{Message, MessageContent, TokenState};
    ...
    match content {
        MessageContent::ToolRequest(tool_request) => {
            if let Ok(tool_call) = &tool_request.tool_call {
                tracing::info!(monotonic_counter.lyxal.tool_calls = 1,
