...
use lyxal::config::signup_openrouter::OpenRouterAuth;
use lyxal::config::signup_tetrate::{configure_tetrate, TetrateAuth};
use lyxal::config::{configure_openrouter, Config};
use serde::Serialize;
use std::sync::Arc;
use utoipa::ToSchema;
