...
use lyxal::session::session_manager::SessionInsights;
    ...
    let target_session_id = if request.copy {
        let original = session_manager
            ...
            .map_err(|e| {
                ...
                lyxal::posthog::emit_error("session_get_failed", &e.to_string());
                ErrorResponse {
        ...
        let copied = session_manager
            ...
            .map_err(|e| {
                ...
                lyxal::posthog::emit_error("session_copy_failed", &e.to_string());
                ErrorResponse {
    ...
    if request.truncate {
        session_manager
            ...
            .map_err(|e| {
                ...
                lyxal::posthog::emit_error("session_truncate_failed", &e.to_string());
                ErrorResponse {
...
async fn get_session_extensions(
    ...
    let extensions = EnabledExtensionsState::from_extension_data(&session.extension_data)
        ...
        .unwrap_or_else(lyxal::config::get_enabled_extensions);
