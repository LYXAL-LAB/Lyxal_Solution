...
impl ComputerControllerServer {
    pub fn new() -> Self {
        ...
        // - macOS/Linux: ~/.cache/lyxal/computer_controller/
        // - Windows:     ~\AppData\Local\Block\lyxal\cache\computer_controller\
        ...
        Self {
            ...
            http_client: Client::builder().user_agent("lyxal/1.0").build().unwrap(),
            instructions,
            system_automation,
        }
    }
    ...
    fn get_info(&self) -> ServerInfo {
        ServerInfo {
            server_info: Implementation {
                name: "lyxal-computercontroller".to_string(),
