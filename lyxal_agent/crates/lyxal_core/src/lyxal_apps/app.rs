...
impl LyxalApp {
    ...
    const PRD_SCRIPT_TYPE: &'static str = "application/x-lyxal-prd";
    const LYXAL_APP_TYPE: &'static str = "LyxalApp";
    const LYXAL_SCHEMA_CONTEXT: &'static str = "urn:lyxal.ai:schema";
    ...
    pub fn from_html(html: &str) -> Result<Self, String> {
        ...
        let json_str = metadata_re
            ...
            .ok_or_else(|| "No LyxalApp JSON-LD metadata found in HTML".to_string())?
            .as_str();
    ...
    pub fn to_html(&self) -> Result<String, String> {
        ...
        let mut metadata = serde_json::json!({
            "@context": Self::LYXAL_SCHEMA_CONTEXT,
            "@type": Self::LYXAL_APP_TYPE,
