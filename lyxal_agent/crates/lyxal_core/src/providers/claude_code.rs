...
impl ClaudeCodeProvider {
    ...
    /// Convert lyxal messages to the format expected by claude CLI
    ...
    async fn execute_command(
        ...
        if std::env::var("LYXAL_CLAUDE_CODE_DEBUG").is_ok() {
        ...
        // Add permission mode based on LYXAL_MODE setting
