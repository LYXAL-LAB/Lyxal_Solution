...
use crate::config::{Config, LyxalMode};
...
impl CodexProvider {
    ...
    /// Convert lyxal messages to a simple text prompt format
    ...
    /// Apply permission flags based on LYXAL_MODE setting
    ...
    async fn execute_command(
        ...
        if std::env::var("LYXAL_CODEX_DEBUG").is_ok() {
        ...
        // This allows users to set LYXAL_PROVIDER=codex without needing to specify a model
        ...
        // Apply permission mode based on LYXAL_MODE
