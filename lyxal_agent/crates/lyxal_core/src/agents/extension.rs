    ...
    || {
        ...
        map.insert(
            ...
            PlatformExtensionDef {
                ...
                display_name: "Apps",
                description:
                    "Create and manage custom Lyxal apps through chat. Apps are HTML/CSS/JavaScript and run in sandboxed windows.",
                default_enabled: true,
        ...
        map.insert(
            ...
            PlatformExtensionDef {
                ...
                description:
                    "Lyxal will make extension calls through code execution, saving tokens",
                default_enabled: false,
                client_factory: |ctx| {
...
pub enum ExtensionConfig {
    ...
    /// Built-in extension that is part of the bundled lyxal MCP server
