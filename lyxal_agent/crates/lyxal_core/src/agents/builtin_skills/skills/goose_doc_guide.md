---
name: lyxal-doc-guide
description: Reference lyxal documentation to create, configure, or explain lyxal-specific features like recipes, extensions, sessions, and providers. You MUST fetch relevant lyxal docs before answering. You MUST NOT rely on training data or assumptions for any lyxal-specific fields, values, names, syntax, or commands.
---

Use this skill when working with **lyxal-specific features**:
- Creating or editing recipes
- Configuring extensions or providers
- Explaining how lyxal features work
- Any lyxal configuration or setup task

Do NOT use this skill for:
- General coding tasks unrelated to lyxal
- Running existing recipes (just run them directly)

## Steps (COMPLETE ALL BEFORE RESPONDING)
1. **Fetch official docs**
   - Fetch the doc map from `https://block.github.io/lyxal/lyxal-docs-map.md`
   ...
   - Fetch: `https://block.github.io/lyxal/docs/guides/sessions/session-management.md`
...
2. **Create/modify content**
   - For lyxal configuration files:
      ...
      - **⚠️ STOP: Before showing the user, verify output content MUST match the schema and reference in the lyxal official documentation:**
...
3. **MANDATORY VERIFICATION - CHECK ALL THESE ITEMS BEFORE STEP 4**
   ...
   - [ ] You MUST NOT rely on training data or assumptions for any lyxal-specific fields, values, names, syntax, or commands.
   ...
   - [ ] List all lyxal-specific items in your answer (commands, fields, syntax, values, how to use, explanations, etc.)
...
4. **Provide your answer and include a "Verification Completed" section**
   - For EACH lyxal-specific item in your response, cite the specific doc file where you verified it

5. **List documentation links**
   - Only include docs actually used
   - Remove `.md` suffix from URLs
   - Example: If you fetched `https://block.github.io/lyxal/docs/guides/sessions/session-management.md`, list it as `https://block.github.io/lyxal/docs/guides/sessions/session-management`
