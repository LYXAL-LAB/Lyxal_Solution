...
use crate::hints::load_hints::{load_hint_files, AGENTS_MD_FILENAME, LYXAL_HINTS_FILENAME};
use crate::{
    config::{Config, LyxalMode},
    prompt_template,
...
impl<'a> SystemPromptBuilder<'a, PromptManager> {
    ...
    pub fn build(self) -> String {
        ...
        let context = SystemPromptContext {
            ...
            lyxal_mode,
            is_autonomous: lyxal_mode == LyxalMode::Auto,
        ...
        .unwrap_or_else(|_| {
            "You are a general-purpose AI agent called lyxal, created by Block".to_string()
        });
