...
/// Lyxal-specific credential store that uses the Config system
///
/// This implementation stores OAuth credentials in the lyxal configuration
/// system, which handles secure storage (e.g., keychain integration).

#[derive(Clone)]
pub struct LyxalCredentialStore {
    name: String,
}

impl LyxalCredentialStore {
...
impl CredentialStore for LyxalCredentialStore {
