...
use crate::oauth::persist::LyxalCredentialStore;
...
pub async fn oauth_flow(
    ...
    let credential_store = LyxalCredentialStore::new(name.clone());
    ...
    oauth_state
        .start_authorization(&[], redirect_uri.as_str(), Some("lyxal"))
        .await?;
