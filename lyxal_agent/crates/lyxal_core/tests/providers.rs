...
use lyxal::providers::anthropic::ANTHROPIC_DEFAULT_MODEL;
use lyxal::providers::azure::AZURE_DEFAULT_MODEL;
use lyxal::providers::base::Provider;
use lyxal::providers::bedrock::BEDROCK_DEFAULT_MODEL;
use lyxal::providers::create_with_named_model;
use lyxal::providers::databricks::DATABRICKS_DEFAULT_MODEL;
use lyxal::providers::errors::ProviderError;
use lyxal::providers::google::GOOGLE_DEFAULT_MODEL;
use lyxal::providers::litellm::LITELLM_DEFAULT_MODEL;
use lyxal::providers::ollama::OLLAMA_DEFAULT_MODEL;
use lyxal::providers::openai::OPEN_AI_DEFAULT_MODEL;
use lyxal::providers::sagemaker_tgi::SAGEMAKER_TGI_DEFAULT_MODEL;
use lyxal::providers::snowflake::SNOWFLAKE_DEFAULT_MODEL;
use lyxal::providers::xai::XAI_DEFAULT_MODEL;
...
impl ProviderTester {
    ...
    async fn test_image_content_support(&self) -> Result<()> {
        ...
        let image_path = "crates/lyxal/examples/test_assets/test_image.png";
