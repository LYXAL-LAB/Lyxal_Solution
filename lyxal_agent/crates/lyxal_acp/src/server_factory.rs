...
use crate::server::{AcpServerConfig, LyxalAcpAgent};
...
impl AcpServer {
    ...
    pub async fn create_agent(&self) -> Result<Arc<LyxalAcpAgent>> {
        ...
        let agent = LyxalAcpAgent::with_config(acp_config).await?;
