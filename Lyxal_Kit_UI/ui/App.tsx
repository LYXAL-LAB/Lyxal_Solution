    ...
    >
      ...
      <div id="page-content" className="flex-1 p-6 overflow-auto">
        <div id="content-wrapper" className="max-w-7xl mx-auto">
          ...
          {/* Section test Lyxal UI */}
          <div className="card bg-gradient-to-r from-primary to-accent text-primary-content shadow-xl mb-6">
            <div className="card-body">
              <h2 className="card-title text-2xl">
                🎉 Lyxal UI Intégré avec Succès !
              </h2>
              <p>Tous les composants et thèmes sont maintenant disponibles dans votre projet.</p>
              <div className="card-actions justify-end">
                <div className="badge badge-secondary">60+ composants</div>
                <div className="badge badge-accent">35 thèmes</div>
                <div className="badge badge-primary">96% optimisé</div>
              </div>
            </div>
          </div>
