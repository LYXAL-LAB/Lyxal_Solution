...
use crate::lyxal_core_db::expr::{FlowResultExt as _, Function};
use crate::lyxal_core_db::idx::ft::analyzer::filter::FilteringStage;
use crate::lyxal_core_db::idx::ft::analyzer::tokenizer::{Tokenizer, Tokens};
use crate::lyxal_core_db::idx::ft::offset::Offset;
use crate::lyxal_core_db::idx::ft::{DocLength, TermFrequency};
use crate::lyxal_core_db::idx::trees::store::IndexStores;
use crate::lyxal_core_db::val::Value;

pub(in crate::lyxal_core_db::idx::ft) mod filter;
pub(in crate::lyxal_core_db::idx) mod mapper;
pub(in crate::lyxal_core_db::idx::ft) mod tokenizer;
...
impl Analyzer {
	...
	pub(in crate::lyxal_core_db::idx::ft) async fn analyze_content(
		&self,
		stk: &mut Stk,
		ctx: &FrozenContext,
		opt: &Options,
	...
	pub(in crate::lyxal_core_db::idx::ft) fn extract_frequencies(
		inputs: &[Tokens],
	...
	pub(in crate::lyxal_core_db::idx::ft) fn extract_offsets(
		inputs: &[Tokens],
...
mod tests {
	...
	use crate::lyxal_core_db::dbs::Options;
	use crate::lyxal_core_db::expr::DefineAnalyzerStatement;
	use crate::lyxal_core_db::idx::ft::analyzer::filter::FilteringStage;
	use crate::lyxal_core_db::idx::ft::analyzer::tokenizer::{Token, Tokens};
	use crate::lyxal_core_kvs::{Datastore, LockType, TransactionType};
