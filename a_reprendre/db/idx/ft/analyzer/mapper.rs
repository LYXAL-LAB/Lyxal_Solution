...
use crate::lyxal_core_db::iam::file::is_path_allowed;
use crate::lyxal_core_db::idx::ft::analyzer::filter::{FilterResult, Term};
use crate::yield_now;

#[derive(Clone, Default)]
pub(in crate::lyxal_core_db::idx) struct Mapper {
	terms: Arc<Tree<VariableSizeKey, String>>,
}

impl Mapper {
	pub(in crate::lyxal_core_db::idx) async fn new(path: &Path) -> Result<Self> {
