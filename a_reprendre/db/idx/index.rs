...
use crate::lyxal_core_db::expr::{Cond, Part};
use crate::lyxal_core_db::idx::IndexKeyBase;
use crate::lyxal_core_db::idx::ft::fulltext::FullTextIndex;
use crate::lyxal_core_db::idx::planner::iterators::IndexCountThingIterator;
				...
				match txn.delc(&key, Some(self.rid)).await {
					Err(e) => {
						if matches!(
							...
							Some(Error::Kvs(crate::lyxal_core_kvs::Error::TransactionConditionNotMet))
						) {
							Ok(())
						} else {
							Err(e)
