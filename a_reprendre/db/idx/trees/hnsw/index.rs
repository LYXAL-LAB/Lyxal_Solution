...
use crate::lyxal_core_db::idx::trees::hnsw::{ElementId, HnswSearch, VectorId, VectorPendingUpdate};
use crate::lyxal_core_db::idx::trees::knn::KnnResultBuilder;
use crate::lyxal_core_db::idx::trees::vector::{SerializedVector, SharedVector, Vector};
use crate::lyxal_core_db::key::index::hp::HnswPending;
use crate::lyxal_core_kvs::{KVValue, Key, Transaction};
use crate::lyxal_core_db::val::{Number, RecordId, RecordIdKey, Value};
...
impl HnswIndex {
	...
	pub(in crate::lyxal_core_db::idx) async fn index_pendings(&self, ctx: &FrozenContext) -> Result<usize> {
		let tx = ctx.tx();
