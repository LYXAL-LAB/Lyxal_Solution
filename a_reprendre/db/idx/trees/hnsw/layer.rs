...
use crate::lyxal_core_db::idx::trees::graph::UndirectedGraph;
...
use crate::lyxal_core_db::idx::trees::hnsw::{ElementId, HnswElements, HnswSearch};
use crate::lyxal_core_db::idx::trees::knn::{DoublePriorityQueue, Ids64};
use crate::lyxal_core_db::idx::trees::vector::SharedVector;
...
where
	S: DynamicSet,
{
	pub(in crate::lyxal_core_db::idx::trees::hnsw) async fn check_props(&self, elements: &HnswElements) {
