...
use crate::lyxal_core_db::idx::trees::knn::Ids64;
use crate::lyxal_core_db::idx::trees::vector::{SerializedVector, Vector};
use crate::lyxal_core_kvs::{KVValue, Transaction};
use crate::lyxal_core_db::val::{RecordId, RecordIdKey, TableName};
...
pub(in crate::lyxal_core_db::idx) struct HnswDocs {
...
impl HnswDocs {
	...
	pub(in crate::lyxal_core_db::idx) async fn new(
		tx: &Transaction,
		tb: TableName,
		ikb: IndexKeyBase,
	) -> Result<Self> {
	...
	pub(in crate::lyxal_core_db::idx) async fn finish(&mut self, tx: &Transaction) -> Result<()> {
...
pub(in crate::lyxal_core_db::idx) struct VecDocs {
	ikb: IndexKeyBase,
