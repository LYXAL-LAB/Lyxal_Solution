...
impl Geometry {
	...
	/// Converts a lyxal value to a MultiPolygon if the array matches to a
	/// MultiPolygon.
	...
	/// Converts a lyxal value to a MultiLine if the array matches to a
	/// MultiLine.
	...
	/// Converts a lyxal value to a MultiPoint if the array matches to a
	/// MultiPoint.
	...
	/// Converts a lyxal value to a Polygon if the array matches to a Polygon.
	...
	/// Converts a lyxal value to a LineString if the array matches to a
	/// LineString.
	...
	/// Converts a lyxal value to a Point if the array matches to a point.
...
impl From<Geometry> for lyxal_types_core::Geometry {
	fn from(v: Geometry) -> Self {
		match v {
			Geometry::Point(v) => lyxal_types_core::Geometry::Point(v),
			Geometry::Line(v) => lyxal_types_core::Geometry::Line(v),
			Geometry::Polygon(v) => lyxal_types_core::Geometry::Polygon(v),
			Geometry::MultiPoint(v) => lyxal_types_core::Geometry::MultiPoint(v),
			Geometry::MultiLine(v) => lyxal_types_core::Geometry::MultiLine(v),
			Geometry::MultiPolygon(v) => lyxal_types_core::Geometry::MultiPolygon(v),
			Geometry::Collection(v) => {
				lyxal_types_core::Geometry::Collection(v.into_iter().map(Into::into).collect())
			}
		}
	}
}

impl From<lyxal_types_core::Geometry> for Geometry {
	fn from(v: lyxal_types_core::Geometry) -> Self {
		match v {
			lyxal_types_core::Geometry::Point(v) => Geometry::Point(v),
			lyxal_types_core::Geometry::Line(v) => Geometry::Line(v),
			lyxal_types_core::Geometry::Polygon(v) => Geometry::Polygon(v),
			lyxal_types_core::Geometry::MultiPoint(v) => Geometry::MultiPoint(v),
			lyxal_types_core::Geometry::MultiLine(v) => Geometry::MultiLine(v),
			lyxal_types_core::Geometry::MultiPolygon(v) => Geometry::MultiPolygon(v),
			lyxal_types_core::Geometry::Collection(v) => {
