...
use crate::lyxal_core_db::val::{Duration, TrySub};
...
impl From<lyxal_types_core::Datetime> for Datetime {
	fn from(v: lyxal_types_core::Datetime) -> Self {
		Self(v.into_inner())
	}
}

impl From<Datetime> for lyxal_types_core::Datetime {
	fn from(x: Datetime) -> Self {
		lyxal_types_core::Datetime::from(x.0)
	}
}
