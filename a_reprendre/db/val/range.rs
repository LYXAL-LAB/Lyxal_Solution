...
use crate::lyxal_core_db::expr::kind::HasKind;
use crate::lyxal_core_db::val::value::{Coerce, CoerceError};
use crate::lyxal_core_db::val::{Array, IndexFormat, Number, Value};

/// A range of lyxal_ql values,
///
