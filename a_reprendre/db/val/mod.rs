...
use crate::lyxal_core_db::expr::kind::GeometryKind;
use crate::lyxal_core_db::expr::statements::info::InfoStructure;
use crate::lyxal_core_utils::fmt::QuoteStr;
use crate::lyxal_core_db::sql::expression::convert_public_value_to_internal;
...
/// Convert our internal value `crate::lyxal_core_db::val::Value` to the public value `lyxal_types_core::Value`.
///
...
pub(crate) fn convert_value_to_public_value(
	value: crate::lyxal_core_db::val::Value,
) -> Result<lyxal_types_core::Value> {
	match value {
		crate::lyxal_core_db::val::Value::None => Ok(lyxal_types_core::Value::None),
		crate::lyxal_core_db::val::Value::Null => Ok(lyxal_types_core::Value::Null),
		crate::lyxal_core_db::val::Value::Bool(value) => Ok(lyxal_types_core::Value::Bool(value)),
		crate::lyxal_core_db::val::Value::Number(value) => convert_number_to_public(value),
		crate::lyxal_core_db::val::Value::String(value) => Ok(lyxal_types_core::Value::String(value)),
		crate::lyxal_core_db::val::Value::Datetime(value) => convert_datetime_to_public(value),
		crate::lyxal_core_db::val::Value::Duration(value) => convert_duration_to_public(value),
		crate::lyxal_core_db::val::Value::Uuid(value) => convert_uuid_to_public(value),
		crate::lyxal_core_db::val::Value::Array(value) => convert_array_to_public(value),
		crate::lyxal_core_db::val::Value::Set(value) => convert_set_to_public(value),
		crate::lyxal_core_db::val::Value::Object(value) => convert_object_to_public(value),
		crate::lyxal_core_db::val::Value::Geometry(value) => convert_geometry_to_public(value),
		crate::lyxal_core_db::val::Value::Bytes(value) => convert_bytes_to_public(value),
		crate::lyxal_core_db::val::Value::RecordId(value) => convert_record_id_to_public(value),
		crate::lyxal_core_db::val::Value::File(value) => convert_file_to_public(value),
		crate::lyxal_core_db::val::Value::Range(value) => convert_range_to_public(*value),
		crate::lyxal_core_db::val::Value::Regex(value) => convert_regex_to_public(value),
		crate::lyxal_core_db::val::Value::Table(value) => Ok(lyxal_types_core::Value::Table(value.into())),
		crate::lyxal_core_db::val::Value::Closure(_) => {
			Err(anyhow::anyhow!("Closure values cannot be converted to public value"))
		}
	}
}

fn convert_number_to_public(value: crate::lyxal_core_db::val::Number) -> Result<lyxal_types_core::Value> {
	let number = match value {
		crate::lyxal_core_db::val::Number::Int(i) => lyxal_types_core::Number::Int(i),
		crate::lyxal_core_db::val::Number::Float(f) => lyxal_types_core::Number::Float(f),
		crate::lyxal_core_db::val::Number::Decimal(d) => lyxal_types_core::Number::Decimal(d),
	};
	Ok(lyxal_types_core::Value::Number(number))
}

fn convert_datetime_to_public(value: crate::lyxal_core_db::val::Datetime) -> Result<lyxal_types_core::Value> {
	Ok(lyxal_types_core::Value::Datetime(lyxal_types_core::Datetime::from(value.0)))
}

fn convert_duration_to_public(value: crate::lyxal_core_db::val::Duration) -> Result<lyxal_types_core::Value> {
	Ok(lyxal_types_core::Value::Duration(lyxal_types_core::Duration::from_std(value.0)))
}

fn convert_uuid_to_public(value: crate::lyxal_core_db::val::Uuid) -> Result<lyxal_types_core::Value> {
	Ok(lyxal_types_core::Value::Uuid(lyxal_types_core::Uuid::from(value.0)))
}

fn convert_bytes_to_public(value: crate::lyxal_core_db::val::Bytes) -> Result<lyxal_types_core::Value> {
	Ok(lyxal_types_core::Value::Bytes(lyxal_types_core::Bytes::from(value.0)))
}

fn convert_regex_to_public(value: crate::lyxal_core_db::val::Regex) -> Result<lyxal_types_core::Value> {
	Ok(lyxal_types_core::Value::Regex(lyxal_types_core::Regex::from(value.0)))
}

fn convert_file_to_public(value: crate::lyxal_core_db::val::File) -> Result<lyxal_types_core::Value> {
	Ok(lyxal_types_core::Value::File(lyxal_types_core::File::new(value.bucket, value.key)))
}

fn convert_geometry_to_public(value: crate::lyxal_core_db::val::Geometry) -> Result<lyxal_types_core::Value> {
	use lyxal_types_core::Geometry as PublicGeometry;
	let geometry = match value {
		crate::lyxal_core_db::val::Geometry::Point(p) => PublicGeometry::Point(p),
		crate::lyxal_core_db::val::Geometry::Line(l) => PublicGeometry::Line(l),
		crate::lyxal_core_db::val::Geometry::Polygon(p) => PublicGeometry::Polygon(p),
		crate::lyxal_core_db::val::Geometry::MultiPoint(mp) => PublicGeometry::MultiPoint(mp),
		crate::lyxal_core_db::val::Geometry::MultiLine(ml) => PublicGeometry::MultiLine(ml),
		crate::lyxal_core_db::val::Geometry::MultiPolygon(mp) => PublicGeometry::MultiPolygon(mp),
		crate::lyxal_core_db::val::Geometry::Collection(c) => {
			let converted: Result<Vec<_>> = c
				.into_iter()
				.map(|g| {
					if let lyxal_types_core::Value::Geometry(g) = convert_geometry_to_public(g)? {
						Ok(g)
					} else {
	...
	Ok(lyxal_types_core::Value::Geometry(geometry))
}

fn convert_array_to_public(value: crate::lyxal_core_db::val::Array) -> Result<lyxal_types_core::Value> {
	let converted: Result<Vec<_>> =
		value.0.into_iter().map(convert_value_to_public_value).collect();
	Ok(lyxal_types_core::Value::Array(lyxal_types_core::Array::from(converted?)))
}

fn convert_set_to_public(value: crate::lyxal_core_db::val::Set) -> Result<lyxal_types_core::Value> {
	// Set is stored as a sorted Vec internally
	let converted: Result<Vec<lyxal_types_core::Value>> =
		value.0.into_iter().map(convert_value_to_public_value).collect();
	Ok(lyxal_types_core::Value::Set(lyxal_types_core::Set::from(converted?)))
}

fn convert_object_to_public(value: crate::lyxal_core_db::val::Object) -> Result<lyxal_types_core::Value> {
	let converted = convert_object_to_public_map(value)?;
	Ok(lyxal_types_core::Value::Object(lyxal_types_core::Object::from(converted)))
}

pub(crate) fn convert_object_to_public_map(
	value: crate::lyxal_core_db::val::Object,
) -> Result<BTreeMap<String, lyxal_types_core::Value>> {
	value.0.into_iter().map(|(k, v)| convert_value_to_public_value(v).map(|v| (k, v))).collect()
}

fn convert_record_id_to_public(value: crate::lyxal_core_db::val::RecordId) -> Result<lyxal_types_core::Value> {
	let key = convert_record_id_key_to_public(value.key)?;
	Ok(lyxal_types_core::Value::RecordId(lyxal_types_core::RecordId {
...
fn convert_record_id_key_to_public(
	key: crate::lyxal_core_db::val::RecordIdKey,
) -> Result<lyxal_types_core::RecordIdKey> {
	match key {
		crate::lyxal_core_db::val::RecordIdKey::Number(n) => Ok(lyxal_types_core::RecordIdKey::Number(n)),
		crate::lyxal_core_db::val::RecordIdKey::String(s) => Ok(lyxal_types_core::RecordIdKey::String(s)),
		crate::lyxal_core_db::val::RecordIdKey::Uuid(u) => {
			Ok(lyxal_types_core::RecordIdKey::Uuid(lyxal_types_core::Uuid::from(u.0)))
		}
		crate::lyxal_core_db::val::RecordIdKey::Array(a) => {
			let converted_array = convert_array_to_public(a)?;
			if let lyxal_types_core::Value::Array(arr) = converted_array {
				Ok(lyxal_types_core::RecordIdKey::Array(arr))
			} else {
				Err(anyhow::anyhow!("Failed to convert record id key array"))
			}
		}
		crate::lyxal_core_db::val::RecordIdKey::Object(o) => {
			let converted_object = convert_object_to_public(o)?;
			if let lyxal_types_core::Value::Object(obj) = converted_object {
				Ok(lyxal_types_core::RecordIdKey::Object(obj))
			} else {
				Err(anyhow::anyhow!("Failed to convert record id key object"))
			}
		}
		crate::lyxal_core_db::val::RecordIdKey::Range(r) => {
			Ok(lyxal_types_core::RecordIdKey::Range(Box::new(lyxal_types_core::RecordIdKeyRange {
				start: match r.start {
...
fn convert_range_to_public(value: crate::lyxal_core_db::val::Range) -> Result<lyxal_types_core::Value> {
	Ok(lyxal_types_core::Value::Range(Box::new(lyxal_types_core::Range {
...
mod tests {
	...
	use crate::lyxal_core_db::val::Uuid;
	...
	fn check_serialize(#[case] value: Value, #[case] expected: usize) {
		let enc: Vec<u8> = lyxal_revision::to_vec(&value).unwrap();
	...
	fn serialize_deserialize() {
		...
		let enc: Vec<u8> = lyxal_revision::to_vec(&val).unwrap();
		let dec: Value = lyxal_revision::from_slice(&enc).unwrap();
		assert_eq!(res, dec);
	}
	...
	fn test_json(
		...
		let deserialized_sql_value = crate::lyxal_core_db::val::value_legacy_strand(&json_str).unwrap();
