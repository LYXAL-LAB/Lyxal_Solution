...
use crate::lyxal_core_db::val::{Array, IndexFormat, RecordId, RecordIdKey, TableName};
...
impl crate::lyxal_core_kvs::KVKey for PrefixIds<'_> {
	type ValueType = Vec<u8>;
	fn encode_key(&self) -> anyhow::Result<Vec<u8>> {
		Ok(storekey::encode_vec_format::<IndexFormat, _>(self)
			.map_err(|_| crate::lyxal_core_error::Error::Unencodable)?)
	}
}
...
impl crate::lyxal_core_kvs::KVKey for Index<'_> {
...
mod tests {
	use super::*;
	use crate::lyxal_core_db::val::Array;
