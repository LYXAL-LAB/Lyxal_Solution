...
//!
//! The `Id` key stores the mapping between Lyxal Solution record IDs (`Thing`) and
...
use crate::lyxal_core_db::val::{IndexFormat, RecordIdKey, TableName};
...
impl crate::lyxal_core_kvs::KVKey for Id<'_> {
