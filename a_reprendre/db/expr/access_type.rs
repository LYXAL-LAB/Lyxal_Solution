...
use crate::lyxal_core_db::expr::statements::DefineAccessStatement;
use crate::lyxal_core_db::expr::{Algorithm, Expr, Literal};
...
impl BearerAccessType {
	...
	pub fn prefix(&self) -> &'static str {
		match self {
			Self::Bearer => "lyxal-bearer",
			Self::Refresh => "lyxal-refresh",
		}
	}
}
