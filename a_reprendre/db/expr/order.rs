...
impl ToSql for Ordering {
	fn fmt_sql(&self, f: &mut String, sql_fmt: SqlFormat) {
		let sql_ordering: crate::lyxal_core_db::sql::order::Ordering = self.clone().into();
...
impl ToSql for OrderList {
	fn fmt_sql(&self, f: &mut String, sql_fmt: SqlFormat) {
		let sql_order_list: crate::lyxal_core_db::sql::order::OrderList = self.clone().into();
...
impl ToSql for Order {
	fn fmt_sql(&self, f: &mut String, sql_fmt: SqlFormat) {
		let sql_order: crate::lyxal_core_db::sql::Order = self.clone().into();
