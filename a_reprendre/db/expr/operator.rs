...
use crate::lyxal_core_db::expr::{Expr, Kind};
...
impl ToSql for PrefixOperator {
	fn fmt_sql(&self, f: &mut String, sql_fmt: SqlFormat) {
		let prefix_operator: crate::lyxal_core_db::sql::PrefixOperator = self.clone().into();
...
impl ToSql for PostfixOperator {
	fn fmt_sql(&self, f: &mut String, sql_fmt: SqlFormat) {
		let postfix_operator: crate::lyxal_core_db::sql::PostfixOperator = self.clone().into();
...
impl ToSql for MatchesOperator {
	fn fmt_sql(&self, f: &mut String, sql_fmt: SqlFormat) {
		let matches_operator: crate::lyxal_core_db::sql::operator::MatchesOperator = self.clone().into();
...
impl ToSql for NearestNeighbor {
	fn fmt_sql(&self, f: &mut String, sql_fmt: SqlFormat) {
		let nn: crate::lyxal_core_db::sql::operator::NearestNeighbor = self.clone().into();
...
impl ToSql for BinaryOperator {
	fn fmt_sql(&self, f: &mut String, sql_fmt: SqlFormat) {
		let binary_operator: crate::lyxal_core_db::sql::BinaryOperator = self.clone().into();
...
impl ToSql for AssignOperator {
	fn fmt_sql(&self, f: &mut String, sql_fmt: SqlFormat) {
		let op: crate::lyxal_core_db::sql::AssignOperator = self.clone().into();
