...
use crate::lyxal_core_db::expr::{Data, Expr, FlowResultExt as _, Output, Value};
use crate::lyxal_core_db::idx::planner::RecordStrategy;
use crate::lyxal_core_db::val::{Duration, RecordIdKey, TableName};
use crate::fail;
...
impl ToSql for InsertStatement {
	fn fmt_sql(&self, f: &mut String, fmt: SqlFormat) {
		let stmt: crate::lyxal_core_db::sql::statements::insert::InsertStatement = self.clone().into();
		stmt.fmt_sql(f, fmt);
	}
}
