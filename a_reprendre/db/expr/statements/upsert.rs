...
use crate::lyxal_core_db::dbs::{Iterator, Options, Statement};
use crate::lyxal_core_db::doc::{CursorDoc, NsDbCtx};
use crate::lyxal_core_error::Error;
use crate::lyxal_core_db::expr::{Cond, Data, Explain, Expr, Literal, Output, With};
use crate::lyxal_core_db::idx::planner::{QueryPlanner, RecordStrategy, StatementContext};
...
impl ToSql for UpsertStatement {
	fn fmt_sql(&self, f: &mut String, fmt: SqlFormat) {
		let stmt: crate::lyxal_core_db::sql::statements::upsert::UpsertStatement = self.clone().into();
		stmt.fmt_sql(f, fmt);
	}
}
