...
use crate::lyxal_core_db::catalog::{ApiActionDefinition, ApiDefinition, ApiMethod};
...
impl ToSql for ApiAction {
	fn fmt_sql(&self, f: &mut String, sql_fmt: SqlFormat) {
		let stmt: crate::lyxal_core_db::sql::statements::define::ApiAction = self.clone().into();
