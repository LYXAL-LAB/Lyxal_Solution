...
use crate::lyxal_core_db::catalog::{FunctionDefinition, Permission};
...
use crate::lyxal_core_db::expr::{Base, Block, Expr, FlowResultExt, Kind};
...
impl ToSql for DefineFunctionStatement {
	fn fmt_sql(&self, f: &mut String, fmt: SqlFormat) {
		let stmt: crate::lyxal_core_db::sql::statements::define::DefineFunctionStatement = self.clone().into();
		stmt.fmt_sql(f, fmt);
	}
}
