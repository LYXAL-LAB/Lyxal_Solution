...
use crate::lyxal_core_db::catalog::{Index, IndexDefinition, TableDefinition, TableId};
...
use crate::lyxal_core_db::expr::parameterize::{expr_to_ident, exprs_to_fields};
use crate::lyxal_core_db::expr::{Base, Expr, FlowResultExt, Literal, Part};
...
pub(in crate::lyxal_core_db::expr::statements) async fn run_indexing(
	ctx: &FrozenContext,
	opt: &Options,
	tb: TableId,
