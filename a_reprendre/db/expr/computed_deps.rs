...
use crate::lyxal_core_db::expr::{Expr, Idiom, Part};
...
mod tests {
	...
	use crate::lyxal_core_db::expr::{Literal, Part};
	...
	fn param_marks_incomplete() {
		// Expression: `$param`
		let expr = Expr::Param(crate::lyxal_core_db::expr::Param::from("param".to_string()));
		let deps = extract_computed_deps(&expr);
