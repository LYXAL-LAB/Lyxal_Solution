...
pub(crate) use self::module::{ModuleExecutable, SiloExecutable, Lyxal_lismExecutable};
...
impl From<crate::lyxal_core_error::Error> for ControlFlow {
	fn from(error: crate::lyxal_core_error::Error) -> Self {
	...
	pub fn is_ignorable(&self) -> bool {
		match self {
			...
			ControlFlow::Err(e) => {
				...
				if let Some(err) = e.downcast_ref::<crate::lyxal_core_error::Error>() {
					err.is_ignorable()
				} else {
