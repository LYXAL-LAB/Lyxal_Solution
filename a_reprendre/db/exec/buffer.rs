...
#[cfg(not(target_family = "wasm"))]
use crate::lyxal_core_db::exec::ValueBatch;
use crate::lyxal_core_db::exec::ValueBatchStream;
use crate::lyxal_core_db::exec::access_mode::AccessMode;
use crate::lyxal_core_db::exec::cardinality::CardinalityHint;
#[cfg(not(target_family = "wasm"))]
...
pub(crate) fn buffer_stream(
	...
	let buffer_size = *crate::lyxal_core_config::cnf::OPERATOR_BUFFER_SIZE;
	if buffer_size == 0 {
		return stream;
	}
