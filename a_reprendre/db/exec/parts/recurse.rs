...
pub(crate) use crate::lyxal_core_db::exec::operators::recursion::evaluate_repeat_recurse;
...
impl PhysicalExpr for RecursePart {
	...
	async fn evaluate(&self, ctx: EvalContext<'_>) -> FlowResult<Value> {
		...
		let stream = self.op.execute(&bound_ctx).map_err(|e| match e {
			crate::lyxal_core_db::expr::ControlFlow::Err(e) => crate::lyxal_core_db::expr::ControlFlow::Err(e),
			other => other,
		})?;
