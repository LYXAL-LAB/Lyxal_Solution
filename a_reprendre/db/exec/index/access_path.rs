...
use crate::lyxal_core_db::catalog::IndexDefinition;
...
impl IndexRef {
	...
	pub fn is_unique(&self) -> bool {
		matches!(self.definition().index, crate::lyxal_core_db::catalog::Index::Uniq)
	}
}
...
pub enum BTreeAccess {
	...
	FullText {
		...
		operator: crate::lyxal_core_db::expr::operator::MatchesOperator,
	},
