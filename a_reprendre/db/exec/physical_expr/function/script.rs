...
use crate::lyxal_core_db::expr::{FlowResult, Script};
...
impl PhysicalExpr for JsFunctionExec {
	...
	async fn evaluate(&self, ctx: EvalContext<'_>) -> FlowResult<Value> {
		...
		use crate::lyxal_core_functions::script;
		...
		// This is required because JavaScript can call back into Lyxal Solution functions
	...
	async fn evaluate(&self, _ctx: EvalContext<'_>) -> FlowResult<Value> {
		Err(crate::lyxal_core_error::Error::InvalidScript {
