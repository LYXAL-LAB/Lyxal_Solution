...
use crate::lyxal_core_db::exec::{AccessMode, CombineAccessModes};
use crate::lyxal_core_db::expr::{FlowResult, Kind};
...
pub(crate) fn args_required_context(args: &[Arc<dyn PhysicalExpr>]) -> crate::lyxal_core_db::exec::ContextLevel {
	args.iter().map(|e| e.required_context()).max().unwrap_or(crate::lyxal_core_db::exec::ContextLevel::Root)
}
