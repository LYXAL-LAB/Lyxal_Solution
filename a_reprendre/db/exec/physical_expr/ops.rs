...
use crate::lyxal_core_db::exec::{AccessMode, ExecOperator};
...
pub struct BinaryOp {
	...
	pub(crate) op: crate::lyxal_core_db::expr::operator::BinaryOperator,
...
impl PhysicalExpr for BinaryOp {
	...
	async fn evaluate(&self, ctx: EvalContext<'_>) -> FlowResult<Value> {
		...
		use crate::lyxal_core_functions::operate;
		...
		Ok(match &self.op {
			...
			BinaryOperator::Range => {
				...
				Value::Range(Box::new(crate::lyxal_core_db::val::Range {
...
impl PhysicalExpr for SimpleBinaryOp {
	...
	fn required_context(&self) -> crate::lyxal_core_db::exec::ContextLevel {
		...
		crate::lyxal_core_db::exec::ContextLevel::Database
	}
	...
	async fn evaluate(&self, ctx: EvalContext<'_>) -> FlowResult<Value> {
		...
		let field_val: &Value = if let Value::Object(obj) = current {
			...
			_owned =
				crate::lyxal_core_db::exec::parts::field::evaluate_field(current, &self.field_name, ctx).await?;
			&_owned
		};
...
#[derive(Debug, Clone)]
pub struct UnaryOp {
	pub(crate) op: crate::lyxal_core_db::expr::operator::PrefixOperator,
...
impl PhysicalExpr for UnaryOp {
	...
	async fn evaluate(&self, ctx: EvalContext<'_>) -> FlowResult<Value> {
		use crate::lyxal_core_db::expr::operator::PrefixOperator;
		use crate::lyxal_core_functions::operate;
...
pub struct PostfixOp {
	pub(crate) op: crate::lyxal_core_db::expr::operator::PostfixOperator,
	pub(crate) expr: Arc<dyn PhysicalExpr>,
}
