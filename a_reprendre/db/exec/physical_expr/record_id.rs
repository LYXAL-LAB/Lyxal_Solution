...
use crate::lyxal_core_db::expr::record_id::RecordIdKeyGen;
use crate::lyxal_core_utils::fmt::EscapeRidKey;
use crate::lyxal_core_db::val::{Array, Object, RecordId, RecordIdKey, RecordIdKeyRange, TableName, Uuid, Value};
...
impl PhysicalRecordIdKey {
	...
	pub fn evaluate<'a>(
		&'a self,
		ctx: EvalContext<'a>,
	) -> crate::lyxal_core_db::exec::BoxFut<'a, FlowResult<RecordIdKey>> {
		Box::pin(async move {
			match self {
