...
use crate::lyxal_core_db::expr::part::{DestructurePart, Part};
...
) -> Result<(), crate::lyxal_core_db::expr::ControlFlow> {
	if field.expr.is_projection_function()
...
fn omit_nested_field(value: &mut Value, idiom: &Idiom, depth: usize) {
	...
	match part {
		...
		Part::Value(expr) => {
			...
			if let crate::lyxal_core_db::expr::Expr::Literal(crate::lyxal_core_db::expr::Literal::Integer(idx)) = expr
...
) -> Result<Value, crate::lyxal_core_db::expr::ControlFlow> {
