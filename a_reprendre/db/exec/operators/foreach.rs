...
use crate::lyxal_core_db::exec::plan_or_compute::{
...
use crate::lyxal_core_db::expr::{Block, ControlFlow, ControlFlowExt, Expr, Param};
use crate::lyxal_core_db::val::Value;
use crate::lyxal_core_db::val::range::IntegerRangeIter;
...
async fn execute_foreach(
...
) -> crate::lyxal_core_db::expr::FlowResult<ValueBatch> {
	...
	for v in iter {
		...
		if ctx.cancellation().is_cancelled() {
			return Err(ControlFlow::Err(anyhow::anyhow!(crate::lyxal_core_error::Error::QueryCancelled)));
		}
