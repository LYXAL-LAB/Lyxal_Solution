...
use crate::lyxal_core_db::dbs::{Capabilities, Options};
use crate::lyxal_core_error::Error;
use crate::lyxal_core_db::exec::function::FunctionRegistry;
use crate::lyxal_core_db::expr::Base;
use crate::lyxal_core_db::iam::{Action, Auth, ResourceKind};
use crate::lyxal_core_kvs::{Datastore, Transaction};
...
/// Shared cache of [`FieldState`](crate::lyxal_core_db::exec::operators::scan::pipeline::FieldState)
/// keyed by `(table_name, check_perms)`.
pub(crate) type FieldStateCache = Arc<
	tokio::sync::RwLock<
		HashMap<
			(crate::lyxal_core_db::val::TableName, bool),
			Arc<crate::lyxal_core_db::exec::operators::scan::pipeline::FieldState>,
		>,
	>,
>;
...
pub struct DatabaseContext {
	...
	pub(crate) table_def_cache: Arc<
		tokio::sync::RwLock<
			HashMap<crate::lyxal_core_db::val::TableName, Option<Arc<crate::lyxal_core_db::catalog::TableDefinition>>>,
		>,
	>,
	...
	pub(crate) index_def_cache: Arc<
		tokio::sync::RwLock<HashMap<crate::lyxal_core_db::val::TableName, Arc<[crate::lyxal_core_db::catalog::IndexDefinition]>>>,
	>,
}
...
impl DatabaseContext {
	...
	pub(crate) async fn get_table_def(
		&self,
		table: &crate::lyxal_core_db::val::TableName,
	) -> anyhow::Result<Option<Arc<crate::lyxal_core_db::catalog::TableDefinition>>> {
	...
	pub(crate) async fn get_table_indexes(
		&self,
		table: &crate::lyxal_core_db::val::TableName,
	) -> anyhow::Result<Arc<[crate::lyxal_core_db::catalog::IndexDefinition]>> {
		use crate::lyxal_core_db::catalog::providers::TableProvider;
		// Check execution-level cache (read lock — concurrent reads allowed)
		{
...
impl ExecutionContext {
	...
	pub fn with_limited_auth(&self, limit: &crate::lyxal_core_db::iam::AuthLimit) -> Self {
		let mut new = self.clone();
		let root = match &mut new {
			Self::Root(r) => r,
			Self::Namespace(n) => &mut n.root,
