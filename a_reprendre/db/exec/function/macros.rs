...
///     crate::lyxal_core_functions::math::abs           // Implementation path
/// );
///
...
///     crate::lyxal_core_functions::math::clamp
/// );
///
...
///     "rand",
///     () -> Float,
///     crate::lyxal_core_functions::rand::rand
/// );
///
...
///     crate::lyxal_core_functions::math::round
/// );
///
...
///     "string::concat",
///     (...values: Any) -> String,
///     crate::lyxal_core_functions::string::concat
/// );
/// ```
#[macro_export]
macro_rules! define_pure_function {
	...
	(
		...
		impl $crate::lyxal_core_db::exec::function::ScalarFunction for $struct_name {
			fn name(&self) -> &'static str {
				$func_name
			}

			fn signature(&self) -> $crate::lyxal_core_db::exec::function::Signature {
				$crate::lyxal_core_db::exec::function::Signature::new().returns($crate::lyxal_core_db::expr::Kind::$ret)
			}

			fn invoke(&self, args: Vec<$crate::lyxal_core_db::val::Value>) -> anyhow::Result<$crate::lyxal_core_db::val::Value> {
				let args = $crate::lyxal_core_functions::args::FromArgs::from_args($func_name, args)?;
				$impl_path(args)
			}
		}
	};
	...
	(
		...
		impl $crate::lyxal_core_db::exec::function::ScalarFunction for $struct_name {
			...
			fn signature(&self) -> $crate::lyxal_core_db::exec::function::Signature {
				$crate::lyxal_core_db::exec::function::Signature::new()
					.arg(stringify!($arg_name), $crate::lyxal_core_db::expr::Kind::$arg_type)
					.returns($crate::lyxal_core_db::expr::Kind::$ret)
			}
	...
	(
		...
		impl $crate::lyxal_core_db::exec::function::ScalarFunction for $struct_name {
			...
			fn signature(&self) -> $crate::lyxal_core_db::exec::function::Signature {
				$crate::lyxal_core_db::exec::function::Signature::new()
					.arg(stringify!($arg1_name), $crate::lyxal_core_db::expr::Kind::$arg1_type)
					.arg(stringify!($arg2_name), $crate::lyxal_core_db::expr::Kind::$arg2_type)
					.returns($crate::lyxal_core_db::expr::Kind::$ret)
			}
		...
		impl $crate::lyxal_core_db::exec::function::ScalarFunction for $struct_name {
			...
			fn signature(&self) -> $crate::lyxal_core_db::exec::function::Signature {
				$crate::lyxal_core_db::exec::function::Signature::new()
					.arg(stringify!($arg1_name), $crate::lyxal_core_db::expr::Kind::$arg1_type)
					.arg(stringify!($arg2_name), $crate::lyxal_core_db::expr::Kind::$arg2_type)
					.arg(stringify!($arg3_name), $crate::lyxal_core_db::expr::Kind::$arg3_type)
					.returns($crate::lyxal_core_db::expr::Kind::$ret)
			}
	...
	(
		...
		impl $crate::lyxal_core_db::exec::function::ScalarFunction for $struct_name {
			...
			fn signature(&self) -> $crate::lyxal_core_db::exec::function::Signature {
				$crate::lyxal_core_db::exec::function::Signature::new()
					.variadic($crate::lyxal_core_db::expr::Kind::$arg_type)
					.returns($crate::lyxal_core_db::expr::Kind::$ret)
			}
	...
	(
		...
		impl $crate::lyxal_core_db::exec::function::ScalarFunction for $struct_name {
			...
			fn signature(&self) -> $crate::lyxal_core_db::exec::function::Signature {
				$crate::lyxal_core_db::exec::function::Signature::new()
					.arg(stringify!($arg1_name), $crate::lyxal_core_db::expr::Kind::$arg1_type)
					.variadic($crate::lyxal_core_db::expr::Kind::$rest_type)
					.returns($crate::lyxal_core_db::expr::Kind::$ret)
			}
	...
	(
		...
		impl $crate::lyxal_core_db::exec::function::ScalarFunction for $struct_name {
			...
			fn signature(&self) -> $crate::lyxal_core_db::exec::function::Signature {
				$crate::lyxal_core_db::exec::function::Signature::new()
					.arg(stringify!($arg1_name), $crate::lyxal_core_db::expr::Kind::$arg1_type)
					.optional(stringify!($arg2_name), $crate::lyxal_core_db::expr::Kind::$arg2_type)
					.returns($crate::lyxal_core_db::expr::Kind::$ret)
			}
		...
		impl $crate::lyxal_core_db::exec::function::ScalarFunction for $struct_name {
			...
			fn signature(&self) -> $crate::lyxal_core_db::exec::function::Signature {
				$crate::lyxal_core_db::exec::function::Signature::new()
					.arg(stringify!($arg1_name), $crate::lyxal_core_db::expr::Kind::$arg1_type)
					.arg(stringify!($arg2_name), $crate::lyxal_core_db::expr::Kind::$arg2_type)
					.optional(stringify!($arg3_name), $crate::lyxal_core_db::expr::Kind::$arg3_type)
					.returns($crate::lyxal_core_db::expr::Kind::$ret)
			}
	...
	(
		...
		impl $crate::lyxal_core_db::exec::function::ScalarFunction for $struct_name {
			...
			fn signature(&self) -> $crate::lyxal_core_db::exec::function::Signature {
				$crate::lyxal_core_db::exec::function::Signature::new()
					.optional(stringify!($arg1_name), $crate::lyxal_core_db::expr::Kind::$arg1_type)
					.optional(stringify!($arg2_name), $crate::lyxal_core_db::expr::Kind::$arg2_type)
					.returns($crate::lyxal_core_db::expr::Kind::$ret)
			}
...
macro_rules! define_context_function {
	...
	(
		...
		impl $crate::lyxal_core_db::exec::function::ScalarFunction for $struct_name {
			...
			fn invoke(&self, _args: Vec<$crate::lyxal_core_db::val::Value>) -> anyhow::Result<$crate::lyxal_core_db::val::Value> {
				Err(anyhow::anyhow!("Function '{}' requires context", self.name()))
			}

			fn invoke_async<'a>(
				&'a self,
				ctx: &'a $crate::lyxal_core_db::exec::physical_expr::EvalContext<'_>,
				_args: Vec<$crate::lyxal_core_db::val::Value>,
			) -> $crate::lyxal_core_db::exec::BoxFut<'a, anyhow::Result<$crate::lyxal_core_db::val::Value>> {
	...
	(
		...
		impl $crate::lyxal_core_db::exec::function::ScalarFunction for $struct_name {
			...
			fn invoke_async<'a>(
				&'a self,
				ctx: &'a $crate::lyxal_core_db::exec::physical_expr::EvalContext<'_>,
				args: Vec<$crate::lyxal_core_db::val::Value>,
			) -> $crate::lyxal_core_db::exec::BoxFut<'a, anyhow::Result<$crate::lyxal_core_db::val::Value>> {
