...
pub trait Accumulator: crate::lyxal_core_db::exec::SendSyncRequirement + Debug {
...
pub trait AggregateFunction: crate::lyxal_core_db::exec::SendSyncRequirement + Debug {
...
macro_rules! define_aggregate {
	...
	(
		...
		impl $crate::lyxal_core_db::exec::function::AggregateFunction for $struct_name {
			fn name(&self) -> &'static str {
				$func_name
			}

			fn create_accumulator(&self) -> Box<dyn $crate::lyxal_core_db::exec::function::Accumulator> {
