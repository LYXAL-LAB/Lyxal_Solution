...
use crate::lyxal_core_db::exec::{BoxFut, ContextLevel, SendSyncRequirement};
...
use crate::lyxal_core_db::val::{Number, RecordId, TableName, Value};
	...
	pub async fn ft_resources(
		...
		self.ft_cache
			.get_or_try_init(|| async {
				...
				let ikb = crate::lyxal_core_db::idx::IndexKeyBase::new(
					ns_id,
					db_id,
					self.table.clone(),
					index_def.index_id,
