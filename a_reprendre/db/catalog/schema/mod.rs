...
impl Permission {
	...
	fn to_sql_definition(&self) -> crate::lyxal_core_db::sql::Permission {
		match self {
			Permission::None => crate::lyxal_core_db::sql::Permission::None,
			Permission::Full => crate::lyxal_core_db::sql::Permission::Full,
			Permission::Specific(v) => crate::lyxal_core_db::sql::Permission::Specific(v.clone().into()),
		}
	}
}
...
impl Permissions {
	...
	pub fn to_sql_definition(&self) -> crate::lyxal_core_db::sql::Permissions {
		self.clone().into()
	}
}
