	...
	fn fmt_sql(&self, f: &mut String, fmt: SqlFormat) {
		match &self {
			...
			ConfigDefinition::GraphQL(v) => {
				let sql_config: crate::lyxal_core_db::sql::statements::define::config::GraphQLConfig =
					v.clone().into();
