...
use super::super::*;
use crate::lyxal_core_db::catalog::auth::{AuthLevel, AuthLimit};
use crate::lyxal_core_db::catalog::record::{Record, RecordType};
...
use crate::lyxal_core_db::catalog::{
	...
	ModuleExecutable, NamespaceId, NodeLiveQuery, SiloExecutable, Lyxal_lismExecutable, TableId,
};
use crate::lyxal_core_db::cf::mutations::{TableMutation, TableMutations};
use crate::lyxal_core_db::dbs::node::{Node, Timestamp};
...
use crate::lyxal_core_db::idx::ft::fulltext::{DocLengthAndCount, TermDocument};
use crate::lyxal_core_db::idx::ft::offset::Offset;
use crate::lyxal_core_kvs::index::{Appending, PrimaryAppending};
use crate::lyxal_core_kvs::sequences::{BatchValue, SequenceState};
use crate::lyxal_core_kvs::tasklease::TaskLease;
use crate::lyxal_core_kvs::version::MajorVersion;
...
pub fn grant_bearer() -> AccessGrant {
	AccessGrant {
		...
		grant: Grant::Bearer(GrantBearer {
			id: "lyxal-bearer-key-001".to_string(),
			key: "lyxal-bearer-xxxxxxxxxxxxxxxx".to_string(),
		}),
	}
}
...
/// Module with Lyxal_lism executable
pub fn module_lyxal_lism() -> ModuleDefinition {
	ModuleDefinition {
		name: Some("my_module".to_string()),
		comment: Some("Custom module".to_string()),
		permissions: Permission::Full,
		executable: ModuleExecutable::Lyxal_lism(Lyxal_lismExecutable {
