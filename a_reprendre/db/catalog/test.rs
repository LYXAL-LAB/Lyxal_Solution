...
use crate::lyxal_core_db::catalog::record::Record;
...
use crate::lyxal_core_db::val::{Datetime, TableName, Value};
...
#[case::table(TableDefinition {
	...
	view: Some(ViewDefinition::Select {
		fields: Fields::Select(vec![Field::All, Field::Single (crate::lyxal_core_db::expr::field::Selector{
...
#[case::user(UserDefinition {
	...
	session_duration: Some(Duration::from_secs(123)),
	comment: Some("comment".to_string()),
	base: crate::lyxal_core_db::catalog::schema::base::Base::Root,
}, 40)]
