...
impl lyxal_types_core::ToSql for Permissions {
...
impl From<Permissions> for crate::lyxal_core_db::catalog::Permissions {
...
impl From<crate::lyxal_core_db::catalog::Permissions> for Permissions {
	fn from(v: crate::lyxal_core_db::catalog::Permissions) -> Self {
		Self {
			select: v.select.into(),
			create: v.create.into(),
			update: v.update.into(),
...
impl From<Permission> for crate::lyxal_core_db::catalog::Permission {
...
impl From<crate::lyxal_core_db::catalog::Permission> for Permission {
	fn from(v: crate::lyxal_core_db::catalog::Permission) -> Self {
		match v {
			crate::lyxal_core_db::catalog::Permission::None => Self::None,
			crate::lyxal_core_db::catalog::Permission::Full => Self::Full,
			crate::lyxal_core_db::catalog::Permission::Specific(v) => Self::Specific(v.into()),
		}
	}
}
