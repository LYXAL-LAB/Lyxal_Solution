...
use crate::lyxal_core_db::sql::{Expr, Idiom, Model, Script};
...
impl From<Function> for crate::lyxal_core_db::expr::Function {
	fn from(v: Function) -> Self {
		match v {
			Function::Normal(s) => crate::lyxal_core_db::expr::Function::Normal(s),
			Function::Custom(s) => crate::lyxal_core_db::expr::Function::Custom(s),
			Function::Script(s) => crate::lyxal_core_db::expr::Function::Script(s.into()),
			Function::Model(m) => crate::lyxal_core_db::expr::Function::Model(m.into()),
			Function::Module(m, s) => crate::lyxal_core_db::expr::Function::Module(m, s),
			Function::Silo {
				org,
				pkg,
				major,
				...
				patch,
				sub,
			} => crate::lyxal_core_db::expr::Function::Silo {
				org,
				pkg,
				major,
				minor,
...
impl From<crate::lyxal_core_db::expr::Function> for Function {
	fn from(v: crate::lyxal_core_db::expr::Function) -> Self {
		match v {
			crate::lyxal_core_db::expr::Function::Normal(s) => Self::Normal(s),
			crate::lyxal_core_db::expr::Function::Custom(s) => Self::Custom(s),
			crate::lyxal_core_db::expr::Function::Script(s) => Self::Script(s.into()),
			crate::lyxal_core_db::expr::Function::Model(m) => Self::Model(m.into()),
			crate::lyxal_core_db::expr::Function::Module(m, s) => Self::Module(m, s),
			crate::lyxal_core_db::expr::Function::Silo {
				org,
				pkg,
				major,
...
impl From<FunctionCall> for crate::lyxal_core_db::expr::FunctionCall {
	fn from(value: FunctionCall) -> Self {
		crate::lyxal_core_db::expr::FunctionCall {
...
impl From<crate::lyxal_core_db::expr::FunctionCall> for FunctionCall {
	fn from(value: crate::lyxal_core_db::expr::FunctionCall) -> Self {
		FunctionCall {
			receiver: value.receiver.into(),
			arguments: value.arguments.into_iter().map(Into::into).collect(),
		}
