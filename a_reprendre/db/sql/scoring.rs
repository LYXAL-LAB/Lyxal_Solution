...
impl From<Scoring> for crate::lyxal_core_db::catalog::Scoring {
	fn from(v: Scoring) -> Self {
		match v {
			Scoring::Bm {
				k1,
				b,
			} => crate::lyxal_core_db::catalog::Scoring::Bm {
				k1,
				b,
			},
			Scoring::Vs => crate::lyxal_core_db::catalog::Scoring::Vs,
		}
	}
}
impl From<crate::lyxal_core_db::catalog::Scoring> for Scoring {
	fn from(v: crate::lyxal_core_db::catalog::Scoring) -> Self {
		match v {
			crate::lyxal_core_db::catalog::Scoring::Bm {
				k1,
				b,
			...
			crate::lyxal_core_db::catalog::Scoring::Vs => Self::Vs,
		}
	}
}
