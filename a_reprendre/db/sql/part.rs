...
use crate::lyxal_core_db::sql::{Expr, Idiom, Lookup};
...
impl From<Part> for crate::lyxal_core_db::expr::Part {
	fn from(v: Part) -> Self {
		match v {
			Part::All => Self::All,
			...
			Part::Recurse(recurse, idiom, instructions) => {
				...
				crate::lyxal_core_db::expr::Part::Recurse(recurse.into(), idiom, instructions)
			}
			Part::Doc => crate::lyxal_core_db::expr::Part::Doc,
			Part::RepeatRecurse => crate::lyxal_core_db::expr::Part::RepeatRecurse,
		}
	}
}

impl From<crate::lyxal_core_db::expr::Part> for Part {
	fn from(v: crate::lyxal_core_db::expr::Part) -> Self {
		match v {
			crate::lyxal_core_db::expr::Part::All => Self::All,
			crate::lyxal_core_db::expr::Part::Flatten => Self::Flatten,
			crate::lyxal_core_db::expr::Part::Last => Self::Last,
			crate::lyxal_core_db::expr::Part::First => Self::First,
			crate::lyxal_core_db::expr::Part::Field(ident) => Self::Field(ident),
			crate::lyxal_core_db::expr::Part::Where(value) => Self::Where(value.into()),
			crate::lyxal_core_db::expr::Part::Lookup(graph) => Self::Graph(graph.into()),
			crate::lyxal_core_db::expr::Part::Value(value) => Self::Value(value.into()),
			crate::lyxal_core_db::expr::Part::Start(value) => Self::Start(value.into()),
			crate::lyxal_core_db::expr::Part::Method(method, values) => {
				Self::Method(method, values.into_iter().map(Into::into).collect())
			}
			crate::lyxal_core_db::expr::Part::Destructure(parts) => {
				Self::Destructure(parts.into_iter().map(Into::<DestructurePart>::into).collect())
			}
			crate::lyxal_core_db::expr::Part::Optional => Self::Optional,
			crate::lyxal_core_db::expr::Part::Recurse(recurse, idiom, instructions) => Self::Recurse(
				recurse.into(),
				idiom.map(|idiom| idiom.into()),
				instructions.map(Into::into),
			),
			crate::lyxal_core_db::expr::Part::Doc => Self::Doc,
			crate::lyxal_core_db::expr::Part::RepeatRecurse => Self::RepeatRecurse,
		}
	}
}
...
impl From<DestructurePart> for crate::lyxal_core_db::expr::part::DestructurePart {
...
impl From<crate::lyxal_core_db::expr::part::DestructurePart> for DestructurePart {
	fn from(v: crate::lyxal_core_db::expr::part::DestructurePart) -> Self {
		match v {
			crate::lyxal_core_db::expr::part::DestructurePart::All(v) => Self::All(v),
			crate::lyxal_core_db::expr::part::DestructurePart::Field(v) => Self::Field(v),
			crate::lyxal_core_db::expr::part::DestructurePart::Aliased(v, idiom) => Self::Aliased(v, idiom.into()),
			crate::lyxal_core_db::expr::part::DestructurePart::Destructure(v, d) => {
...
impl From<Recurse> for crate::lyxal_core_db::expr::part::Recurse {
...
impl From<crate::lyxal_core_db::expr::part::Recurse> for Recurse {
	fn from(v: crate::lyxal_core_db::expr::part::Recurse) -> Self {
		match v {
			crate::lyxal_core_db::expr::part::Recurse::Fixed(v) => Self::Fixed(v),
			crate::lyxal_core_db::expr::part::Recurse::Range(min, max) => Self::Range(min, max),
		}
	}
}
// ------------------------------
...
impl From<RecurseInstruction> for crate::lyxal_core_db::expr::part::RecurseInstruction {
...
impl From<crate::lyxal_core_db::expr::part::RecurseInstruction> for RecurseInstruction {
	fn from(v: crate::lyxal_core_db::expr::part::RecurseInstruction) -> Self {
		match v {
			crate::lyxal_core_db::expr::part::RecurseInstruction::Path {
				inclusive,
			} => Self::Path {
				inclusive,
			},
			crate::lyxal_core_db::expr::part::RecurseInstruction::Collect {
				inclusive,
			} => Self::Collect {
				inclusive,
			},
			crate::lyxal_core_db::expr::part::RecurseInstruction::Shortest {
				expects,
				inclusive,
			} => Self::Shortest {
				expects: expects.into(),
