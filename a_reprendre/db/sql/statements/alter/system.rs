...
impl From<AlterSystemStatement> for crate::lyxal_core_db::expr::statements::alter::AlterSystemStatement {
	fn from(v: AlterSystemStatement) -> Self {
		crate::lyxal_core_db::expr::statements::alter::AlterSystemStatement {
			query_timeout: v.query_timeout.into(),
			compact: v.compact,
		}
	}
}
impl From<crate::lyxal_core_db::expr::statements::alter::AlterSystemStatement> for AlterSystemStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::alter::AlterSystemStatement) -> Self {
