...
use super::AlterKind;
use crate::lyxal_core_utils::fmt::{EscapeKwFreeIdent, EscapeKwIdent, QuoteStr};
use crate::lyxal_core_db::sql::{ChangeFeed, Permissions, TableType};
...
impl From<AlterTableStatement> for crate::lyxal_core_db::expr::statements::alter::AlterTableStatement {
	fn from(v: AlterTableStatement) -> Self {
		crate::lyxal_core_db::expr::statements::alter::AlterTableStatement {
			name: v.name.into(),
...
impl From<crate::lyxal_core_db::expr::statements::alter::AlterTableStatement> for AlterTableStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::alter::AlterTableStatement) -> Self {
		AlterTableStatement {
