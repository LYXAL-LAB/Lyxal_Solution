...
use super::AlterKind;
use crate::lyxal_core_utils::fmt::{EscapeKwFreeIdent, QuoteStr};
use crate::lyxal_core_db::sql::CoverStmts;
use crate::lyxal_core_db::sql::reference::Reference;
use crate::lyxal_core_db::sql::{Expr, Idiom, Kind, Permissions};
...
impl From<crate::lyxal_core_db::expr::statements::alter::AlterDefault> for AlterDefault {
	fn from(value: crate::lyxal_core_db::expr::statements::alter::AlterDefault) -> Self {
		match value {
			crate::lyxal_core_db::expr::statements::alter::AlterDefault::None => AlterDefault::None,
			crate::lyxal_core_db::expr::statements::alter::AlterDefault::Drop => AlterDefault::Drop,
			crate::lyxal_core_db::expr::statements::alter::AlterDefault::Always(expr) => {
				AlterDefault::Always(expr.into())
			}
			crate::lyxal_core_db::expr::statements::alter::AlterDefault::Set(expr) => {
...
impl From<AlterDefault> for crate::lyxal_core_db::expr::statements::alter::AlterDefault {
	fn from(value: AlterDefault) -> Self {
		match value {
			AlterDefault::None => crate::lyxal_core_db::expr::statements::alter::AlterDefault::None,
			AlterDefault::Drop => crate::lyxal_core_db::expr::statements::alter::AlterDefault::Drop,
			AlterDefault::Always(expr) => {
				crate::lyxal_core_db::expr::statements::alter::AlterDefault::Always(expr.into())
			}
			AlterDefault::Set(expr) => {
				crate::lyxal_core_db::expr::statements::alter::AlterDefault::Set(expr.into())
			}
		}
	}
}
...
pub struct AlterFieldStatement {
	#[cfg_attr(feature = "arbitrary", arbitrary(with = crate::lyxal_core_db::sql::arbitrary::local_idiom))]
	pub name: Idiom,
	pub what: String,
	pub if_exists: bool,
...
impl From<AlterFieldStatement> for crate::lyxal_core_db::expr::statements::alter::AlterFieldStatement {
	fn from(v: AlterFieldStatement) -> Self {
		crate::lyxal_core_db::expr::statements::alter::AlterFieldStatement {
			name: v.name.into(),
			what: v.what.into(),
...
impl From<crate::lyxal_core_db::expr::statements::alter::AlterFieldStatement> for AlterFieldStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::alter::AlterFieldStatement) -> Self {
		AlterFieldStatement {
			name: v.name.into(),
