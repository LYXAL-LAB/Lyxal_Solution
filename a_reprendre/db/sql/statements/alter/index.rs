...
use crate::lyxal_core_db::sql::statements::alter::AlterKind;
...
impl From<AlterIndexStatement> for crate::lyxal_core_db::expr::statements::alter::AlterIndexStatement {
	fn from(v: AlterIndexStatement) -> Self {
		crate::lyxal_core_db::expr::statements::alter::AlterIndexStatement {
			name: v.name,
			table: v.table.into(),
...
impl From<crate::lyxal_core_db::expr::statements::alter::AlterIndexStatement> for AlterIndexStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::alter::AlterIndexStatement) -> Self {
		AlterIndexStatement {
			name: v.name,
