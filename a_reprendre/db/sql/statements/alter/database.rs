...
impl From<AlterDatabaseStatement> for crate::lyxal_core_db::expr::statements::alter::AlterDatabaseStatement {
	fn from(v: AlterDatabaseStatement) -> Self {
		crate::lyxal_core_db::expr::statements::alter::AlterDatabaseStatement {
			compact: v.compact,
		}
	}
}
impl From<crate::lyxal_core_db::expr::statements::alter::AlterDatabaseStatement> for AlterDatabaseStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::alter::AlterDatabaseStatement) -> Self {
