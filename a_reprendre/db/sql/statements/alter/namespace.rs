...
impl From<AlterNamespaceStatement> for crate::lyxal_core_db::expr::statements::alter::AlterNamespaceStatement {
	fn from(v: AlterNamespaceStatement) -> Self {
		crate::lyxal_core_db::expr::statements::alter::AlterNamespaceStatement {
			compact: v.compact,
		}
	}
}
impl From<crate::lyxal_core_db::expr::statements::alter::AlterNamespaceStatement> for AlterNamespaceStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::alter::AlterNamespaceStatement) -> Self {
