...
use crate::lyxal_core_utils::fmt::{Fmt, fmt_separated_by};
...
impl From<IfelseStatement> for crate::lyxal_core_db::expr::statements::IfelseStatement {
	fn from(v: IfelseStatement) -> Self {
		crate::lyxal_core_db::expr::statements::IfelseStatement {
...
impl From<crate::lyxal_core_db::expr::statements::IfelseStatement> for IfelseStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::IfelseStatement) -> Self {
		IfelseStatement {
			exprs: v.exprs.into_iter().map(|(a, b)| (From::from(a), From::from(b))).collect(),
			close: v.close.map(Into::into),
		}
