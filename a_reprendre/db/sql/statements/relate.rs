...
use crate::lyxal_core_db::sql::{Data, Expr, Literal, Output, RecordIdKeyLit, RecordIdLit};
...
impl From<RelateStatement> for crate::lyxal_core_db::expr::statements::RelateStatement {
	fn from(v: RelateStatement) -> Self {
		crate::lyxal_core_db::expr::statements::RelateStatement {
			only: v.only,
...
impl From<crate::lyxal_core_db::expr::statements::RelateStatement> for RelateStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::RelateStatement) -> Self {
		RelateStatement {
			only: v.only,
			through: v.through.into(),
			from: v.from.into(),
