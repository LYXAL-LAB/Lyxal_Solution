...
pub(crate) use connector::RemoveConnectorStatement;
...
pub(crate) enum RemoveStatement {
    ...
    Connector(RemoveConnectorStatement),
...
impl ToSql for RemoveStatement {
	fn fmt_sql(&self, f: &mut String, fmt: SqlFormat) {
		match self {
            ...
            Self::Connector(v) => v.fmt_sql(f, fmt),
...
impl From<RemoveStatement> for crate::lyxal_core_db::expr::statements::RemoveStatement {
	fn from(v: RemoveStatement) -> Self {
		match v {
			RemoveStatement::Namespace(v) => Self::Namespace(v.into()),
            RemoveStatement::Connector(v) => Self::Connector(v.into()),
...
impl From<crate::lyxal_core_db::expr::statements::RemoveStatement> for RemoveStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::RemoveStatement) -> Self {
		match v {

			crate::lyxal_core_db::expr::statements::RemoveStatement::Namespace(v) => Self::Namespace(v.into()),
			crate::lyxal_core_db::expr::statements::RemoveStatement::Connector(v) => Self::Connector(v.into()),
			crate::lyxal_core_db::expr::statements::RemoveStatement::Database(v) => Self::Database(v.into()),
			crate::lyxal_core_db::expr::statements::RemoveStatement::Function(v) => Self::Function(v.into()),
			crate::lyxal_core_db::expr::statements::RemoveStatement::Analyzer(v) => Self::Analyzer(v.into()),
			crate::lyxal_core_db::expr::statements::RemoveStatement::Access(v) => Self::Access(v.into()),
			crate::lyxal_core_db::expr::statements::RemoveStatement::Param(v) => Self::Param(v.into()),
			crate::lyxal_core_db::expr::statements::RemoveStatement::Table(v) => Self::Table(v.into()),
			crate::lyxal_core_db::expr::statements::RemoveStatement::Event(v) => Self::Event(v.into()),
			crate::lyxal_core_db::expr::statements::RemoveStatement::Field(v) => Self::Field(v.into()),
			crate::lyxal_core_db::expr::statements::RemoveStatement::Index(v) => Self::Index(v.into()),
			crate::lyxal_core_db::expr::statements::RemoveStatement::User(v) => Self::User(v.into()),
			crate::lyxal_core_db::expr::statements::RemoveStatement::Model(v) => Self::Model(v.into()),
			crate::lyxal_core_db::expr::statements::RemoveStatement::Api(v) => Self::Api(v.into()),
			crate::lyxal_core_db::expr::statements::RemoveStatement::Bucket(v) => Self::Bucket(v.into()),
			crate::lyxal_core_db::expr::statements::RemoveStatement::Sequence(v) => Self::Sequence(v.into()),
			crate::lyxal_core_db::expr::statements::RemoveStatement::Module(v) => Self::Module(v.into()),
		}
	}
}
