...
impl From<RemoveIndexStatement> for crate::lyxal_core_db::expr::statements::RemoveIndexStatement {
	fn from(v: RemoveIndexStatement) -> Self {
		crate::lyxal_core_db::expr::statements::RemoveIndexStatement {
			name: v.name.into(),
...
impl From<crate::lyxal_core_db::expr::statements::RemoveIndexStatement> for RemoveIndexStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::RemoveIndexStatement) -> Self {
