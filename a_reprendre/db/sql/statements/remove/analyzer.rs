...
impl From<RemoveAnalyzerStatement> for crate::lyxal_core_db::expr::statements::RemoveAnalyzerStatement {
	fn from(v: RemoveAnalyzerStatement) -> Self {
		crate::lyxal_core_db::expr::statements::RemoveAnalyzerStatement {
			name: v.name.into(),
...
impl From<crate::lyxal_core_db::expr::statements::RemoveAnalyzerStatement> for RemoveAnalyzerStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::RemoveAnalyzerStatement) -> Self {
