...
impl From<RemoveFieldStatement> for crate::lyxal_core_db::expr::statements::RemoveFieldStatement {
	fn from(v: RemoveFieldStatement) -> Self {
		crate::lyxal_core_db::expr::statements::RemoveFieldStatement {
			name: v.name.into(),
...
impl From<crate::lyxal_core_db::expr::statements::RemoveFieldStatement> for RemoveFieldStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::RemoveFieldStatement) -> Self {
