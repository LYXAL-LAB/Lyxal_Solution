...
impl From<RemoveApiStatement> for crate::lyxal_core_db::expr::statements::remove::RemoveApiStatement {
	fn from(v: RemoveApiStatement) -> Self {
		crate::lyxal_core_db::expr::statements::remove::RemoveApiStatement {
			name: v.name.into(),
...
impl From<crate::lyxal_core_db::expr::statements::remove::RemoveApiStatement> for RemoveApiStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::remove::RemoveApiStatement) -> Self {
		RemoveApiStatement {
			name: v.name.into(),
			if_exists: v.if_exists,
		}
