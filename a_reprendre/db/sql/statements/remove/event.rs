...
impl From<RemoveEventStatement> for crate::lyxal_core_db::expr::statements::RemoveEventStatement {
	fn from(v: RemoveEventStatement) -> Self {
		crate::lyxal_core_db::expr::statements::RemoveEventStatement {
			name: v.name.into(),
...
impl From<crate::lyxal_core_db::expr::statements::RemoveEventStatement> for RemoveEventStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::RemoveEventStatement) -> Self {
