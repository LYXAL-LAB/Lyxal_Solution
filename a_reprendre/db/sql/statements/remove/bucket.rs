...
impl From<RemoveBucketStatement> for crate::lyxal_core_db::expr::statements::remove::RemoveBucketStatement {
	fn from(v: RemoveBucketStatement) -> Self {
		crate::lyxal_core_db::expr::statements::remove::RemoveBucketStatement {
			name: v.name.into(),
...
impl From<crate::lyxal_core_db::expr::statements::remove::RemoveBucketStatement> for RemoveBucketStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::remove::RemoveBucketStatement) -> Self {
