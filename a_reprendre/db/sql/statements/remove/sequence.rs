...
impl From<RemoveSequenceStatement> for crate::lyxal_core_db::expr::statements::remove::RemoveSequenceStatement {
	fn from(v: RemoveSequenceStatement) -> Self {
		crate::lyxal_core_db::expr::statements::remove::RemoveSequenceStatement {
			name: v.name.into(),
...
impl From<crate::lyxal_core_db::expr::statements::remove::RemoveSequenceStatement> for RemoveSequenceStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::remove::RemoveSequenceStatement) -> Self {
