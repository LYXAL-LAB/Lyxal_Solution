...
impl From<RemoveNamespaceStatement> for crate::lyxal_core_db::expr::statements::RemoveNamespaceStatement {
	fn from(v: RemoveNamespaceStatement) -> Self {
		crate::lyxal_core_db::expr::statements::RemoveNamespaceStatement {
			name: v.name.into(),
...
impl From<crate::lyxal_core_db::expr::statements::RemoveNamespaceStatement> for RemoveNamespaceStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::RemoveNamespaceStatement) -> Self {
