...
impl From<InsertStatement> for crate::lyxal_core_db::expr::statements::InsertStatement {
	fn from(v: InsertStatement) -> Self {
		crate::lyxal_core_db::expr::statements::InsertStatement {
...
impl From<crate::lyxal_core_db::expr::statements::InsertStatement> for InsertStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::InsertStatement) -> Self {
		InsertStatement {
			into: v.into.map(Into::into),
			data: v.data.into(),
			ignore: v.ignore,
