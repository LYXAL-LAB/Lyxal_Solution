...
impl From<DefineSequenceStatement> for crate::lyxal_core_db::expr::statements::define::DefineSequenceStatement {
...
impl From<crate::lyxal_core_db::expr::statements::define::DefineSequenceStatement> for DefineSequenceStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::define::DefineSequenceStatement) -> Self {
