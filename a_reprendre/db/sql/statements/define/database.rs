...
impl From<DefineDatabaseStatement> for crate::lyxal_core_db::expr::statements::DefineDatabaseStatement {
	fn from(v: DefineDatabaseStatement) -> Self {
		crate::lyxal_core_db::expr::statements::DefineDatabaseStatement {
			kind: v.kind.into(),
			id: v.id,
			name: v.name.into(),
...
impl From<crate::lyxal_core_db::expr::statements::DefineDatabaseStatement> for DefineDatabaseStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::DefineDatabaseStatement) -> Self {
