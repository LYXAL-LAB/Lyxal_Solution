...
impl ToSql for DefineEventStatement {
	fn fmt_sql(&self, f: &mut String, fmt: SqlFormat) {
		...
		write_sql!(f, fmt, " {} ON {}", &self.name, &self.target_table,);
		...
		write_sql!(f, fmt, " WHEN {}", &self.when,);
...
impl From<DefineEventStatement> for crate::lyxal_core_db::expr::statements::DefineEventStatement {
	fn from(v: DefineEventStatement) -> Self {
		crate::lyxal_core_db::expr::statements::DefineEventStatement {
			kind: v.kind.into(),
			name: v.name.into(),
...
impl From<crate::lyxal_core_db::expr::statements::DefineEventStatement> for DefineEventStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::DefineEventStatement) -> Self {
