...
impl From<DefineNamespaceStatement> for crate::lyxal_core_db::expr::statements::DefineNamespaceStatement {
...
impl From<crate::lyxal_core_db::expr::statements::DefineNamespaceStatement> for DefineNamespaceStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::DefineNamespaceStatement) -> Self {
		Self {
			kind: v.kind.into(),
			id: v.id,
			name: v.name.into(),
