...
impl From<DefineBucketStatement> for crate::lyxal_core_db::expr::statements::define::DefineBucketStatement {
	fn from(v: DefineBucketStatement) -> Self {
		crate::lyxal_core_db::expr::statements::define::DefineBucketStatement {
			kind: v.kind.into(),
			name: v.name.into(),
...
impl From<crate::lyxal_core_db::expr::statements::define::DefineBucketStatement> for DefineBucketStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::define::DefineBucketStatement) -> Self {
