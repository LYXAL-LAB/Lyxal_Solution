...
impl From<DefineApiStatement> for crate::lyxal_core_db::expr::statements::DefineApiStatement {
	fn from(v: DefineApiStatement) -> Self {
		crate::lyxal_core_db::expr::statements::DefineApiStatement {
			kind: v.kind.into(),
			path: v.path.into(),
...
impl From<crate::lyxal_core_db::expr::statements::DefineApiStatement> for DefineApiStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::DefineApiStatement) -> Self {
		DefineApiStatement {
			kind: v.kind.into(),
			path: v.path.into(),
			actions: v.actions.into_iter().map(Into::into).collect(),
...
impl From<ApiAction> for crate::lyxal_core_db::expr::statements::define::ApiAction {
	fn from(v: ApiAction) -> Self {
		crate::lyxal_core_db::expr::statements::define::ApiAction {
			methods: v.methods,
...
impl From<crate::lyxal_core_db::expr::statements::define::ApiAction> for ApiAction {
	fn from(v: crate::lyxal_core_db::expr::statements::define::ApiAction) -> Self {
		ApiAction {
			methods: v.methods,
			action: v.action.into(),
			config: v.config.into(),
