...
use crate::lyxal_core_db::sql::{AccessType, Base, Expr, Literal};
...
impl From<DefineAccessStatement> for crate::lyxal_core_db::expr::statements::DefineAccessStatement {
	fn from(v: DefineAccessStatement) -> Self {
		crate::lyxal_core_db::expr::statements::DefineAccessStatement {
			kind: v.kind.into(),
			name: v.name.into(),
			base: v.base.into(),
...
impl From<crate::lyxal_core_db::expr::statements::DefineAccessStatement> for DefineAccessStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::DefineAccessStatement) -> Self {
