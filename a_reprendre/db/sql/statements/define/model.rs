...
impl From<DefineModelStatement> for crate::lyxal_core_db::expr::statements::DefineModelStatement {
...
impl From<crate::lyxal_core_db::expr::statements::DefineModelStatement> for DefineModelStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::DefineModelStatement) -> Self {
		Self {
			kind: v.kind.into(),
			hash: v.hash,
			name: v.name,
