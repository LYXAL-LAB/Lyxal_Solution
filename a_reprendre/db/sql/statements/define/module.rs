...
use crate::lyxal_core_db::sql::{Expr, Literal, ModuleExecutable, Permission};
...
impl From<DefineModuleStatement> for crate::lyxal_core_db::expr::statements::DefineModuleStatement {
...
impl From<crate::lyxal_core_db::expr::statements::DefineModuleStatement> for DefineModuleStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::DefineModuleStatement) -> Self {
		Self {
			kind: v.kind.into(),
			name: v.name,
			executable: v.executable.into(),
