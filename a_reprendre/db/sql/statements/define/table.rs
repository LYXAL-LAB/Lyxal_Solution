...
use crate::lyxal_core_db::sql::{Expr, Literal, Permissions, TableType, View};
...
impl From<DefineTableStatement> for crate::lyxal_core_db::expr::statements::DefineTableStatement {
	fn from(v: DefineTableStatement) -> Self {
		crate::lyxal_core_db::expr::statements::DefineTableStatement {
			kind: v.kind.into(),
			id: v.id,
			name: v.name.into(),
			drop: v.drop,
...
impl From<crate::lyxal_core_db::expr::statements::DefineTableStatement> for DefineTableStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::DefineTableStatement) -> Self {
