...
impl From<GraphQLConfig> for crate::lyxal_core_db::catalog::GraphQLConfig {
	fn from(v: GraphQLConfig) -> Self {
		crate::lyxal_core_db::catalog::GraphQLConfig {
...
impl From<crate::lyxal_core_db::catalog::GraphQLConfig> for GraphQLConfig {
	fn from(v: crate::lyxal_core_db::catalog::GraphQLConfig) -> Self {
		GraphQLConfig {
			tables: v.tables.into(),
			functions: v.functions.into(),
			depth_limit: v.depth_limit,
...
impl From<TablesConfig> for crate::lyxal_core_db::catalog::GraphQLTablesConfig {
...
impl From<crate::lyxal_core_db::catalog::GraphQLTablesConfig> for TablesConfig {
	fn from(v: crate::lyxal_core_db::catalog::GraphQLTablesConfig) -> Self {
		match v {
			crate::lyxal_core_db::catalog::GraphQLTablesConfig::None => Self::None,
			crate::lyxal_core_db::catalog::GraphQLTablesConfig::Auto => Self::Auto,
			crate::lyxal_core_db::catalog::GraphQLTablesConfig::Include(cs) => Self::Include(
				cs.into_iter()
					.map(|t| TableConfig {
						name: t.into_string(),
					})
			...
			crate::lyxal_core_db::catalog::GraphQLTablesConfig::Exclude(cs) => Self::Exclude(
				cs.into_iter()
					.map(|t| TableConfig {
						name: t.into_string(),
					})
...
impl From<IntrospectionConfig> for crate::lyxal_core_db::catalog::GraphQLIntrospectionConfig {
...
impl From<crate::lyxal_core_db::catalog::GraphQLIntrospectionConfig> for IntrospectionConfig {
	fn from(v: crate::lyxal_core_db::catalog::GraphQLIntrospectionConfig) -> Self {
		match v {
			crate::lyxal_core_db::catalog::GraphQLIntrospectionConfig::Auto => Self::Auto,
			crate::lyxal_core_db::catalog::GraphQLIntrospectionConfig::None => Self::None,
		}
	}
}
...
impl From<FunctionsConfig> for crate::lyxal_core_db::catalog::GraphQLFunctionsConfig {
...
impl From<crate::lyxal_core_db::catalog::GraphQLFunctionsConfig> for FunctionsConfig {
	fn from(v: crate::lyxal_core_db::catalog::GraphQLFunctionsConfig) -> Self {
		match v {
			crate::lyxal_core_db::catalog::GraphQLFunctionsConfig::None => Self::None,
			crate::lyxal_core_db::catalog::GraphQLFunctionsConfig::Auto => Self::Auto,
			crate::lyxal_core_db::catalog::GraphQLFunctionsConfig::Include(cs) => Self::Include(cs),
			crate::lyxal_core_db::catalog::GraphQLFunctionsConfig::Exclude(cs) => Self::Exclude(cs),
		}
	}
}
