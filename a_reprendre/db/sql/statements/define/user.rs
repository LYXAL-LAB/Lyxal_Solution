...
impl From<DefineUserStatement> for crate::lyxal_core_db::expr::statements::DefineUserStatement {
	fn from(v: DefineUserStatement) -> Self {
		...
		Self {
			...
			code,
			roles: v.roles,
			duration: crate::lyxal_core_db::expr::user::UserDuration {
...
impl From<crate::lyxal_core_db::expr::statements::DefineUserStatement> for DefineUserStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::DefineUserStatement) -> Self {
		Self {
			kind: v.kind.into(),
			name: v.name.into(),
			base: v.base.into(),
