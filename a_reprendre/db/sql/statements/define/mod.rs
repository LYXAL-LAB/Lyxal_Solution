...
pub(crate) use connector::DefineConnectorStatement;
...
impl From<crate::lyxal_core_db::expr::statements::define::DefineKind> for DefineKind {
	fn from(value: crate::lyxal_core_db::expr::statements::define::DefineKind) -> Self {
		match value {
			crate::lyxal_core_db::expr::statements::define::DefineKind::Default => DefineKind::Default,
			crate::lyxal_core_db::expr::statements::define::DefineKind::Overwrite => DefineKind::Overwrite,
			crate::lyxal_core_db::expr::statements::define::DefineKind::IfNotExists => DefineKind::IfNotExists,
		}
	}
}

impl From<DefineKind> for crate::lyxal_core_db::expr::statements::define::DefineKind {
	fn from(value: DefineKind) -> Self {
		match value {
			DefineKind::Default => crate::lyxal_core_db::expr::statements::define::DefineKind::Default,
			DefineKind::Overwrite => crate::lyxal_core_db::expr::statements::define::DefineKind::Overwrite,
			DefineKind::IfNotExists => crate::lyxal_core_db::expr::statements::define::DefineKind::IfNotExists,
		}
	}
}
...
impl From<DefineStatement> for crate::lyxal_core_db::expr::statements::DefineStatement {
...
impl From<crate::lyxal_core_db::expr::statements::DefineStatement> for DefineStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::DefineStatement) -> Self {
		match v {
			crate::lyxal_core_db::expr::statements::DefineStatement::Namespace(v) => Self::Namespace(v.into()),
			crate::lyxal_core_db::expr::statements::DefineStatement::Database(v) => Self::Database(v.into()),
			crate::lyxal_core_db::expr::statements::DefineStatement::Function(v) => Self::Function(v.into()),
			crate::lyxal_core_db::expr::statements::DefineStatement::Analyzer(v) => Self::Analyzer(v.into()),
			crate::lyxal_core_db::expr::statements::DefineStatement::Param(v) => Self::Param(v.into()),
			crate::lyxal_core_db::expr::statements::DefineStatement::Table(v) => Self::Table(v.into()),
			crate::lyxal_core_db::expr::statements::DefineStatement::Event(v) => Self::Event(v.into()),
			crate::lyxal_core_db::expr::statements::DefineStatement::Field(v) => Self::Field(v.into()),
			crate::lyxal_core_db::expr::statements::DefineStatement::Index(v) => Self::Index(v.into()),
			crate::lyxal_core_db::expr::statements::DefineStatement::User(v) => Self::User(v.into()),
			crate::lyxal_core_db::expr::statements::DefineStatement::Model(v) => Self::Model(v.into()),
			crate::lyxal_core_db::expr::statements::DefineStatement::Access(v) => Self::Access(v.into()),
			crate::lyxal_core_db::expr::statements::DefineStatement::Config(v) => Self::Config(v.into()),
			crate::lyxal_core_db::expr::statements::DefineStatement::Api(v) => Self::Api(v.into()),
			crate::lyxal_core_db::expr::statements::DefineStatement::Bucket(v) => Self::Bucket(v.into()),
			crate::lyxal_core_db::expr::statements::DefineStatement::Sequence(v) => Self::Sequence(v.into()),
			crate::lyxal_core_db::expr::statements::DefineStatement::Module(v) => Self::Module(v.into()),
		}
	}
}
