...
use crate::lyxal_core_db::sql::{Block, Expr, Kind, Literal, Permission};
...
impl From<DefineFunctionStatement> for crate::lyxal_core_db::expr::statements::DefineFunctionStatement {
...
impl From<crate::lyxal_core_db::expr::statements::DefineFunctionStatement> for DefineFunctionStatement {
	fn from(v: crate::lyxal_core_db::expr::statements::DefineFunctionStatement) -> Self {
		Self {
			kind: v.kind.into(),
			name: v.name,
			args: v.args.into_iter().map(|(i, k)| (i, k.into())).collect(),
