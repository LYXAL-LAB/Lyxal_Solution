...
use crate::lyxal_core_db::sql::{AssignOperator, Expr, Idiom};
...
pub(crate) struct Assignment {
	#[cfg_attr(feature = "arbitrary", arbitrary(with = crate::lyxal_core_db::sql::arbitrary::plain_idiom))]
	pub place: Idiom,
	pub operator: AssignOperator,
	pub value: Expr,
}

impl From<Assignment> for crate::lyxal_core_db::expr::data::Assignment {
	fn from(value: Assignment) -> Self {
		crate::lyxal_core_db::expr::data::Assignment {
...
impl From<crate::lyxal_core_db::expr::data::Assignment> for Assignment {
	fn from(value: crate::lyxal_core_db::expr::data::Assignment) -> Self {
		Assignment {
			place: value.place.into(),
			operator: value.operator.into(),
			value: value.value.into(),
...
impl From<Data> for crate::lyxal_core_db::expr::Data {
	fn from(v: Data) -> Self {
		match v {
...
impl From<crate::lyxal_core_db::expr::Data> for Data {
	fn from(v: crate::lyxal_core_db::expr::Data) -> Self {
		match v {
			crate::lyxal_core_db::expr::Data::EmptyExpression => Self::EmptyExpression,
			crate::lyxal_core_db::expr::Data::SetExpression(v) => {
				Self::SetExpression(v.into_iter().map(Into::into).collect())
			}
			crate::lyxal_core_db::expr::Data::UnsetExpression(v) => {
				Self::UnsetExpression(v.into_iter().map(Into::into).collect())
			}
			crate::lyxal_core_db::expr::Data::PatchExpression(v) => Self::PatchExpression(v.into()),
			crate::lyxal_core_db::expr::Data::MergeExpression(v) => Self::MergeExpression(v.into()),
			crate::lyxal_core_db::expr::Data::ReplaceExpression(v) => Self::ReplaceExpression(v.into()),
			crate::lyxal_core_db::expr::Data::ContentExpression(v) => Self::ContentExpression(v.into()),
			crate::lyxal_core_db::expr::Data::SingleExpression(v) => Self::SingleExpression(v.into()),
			crate::lyxal_core_db::expr::Data::ValuesExpression(v) => Self::ValuesExpression(
				v.into_iter()
					.map(|v| v.into_iter().map(|(a, b)| (a.into(), b.into())).collect())
					.collect(),
			),
			crate::lyxal_core_db::expr::Data::UpdateExpression(v) => {
				Self::UpdateExpression(v.into_iter().map(Into::into).collect())
			}
		}
	}
