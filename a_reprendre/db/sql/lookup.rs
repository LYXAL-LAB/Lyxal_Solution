...
use crate::lyxal_core_db::sql::order::Ordering;
use crate::lyxal_core_db::sql::{Cond, Dir, Fields, Groups, Idiom, Limit, RecordIdKeyRangeLit, Splits, Start};
...
impl From<Lookup> for crate::lyxal_core_db::expr::Lookup {
...
impl From<crate::lyxal_core_db::expr::Lookup> for Lookup {
	fn from(v: crate::lyxal_core_db::expr::Lookup) -> Self {
		Lookup {
			kind: v.kind.into(),
...
impl From<LookupKind> for crate::lyxal_core_db::expr::lookup::LookupKind {
...
impl From<crate::lyxal_core_db::expr::lookup::LookupKind> for LookupKind {
	fn from(v: crate::lyxal_core_db::expr::lookup::LookupKind) -> Self {
		match v {
			crate::lyxal_core_db::expr::lookup::LookupKind::Graph(dir) => Self::Graph(dir.into()),
			crate::lyxal_core_db::expr::lookup::LookupKind::Reference => Self::Reference,
		}
	}
}
...
impl From<LookupSubject> for crate::lyxal_core_db::expr::lookup::LookupSubject {
...
impl From<crate::lyxal_core_db::expr::lookup::LookupSubject> for LookupSubject {
	fn from(v: crate::lyxal_core_db::expr::lookup::LookupSubject) -> Self {
		match v {
