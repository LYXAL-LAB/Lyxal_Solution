...
use crate::lyxal_core_db::sql::statements::access::{AccessStatementGrant, Subject};
...
use crate::lyxal_core_db::val::{Bytes, Duration, File, Geometry, Number, Object, RecordId, Set, Value};
                ...
                exprs: vec![(
                    Expr::Binary {
                        left: Box::new(Expr::Idiom(Idiom(vec![
                            crate::lyxal_core_db::sql::Part::Field("user".to_string()),
                            crate::lyxal_core_db::sql::Part::Field("active".to_string())
                        ]))),
