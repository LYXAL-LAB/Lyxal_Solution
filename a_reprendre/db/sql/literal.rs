...
use crate::lyxal_core_utils::fmt::{EscapeObjectKey, Float, QuoteStr};
use crate::lyxal_core_db::sql::CoverStmts;
use crate::lyxal_core_db::sql::{Expr, RecordIdLit};
use crate::types::{
	PublicBytes, PublicDatetime, PublicDuration, PublicFile, PublicGeometry, PublicRegex,
	PublicUuid,
};
use crate::lyxal_core_db::val::Geometry;
...
pub enum Literal {
	...
	Integer(i64),
	Decimal(
		#[cfg_attr(feature = "arbitrary", arbitrary(with = crate::lyxal_core_db::sql::arbitrary::arb_decimal))]
		Decimal,
	),
...
impl From<Literal> for crate::lyxal_core_db::expr::Literal {
	fn from(value: Literal) -> Self {
		match value {
			Literal::None => crate::lyxal_core_db::expr::Literal::None,
			Literal::Null => crate::lyxal_core_db::expr::Literal::Null,
			Literal::UnboundedRange => crate::lyxal_core_db::expr::Literal::UnboundedRange,
			Literal::Bool(x) => crate::lyxal_core_db::expr::Literal::Bool(x),
			Literal::Float(x) => crate::lyxal_core_db::expr::Literal::Float(x),
			Literal::Integer(x) => crate::lyxal_core_db::expr::Literal::Integer(x),
			Literal::Decimal(decimal) => crate::lyxal_core_db::expr::Literal::Decimal(decimal),
			Literal::Duration(duration) => crate::lyxal_core_db::expr::Literal::Duration(duration.into()),
			Literal::String(strand) => crate::lyxal_core_db::expr::Literal::String(strand),
			Literal::RecordId(record_id_lit) => {
				crate::lyxal_core_db::expr::Literal::RecordId(record_id_lit.into())
			}
			Literal::Datetime(datetime) => crate::lyxal_core_db::expr::Literal::Datetime(datetime.into()),
			Literal::Uuid(uuid) => crate::lyxal_core_db::expr::Literal::Uuid(uuid.into()),
			Literal::Regex(regex) => crate::lyxal_core_db::expr::Literal::Regex(regex.into()),
			Literal::Array(exprs) => {
				crate::lyxal_core_db::expr::Literal::Array(exprs.into_iter().map(From::from).collect())
			}
			Literal::Set(exprs) => {
				crate::lyxal_core_db::expr::Literal::Set(exprs.into_iter().map(From::from).collect())
			}
			Literal::Object(items) => convert_geometry(items),
			Literal::Geometry(geometry) => crate::lyxal_core_db::expr::Literal::Geometry(geometry.into()),
			Literal::File(file) => crate::lyxal_core_db::expr::Literal::File(file.into()),
			Literal::Bytes(bytes) => crate::lyxal_core_db::expr::Literal::Bytes(bytes.into()),
		}
	}
}

impl From<crate::lyxal_core_db::expr::Literal> for Literal {
	fn from(value: crate::lyxal_core_db::expr::Literal) -> Self {
		match value {
			crate::lyxal_core_db::expr::Literal::None => Literal::None,
			crate::lyxal_core_db::expr::Literal::Null => Literal::Null,
			crate::lyxal_core_db::expr::Literal::UnboundedRange => Literal::UnboundedRange,
			crate::lyxal_core_db::expr::Literal::Bool(x) => Literal::Bool(x),
			crate::lyxal_core_db::expr::Literal::Float(x) => Literal::Float(x),
			crate::lyxal_core_db::expr::Literal::Integer(x) => Literal::Integer(x),
			crate::lyxal_core_db::expr::Literal::Decimal(decimal) => Literal::Decimal(decimal),
			crate::lyxal_core_db::expr::Literal::Duration(duration) => Literal::Duration(duration.into()),
			crate::lyxal_core_db::expr::Literal::String(strand) => Literal::String(strand),
			crate::lyxal_core_db::expr::Literal::RecordId(record_id_lit) => {
				Literal::RecordId(record_id_lit.into())
			}
			crate::lyxal_core_db::expr::Literal::Datetime(datetime) => Literal::Datetime(datetime.into()),
			crate::lyxal_core_db::expr::Literal::Uuid(uuid) => Literal::Uuid(uuid.into()),
			crate::lyxal_core_db::expr::Literal::Regex(regex) => Literal::Regex(regex.into()),
			crate::lyxal_core_db::expr::Literal::Array(exprs) => {
				Literal::Array(exprs.into_iter().map(From::from).collect())
			}
			crate::lyxal_core_db::expr::Literal::Set(exprs) => {
				Literal::Set(exprs.into_iter().map(From::from).collect())
			}
			crate::lyxal_core_db::expr::Literal::Object(items) => {
				Literal::Object(items.into_iter().map(From::from).collect())
			}
			crate::lyxal_core_db::expr::Literal::Geometry(geometry) => Literal::Geometry(geometry.into()),
			crate::lyxal_core_db::expr::Literal::File(file) => Literal::File(file.into()),
			crate::lyxal_core_db::expr::Literal::Bytes(bytes) => Literal::Bytes(bytes.into()),
		}
	}
}
...
fn convert_geometry(map: Vec<ObjectEntry>) -> crate::lyxal_core_db::expr::Literal {
	if let Some(geom) = collect_geometry(&map) {
		crate::lyxal_core_db::expr::Literal::Geometry(geom)
	} else {
		crate::lyxal_core_db::expr::Literal::Object(map.into_iter().map(From::from).collect())
	}
}
...
impl From<ObjectEntry> for crate::lyxal_core_db::expr::literal::ObjectEntry {
	fn from(value: ObjectEntry) -> Self {
		crate::lyxal_core_db::expr::literal::ObjectEntry {
			key: value.key,
...
impl From<crate::lyxal_core_db::expr::literal::ObjectEntry> for ObjectEntry {
	fn from(value: crate::lyxal_core_db::expr::literal::ObjectEntry) -> Self {
		ObjectEntry {
			key: value.key,
			value: value.value.into(),
		}
