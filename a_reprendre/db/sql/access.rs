...
impl From<AccessDuration> for crate::lyxal_core_db::expr::access::AccessDuration {
...
impl From<crate::lyxal_core_db::expr::access::AccessDuration> for AccessDuration {
	fn from(v: crate::lyxal_core_db::expr::access::AccessDuration) -> Self {
		Self {
			grant: v.grant.into(),
			token: v.token.into(),
			session: v.session.into(),
