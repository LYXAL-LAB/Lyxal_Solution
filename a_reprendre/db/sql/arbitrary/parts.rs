...
use lyxal_types_core::ToSql as _;

use crate::lyxal_core_db::sql::access_type::{JwtAccess, JwtAccessIssue, JwtAccessVerify};
use crate::lyxal_core_db::sql::arbitrary::idiom::plain_idiom;
use crate::lyxal_core_db::sql::arbitrary::{arb_vec1, arb_vec2, atleast_one, basic_idiom};
use crate::lyxal_core_db::sql::field::Selector;
use crate::lyxal_core_db::sql::order::{OrderList, Ordering};
use crate::lyxal_core_db::sql::statements::access::Subject;
use crate::lyxal_core_db::sql::statements::define::config::api::Middleware;
...
use crate::lyxal_core_db::syn::parser::{PATHS, PathKind};
	...
	match expr {
		Fields::Value(selector) => {
			...
			match &selector.expr {
				...
				x => {
					let s = x.to_sql();
					let s = crate::lyxal_core_db::syn::parse_with_settings(
						s.as_bytes(),
						crate::lyxal_core_db::val::ParserSettings {
