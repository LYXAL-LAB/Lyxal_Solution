...
use crate::lyxal_core_db::sql::{BinaryOperator, Expr, Literal};

#[derive(Clone, Debug, PartialEq, Eq)]
#[cfg_attr(feature = "arbitrary", derive(arbitrary::Arbitrary))]
pub struct Block(pub(crate) Vec<Expr>);

impl From<Block> for crate::lyxal_core_db::expr::Block {
	fn from(v: Block) -> Self {
		crate::lyxal_core_db::expr::Block(v.0.into_iter().map(Into::into).collect())
	}
}
impl From<crate::lyxal_core_db::expr::Block> for Block {
	fn from(v: crate::lyxal_core_db::expr::Block) -> Self {
