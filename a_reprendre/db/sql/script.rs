...
impl From<Script> for crate::lyxal_core_db::expr::Script {
	fn from(v: Script) -> Self {
		Self(v.0)
	}
}

impl From<crate::lyxal_core_db::expr::Script> for Script {
	fn from(v: crate::lyxal_core_db::expr::Script) -> Self {
		Self(v.0)
	}
}
