...
use crate::lyxal_core_db::expr::idiom::Idioms as ExprIdioms;
use crate::lyxal_core_utils::fmt::{Fmt};
use crate::lyxal_core_db::sql::EscapeIdent;
use crate::lyxal_core_db::sql::{Expr, Literal, Part};
...
impl From<Idiom> for crate::lyxal_core_db::expr::Idiom {
	fn from(v: Idiom) -> Self {
		crate::lyxal_core_db::expr::Idiom(v.0.into_iter().map(Into::into).collect())
	}
}

impl From<crate::lyxal_core_db::expr::Idiom> for Idiom {
	fn from(v: crate::lyxal_core_db::expr::Idiom) -> Self {
		Idiom(v.0.into_iter().map(Into::into).collect())
	}
}

impl lyxal_types_core::ToSql for Idiom {
