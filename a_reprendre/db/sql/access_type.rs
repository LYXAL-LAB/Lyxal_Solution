...
use crate::lyxal_core_db::sql::{Algorithm, Literal};
...
impl From<crate::lyxal_core_db::expr::access_type::JwtAccessVerify> for JwtAccessVerify {
	fn from(v: crate::lyxal_core_db::expr::access_type::JwtAccessVerify) -> Self {
		match v {
			crate::lyxal_core_db::expr::access_type::JwtAccessVerify::Key(v) => Self::Key(v.into()),
			crate::lyxal_core_db::expr::access_type::JwtAccessVerify::Jwks(v) => Self::Jwks(v.into()),
		}
	}
}
