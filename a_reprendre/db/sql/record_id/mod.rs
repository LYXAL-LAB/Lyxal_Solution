...
impl From<RecordIdLit> for crate::lyxal_core_db::expr::RecordIdLit {
	fn from(v: RecordIdLit) -> Self {
		crate::lyxal_core_db::expr::RecordIdLit {
...
impl From<crate::lyxal_core_db::expr::RecordIdLit> for RecordIdLit {
	fn from(v: crate::lyxal_core_db::expr::RecordIdLit) -> Self {
		RecordIdLit {
