...
impl From<RecordIdKeyRangeLit> for crate::lyxal_core_db::expr::RecordIdKeyRangeLit {
	fn from(value: RecordIdKeyRangeLit) -> Self {
		crate::lyxal_core_db::expr::RecordIdKeyRangeLit {
...
impl From<crate::lyxal_core_db::expr::RecordIdKeyRangeLit> for RecordIdKeyRangeLit {
	fn from(value: crate::lyxal_core_db::expr::RecordIdKeyRangeLit) -> Self {
		RecordIdKeyRangeLit {
			start: value.start.map(|x| x.into()),
			end: value.end.map(|x| x.into()),
		}
