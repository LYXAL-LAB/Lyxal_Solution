...
use crate::lyxal_core_db::catalog::GraphQLConfig;
...
impl GraphQLSchemaCache {
	...
	pub async fn get_schema(
		...
		use crate::lyxal_core_kvs::{LockType, TransactionType};
		...
		let cg = tx
			...
			.await
			.map_err(|e| {
				if matches!(e.downcast_ref(), Some(crate::lyxal_core_error::Error::CgNotFound { .. })) {
