...
use crate::lyxal_core_db::catalog::TableDefinition;
use crate::lyxal_core_db::doc::CursorRecord;
...
pub enum TableMutation {
	...
	/// Example, ("mytb:tobie", {{"note": "lyxal"}}, [{"op": "add", "path":
	/// "/note", "value": "lyxal"}], false) Means that we have already
...
impl TableMutation {
	...
	pub fn into_value(self) -> Value {
		...
		let o = crate::lyxal_core_db::val::Object::from(h);
		Value::Object(o)
	}
}
...
mod tests {
	...
	use super::*;
	use crate::lyxal_core_db::catalog::{DatabaseId, NamespaceId, TableId};
	use crate::lyxal_core_db::val::convert_value_to_public_value;
	...
	fn serialization() {
		...
		assert_eq!(
			s,
			r#"{"changes":[{"update":{"id":"mytb:tobie","note":"lyxal"}},{"delete":{"id":"mytb:tobie"}},{"define_table":{"drop":false,"id":3,"kind":{"kind":"ANY"},"name":"mytb","permissions":{"create":false,"delete":false,"select":false,"update":false},"schemafull":false}}],"versionstamp":65536}"#
		);
	}
	...
	fn serialization_rev2() {
		...
		assert_eq!(
			s,
			r#"{"changes":[{"current":{"id":"mytb:tobie","note":"lyxal"},"update":[{"op":"add","path":"/note","value":"lyxal"}]},{"current":{"id":"mytb:tobie2","note":"lyxal"},"update":[{"op":"remove","path":"/temp"}]},{"delete":{"id":"mytb:tobie"}},{"delete":{"id":"mytb:tobie"}},{"define_table":{"drop":false,"id":3,"kind":{"kind":"ANY"},"name":"mytb","permissions":{"create":false,"delete":false,"select":false,"update":false},"schemafull":false}}],"versionstamp":65536}"#
		);
	}
}
