//! This module defines and handles the `context` for the Lyxal Solution database.
//! ## Concept
...
//! Lyxal Solution database. Whilst at this point in time there is no definition
