...
use lyxal_types_core::{Error as TypesError, ErrorDetails, Kind, LyxalValue, Value, kind, object};
use web_time::Instant;

use crate::lyxal_core_db::expr::TopLevelExpr;
...
impl LyxalValue for QueryResult {
	fn kind_of() -> Kind {
		kind!(
			{
				status: "OK",
...
#[cfg(test)]
mod tests {
	use lyxal_types_core::{AuthError, NotAllowedError, NotFoundError, ValidationError};
