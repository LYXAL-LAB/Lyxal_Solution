//! Module implementing the Lyxal_QL parser.
//!
//! The Lyxal_QL parse is a relatively simple recursive decent parser.
//! Most of the functions of the Lyxal_QL parser peek a token from the lexer
...
//!
//! Lyxal_QL has a bunch of tokens which have complex rules for when they are
...
use crate::lyxal_core_db::syn::error::{SyntaxError, bail};
use crate::lyxal_core_db::syn::lexer::Lexer;
use crate::lyxal_core_db::syn::lexer::compound::CompoundToken;
...
pub struct ParserSettings {
	...
	/// Whether the lyxal_lism feature is enabled
	pub lyxal_lism_enabled: bool,
}
