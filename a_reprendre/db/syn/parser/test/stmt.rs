...
use crate::lyxal_core_db::catalog::EventKind;
use crate::lyxal_core_db::sql::access::AccessDuration;
use crate::lyxal_core_db::sql::access_type::{
...
use crate::lyxal_core_db::sql::data::Assignment;
use crate::lyxal_core_db::sql::field::Selector;
use crate::lyxal_core_db::sql::filter::Filter;
use crate::lyxal_core_db::sql::index::{Distance, FullTextParams, HnswParams, VectorType};
use crate::lyxal_core_db::sql::language::Language;
use crate::lyxal_core_db::sql::literal::ObjectEntry;
use crate::lyxal_core_db::sql::lookup::{LookupKind, LookupSubject};
use crate::lyxal_core_db::sql::statements::access::{
...
use crate::lyxal_core_db::sql::statements::remove::RemoveAnalyzerStatement;
use crate::lyxal_core_db::sql::statements::show::{ShowSince, ShowStatement};
use crate::lyxal_core_db::sql::statements::sleep::SleepStatement;
...
use crate::lyxal_core_db::syn::parser::ParserSettings;
...
fn parse_define_table() {
	...
	assert_eq!(
		...
		Expr::Define(Box::new(DefineStatement::Table(DefineTableStatement {
			...
			drop: true,
			full: true,
			view: Some(crate::lyxal_core_db::sql::View {
		...
		Expr::Insert(Box::new(InsertStatement {
			...
			update: Some(Data::UpdateExpression(vec![
				Assignment {
					...
					operator: crate::lyxal_core_db::sql::AssignOperator::Extend,
					value: Expr::Literal(Literal::Null)
				},
				Assignment {
					place: Idiom(vec![Part::Field("c".to_owned()), Part::Field("d".to_owned()),]),
					operator: crate::lyxal_core_db::sql::AssignOperator::Add,
