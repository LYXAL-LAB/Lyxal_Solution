...
use crate::lyxal_core_db::sql::statements::remove::{
	RemoveAnalyzerStatement, RemoveApiStatement, RemoveBucketStatement,RemoveConnectorStatement,
...
use crate::lyxal_core_db::sql::{ModuleName, Param};
use crate::lyxal_core_db::syn::error::bail;
use crate::lyxal_core_db::syn::parser::mac::{expected, expected_whitespace, unexpected};
use crate::lyxal_core_db::syn::parser::{ParseResult, Parser};
use crate::lyxal_core_db::syn::token::t;
	...
	pub(crate) async fn parse_remove_stmt(
		...
		let res = match next.kind {
			...
			t!("CONNECTOR") => {
				...
				RemoveStatement::Connector(RemoveConnectorStatement {
					name,
					if_exists,
				})
			}
			...
			t!("TABLE") => {
				...
				RemoveStatement::Table(crate::lyxal_core_db::sql::statements::RemoveTableStatement {
					name,
					if_exists,
					expunge,
				})
