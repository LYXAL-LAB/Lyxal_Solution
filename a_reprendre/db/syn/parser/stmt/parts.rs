...
use crate::lyxal_core_db::sql::index::{Distance, VectorType};
use crate::lyxal_core_db::sql::reference::{Reference, ReferenceDeleteStrategy};
...
use crate::lyxal_core_db::syn::token::{DistanceKind, Span, TokenKind, VectorTypeKind, t};
			...
			TokenKind::Distance(k) => {
				let dist = match k {
					...
					DistanceKind::Minkowski => {
						let distance: lyxal_types_core::Number = self.next_token_value()?;
