...
use crate::lyxal_core_db::sql::{Constant, Expr, Function, FunctionCall};
use crate::lyxal_core_db::syn::error::MessageKind;
use crate::lyxal_core_db::syn::parser::mac::expected;
use crate::lyxal_core_db::syn::parser::{SyntaxError, unexpected};
use crate::lyxal_core_db::syn::token::{Span, t};
...
> = phf_map! {
		...
		//
		UniCase::ascii("connector::call") => (PathKind::Function, None),
		UniCase::ascii("connector::list") => (PathKind::Function, None),
		UniCase::ascii("connector::info") => (PathKind::Function, None),
		UniCase::ascii("connector::health") => (PathKind::Function, None),
		UniCase::ascii("connector::batch") => (PathKind::Function, None),
		//
