...
use crate::lyxal_core_db::syn::token::{DistanceKind, Keyword, TokenKind, VectorTypeKind};
...
pub(crate) static KEYWORDS: phf::Map<UniCase<&'static str>, TokenKind> = phf_map! {
	...
	UniCase::ascii("APIKEY")    => TokenKind::Keyword(Keyword::Apikey),
	...
	UniCase::ascii("BACKOFF")   => TokenKind::Keyword(Keyword::Backoff),
	UniCase::ascii("BASIC")     => TokenKind::Keyword(Keyword::Basic),
	UniCase::ascii("BODY")      => TokenKind::Keyword(Keyword::Body),
	...
	UniCase::ascii("CONNECTOR") => TokenKind::Keyword(Keyword::Connector),
	...
	UniCase::ascii("ENDPOINT")  => TokenKind::Keyword(Keyword::Endpoint),
	...
	UniCase::ascii("METHOD")    => TokenKind::Keyword(Keyword::Method),
	...
	UniCase::ascii("STATUS")    => TokenKind::Keyword(Keyword::Status),
