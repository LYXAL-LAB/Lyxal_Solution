use super::Lexer;
use crate::lyxal_core_db::syn::error::{MessageKind, SyntaxError};
use crate::lyxal_core_db::syn::lexer::unicode::chars::JS_LINE_TERIMATORS;
use crate::lyxal_core_db::syn::token::{Token, t};
