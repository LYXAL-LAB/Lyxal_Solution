...
use crate::lyxal_core_error;
use crate::lyxal_core_error::Error;
use crate::lyxal_core_db::expr::statements::InsertStatement;
...
impl Document {
	pub(super) async fn insert(
		...
		let retry = match self.insert_create(stk, ctx, opt, &Statement::Insert(stm)).await {
			...
			Err(IgnoreError::Error(e)) => match e.downcast_ref::<crate::lyxal_core_error::Error>() {
