...
use lyxal_types_core::LyxalValue;
...
use crate::lyxal_core_db::val::{Object, Value, convert_object_to_public_map};
use crate::{crate::lyxal_core_db::iam, crate::lyxal_core_db::syn};
...
///
/// ```rust
/// use lyxal_core::iam::token::Token;
///
/// // Access-only token
...
/// };
/// ```
#[derive(Clone, Eq, PartialEq, PartialOrd, LyxalValue, Hash)]
#[lyxal(crate = "lyxal_types_core")]
#[lyxal(untagged)]
...
pub struct Claims {
	...
	#[serde(alias = "NS")]
	#[serde(rename = "NS")]
	#[serde(alias = "https://lyxal.com/ns")]
	#[serde(alias = "https://lyxal.com/namespace")]
	#[serde(skip_serializing_if = "Option::is_none")]
	pub ns: Option<String>,
	#[serde(alias = "db")]
	#[serde(alias = "DB")]
	#[serde(rename = "DB")]
	#[serde(alias = "https://lyxal.com/db")]
	#[serde(alias = "https://lyxal.com/database")]
	#[serde(skip_serializing_if = "Option::is_none")]
	pub db: Option<String>,
	#[serde(alias = "ac")]
	#[serde(alias = "AC")]
	#[serde(rename = "AC")]
	#[serde(alias = "https://lyxal.com/ac")]
	#[serde(alias = "https://lyxal.com/access")]
	#[serde(skip_serializing_if = "Option::is_none")]
	pub ac: Option<String>,
	#[serde(alias = "id")]
	#[serde(alias = "ID")]
	#[serde(rename = "ID")]
	#[serde(alias = "https://lyxal.com/id")]
	#[serde(alias = "https://lyxal.com/record")]
	#[serde(skip_serializing_if = "Option::is_none")]
	pub id: Option<String>,
	#[serde(alias = "rl")]
	#[serde(alias = "RL")]
	#[serde(rename = "RL")]
	#[serde(alias = "https://lyxal.com/rl")]
	#[serde(alias = "https://lyxal.com/roles")]
	#[serde(skip_serializing_if = "Option::is_none")]
	...
	pub(crate) fn into_claims_object(self) -> Object {
		...
		if let Some(custom_claims) = self.custom_claims {
			for (claim, value) in custom_claims {
				...
				// Parse that JSON string into the corresponding Lyxal_QL value
