...
use crate::lyxal_core_functions::util::math::vector::{
...
pub mod distance {
	...
	use crate::lyxal_core_functions::get_execution_context;
	use crate::lyxal_core_functions::util::math::vector::{
		ChebyshevDistance, EuclideanDistance, HammingDistance, ManhattanDistance, MinkowskiDistance,
	};
	use crate::lyxal_core_db::idx::planner::IterationStage;
	use crate::lyxal_core_db::val::{Number, Value};
...
pub mod similarity {
	...
	use crate::lyxal_core_error::Error;
	use crate::lyxal_core_functions::util::math::vector::{CosineSimilarity, JaccardSimilarity, PearsonSimilarity};
	use crate::lyxal_core_db::val::{Number, Value};
