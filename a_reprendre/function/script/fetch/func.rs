...
use crate::lyxal_core_functions::http::resolver::FilteringResolver;
use crate::lyxal_core_functions::script::fetch::RequestError;
use crate::lyxal_core_functions::script::fetch::body::{Body, BodyData, BodyKind};
use crate::lyxal_core_functions::script::fetch::classes::{
	self, Request, RequestInit, Response, ResponseInit, ResponseType,
};
use crate::lyxal_core_functions::script::modules::lyxal::query::QueryContext;
...
pub async fn fetch<'js>(
	...
	// Lyxal Implementation keeps all javascript parts inside the context::with
	...
	let redirect_limit = *crate::lyxal_core_config::cnf::MAX_HTTP_REDIRECTS;
