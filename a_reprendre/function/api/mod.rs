...
use crate::lyxal_core_api::err::ApiError;
use crate::lyxal_core_rpc::format as api_format;
use crate::lyxal_core_api::invocation::process_api_request_with_stack;
use crate::lyxal_core_api::request::ApiRequest;
use crate::lyxal_core_api::response::ApiResponse;
use crate::lyxal_core_db::catalog::ApiDefinition;
...
use crate::lyxal_core_functions::args::FromPublic;
use crate::lyxal_core_db::val::{Closure, Duration, Value};
use crate::fail;

pub mod req;
pub mod res;

/// Invokes an API endpoint programmatically from within Lyxal_QL.
///
/// This function allows you to call a defined API endpoint from within Lyxal_QL code,
...
///
/// # Returns
/// * `Ok(response)` - The API response as a Lyxal_QL value
...
pub async fn invoke(
	...
	if !req.headers.contains_key(ACCEPT) {
		...
		req.headers.insert(ACCEPT, "application/vnd.lyxal.native;q=0.9, */*;q=0.8".try_into()?);
	}
