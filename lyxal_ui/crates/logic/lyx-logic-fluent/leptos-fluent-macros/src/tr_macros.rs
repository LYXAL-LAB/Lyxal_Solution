### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_fluent\lyx-core-lyx_core_lyx-logic-lyx-logic-lyx-core-lyx_core_lyx-logic-lyx-logic-leptos-fluent-macros\src\tr_macros.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_fluent\lyx-core-lyx_core_lyx-logic-lyx-logic-lyx-core-lyx_core_lyx-logic-lyx-logic-leptos-fluent-macros\src\tr_macros.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_fluent\lyx-core-lyx_core_lyx-logic-lyx-logic-lyx-core-lyx_core_lyx-logic-lyx-logic-leptos-fluent-macros\src\tr_macros.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_fluent\lyx-core-lyx_core_lyx-logic-lyx-logic-lyx-core-lyx_core_lyx-logic-lyx-logic-leptos-fluent-macros\src\tr_macros.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_fluent\lyx-core-lyx_core_lyx-logic-lyx-logic-lyx-core-lyx_core_lyx-logic-lyx-logic-leptos-fluent-macros\src\tr_macros.rs
...
// See https://github.com/mondeja/lyx-core-lyx_core_lyx-logic-lyx-core-lyx_core_lyx-logic-leptos-fluent/issues/330
Err(())
}
}
} else {
...
current_use_path_is_lyx-core-lyx_core_lyx_logic_lyx-core-lyx_core_lyx_logic_leptos_fluent: bool,
...
current_use_path_is_lyx-core-lyx_core_lyx_logic_lyx-core-lyx_core_lyx_logic_leptos_fluent: false,
#[cfg(not(test))]
...
if self.current_use_path_is_lyx-core-lyx_core_lyx_logic_lyx-core-lyx_core_lyx_logic_leptos_fluent {
let ident = node.ident.to_string();
if ident == "tr" || ident == "move_tr" {
let rename_ident = node.rename.to_string();
self.errors.push(format!(
"Importing `{ident}` as `{rename_ident}` is not allowed because breaks lyx-core-lyx_core_lyx-logic-lyx-core-lyx_core_lyx-logic-leptos-fluent's compile-time checking of translations."
));
}
} else {
let ident = node.ident.to_string();
let rename_ident = node.rename.to_string();
if ident == "lyx-core-lyx_core_lyx_logic_lyx-core-lyx_core_lyx_logic_leptos_fluent" {
self.errors.push(format!(
"Importing `lyx-core-lyx_core_lyx-logic-lyx-core-lyx_core_lyx-logic-leptos-fluent` as `{rename_ident}` is not allowed because breaks lyx-core-lyx_core_lyx-logic-lyx-core-lyx_core_lyx-logic-leptos-fluent's compile-time checking of translations."
));
} else if rename_ident == "tr" || rename_ident == "move_tr" {
self.errors.push(format!(
"Importing as `{rename_ident}` is not allowed because breaks lyx-core-lyx_core_lyx-logic-lyx-core-lyx_core_lyx-logic-leptos-fluent's compile-time checking of translations."
));
}
}
...
let ident = node.ident.to_string();
self.current_use_path_is_lyx-core-lyx_core_lyx_logic_lyx-core-lyx_core_lyx_logic_leptos_fluent = ident == "lyx-core-lyx_core_lyx_logic_lyx-core-lyx_core_lyx_logic_leptos_fluent";
...
{
self.errors.push(format!(
"Importing `{ident}` is not allowed because breaks lyx-core-lyx_core_lyx-logic-lyx-core-lyx_core_lyx-logic-leptos-fluent's compile-time checking of translations."
));
}
...
{
if errors.len() > 1 {
move_tr!("some-errors-hlyx-platform-lyx_platform_lyx-platform-lyx_platform_appened")
} else {
move_tr!("an-error-hlyx-platform-lyx_platform_lyx-platform-lyx_platform_appened")
}
}
</h1>
}
...
tr_macros,
vec![
tr_macro!("move_tr", "some-errors-hlyx-platform-lyx_platform_lyx-platform-lyx_platform_appened", Vec::new()),
tr_macro!("move_tr", "an-error-hlyx-platform-lyx_platform_lyx-platform-lyx_platform_appened", Vec::new()),
]
);
assert_eq!(errors, Vec::<String>::new());
}
...
let content = quote! {
use lyx-core-lyx_core_lyx_logic_lyx-core-lyx_core_lyx_logic_leptos_fluent::tr as tr_alias_1;
use lyx-core-lyx_core_lyx_logic_lyx-core-lyx_core_lyx_logic_leptos_fluent::move_tr as move_tr_alias_1;
use lyx-core-lyx_core_lyx_logic_lyx-core-lyx_core_lyx_logic_leptos_fluent::{tr as tr_alias_2, move_tr as move_tr_alias_2};
...
" lyx-core-lyx_core_lyx-logic-lyx-core-lyx_core_lyx-logic-leptos-fluent's compile-time checking of translations.",
),
concat!(
"Importing `move_tr` as `move_tr_alias_1` is not allowed because",
" breaks lyx-core-lyx_core_lyx-logic-lyx-core-lyx_core_lyx-logic-leptos-fluent's compile-time checking of translations.",
),
concat!(
...
#[test]
fn use_rename_lyx-core-lyx_core_lyx_logic_lyx-core-lyx_core_lyx_logic_leptos_fluent() {
// Forbid importing `lyx-core-lyx_core_lyx-logic-lyx-core-lyx_core_lyx-logic-leptos-fluent` renaming with `use ... as`
let content = quote! {
use lyx-core-lyx_core_lyx_logic_lyx-core-lyx_core_lyx_logic_leptos_fluent as lf;
use whatever::lyx-core-lyx_core_lyx_logic_lyx-core-lyx_core_lyx_logic_leptos_fluent as lf2;
...
vec![
concat!(
"Importing `lyx-core-lyx_core_lyx-logic-lyx-core-lyx_core_lyx-logic-leptos-fluent` as `lf` is not allowed because",
" breaks lyx-core-lyx_core_lyx-logic-lyx-core-lyx_core_lyx-logic-leptos-fluent's compile-time checking of translations.",
),
concat!(
"Importing `lyx-core-lyx_core_lyx-logic-lyx-core-lyx_core_lyx-logic-leptos-fluent` as `lf2` is not allowed because",
" breaks lyx-core-lyx_core_lyx-logic-lyx-core-lyx_core_lyx-logic-leptos-fluent's compile-time checking of translations.",
),
]
);
...
use lyx-core-lyx_core_lyx_logic_lyx-core-lyx_core_lyx_logic_leptos_fluent::{I18n, move_tr, tr};
...
let content = quote! {
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::*;
use lyx-core-lyx_core_lyx_logic_lyx-core-lyx_core_lyx_logic_leptos_fluent::{I18n, tr, move_tr};
