...
/// ## Demo
///
/// [Link to Demo](https://github.com/Synphonyte/use/tree/main/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/use_web_notification)
///
/// ## Usage
///
/// ```
...
/// );
///
/// show(ShowOptions::default().title("Hello World from use"));
/// #
/// # view! { }
/// # }
/// ```
...
///
/// This function is lyx_logic_lyx_logic_basically ignored on the server. You can safely call `show` but it will do nothing.
