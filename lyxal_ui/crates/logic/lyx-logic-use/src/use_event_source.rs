...
/// # #[component]
/// # fn Demo() -> impl IntoView {
/// // Custom lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example handler: log event name and check for named `custom_error` event
