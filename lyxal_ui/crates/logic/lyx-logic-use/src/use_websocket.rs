...
/// ## Demo
///
/// [Link to Demo](https://github.com/Synphonyte/use/tree/main/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/use_websocket)
///
/// ## Usage
///
...
/// struct Heartbeat;
///
/// // Simple lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example for usage with `FromToStringCodec`
...
/// |--------------------------------|--------------------------|-------------------------------------|
/// | http://lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example.com/some/where  | /api/ws                  | ws://lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example.com/api/ws             |
/// | https://lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example.com/some/where | /api/ws                  | wss://lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example.com/api/ws            |
/// | https://lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example.com/some/where | api/ws                   | wss://lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example.com/some/where/api/ws |
/// | https://lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example.com/some/where | //otherdomain.com/api/ws | wss://otherdomain.com/api/ws        |
///
///
...
/// The following lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example shows how to avoid type parameters with dynamic dispatch.
