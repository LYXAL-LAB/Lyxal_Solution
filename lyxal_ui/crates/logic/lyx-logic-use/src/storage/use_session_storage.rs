...
///
/// Use [`use_local_storage`](https://use.rs/storage/use_local_storage.html) to store data that is shared amongst all pages with the same origin and persists between page sessions.
///
/// ## Usage
