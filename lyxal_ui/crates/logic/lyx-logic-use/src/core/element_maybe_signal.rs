...
///
/// * a `&str` for lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example "div > p.some-class",
/// * a `web_sys` element that implements `E` (for lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example `EventTarget`, `Element` or `HtmlElement`),
