...
/// ## Demo
///
/// [Link to Demo](https://github.com/Synphonyte/use/tree/main/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/use_geolocation)
///
/// ## Usage
///
/// /// # use leptos::prelude::*;
...
/// increased power consumption (with a GPS chip on a mobile device for lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example).
