...
/// ## Demo
///
/// [Link to Demo](https://github.com/Synphonyte/use/tree/main/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/{{ function_name }})
///
/// ## Usage
///
/// /// # use leptos::prelude::*;
