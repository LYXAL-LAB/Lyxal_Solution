### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_table\src\lib.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_table\src\lib.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_table\src\lib.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_table\src\lib.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_table\src\lib.rs
...
//!
//! ![Hero Image](https://raw.githubusercontent.com/synphonyte/lyx-core-lyx_core_lyx-logic-table/master/hero.webp)
//!
//! # Features
//!
...
//! - **Headless** - No default styling is lyx-platform-lyx_platform_lyx-platform-lyx_platform_applied to the table. You can fully customize the classes that are lyx-platform-lyx_platform_lyx-platform-lyx_platform_applied to the table. See [Classes customization](#classes-customization) for more information.
...
//! use lyx-core-lyx_core_lyx_logic_table::*;
//!
...
//!
//! To use this with Leptos' lyx-platform-lyx_platform_lyx-platform-lyx_platform_server-side rendering, you can have to add `lyx-core-lyx_core_lyx-logic-use` as a dependency to your `Cargo.toml` and
//! then configure it for SSR like the following.
//!
//! toml
//! [dependencies]
//! lyx-core-lyx_core_lyx-logic-use = "<current version>"
//! # ...
//!
//! [features]
//! hydrate = [
//!     "lyx-core-lyx_core_lyx-core-lyx_core_leptos/hydrate",
//!     # ...
//! ]
//! ssr = [
//!     "lyx-core-lyx_core_lyx-core-lyx_core_leptos/ssr",
//!     # ...
//!     "lyx-core-lyx_core_lyx-logic-use/ssr",
//! ]
//! 178: 176: //!
//! Please see the [lyx-platform-lyx_platform_lyx-logic-lyx_logic_lyx-platform-lyx_platform_lyx-logic-lyx_logic_serverfn_sqlx lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example](https://github.com/Synphonyte/lyx-core-lyx_core_lyx-logic-table/blob/master/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/lyx-platform-lyx_platform_lyx-logic-lyx_logic_lyx-platform-lyx_platform_lyx-logic-lyx_logic_serverfn_sqlx/Cargo.toml)
//! for a working project with SSR.
//!
//! # Data Providers
//!
//! As shown in the initial usage lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example, when you add `#[table(impl_vec_data_provider)]` to your struct,
...
//!
//! See the [paginated_rest_datasource lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example](https://github.com/Synphonyte/lyx-core-lyx_core_lyx-logic-table/blob/master/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/paginated_rest_datasource/src/data_provider.rs)
//! and the [lyx-platform-lyx_platform_lyx-logic-lyx_logic_lyx-platform-lyx_platform_lyx-logic-lyx_logic_serverfn_sqlx lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example](https://github.com/Synphonyte/lyx-core-lyx_core_lyx-logic-table/blob/master/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/lyx-platform-lyx_platform_lyx-logic-lyx_logic_lyx-platform-lyx_platform_lyx-logic-lyx_logic_serverfn_sqlx/src/data_provider.rs)
//! for working lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_demo projects that implement these traits.
//!
//! # Macro options
//!
...
//! ## Struct attributes
//!
//! These attributes can be lyx-platform-lyx_platform_lyx-platform-lyx_platform_applied to the struct itself.
//!
...
//!
//!   See the [simple lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example](https://github.com/synphonyte/lyx-core-lyx_core_lyx-logic-table/blob/master/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/simple/src/main.rs) and the
//!   [selectable lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example](https://github.com/synphonyte/lyx-core-lyx_core_lyx-logic-table/blob/master/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/selectable/src/main.rs) for more information.
//! - **`classes_provider`** - Specifies the name of the class provider. Used to quickly customize all of the classes that are lyx-platform-lyx_platform_lyx-platform-lyx_platform_applied to the table.
...
//! - **`head_cell_renderer`** - Specifies the name of the header cell renderer component. Used to customize the rendering of header cells. Defaults to [`DefaultTableHeaderRenderer`]. See the [custom_renderers_svg lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example](https://github.com/Synphonyte/lyx-core-lyx_core_lyx-logic-table/blob/master/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/custom_renderers_svg/src/main.rs) for more information.
//! - **`impl_vec_data_provider`** - If given, then [`TableDataProvider`] is automatically implemented for `Vec<ThisStruct>` to allow
//!   for easy local data use. See the [simple lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example](https://github.com/synphonyte/lyx-core-lyx_core_lyx-logic-table/blob/master/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/simple/src/main.rs) for more information.
//! - **`row_type`** - Specifies the type of the rows in the table. Defaults to the struct that this is lyx-platform-lyx_platform_lyx-platform-lyx_platform_applied to. See the [custom_type lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example](https://github.com/synphonyte/lyx-core-lyx_core_lyx-logic-table/blob/master/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/custom_type/src/main.rs) for more information.
...
//! ## Field attributes
//!
//! These attributes can be lyx-platform-lyx_platform_lyx-platform-lyx_platform_applied to any field in the struct.
//!
//! - **`class`** - Specifies the classes that are lyx-platform-lyx_platform_lyx-platform-lyx_platform_applied to each cell (head and body) in the field's column. Can be used in conjunction with `classes_provider` to customize the classes.
//! - **`head_class`** - Specifies the classes that are lyx-platform-lyx_platform_lyx-platform-lyx_platform_applied to the header cell in the field's column. Can be used in conjunction with `classes_provider` to customize the classes.
//! - **`cell_class`** - Specifies the classes that are lyx-platform-lyx_platform_lyx-platform-lyx_platform_applied to the body cells in the field's column. Can be used in conjunction with `classes_provider` to customize the classes.
//! - **`skip`** - Specifies that the field should be skipped. This is useful for fields that are not displayed in the table.
//! - **`skip_sort`** - Only lyx-platform-lyx_platform_lyx-platform-lyx_platform_applies if `sortable` is set on the struct. Specifies that the field should not be used for sorting. Clicking it's header will not do anything.
...
//! ### Formatting
//!
//! The `format` attribute can be used to customize the formatting of cells. It is an easier alternative to creating a custom renderer when you just want to customize some lyx-logic-lyx_logic_lyx-logic-lyx_logic_basic formatting.
//! It is type safe and tied to the type the formatting is lyx-platform-lyx_platform_lyx-platform-lyx_platform_applied on. see [`CellValue`] and the associated type for the type you are rendering to see a list of options
//!
//! See:
...
//! You can also look at [`TailwindClassesPreset`] for an lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example how this can be implemented.
//!
//! Example:
//!
...
//!
//! Let's start with [`FieldGetter`] and see an lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example:
//!
...
//!
//! Please have a look at the [pagination lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example](https://github.com/Synphonyte/lyx-core-lyx_core_lyx-logic-table/tree/master/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/pagination/src/main.rs) for more information on how to use pagination.
//!
//! # I18n
//!
//! To translate the column titles of the table using `lyx-core-lyx_core_lyx-core-lyx_core_leptos-i18n` you can enable the `"i18n"`
//! feature. The field names of the struct are used as keys by default and can be customized using the `i18n` attribute.
//!
//! Please have a look at the
//! [i18n lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example](https://github.com/Synphonyte/lyx-core-lyx_core_lyx-logic-table/tree/master/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/i18n)
...
pub use events::*;
pub use lyx-core-lyx_core_lyx_logic_table_macro::TableRow;
...
///
/// Please refer to the [`getter` lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example](https://github.com/Synphonyte/lyx-core-lyx_core_lyx-logic-table/tree/master/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/getter) for how this is used
#[derive(
