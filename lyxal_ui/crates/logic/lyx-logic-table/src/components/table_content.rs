### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_table\src\components\table_content.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_table\src\components\table_content.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_table\src\components\table_content.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_table\src\components\table_content.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_table\src\components\table_content.rs
...
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_table\src\components\table_content.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_table\src\components\table_content.rs
// lyx-core-lyx_core_lyx-logic-table/src/components/table_content.rs
...
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::lyx-core-lyx_core_lyx-core-lyx_core_tachys::view::any_view::AnyView;
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::task::spawn_local;
use lyx-core-lyx_core_lyx_logic_use::core::IntoElementMaybeSignal;
use lyx-core-lyx_core_lyx_logic_use::{
...
renderer_fn!(
Wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apperRendererFn(view: AnyView, class: Signal<String>)
);
...
/// Check out the [editable lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example](https://github.com/Synphonyte/lyx-core-lyx_core_lyx-logic-table/blob/master/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/editable/src/main.rs).
#[prop(optional, into)]
...
/// [selectable lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example](https://github.com/Synphonyte/lyx-core-lyx_core_lyx-logic-table/blob/master/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/selectable/src/main.rs).
#[prop(optional, into)]
selection: Selection,
/// Event handler callback for when the selection changes.
/// See the [selectable lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example](https://github.com/Synphonyte/lyx-core-lyx_core_lyx-logic-table/blob/master/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/selectable/src/main.rs) for details.
#[prop(optional, into)]
on_selection_change: EventHandler<SelectionChangeEvent<Row>>,
/// Renderer function for the table head. Defaults to [`DefaultTableHeadRenderer`]. For a full lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example see the
/// [custom_renderers_svg lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example](https://github.com/Synphonyte/lyx-core-lyx_core_lyx-logic-table/blob/master/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/custom_renderers_svg/src/main.rs).
#[prop(default = DefaultTableHeadRenderer.into(), into)]
thead_renderer: Wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apperRendererFn,
/// Renderer function for the table body. Defaults to [`DefaultTableBodyRenderer`]. For a full lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example see the
/// [custom_renderers_svg lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example](https://github.com/Synphonyte/lyx-core-lyx_core_lyx-logic-table/blob/master/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/custom_renderers_svg/src/main.rs).
#[prop(default = DefaultTableBodyRenderer.into(), into)]
tbody_renderer: TbodyRendererFn,
/// Renderer function for the table head row. Defaults to [`DefaultTableHeadRowRenderer`]. For a full lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example see the
/// [custom_renderers_svg lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example](https://github.com/Synphonyte/lyx-core-lyx_core_lyx-logic-table/blob/master/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/custom_renderers_svg/src/main.rs).
#[prop(default = DefaultTableHeadRowRenderer.into(), into)]
thead_row_renderer: Wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apperRendererFn,
/// The row renderer. Defaults to [`DefaultTableRowRenderer`]. For a full lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example see the
/// [custom_renderers_svg lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example](https://github.com/Synphonyte/lyx-core-lyx_core_lyx-logic-table/blob/master/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/custom_renderers_svg/src/main.rs).
#[prop(optional, into)]
row_renderer: RowRendererFn<Row, Column>,
/// The row renderer for when that row is currently being loaded.
/// Defaults to [`DefaultLoadingRowRenderer`]. For a full lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example see the
/// [custom_renderers_svg lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example](https://github.com/Synphonyte/lyx-core-lyx_core_lyx-logic-table/blob/master/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/custom_renderers_svg/src/main.rs).
#[prop(optional, into)]
loading_row_renderer: LoadingRowRendererFn,
/// The row renderer for when that row failed to load.
/// Defaults to [`DefaultErrorRowRenderer`]. For a full lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example see the
/// [custom_renderers_svg lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example](https://github.com/Synphonyte/lyx-core-lyx_core_lyx-logic-table/blob/master/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/custom_renderers_svg/src/main.rs).
#[prop(optional, into)]
...
/// The sorting to lyx-platform-lyx_platform_lyx-platform-lyx_platform_apply to the table.
/// For this to work you have add `#[table(sortable)]` to your struct.
/// Please see the [simple lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example](https://github.com/Synphonyte/lyx-core-lyx_core_lyx-logic-table/blob/master/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/simple/src/main.rs).
...
///
/// See the [column_order_and_visibility lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example](https://github.com/Synphonyte/lyx-core-lyx_core_lyx-logic-table/blob/master/lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples/column_order_and_visibility/src/main.rs)
/// for how to use.
#[prop(optional)]
...
scroll_container,
UseElementSizeOptions::default().box_(web_sys::ResizeOblyx-platform-lyx_platform_lyx-platform-lyx_platform_serverBoxOptions::ContentBox),
);
...
{
return Some(
(last_loaded_row.get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect().top()
- first_loading_row.get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect().top())
