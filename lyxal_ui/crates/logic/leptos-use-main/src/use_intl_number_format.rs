...
/// );
/// let formatted = number_format.format(number); // Ù¡Ù¢Ù£Ù¤Ù¥Ù¦Ù«Ù§Ù¨Ù©
///
...
/// );
/// let formatted = number_format.format(number); // ä¸€äºŒä¸‰,å››äº”å…­.ä¸ƒå…«ä¹
///
...
///         .currency("EUR"),
/// );
/// let formatted = number_format.format(number); // 123.456,79 â‚¬
///
...
///         .currency("JPY"),
/// );
/// let formatted = number_format.format(number); // ï¿¥123,457
///
...
/// );
///
/// let formatted = nf.format_range(3, 5); // "$3 â€“ $5"
///
...
/// );
///
/// let formatted = nf.format_range(3, 5); // "3-5 â‚¬"
/// let formatted = nf.format_range(2.9, 3.1); // "~3 â‚¬"
/// #
/// # view! { }
/// # }
