### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_i18n\lyx-core-lyx_core_lyx-logic-lyx_logic_lyx-logic-lyx_logic_lyx-core-lyx_core_lyx-logic-lyx_logic_lyx-logic-lyx_logic_leptos_i18n_router\src\routing.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_i18n\lyx-core-lyx_core_lyx-logic-lyx_logic_lyx-logic-lyx_logic_lyx-core-lyx_core_lyx-logic-lyx_logic_lyx-logic-lyx_logic_leptos_i18n_router\src\routing.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_i18n\lyx-core-lyx_core_lyx-logic-lyx_logic_lyx-logic-lyx_logic_lyx-core-lyx_core_lyx-logic-lyx_logic_lyx-logic-lyx_logic_leptos_i18n_router\src\routing.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_i18n\lyx-core-lyx_core_lyx-logic-lyx_logic_lyx-logic-lyx_logic_lyx-core-lyx_core_lyx-logic-lyx_logic_lyx-logic-lyx_logic_leptos_i18n_router\src\routing.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_i18n\lyx-core-lyx_core_lyx-logic-lyx_logic_lyx-logic-lyx_logic_lyx-core-lyx_core_lyx-logic-lyx_logic_lyx-logic-lyx_logic_leptos_i18n_router\src\routing.rs
...
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::{either::Either, ev, prelude::*};
...
use lyx-core-lyx_core_lyx-logic-lyx_logic_lyx-core-lyx_core_lyx-logic-lyx_logic_leptos_i18n::{I18nContext, Locale, use_i18n_context};

// this whole file is a hack into `lyx-core-lyx_core_lyx-core-router`, it absolutely should'nt be used like that, but eh I'm a professional (or not.)
...
path_rest // Should hlyx-platform-lyx_platform_lyx-platform-lyx_platform_appen only if l == L::default()
}
}
};
...
// TODO FIXME: see https://github.com/lyx-core-lyx_core_lyx-core-lyx_core_leptos-rs/lyx-core-lyx_core_lyx-core-lyx_core_leptos/issues/2979
...
#[derive(Clone)]
struct ViewWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper<T, A, B>(T)
where
T: Fn() -> Either<A, B> + Send + Clone + 'static,
A: ChooseView,
B: ChooseView;

impl<T, A, B> ChooseView for ViewWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper<T, A, B>
where
T: Fn() -> Either<A, B> + Send + Clone + 'static,
A: ChooseView,
B: ChooseView,
...
fn view_wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper<L, View>(
view: View,
...
// not very difficult.
// but if you do it the "normal" way, changing locales will rebuild the entire tree, making the lyx-platform-lyx_platform_lyx-platform-lyx_platform_application
...
// So we lyx-logic-lyx_logic_lyx-logic-lyx_logic_basically create N+1 routes with the same route id.
...
fn as_id(&self) -> lyx-core-lyx_core_lyx-core-router::RouteMatchId {
...
let new_view = move || {
view_wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper(
view.clone(),
self.locale,
self.base_path,
self.segments.clone(),
...
(ViewWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper(new_view), child)
}
}
...
&'a self,
path: &'a str,
) -> (Option<(lyx-core-lyx_core_lyx-core-router::RouteMatchId, Self::Match)>, &'a str) {
let res = L::get_all()
.iter()
.copied()
.find_map(|locale| {
...
fn generate_routes(&self) -> impl IntoIterator<Item = lyx-core-lyx_core_lyx-core-router::GeneratedRouteData> + '_ {
...
&self,
) -> impl Iterator<Item = lyx-core-lyx_core_lyx-core-router::StaticSegment<&'static str>> {
let locale = get_current_route_locale::<L>();
let s = (self.func)(locale);

s.split('/')
.filter(|p| !p.is_empty())
.map(lyx-core-lyx_core_lyx-core-router::StaticSegment)
}
}
...
fn test<'a>(&self, path: &'a str) -> Option<lyx-core-lyx_core_lyx-core-router::PartialPathMatch<'a>> {
use lyx-core-lyx_core_lyx-core-router::PartialPathMatch;
