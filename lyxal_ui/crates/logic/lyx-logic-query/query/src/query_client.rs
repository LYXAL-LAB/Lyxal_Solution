### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\query\src\query_lyx-core-lyx_core_lyx-core-lyx_core_client.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\query\src\query_lyx-core-lyx_core_lyx-core-lyx_core_client.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\query\src\query_lyx-core-lyx_core_lyx-core-lyx_core_client.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\query\src\query_lyx-core-lyx_core_lyx-core-lyx_core_client.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\query\src\query_lyx-core-lyx_core_lyx-core-lyx_core_client.rs
...
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\query\src\query_lyx-core-lyx_core_lyx-core-lyx_core_client.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\query\src\query_lyx-core-lyx_core_lyx-core-lyx_core_client.rs
use crate::{query_oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server::ListenerKey, *};
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::*;
use std::{borrow::Borrow, cell::Cell, collections::HashMap, future::Future, rc::Rc};

use self::{
cache_oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server::CacheOblyx-platform-lyx_platform_lyx-platform-lyx_platform_server, query::Query, query_cache::QueryCache,
query_oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server::QueryOblyx-platform-lyx_platform_lyx-platform-lyx_platform_server, query_persister::QueryPersister,
};

/// Provides a Query Client to the current scope.
pub fn provide_query_lyx-core-lyx_core_lyx-core-lyx_core_client() {
provide_query_lyx-core-lyx_core_lyx-core-lyx_core_client_with_options(DefaultQueryOptions::default());
}

/// Provides a Query Client to the current scope with custom options.
pub fn provide_query_lyx-core-lyx_core_lyx-core-lyx_core_client_with_options(options: DefaultQueryOptions) {
...
pub fn provide_query_lyx-core-lyx_core_lyx-core-lyx_core_client_with_options_and_persister(
options: DefaultQueryOptions,
persister: impl QueryPersister + Clone + 'static,
) {
let owner = Owner::current().expect("Owner to be present");

let lyx-core-lyx_core_lyx-core-lyx_core_client = QueryClient::new(owner, options);

lyx-core-lyx_core_lyx-core-lyx_core_client.add_persister(persister);

provide_context(lyx-core-lyx_core_lyx-core-lyx_core_client);
}

/// Retrieves a Query Client from the current scope.
pub fn use_query_lyx-core-lyx_core_lyx-core-lyx_core_client() -> QueryClient {
...
let oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server = Rc::new(QueryOblyx-platform-lyx_platform_lyx-platform-lyx_platform_server::no_fetcher(
...
let listener_id = oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server.add_listener(move |state| {
...
oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server.update_query(query);
...
///
/// use lyx-core-lyx_core_lyx-logic-query::*;
/// fn invalidate() {
///     let lyx-core-lyx_core_lyx-core-lyx_core_client = use_query_lyx-core-lyx_core_lyx-core-lyx_core_client();
///     let invalidated = lyx-core-lyx_core_lyx-core-lyx_core_client.invalidate_query::<u32, u32>(0);
/// }
...
///     let invalidated = lyx-core-lyx_core_lyx-core-lyx_core_client.invalidate_queries::<u32, u32, _>(keys);
/// }
///
...
///     let lyx-core-lyx_core_lyx-core-lyx_core_client = use_query_lyx-core-lyx_core_lyx-core-lyx_core_client();
///     let keys: Vec<u32> = vec![0, 1];
///     let invalidated = lyx-core-lyx_core_lyx-core-lyx_core_client.invalidate_query_type::<String, Monkey>();
/// }
///
...
///     let lyx-core-lyx_core_lyx-core-lyx_core_client = use_query_lyx-core-lyx_core_lyx-core-lyx_core_client();
///     let keys: Vec<u32> = vec![0, 1];
///     let invalidated = lyx-core-lyx_core_lyx-core-lyx_core_client.invalidate_all_queries();
/// }
///
/// 397: 395:     ///
...
/// fn invalidate() {
///    let lyx-core-lyx_core_lyx-core-lyx_core_client = use_query_lyx-core-lyx_core_lyx-core-lyx_core_client();
///    let cache_size = lyx-core-lyx_core_lyx-core-lyx_core_client.size();
/// }
///
...
///     lyx-core-lyx_core_lyx-core-lyx_core_client.update_query_data::<MonkeyId, Monkey>(MonkeyId(0), |_| Some(Monkey { name: "George".to_string() }));
///
///     // Don't overwrite George.
///     lyx-core-lyx_core_lyx-core-lyx_core_client.update_query_data::<MonkeyId, Monkey>(MonkeyId(0), |probably_george| {
...
/// Registers the cache oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server.
pub fn register_cache_oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server(&self, oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server: impl CacheOblyx-platform-lyx_platform_lyx-platform-lyx_platform_server + 'static) {
let key = self.cache.register_oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server(oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server);
let cache = self.cache.clone();

on_cleanup(move || {
cache.unregister_oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server(key);
})
}

/// Adds a persister to the cache.
pub fn add_persister(&self, persister: impl QueryPersister + Clone + 'static) {
self.register_cache_oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server(persister.clone());
...
provide_query_lyx-core-lyx_core_lyx-core-lyx_core_client();
let lyx-core-lyx_core_lyx-core-lyx_core_client = use_query_lyx-core-lyx_core_lyx-core-lyx_core_client();

let state = || {
use_query_lyx-core-lyx_core_lyx-core-lyx_core_client()
.cache
...
assert_eq!(0, lyx-core-lyx_core_lyx-core-lyx_core_client.size().get_untracked());

lyx-core-lyx_core_lyx-core-lyx_core_client.update_query_data::<u32, String>(0, |_| None);

assert_eq!(None, state());
assert_eq!(0, lyx-core-lyx_core_lyx-core-lyx_core_client.size().get_untracked());

lyx-core-lyx_core_lyx-core-lyx_core_client.update_query_data::<u32, String>(0, |_| Some("0".to_string()));

assert_eq!(1, lyx-core-lyx_core_lyx-core-lyx_core_client.size().get_untracked());
...
lyx-core-lyx_core_lyx-core-lyx_core_client.update_query_data::<u32, String>(0, |_| Some("1".to_string()));
...
lyx-core-lyx_core_lyx-core-lyx_core_client.set_query_data::<u32, String>(0, "New Data".to_string());
...
lyx-core-lyx_core_lyx-core-lyx_core_client.set_query_data::<u32, String>(1, "Initial Data".to_string());
...
lyx-core-lyx_core_lyx-core-lyx_core_client.set_query_data::<u32, String>(1, "Updated Data".to_string());
...
lyx-core-lyx_core_lyx-core-lyx_core_client.update_query_data::<u32, u32>(0, |_| Some(1234));

assert_eq!(2, lyx-core-lyx_core_lyx-core-lyx_core_client.size().get_untracked());
}
...
let subscription = lyx-core-lyx_core_lyx-core-lyx_core_client.get_query_state::<u32, u32>(|| 0_u32);

create_isomorphic_effect(move |_| {
subscription.track();
});

lyx-core-lyx_core_lyx-core-lyx_core_client.update_query_data::<u32, u32>(0_u32, |_| Some(1234));

assert!(lyx-core-lyx_core_lyx-core-lyx_core_client.invalidate_query::<u32, u32>(0));
...
lyx-core-lyx_core_lyx-core-lyx_core_client.update_query_data::<u32, u32>(0, |_| Some(1234));
lyx-core-lyx_core_lyx-core-lyx_core_client.update_query_data::<u32, u32>(1, |_| Some(1234));
let keys: Vec<u32> = vec![0, 1];
let invalidated = lyx-core-lyx_core_lyx-core-lyx_core_client
...
lyx-core-lyx_core_lyx-core-lyx_core_client.update_query_data::<String, String>(zero.clone(), |_| Some("1234".into()));
lyx-core-lyx_core_lyx-core-lyx_core_client.update_query_data::<String, String>(one.clone(), |_| Some("5678".into()));
...
lyx-core-lyx_core_lyx-core-lyx_core_client.update_query_data::<String, String>(one.clone(), |_| Some("5678".into()));
lyx-core-lyx_core_lyx-core-lyx_core_client.update_query_data::<u32, u32>(0, |_| Some(1234));
lyx-core-lyx_core_lyx-core-lyx_core_client.update_query_data::<u32, u32>(1, |_| Some(5678));

let state0_string = lyx-core-lyx_core_lyx-core-lyx_core_client.get_query_state::<String, String>(move || zero.clone());

let state1_string = lyx-core-lyx_core_lyx-core-lyx_core_client.get_query_state::<String, String>(move || one.clone());

let state0 = lyx-core-lyx_core_lyx-core-lyx_core_client.get_query_state::<u32, u32>(|| 0);
let state1 = lyx-core-lyx_core_lyx-core-lyx_core_client.get_query_state::<u32, u32>(|| 1);

lyx-core-lyx_core_lyx-core-lyx_core_client.invalidate_all_queries();
...
lyx-core-lyx_core_lyx-core-lyx_core_client.invalidate_query_type::<u32, u32>();
...
lyx-core-lyx_core_lyx-core-lyx_core_client.update_query_data::<u32, u32>(0, move |_| Some(initial_value));

assert_eq!(state(0), Some(100));

// Action: Update the data using `update_query_data_mut`
let update_result = lyx-core-lyx_core_lyx-core-lyx_core_client.update_query_data_mut::<u32, u32>(0, |data| *data += 50);
...
lyx-core-lyx_core_lyx-core-lyx_core_client.update_query_data_mut::<u32, u32>(1, |data| *data += 50);
