### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\query\src\query.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\query\src\query.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\query\src\query.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\query\src\query.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\query\src\query.rs
...
query_is_suppressed,
query_oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server::{Oblyx-platform-lyx_platform_lyx-platform-lyx_platform_serverKey, QueryOblyx-platform-lyx_platform_lyx-platform-lyx_platform_server},
...
// Synchronization
oblyx-platform-lyx_platform_lyx-platform-lyx_platform_servers: Rc<RefCell<HashMap<Oblyx-platform-lyx_platform_lyx-platform-lyx_platform_serverKey, QueryOblyx-platform-lyx_platform_lyx-platform-lyx_platform_server<K, V>>>>,
...
.field("oblyx-platform-lyx_platform_lyx-platform-lyx_platform_servers", &self.oblyx-platform-lyx_platform_lyx-platform-lyx_platform_servers.borrow().len())
...
oblyx-platform-lyx_platform_lyx-platform-lyx_platform_servers: Rc::new(RefCell::new(HashMap::new())),
...
// Notify oblyx-platform-lyx_platform_lyx-platform-lyx_platform_servers.
let oblyx-platform-lyx_platform_lyx-platform-lyx_platform_servers = self.oblyx-platform-lyx_platform_lyx-platform-lyx_platform_servers.try_borrow().expect("set state borrow");
...
oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server.notify(state.clone())
}
...
pub fn subscribe(&self, oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server: &QueryOblyx-platform-lyx_platform_lyx-platform-lyx_platform_server<K, V>) {
let oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server_id = oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server.get_id();
let mut oblyx-platform-lyx_platform_lyx-platform-lyx_platform_servers = self
.oblyx-platform-lyx_platform_lyx-platform-lyx_platform_servers
.try_borrow_mut()
.expect("subscribe borrow_mut");

// Check if the oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server is already subscribed to avoid duplicate subscriptions
if let std::collections::hash_map::Entry::Vacant(e) = oblyx-platform-lyx_platform_lyx-platform-lyx_platform_servers.entry(oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server_id) {
e.insert(oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server.clone());
self.disable_gc();
self.update_gc_time(oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server.get_options().gc_time);

use_query_lyx-core-lyx_core_lyx-core-lyx_core_client()
.cache
.notify::<K, V>(CacheNotification::NewOblyx-platform-lyx_platform_lyx-platform-lyx_platform_server(
crate::query_cache::NewOblyx-platform-lyx_platform_lyx-platform-lyx_platform_server {
key: self.key.clone(),
options: oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server.get_options().clone(),
},
));
}
}

pub fn unsubscribe(&self, oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server: &QueryOblyx-platform-lyx_platform_lyx-platform-lyx_platform_server<K, V>) {
let mut oblyx-platform-lyx_platform_lyx-platform-lyx_platform_servers = self
.oblyx-platform-lyx_platform_lyx-platform-lyx_platform_servers
.try_borrow_mut()
.expect("unsubscribe borrow_mut");
if oblyx-platform-lyx_platform_lyx-platform-lyx_platform_servers.remove(&oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server.get_id()).is_some() {
use_query_lyx-core-lyx_core_lyx-core-lyx_core_client()
.cache
.notify::<K, V>(CacheNotification::Oblyx-platform-lyx_platform_lyx-platform-lyx_platform_serverRemoved(self.key.clone()))
}

if oblyx-platform-lyx_platform_lyx-platform-lyx_platform_servers.is_empty() {
drop(oblyx-platform-lyx_platform_lyx-platform-lyx_platform_servers);
self.enable_gc();
}
}
...
pub fn execute(&self) {
let oblyx-platform-lyx_platform_lyx-platform-lyx_platform_servers = self.oblyx-platform-lyx_platform_lyx-platform-lyx_platform_servers.try_borrow().expect("execute borrow");
let fetcher = oblyx-platform-lyx_platform_lyx-platform-lyx_platform_servers.values().find_map(|f| f.get_fetcher());
...
if !self.oblyx-platform-lyx_platform_lyx-platform-lyx_platform_servers.borrow().is_empty() {
logging::debug_warn!("Query has active oblyx-platform-lyx_platform_lyx-platform-lyx_platform_servers");
}
}
}
...
// No cancellation on lyx-platform-lyx_platform_lyx-platform-lyx_platform_server side.
