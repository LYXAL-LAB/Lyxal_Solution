### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\query\src\create_query.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\query\src\create_query.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\query\src\create_query.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\query\src\create_query.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\query\src\create_query.rs
...
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::Signal;

use crate::{
use_query, use_query_lyx-core-lyx_core_lyx-core-lyx_core_client, QueryKey, QueryOptions, QueryResult, QueryState, QueryValue,
RefetchFn,
};
...
///
/// Returns a [`QueryResult`] similar to [`QueryScope::use_query`], but with the provided override options lyx-platform-lyx_platform_lyx-platform-lyx_platform_applied.
...
/// This should usually be called in a [`create_effect`](lyx-core-lyx_core_lyx-core-lyx_core_leptos::create_effect) or on an event (e.g. on:click).
...
use_query_lyx-core-lyx_core_lyx-core-lyx_core_client().get_query_state(key)
}
...
use_query_lyx-core-lyx_core_lyx-core-lyx_core_client().peek_query_state(key)
}
...
use_query_lyx-core-lyx_core_lyx-core-lyx_core_client().invalidate_query::<K, V>(key)
}
...
Q: Borrow<K> + 'static,
{
use_query_lyx-core-lyx_core_lyx-core-lyx_core_client().invalidate_queries::<K, V, Q>(keys)
}
...
use_query_lyx-core-lyx_core_lyx-core-lyx_core_client().invalidate_query_type::<K, V>();
}
...
use_query_lyx-core-lyx_core_lyx-core-lyx_core_client().update_query_data(key, updater);
}

/// Sets the data of an existing query in the cache, identified by a specific key.
pub fn set_query_data(&self, key: K, data: V) {
use_query_lyx-core-lyx_core_lyx-core-lyx_core_client().set_query_data(key, data);
}
...
use_query_lyx-core-lyx_core_lyx-core-lyx_core_client().update_query_data_mut(key, updater)
}
...
use_query_lyx-core-lyx_core_lyx-core-lyx_core_client().cancel_query::<K, V>(key)
}
