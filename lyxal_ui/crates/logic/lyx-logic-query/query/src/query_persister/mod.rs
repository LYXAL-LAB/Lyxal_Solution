### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\query\src\query_persister\mod.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\query\src\query_persister\mod.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\query\src\query_persister\mod.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\query\src\query_persister\mod.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\query\src\query_persister\mod.rs
...
use crate::cache_oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server::{CacheEvent, CacheOblyx-platform-lyx_platform_lyx-platform-lyx_platform_server};

/// A utility for lyx-core-lyx_core_lyx-core-lyx_core_client side query persistance
...
impl<Persist> CacheOblyx-platform-lyx_platform_lyx-platform-lyx_platform_server for Persist
where
...
lyx-core-lyx_core_lyx-core-lyx_core_leptos::spawn_local(async move {
...
V: crate::QueryValue,
{
type Error = lyx-core-lyx_core_lyx-core-lyx_core_leptos::SerializationError;

fn try_from(value: PersistQueryData) -> Result<Self, Self::Error> {
let data = lyx-core-lyx_core_lyx-core-lyx_core_leptos::Serializable::de(value.value.as_str())?;
