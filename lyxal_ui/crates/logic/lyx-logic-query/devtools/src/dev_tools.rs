### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\devtools\src\dev_tools.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\devtools\src\dev_tools.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\devtools\src\dev_tools.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\devtools\src\dev_tools.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_query\devtools\src\dev_tools.rs
...
cache_oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server::{
CacheEvent, CacheOblyx-platform-lyx_platform_lyx-platform-lyx_platform_server, CreatedQuery, Oblyx-platform-lyx_platform_lyx-platform-lyx_platform_serverAdded, QueryCacheKey, SerializedQuery,
},
*,
};
...
let lyx-core-lyx_core_lyx-core-lyx_core_client = lyx-core-lyx_core_lyx-logic-query::use_query_lyx-core-lyx_core_lyx-core-lyx_core_client();
let state = DevtoolsContext::new();
lyx-core-lyx_core_lyx-core-lyx_core_client.register_cache_oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server(state.clone());
...
<div class="lyx-core-lyx_core_lyx-core-lyx_core_leptos-query-devtools lq-font-mono">
<Devtools/>
</div>
</Portal>
}
...
oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server_count: RwSignal<usize>,
...
impl CacheOblyx-platform-lyx_platform_lyx-platform-lyx_platform_server for DevtoolsContext {
...
oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server_count: create_rw_signal(0),
is_stale,
mark_invalid,
}
});
...
CacheEvent::Oblyx-platform-lyx_platform_lyx-platform-lyx_platform_serverAdded(oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server) => {
let Oblyx-platform-lyx_platform_lyx-platform-lyx_platform_serverAdded { key, options } = oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server;
let QueryOptions {
stale_time,
gc_time,
..
...
entry.oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server_count.update(|c| *c += 1);
{
...
CacheEvent::Oblyx-platform-lyx_platform_lyx-platform-lyx_platform_serverRemoved(key) => {
self.query_state.update(|map| {
if let Some(entry) = map.get_mut(&key) {
entry.oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server_count.update(|c| {
if *c > 0 {
*c -= 1
}
});
...
let container_ref = lyx-core-lyx_core_lyx-core-lyx_core_leptos::create_node_ref::<lyx-core-lyx_core_lyx-core-lyx_core_leptos::html::Div>();
...
let start_y = event.lyx-core-lyx_core_lyx-core-lyx_core_client_y() as f64;

let move_closure = Closure::wrap(Box::new(move |move_event: web_sys::MouseEvent| {
move_event.prevent_default();

let val_to_add = start_y - move_event.lyx-core-lyx_core_lyx-core-lyx_core_client_y() as f64;
...
let cache = lyx-core-lyx_core_lyx-logic-query::use_query_lyx-core-lyx_core_lyx-core-lyx_core_client();
...
key,
state,
oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server_count,
is_stale,
..
} = entry.clone();
let oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server = move || {
let count = oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server_count.get();
if count == 0 {
view! {
...
{oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server}
...
<div class=entry_class>
<dt class="lq-text-zinc-100">Active Oblyx-platform-lyx_platform_lyx-platform-lyx_platform_servers</dt>
<dd class="lq-text-zinc-200">{oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server_count}</dd>
</div>
