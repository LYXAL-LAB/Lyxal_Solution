### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_table_macro\src\table_row.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_table_macro\src\table_row.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_table_macro\src\table_row.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_table_macro\src\table_row.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\logic\lyx_logic_table_macro\src\table_row.rs
...
quote! {
<lyx-core-lyx_core_lyx_logic_table::DefaultTableCellRenderer<_, #column_type, #type_ident, #marker> options=#format_props #value_prop #class_prop #index_prop row=row />
}
}
...
value=lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::Signal::derive(move || value.get().expect("Just checked above that it's not None"))
};
...
quote! {
{
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::Read;

let value = lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::Signal::derive(move || { row.read().#getter });

lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::view! {
<lyx-core-lyx_core_lyx-core-lyx_core_leptos::control_flow::Show
when={
move || { value.read().is_some() }
}
fallback=move || {
type DefaultMarker = ();
lyx-core-lyx_core_lyx-core-lyx_core_leptos::view! {
<lyx-core-lyx_core_lyx_logic_table::DefaultTableCellRenderer<_, #column_type, String, DefaultMarker>
value=lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::Signal::stored(#none_value.to_string())
options=()
...
{
type DefaultMarker = ();
let mut o = <#ty as ::lyx-core-lyx_core_lyx_logic_table::CellValue<#marker>>::RenderOptions::default();
#(#values)*
o
}
}
...
let class_prop = quote! { class=lyx-core-lyx_core_lyx_logic_table::TableClassesProvider::cell(&class_provider, #joined_classes) };

let value_prop = quote! {
value={
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::Read;

lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::Signal::derive(move || row.read().#getter)
}
};
...
quote! {lyx-core-lyx_core_lyx_logic_table::DefaultTableHeaderCellRenderer}
}
}
...
Ok(lyx-core-lyx_core_lyx_logic_table::get_vec_range_clamped(self, range))
}
...
.as_ref()
.map(|id| quote! { #id })
.unwrap_or(quote! { lyx-core-lyx_core_lyx_logic_table::DummyTableClassesProvider });
...
// Match arms on column type to call the lyx-platform-lyx_platform_lyx-platform-lyx_platform_appropriate cell renderer for that column.
...
<#thead_cell_renderer
class=lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::Signal::derive(move || class_provider.thead_cell(lyx-core-lyx_core_lyx_logic_table::get_sorting_for_column(#column, sorting), #head_class))
inner_class=class_provider.thead_cell_inner()
index=#column
sort_priority=lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::Signal::derive(move || {
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::Read;
...
sort_direction=lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::Signal::derive(move || lyx-core-lyx_core_lyx_logic_table::get_sorting_for_column(#column, sorting))
#on_click_handling
...
titles.push(quote! { #column => lyx-core-lyx_core_lyx-core-lyx_core_leptos::view! { #thead_renderer }.into_any(), });
...
&column_type,
&column,
vec![quote! { lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::ReadValue::read_value(&dynamic_class) }],
);
let cell_renderer_fn_ident = format_ident!("cell_renderer_for_{name}");
cell_funs.push(quote! {
fn #cell_renderer_fn_ident(row: RwSignal<#ident>, dynamic_class: String) -> lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::AnyView {
type DefaultMarker = ();
let dynamic_class = lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::StoredValue::new(dynamic_class); // Needed a Copy type to pass into Fn or FnMut closures.

let class_provider = <#classes_provider_ident as lyx-core-lyx_core_lyx_logic_table::TableClassesProvider>::new();

lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::IntoAny::into_any(lyx-core-lyx_core_lyx-core-lyx_core_leptos::view! { #cell_renderer_dyn_class })
}
});
...
cells.push(quote! { #column => lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::IntoAny::into_any(lyx-core-lyx_core_lyx-core-lyx_core_leptos::view! { #cell_renderer }), });
}
...
tokens.extend(quote! {
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::{Signal, RwSignal};
...
impl #generic_params_wb lyx-core-lyx_core_lyx_logic_table::TableRow<#column_type> for #ident
#where_clause
{
...
fn render_row(row: RwSignal<Self>, index: usize, columns: RwSignal<Vec<#column_type>>) -> impl lyx-core-lyx_core_lyx-core-lyx_core_leptos::IntoView {
use lyx-core-lyx_core_lyx_logic_table::TableClassesProvider;
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::control_flow::For;
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::{Get, IntoAny};
type DefaultMarker = ();
...
match column {
#(#cells)*
other => lyx-core-lyx_core_lyx-core-lyx_core_leptos::view! {
...
sorting: Signal<std::collections::VecDeque<(#column_type, lyx-core-lyx_core_lyx_logic_table::ColumnSort)>>,
on_head_click: F,
drag_handler: lyx-core-lyx_core_lyx_logic_table::HeadDragHandler<#column_type>,
columns: RwSignal<Vec<#column_type>>
) -> impl lyx-core-lyx_core_lyx-core-lyx_core_leptos::IntoView
where
F: Fn(lyx-core-lyx_core_lyx_logic_table::TableHeadEvent<#column_type>) + Send + Clone + 'static,
{
use lyx-core-lyx_core_lyx_logic_table::TableClassesProvider;
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::{Get, IntoAny};
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::control_flow::For;
...
let drag_state = lyx-core-lyx_core_lyx_logic_table::DragStateRwSignal::new(None);
...
fn cell_renderer_for_column(row: RwSignal<#ident>, column: #column_type, dynamic_class: String) -> lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::AnyView {
match column {
#(#cell_renderer_invocation_match_arms)*
other => lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::IntoAny::into_any(lyx-core-lyx_core_lyx-core-lyx_core_leptos::view! {
format!("Unmatched column type {other:?}, probably a bug.")
})
}
}
