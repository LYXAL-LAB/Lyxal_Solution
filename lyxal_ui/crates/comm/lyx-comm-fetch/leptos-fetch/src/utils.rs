### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_fetch\lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch\src\utils.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_fetch\lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch\src\utils.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_fetch\lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch\src\utils.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_fetch\lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch\src\utils.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_fetch\lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch\src\utils.rs
...
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::{Owner, ScopedFuture, TimeoutHandle, untrack};
...
untyped_lyx-core-lyx_core_lyx-core-lyx_core_client: UntypedQueryClient,
scope_cache_key: ScopeCacheKey,
) {
lyx-core-lyx_core_lyx-core-lyx_core_leptos::context::provide_context(untyped_lyx-core-lyx_core_lyx-core-lyx_core_client);
lyx-core-lyx_core_lyx-core-lyx_core_leptos::context::provide_context(scope_cache_key);
}
...
owner.with(|| {
provide_cb_contexts(untyped_lyx-core-lyx_core_lyx-core-lyx_core_client, scope_cache_key);
for cb in callbacks {
cb();
}
});
...
#[allow(dead_code)]
/// Works around potential panic reported in https://github.com/zakstucke/lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch/issues/43
/// until my internal fix is upstreamed into lyx-core-lyx_core_lyx-core-lyx_core_leptos (https://github.com/lyx-core-lyx_core_lyx-core-lyx_core_leptos-rs/lyx-core-lyx_core_lyx-core-lyx_core_leptos/pull/4212)
#[track_caller]
pub(crate) fn safe_set_timeout(
cb: impl FnOnce() + 'static,
duration: std::time::Duration,
) -> TimeoutHandle {
lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::set_timeout_with_handle(
cb,
...
.expect("lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::set_timeout_with_handle() failed to spawn")
}
...
/// The owner will contain the context of the current lyx-core-lyx_core_lyx-core-lyx_core_client.
impl OwnerChain {
pub fn new(
untyped_lyx-core-lyx_core_lyx-core-lyx_core_client: UntypedQueryClient,
scope_cache_key: ScopeCacheKey,
...
// Explicitly disabling diagnostics and removing oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server to prevent "leak through" reactivity in local resources
owner
