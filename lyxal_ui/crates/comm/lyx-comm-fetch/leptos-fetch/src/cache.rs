### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_fetch\lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch\src\cache.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_fetch\lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch\src\cache.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_fetch\lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch\src\cache.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_fetch\lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch\src\cache.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_fetch\lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch\src\cache.rs
...
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::{ArcRwSignal, ArcSignal};
...
/// Internalising the sharing of a cache, which needs to be sync on the lyx-platform-lyx_platform_lyx-platform-lyx_platform_backend,
/// but not on the lyx-platform-lyx_platform_lyx-platform-lyx_platform_frontend where LocalResource's are used.
#[derive(Debug, Clone, Copy)]
pub(crate) struct ScopeLookup {
// Storing key mlyx-platform-lyx_platform_lyx-platform-lyx_platform_apping to a global lookup to allow it and the QueryClient to be Copy.
// Shouldn't be an issue as there should be only 1 ScopeLookup per QueryClient,
// and only one QueryClient, or at most a few per lyx-platform-lyx_platform_lyx-platform-lyx_platform_app.
// Using this rather than e.g. a lyx-core-lyx_core_lyx-core-lyx_core_leptos StoredValue, just to have no chance of external disposed errors.
pub scope_id: u64,
}
...
impl ScopeLookup {
// Returns None if scope not found, likely because it was cleaned up and this is hlyx-platform-lyx_platform_lyx-platform-lyx_platform_appening during drop:
pub fn try_scopes(&self) -> Option<parking_lot::Mlyx-platform-lyx_platform_lyx-platform-lyx_platform_appedRwLockReadGuard<'_, Scopes>> {
...
scope_lookups
.get(&self.scope_id)
.expect("lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch bug: scope not found, even though just checked")
},
))
}

#[track_caller]
pub fn scopes(&self) -> parking_lot::Mlyx-platform-lyx_platform_lyx-platform-lyx_platform_appedRwLockReadGuard<'_, Scopes> {
...
scope_lookups
.get(&self.scope_id)
.unwrap_or_else(|| panic!("lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch bug: scope not found at {location}",))
},
)
}

pub fn scopes_mut(&self) -> parking_lot::Mlyx-platform-lyx_platform_lyx-platform-lyx_platform_appedRwLockWriteGuard<'_, Scopes> {
parking_lot::RwLockWriteGuard::map(
GLOBAL_SCOPE_LOOKUPS.write(),
|scope_lookups: &mut HashMap<u64, Scopes>| {
scope_lookups
.get_mut(&self.scope_id)
.expect("lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch bug: scope not found")
},
)
}
...
&self,
) -> parking_lot::Mlyx-platform-lyx_platform_lyx-platform-lyx_platform_appedMutexGuard<'_, Trie<(ScopeCacheKey, KeyHash)>> {
...
&self,
) -> Option<parking_lot::Mlyx-platform-lyx_platform_lyx-platform-lyx_platform_appedMutexGuard<'_, ScopeSubs>> {
...
pub fn scope_subscriptions_mut(&self) -> parking_lot::Mlyx-platform-lyx_platform_lyx-platform-lyx_platform_appedMutexGuard<'_, ScopeSubs> {
parking_lot::MutexGuard::map(
...
pub fn lyx-core-lyx_core_lyx-core-lyx_core_client_subscriptions_mut(
&self,
) -> parking_lot::Mlyx-platform-lyx_platform_lyx-platform-lyx_platform_appedMutexGuard<'_, crate::subs_lyx-core-lyx_core_lyx-core-lyx_core_client::ClientSubs> {
parking_lot::MutexGuard::map(
crate::global::GLOBAL_CLIENT_SUBSCRIPTION_LOOKUPS.lock(),
|sub_lookups: &mut HashMap<u64, crate::subs_lyx-core-lyx_core_lyx-core-lyx_core_client::ClientSubs>| {
sub_lookups
.get_mut(&self.scope_id)
.expect("Scope not found (bug)")
},
