### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_fetch\lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch\src\dev_tools\inner\dev_tools.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_fetch\lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch\src\dev_tools\inner\dev_tools.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_fetch\lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch\src\dev_tools\inner\dev_tools.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_fetch\lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch\src\dev_tools\inner\dev_tools.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_fetch\lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch\src\dev_tools\inner\dev_tools.rs
...
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::{portal::Portal, prelude::*};
...
#[component]
pub(crate) fn DevtoolsRoot<Codec: 'static>(lyx-core-lyx_core_lyx-core-lyx_core_client: QueryClient<Codec>) -> impl IntoView {
let open = RwSignal::new(false);
view! {
<Portal>
<style>{include_str!("./styles.css")}</style>
<div class="lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch-devtools lq-font-mono">
<Show
when=move || open.get()
fallback=move || {
...
cache_rep: prepare(lyx-core-lyx_core_lyx-core-lyx_core_client),
open: open.into(),
...
view! { <DevtoolsInner lyx-core-lyx_core_lyx-core-lyx_core_client=lyx-core-lyx_core_lyx-core-lyx_core_client /> }
}
</Show>
</div>
</Portal>
...
#[component]
pub(crate) fn DevtoolsInner<Codec: 'static>(lyx-core-lyx_core_lyx-core-lyx_core_client: QueryClient<Codec>) -> impl IntoView {
let DevtoolsContext {
cache_rep,
selected_query,
filter,
...
let container_ref = lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::NodeRef::<lyx-core-lyx_core_lyx-core-lyx_core_leptos::html::Div>::new();

let height_signal = RwSignal::new(500);

// Drag start handler
let handle_drag_start = move |event: web_sys::MouseEvent| {
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::wasm_bindgen::JsCast;
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::wasm_bindgen::closure::Closure;
...
<ClearCache lyx-core-lyx_core_lyx-core-lyx_core_client=lyx-core-lyx_core_lyx-core-lyx_core_client maybe_cache_key=None />
</div>
</div>
</div>
...
<ClearCache lyx-core-lyx_core_lyx-core-lyx_core_client=lyx-core-lyx_core_lyx-core-lyx_core_client maybe_cache_key=Some(cache_key) />
</div>
</div>
...
selected_query
.get()
.map(|q| view! { <SelectedQuery lyx-core-lyx_core_lyx-core-lyx_core_client=lyx-core-lyx_core_lyx-core-lyx_core_client query=q /> })
}
}}
...
lyx-core-lyx_core_lyx-core-lyx_core_client: QueryClient<Codec>,
maybe_cache_key: Option<ScopeCacheKey>,
) -> impl IntoView {
view! {
<button
class="lq-bg-lq-input lq-text-lq-input-foreground lq-rounded-md lq-px-2 lq-py-1 lq-text-xs lq-inline-flex lq-items-center lq-gap-1 lq-border lq-border-lq-border"
on:click=move |_| {
lyx-core-lyx_core_lyx-core-lyx_core_client.clear();
}
>
...
lyx-core-lyx_core_lyx-core-lyx_core_client.invalidate_query_scope_inner(cache_key);
} else {
...
#[component]
fn SelectedQuery<Codec: 'static>(lyx-core-lyx_core_lyx-core-lyx_core_client: QueryClient<Codec>, query: QueryRep) -> impl IntoView {
...
let mut scopes = lyx-core-lyx_core_lyx-core-lyx_core_client
...
lyx-core-lyx_core_lyx-core-lyx_core_client.untyped_lyx-core-lyx_core_lyx-core-lyx_core_client,
cache_key,
vec![cb_external],
);
}
