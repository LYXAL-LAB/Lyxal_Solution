### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_fetch\lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch\src\pagination\paginated_offset.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_fetch\lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch\src\pagination\paginated_offset.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_fetch\lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch\src\pagination\paginated_offset.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_fetch\lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch\src\pagination\paginated_offset.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_fetch\lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch\src\pagination\paginated_offset.rs
...
///
/// // Fetch page 0
/// let (items, total) = lyx-core-lyx_core_lyx-core-lyx_core_client.fetch_query(scope, PaginatedPageKey {
///     key: (),
///     page_index: 0,
///     page_size: 20,
...
if let Some(metadata) = untyped_lyx-core-lyx_core_lyx-core-lyx_core_client.query_metadata::<PaginatedPageKey<Key>, Option<(Vec<PageItem>, Option<u64>)>>(
scope_cache_key,
&page_key,
)
&& metadata.stale_or_invalidated
&& let Some(backing_metadata) = untyped_lyx-core-lyx_core_lyx-core-lyx_core_client.query_metadata::<KeyWithUnhashedItemCountAndOffsetRequested<Key>, BackingCache<PageItem>>(
...
/// Hence returning (Vec<Item>, Option<total_items>) instead of a custom wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apping Page<Item> type.
...
let (first_page_logs, maybe_total) = lyx-core-lyx_core_lyx-core-lyx_core_client
.fetch_query(
scope.clone(),
PaginatedPageKey {
key: (),
...
let (second_page_logs, maybe_total) = lyx-core-lyx_core_lyx-core-lyx_core_client
.fetch_query(
scope.clone(),
PaginatedPageKey {
key: (),
...
let (items, total) = lyx-core-lyx_core_lyx-core-lyx_core_client
.fetch_query(
scope.clone(),
PaginatedPageKey {
key: (),
...
let result = lyx-core-lyx_core_lyx-core-lyx_core_client
.fetch_query(
scope.clone(),
PaginatedPageKey {
key: (),
...
let (items, returned_total) = lyx-core-lyx_core_lyx-core-lyx_core_client
.fetch_query(
scope.clone(),
PaginatedPageKey {
key: (),
