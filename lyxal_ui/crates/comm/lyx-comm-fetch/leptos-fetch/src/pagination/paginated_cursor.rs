### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_fetch\lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch\src\pagination\paginated_cursor.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_fetch\lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch\src\pagination\paginated_cursor.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_fetch\lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch\src\pagination\paginated_cursor.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_fetch\lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch\src\pagination\paginated_cursor.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_fetch\lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch\src\pagination\paginated_cursor.rs
...
///
/// ,ignore
/// use lyx_comm_lyx-core-lyx_core_lyx_comm_lyx-core-lyx_core_leptos_fetch::{QueryScope, PaginatedPageKey};
///
...
/// let (items, has_more) = lyx-core-lyx_core_lyx-core-lyx_core_client.fetch_query(scope, PaginatedPageKey {
///     key: (),
///     page_index: 0,
///     page_size: 20,
...
/// if has_more {
///     let (next_items, _) = lyx-core-lyx_core_lyx-core-lyx_core_client.fetch_query(scope, PaginatedPageKey {
///         key: (),
///         page_index: 1,
///         page_size: 20,
...
let getter = getter.clone();
async move {
let untyped_lyx-core-lyx_core_lyx-core-lyx_core_client = use_context::<UntypedQueryClient>()
.expect(
"lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch bug, UntypedQueryClient should always have been \
provided to the query context internally"
);
let scope_cache_key = use_context::<ScopeCacheKey>()
.expect(
"lyx-comm-lyx-core-lyx_core_lyx-comm-lyx-core-lyx_core_leptos-fetch bug, ScopeCacheKey itself should always have been \
provided to the query context internally"
);
...
if let Some(metadata) = untyped_lyx-core-lyx_core_lyx-core-lyx_core_client.query_metadata::<PaginatedPageKey<Key>, Option<(Vec<PageItem>, bool)>>(
scope_cache_key,
&page_key,
)
&& metadata.stale_or_invalidated
&& let Some(backing_metadata) = untyped_lyx-core-lyx_core_lyx-core-lyx_core_client.query_metadata::<KeyWithItemCountRequestedUnhashed<Key>, BackingCache<PageItem, Cursor>>(
...
{
untyped_lyx-core-lyx_core_lyx-core-lyx_core_client.invalidate_query(
&backing_cache_scope,
KeyWithItemCountRequestedUnhashed {
key: page_key.key.clone(),
item_count_requested: 0, // Doesn't matter, it's not part of the hash
...
let infinite_cache = untyped_lyx-core-lyx_core_lyx-core-lyx_core_client
.$fetch_fn(
backing_cache_scope,
KeyWithItemCountRequestedUnhashed {
key: page_key.key.clone(),
...
let mut found_nb = 0;
untyped_lyx-core-lyx_core_lyx-core-lyx_core_client
.scope_lookup
.with_cached_scope_mut::<PaginatedPageKey<Key>, Option<(Vec<PageItem>, bool)>, _, _>(
&mut untyped_lyx-core-lyx_core_lyx-core-lyx_core_client.scope_lookup.scopes_mut(),
scope_cache_key,
OnScopeMissing::Skip,
|_| {},
|maybe_scope, _| {
...
if found_nb == 0 {
untyped_lyx-core-lyx_core_lyx-core-lyx_core_client.clear_query(
&backing_cache_scope,
KeyWithItemCountRequestedUnhashed {
key: key.key.clone(),
item_count_requested: 0, // Doesn't matter, it's not part of the hash
...
/// We don't know the serialization mechanism the user is using, so cannot return wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apping types from the query function.
/// Hence returning (Vec<Item>, has_more_pages: bool) instead of a custom wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apping Page<Item> type.
...
let (lyx-core-lyx_core_lyx-core-lyx_core_client, _guard, _owner) = prep_vari!(true);
let scope = QueryScope::new_paginated_with_cursor(|_: (), _, _| async {
(vec![()], Some(()))
});
lyx-core-lyx_core_lyx-core-lyx_core_client.resource(scope, || PaginatedPageKey {
key: (),
page_index: 0,
page_size: 10,
});
...
let (first_page_logs, more_pages) = lyx-core-lyx_core_lyx-core-lyx_core_client
.fetch_query(
scope.clone(),
PaginatedPageKey {
key: (),
...
let (second_page_logs, more_pages) = lyx-core-lyx_core_lyx-core-lyx_core_client
.fetch_query(
scope.clone(),
PaginatedPageKey {
key: (),
...
let (items, has_more) = lyx-core-lyx_core_lyx-core-lyx_core_client
.fetch_query(
scope.clone(),
PaginatedPageKey {
key: (),
...
let lyx-core-lyx_core_lyx-core-lyx_core_client = QueryClient::new();

// Fetch first page
let (first_page, more_pages) = lyx-core-lyx_core_lyx-core-lyx_core_client
.fetch_query(
scope.clone(),
PaginatedPageKey {
key: (),
...
// Fetch second page
let (second_page, more_pages) = lyx-core-lyx_core_lyx-core-lyx_core_client
.fetch_query(
scope.clone(),
PaginatedPageKey {
key: (),
...
// First fetch
let _ = lyx-core-lyx_core_lyx-core-lyx_core_client
.fetch_query(
scope.clone(),
PaginatedPageKey {
key: (),
...
// Fetch first page
let (items1, _) = lyx-core-lyx_core_lyx-core-lyx_core_client
.fetch_query(
scope.clone(),
PaginatedPageKey {
key: "test".to_string(),
...
// Fetch second page
let (items2, _) = lyx-core-lyx_core_lyx-core-lyx_core_client
.fetch_query(
scope.clone(),
PaginatedPageKey {
key: "test".to_string(),
...
let (items1_new, _) = lyx-core-lyx_core_lyx-core-lyx_core_client
.fetch_query(
scope.clone(),
PaginatedPageKey {
key: "test".to_string(),
...
lyx-core-lyx_core_lyx-core-lyx_core_client.untyped_lyx-core-lyx_core_lyx-core-lyx_core_client.clear_query_scope(scope.clone());
} else {
lyx-core-lyx_core_lyx-core-lyx_core_client.invalidate_query_scope(scope.clone());
}
...
let (items2_new, _) = lyx-core-lyx_core_lyx-core-lyx_core_client
.fetch_query(
scope.clone(),
PaginatedPageKey {
key: "test".to_string(),
...
lyx-core-lyx_core_lyx-core-lyx_core_client.fetch_query(
scope.clone(),
PaginatedPageKey {
key: (),
page_index: 0,
...
let (items3, _) = lyx-core-lyx_core_lyx-core-lyx_core_client
.fetch_query(
scope.clone(),
PaginatedPageKey {
key: (),
...
// Fetch first page
let (items, _) = lyx-core-lyx_core_lyx-core-lyx_core_client
.fetch_query(
scope.clone(),
PaginatedPageKey {
key: "test".to_string(),
