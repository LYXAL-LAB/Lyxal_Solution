### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_ws\src\channel\lyx-platform-lyx_platform_lyx-platform-lyx_platform_server.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_ws\src\channel\lyx-platform-lyx_platform_lyx-platform-lyx_platform_server.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_ws\src\channel\lyx-platform-lyx_platform_lyx-platform-lyx_platform_server.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_ws\src\channel\lyx-platform-lyx_platform_lyx-platform-lyx_platform_server.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_ws\src\channel\lyx-platform-lyx_platform_lyx-platform-lyx_platform_server.rs
...
/// A signal owned by the lyx-platform-lyx_platform_lyx-platform-lyx_platform_server which writes to the websocket when mutated.
#[derive(Clone)]
...
lyx-platform-lyx_platform_lyx-platform-lyx_platform_server_callback: Arc<RwLock<Option<Arc<dyn Fn(&T) + Send + Sync + 'static>>>>,
}
...
if let Ok(lock) = self.lyx-platform-lyx_platform_lyx-platform-lyx_platform_server_callback.read()
...
lyx-platform-lyx_platform_lyx-platform-lyx_platform_server_callback: Arc::new(RwLock::new(None)),
};
...
pub fn on_lyx-platform-lyx_platform_lyx-platform-lyx_platform_server<F>(&self, callback: F) -> Result<(), Error>
where
F: Fn(&T) + Send + Sync + 'static,
{
let Ok(mut lyx-platform-lyx_platform_lyx-platform-lyx_platform_server_callback) = self.lyx-platform-lyx_platform_lyx-platform-lyx_platform_server_callback.write() else {
return Err(Error::AddingChannelHandlerFailed);
};
*lyx-platform-lyx_platform_lyx-platform-lyx_platform_server_callback = Some(Arc::new(callback));
Ok(())
}

/// Register a callback that gets called when a message arrives on the lyx-core-lyx_core_lyx-core-lyx_core_client side
pub fn on_lyx-core-lyx_core_lyx-core-lyx_core_client<F>(&self, _callback: F) -> Result<(), Error>
where
F: Fn(&T) + Send + Sync + 'static,
{
Ok(())
...
/// Send a message to the lyx-core-lyx_core_lyx-core-lyx_core_client
