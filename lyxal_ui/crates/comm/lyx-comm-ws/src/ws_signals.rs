### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_ws\src\ws_signals.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_ws\src\ws_signals.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_ws\src\ws_signals.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_ws\src\ws_signals.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\comm\lyx_comm_ws\src\ws_signals.rs
...
pub fn add_oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server(&self, name: &str) -> Option<Receiver<(Option<String>, Messages)>> {
self.signals
.get(name)
.and_then(|v| v.value().subscribe().ok())
}

pub fn add_oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server_channel(&self, name: &str) -> Option<Receiver<(Option<String>, Messages)>> {
self.channels
.get(name)
.and_then(|v| v.value().subscribe().ok())
}
