### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\specialized\lyx_spec_toast\src\toast_container.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\specialized\lyx_spec_toast\src\toast_container.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\specialized\lyx_spec_toast\src\toast_container.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\specialized\lyx_spec_toast\src\toast_container.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\specialized\lyx_spec_toast\src\toast_container.rs
...
use js_sys::Date;
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::{ev, lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos_dom::helpers::TimeoutHandle, prelude::*};
use std::cmp::{max, min};
...
document.query_selector(".lyx-core-lyx_core_lyx-core-lyx_core_leptos-toast-container")
{
let height = toast_container_node.get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect().height();
...
// The close button calls a window.postMessage which we then pick up here and delete the toast if the lyx-core-lyx_core_lyx-core-lyx_core_ids match
...
x: ev.lyx-core-lyx_core_lyx-core-lyx_core_client_x(),
y: ev.lyx-core-lyx_core_lyx-core-lyx_core_client_y(),
}));
}
}
};
...
let y_position = ev.lyx-core-lyx_core_lyx-core-lyx_core_client_y() - _pointer_start.y;
let x_position = ev.lyx-core-lyx_core_lyx-core-lyx_core_client_x() - _pointer_start.x;
...
role="status"
tab-index=0
class="lyx-core-lyx_core_lyx-core-lyx_core_leptos-toast-container"
