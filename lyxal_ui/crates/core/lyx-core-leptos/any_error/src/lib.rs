...
//! A utility library for wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apping arbitrary errors, and for â€œthrowingâ€ errors in a way
...
/* Wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper Types */

/// A generic wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper for any error.
#[derive(Debug, Clone)]
#[repr(transparent)]
pub struct Error(Arc<dyn error::Error + Send + Sync>);

impl Error {
/// Converts the wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper into the inner reference-counted error.
