...
use lyx-core-lyx_core_lyx-core-lyx_core_hydration_context::{SharedContext, SsrSharedContext};
...
use lyx-core-lyx_core_lyx-core-meta::{Link, ServerMetaContextOutput};
...
fn from_lyx-platform-lyx_platform_lyx-platform-lyx_platform_app<IV>(
lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_fn: impl FnOnce() -> IV + Send + 'static,
...
// to_html() on lyx-core-lyx_core_lyx-core-meta components registers them with the meta context,
...
as_="fetch"
type_="lyx-platform-lyx_platform_lyx-platform-lyx_platform_application/wasm"
...
// run lyx-platform-lyx_platform_lyx-platform-lyx_platform_app
let lyx-platform-lyx_platform_lyx-platform-lyx_platform_app = lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_fn();
...
// convert lyx-platform-lyx_platform_lyx-platform-lyx_platform_app to lyx-platform-lyx_platform_lyx-platform-lyx_platform_appropriate response type
// and chain the lyx-platform-lyx_platform_lyx-platform-lyx_platform_app stream, followed by chunks
...
stream_builder(lyx-platform-lyx_platform_lyx-platform-lyx_platform_app, chunks, is_islands_router_navigation)
});
