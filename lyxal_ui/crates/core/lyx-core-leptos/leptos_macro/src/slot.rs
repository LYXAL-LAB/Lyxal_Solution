...
#docs
#prop_docs
#[derive(::lyx-core-lyx_core_lyx-core-lyx_core_leptos::typed_builder_macro::TypedBuilder)]
#[builder(doc, crate_module_path=::lyx-core-lyx_core_lyx-core-lyx_core_leptos::typed_builder)]
...
/*impl #impl_generics ::lyx-core-lyx_core_lyx-core-lyx_core_leptos::Props for #name #generics #where_clause {
...
impl #impl_generics ::lyx-core-lyx_core_lyx-core-lyx_core_leptos::DynAttrs for #name #generics #where_clause {
fn dyn_attrs(mut self, v: Vec<(&'static str, ::lyx-core-lyx_core_lyx-core-lyx_core_leptos::Attribute)>) -> Self {
#dyn_attrs_props
self
}
}*/
...
tokens.lyx-platform-lyx_platform_lyx-platform-lyx_platform_append_all(output)
}
}
...
#[attribute(lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example = "5 * 10")]
...
let ty = &self.ty;
quote! {
fn transform<__IntoReactiveValueMarker>(value: impl ::lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::IntoReactiveValue<#ty, __IntoReactiveValueMarker>) -> #ty {
...
quote! {
fn transform<__IntoReactiveValueMarker>(value: impl ::lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::IntoReactiveValue<#ty, __IntoReactiveValueMarker>) -> Option<#ty> {
