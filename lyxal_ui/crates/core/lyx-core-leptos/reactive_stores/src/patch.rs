...
use lyx-core-lyx_core_lyx-core-lyx_core_reactive_graph::traits::{Notify, UntrackableGuard};
use std::{
borrow::Cow,
...
self.lyx-platform-lyx_platform_lyx-platform-lyx_platform_append(&mut adds);
