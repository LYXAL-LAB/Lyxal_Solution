...
signal::{
guards::{Mlyx-platform-lyx_platform_lyx-platform-lyx_platform_appedMutArc, WriteGuard},
ArcTrigger,
},
traits::{
...
type Reader = Mlyx-platform-lyx_platform_lyx-platform-lyx_platform_appedMutArc<Inner::Reader, Prev::Output>;
type Writer =
Mlyx-platform-lyx_platform_lyx-platform-lyx_platform_appedMutArc<WriteGuard<ArcTrigger, Inner::Writer>, Prev::Output>;
