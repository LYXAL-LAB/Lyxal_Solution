...
use lyx-core-lyx_core_lyx-core-lyx_core_reactive_graph::traits::Get;
use std::{marker::PhantomData, sync::Arc};
use lyx-core-lyx_core_lyx-core-lyx_core_tachys::either::Either;
...
/// Servers as a wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper for both, an `Option` signal or a closure that returns an `Option`.
