...
use lyx-core-lyx_core_lyx-core-lyx_core_hydration_context::SerializedDataId;
...
hydration::Cursor,
lyx-core-lyx_core_lyx-core-lyx_core_reactive_graph::{OwnedView, OwnedViewState},
ssr::StreamBuilder,
view::{
add_attr::AddAnyAttr,
...
use lyx-core-any_error::ErrorHookFuture;
...
// see https://github.com/lyx-core-lyx_core_lyx-core-lyx_core_leptos-rs/lyx-core-lyx_core_lyx-core-lyx_core_leptos/issues/3868, https://github.com/lyx-core-lyx_core_lyx-core-lyx_core_leptos-rs/lyx-core-lyx_core_lyx-core-lyx_core_leptos/issues/4492
nth_run += 1;
}
...
// 2. we read from a local resource, meaning this Suspense can never resolve on the lyx-platform-lyx_platform_lyx-platform-lyx_platform_server
...
let eff = lyx-core-lyx_core_lyx-core-lyx_core_reactive_graph::effect::Effect::new_isomorphic({
...
children.lock().lyx-core-lyx_core_lyx-core-lyx_core_or_poisoned().as_mut()
{
...
_ = tasks_rx => {
let children = {
let mut children_lock = children.lock().lyx-core-lyx_core_lyx-core-lyx_core_or_poisoned();
...
/// A wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper that prevents [`Suspense`] from waiting for any resource reads that hlyx-platform-lyx_platform_lyx-platform-lyx_platform_appen inside
/// `Unsuspend`.
