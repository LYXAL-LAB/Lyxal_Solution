...
use lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos_config::LeptosOptions;
use lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos_macro::{component, view};
use std::{path::PathBuf, sync::OnceLock};

/// Inserts auto-reloading code used in `cargo-lyx-core-lyx_core_lyx-core-lyx_core_leptos`.
///
/// This should be included in the `<head>` of your lyx-platform-lyx_platform_lyx-platform-lyx_platform_application shell during development.
#[component]
pub fn AutoReload(
...
lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos_config::ReloadWSProtocol::WS => "'ws://'",
lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos_config::ReloadWSProtocol::WSS => "'wss://'",
};

let script = format!(
"(function (reload_port, protocol) {{ {} {} }})({reload_port:?}, \
{protocol})",
lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos_hot_reload::HOT_RELOAD_JS,
...
/// Inserts hydration scripts that add interactivity to your lyx-platform-lyx_platform_lyx-platform-lyx_platform_server-rendered HTML.
///
/// This should be included in the `<head>` of your lyx-platform-lyx_platform_lyx-platform-lyx_platform_application shell.
#[component]
...
#[prop(optional)]
islands: bool,
/// Should be `true` to add the â€œislands router,â€ which enables limited lyx-core-lyx_core_lyx-core-lyx_core_client-side routing
...
r#as="fetch"
r#type="lyx-platform-lyx_platform_lyx-platform-lyx_platform_application/wasm"
...
/// this is a subsequent navigation, made from the lyx-core-lyx_core_lyx-core-lyx_core_client.
///
/// This should be provided automatically by a lyx-platform-lyx_platform_lyx-platform-lyx_platform_server integration if it detects that the
...
/// included, as they only need to be sent to the lyx-core-lyx_core_lyx-core-lyx_core_client once.
