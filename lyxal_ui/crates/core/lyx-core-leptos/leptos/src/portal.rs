...
use lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos_dom::helpers::document;
use lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos_macro::component;
use lyx-core-lyx_core_lyx-core-lyx_core_reactive_graph::{effect::Effect, graph::untrack, owner::Owner};
use std::sync::Arc;
...
/// it is wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apped in a `<div>` unless  `is_svg` is `true` in which case it's wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apped in a `<g>`.
/// Setting `use_shadow` to `true` places the element in a shadow root to isolate styles.
#[cfg_attr(feature = "tracing", tracing::instrument(level = "trace", skip_all))]
#[component]
pub fn Portal<V>(
/// Target element where the children will be lyx-platform-lyx_platform_lyx-platform-lyx_platform_appended
#[prop(into, optional)]
...
let _ = mount.lyx-platform-lyx_platform_lyx-platform-lyx_platform_append_child(&container);
let handle = SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper::new((
