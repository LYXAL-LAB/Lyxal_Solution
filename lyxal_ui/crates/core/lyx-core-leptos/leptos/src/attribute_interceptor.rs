...
/// Function stored to build/rebuild the wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apped children when attributes are added.
...
/// use lyx-core-lyx_core_lyx-core-lyx_core_leptos::attribute_interceptor::AttributeInterceptor;
///
/// #[component]
/// pub fn MyComponent() -> impl IntoView {
///     view! {
///         <AttributeInterceptor let:attrs>
///             <div id="wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper">
///                 <div id="inner" {..attrs} />
///             </div>
...
/// Wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper to intercept attributes passed to a component so you can lyx-platform-lyx_platform_lyx-platform-lyx_platform_apply them to a different
/// element.
...
A: Attribute,
{
type Output<SomeNewAttr: lyx-core-lyx_core_lyx-core-lyx_core_leptos::attr::Attribute> =
AttributeInterceptorInner<T, <<A as NextAttribute>::Output<SomeNewAttr> as Attribute>::CloneableOwned>;

fn add_any_attr<NewAttr: lyx-core-lyx_core_lyx-core-lyx_core_leptos::attr::Attribute>(
self,
attr: NewAttr,
) -> Self::Output<NewAttr>
where
...
self,
buf: &mut String,
position: &mut lyx-core-lyx_core_lyx-core-lyx_core_leptos::lyx-core-lyx_core_lyx-core-lyx_core_tachys::view::Position,
escape: bool,
mark_branches: bool,
...
self,
cursor: &lyx-core-lyx_core_lyx-core-lyx_core_leptos::lyx-core-lyx_core_lyx-core-lyx_core_tachys::hydration::Cursor,
position: &lyx-core-lyx_core_lyx-core-lyx_core_leptos::lyx-core-lyx_core_lyx-core-lyx_core_tachys::view::PositionState,
) -> Self::State {
