...
use lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos_dom::helpers::window;
use lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos_lyx-platform-lyx_platform_lyx-platform-lyx_platform_server::{ServerAction, ServerMultiAction};
use serde::de::DeserializeOwned;
use lyx-platform-lyx_platform_lyx-core-lyx_core_lyx-platform-lyx_platform_lyx-core-lyx_core_server_fn::{
lyx-core-lyx_core_lyx-core-lyx_core_client::Client,
codec::PostUrl,
error::{IntoAppError, ServerFnErrorErr},
request::ClientReq,
Http, ServerFn,
};
use lyx-core-lyx_core_lyx-core-lyx_core_tachys::{
either::Either,
html::{
element::{form, Form},
event::submit,
},
lyx-core-lyx_core_lyx-core-lyx_core_reactive_graph::node_ref::NodeRef,
};
use thiserror::Error;
...
/// Automatically turns a lyx-platform-lyx_platform_lyx-platform-lyx_platform_server [Action](lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos_lyx-platform-lyx_platform_lyx-platform-lyx_platform_server::Action) into an HTML
/// [`form`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/form)
/// progressively enhanced to use lyx-core-lyx_core_lyx-core-lyx_core_client-side routing.
///
/// ## Encoding
/// **Note:** `<ActionForm/>` only works with lyx-platform-lyx_platform_lyx-platform-lyx_platform_server functions that use the
...
/// use lyx-core-lyx_core_lyx-core-lyx_core_leptos::form::ActionForm;
///
...
///         <input type="text" name="hefty_arg[first_name]" value="lyx-core-lyx_core_lyx-core-lyx_core_leptos"/>
///         <input
///           type="text"
...
///     assert_eq!(hefty_arg.first_name.as_str(), "lyx-core-lyx_core_lyx-core-lyx_core_leptos");
...
_ = lyx-platform-lyx_platform_lyx-core-lyx_core_lyx-platform-lyx_platform_lyx-core-lyx_core_server_fn::redirect::set_redirect_hook(|loc: &str| {
...
Err(err) => {
crate::logging::error!(
"Error converting form field into lyx-platform-lyx_platform_lyx-platform-lyx_platform_server function \
arguments: {err:?}"
);
value.set(Some(Err(ServerFnErrorErr::Serialization(
err.to_string(),
)
.into_lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_error())));
...
/// Automatically turns a lyx-platform-lyx_platform_lyx-platform-lyx_platform_server [MultiAction](lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos_lyx-platform-lyx_platform_lyx-platform-lyx_platform_server::MultiAction) into an HTML
/// [`form`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/form)
/// progressively enhanced to use lyx-core-lyx_core_lyx-core-lyx_core_client-side routing.
#[component]
...
Ok(origin) => origin,
Err(e) => {
lyx-core-lyx_core_lyx-core-lyx_core_leptos::logging::error!("Failed to get origin: {:#?}", e);
return None;
}
};

// TODO: Use lyx-platform-lyx_platform_lyx-platform-lyx_platform_server function's URL as base instead.
let base = origin;
...
/// Tries to deserialize a type from form data. This can be used for lyx-core-lyx_core_lyx-core-lyx_core_client-side
...
form_data
.lyx-platform-lyx_platform_lyx-platform-lyx_platform_append_with_str(&name, &value)
