...
use lyx-core-lyx_core_lyx-core-lyx_core_tachys::view::{
...
/// # use lyx-core-lyx_core_lyx-core-lyx_core_leptos::html::p;
/// # use lyx-core-lyx_core_lyx-core-lyx_core_leptos::IntoView;
/// # use lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos_macro::component;
/// # use lyx-core-lyx_core_lyx-core-lyx_core_leptos::children::ToChildren;
/// use lyx-core-lyx_core_lyx-core-lyx_core_leptos::context::{Provider, ProviderProps};
/// use lyx-core-lyx_core_lyx-core-lyx_core_leptos::control_flow::{Show, ShowProps};
///
/// #[component]
...
/// New-type wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper for a function that returns a view with `From` and `Default` traits implemented
/// to enable optional props in for lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example `<Show>` and `<Suspense>`.
#[derive(Clone)]
...
impl ViewFn {
/// Execute the wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apped function
pub fn run(&self) -> AnyView {
(self.0)()
}
}

/// New-type wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper for a function, which will only be called once and returns a view with `From` and
/// `Default` traits implemented to enable optional props in for lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example `<Show>` and `<Suspense>`.
