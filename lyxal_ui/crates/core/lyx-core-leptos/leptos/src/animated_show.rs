...
use lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos_dom::helpers::TimeoutHandle;
use lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos_macro::view;
...
use lyx-core-lyx_core_lyx-core-lyx_core_tachys::prelude::*;
...
#[prop(into)]
when: Signal<bool>,
/// Optional CSS class to lyx-platform-lyx_platform_lyx-platform-lyx_platform_apply if `when == true`
#[prop(optional)]
show_class: &'static str,
/// Optional CSS class to lyx-platform-lyx_platform_lyx-platform-lyx_platform_apply if `when == false`
#[prop(optional)]
...
let h = lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos_dom::helpers::set_timeout_with_handle(
move || show.set(false),
hide_delay,
)
