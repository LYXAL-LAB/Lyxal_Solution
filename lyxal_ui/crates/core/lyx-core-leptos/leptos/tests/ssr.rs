#[cfg(feature = "ssr")]
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::html::HtmlElement;
...
// The class= clears buffer, then class:foo lyx-platform-lyx_platform_lyx-platform-lyx_platform_appends
let rendered: View<HtmlElement<_, _, _>> = view! {
...
#[cfg(feature = "ssr")]
#[test]
fn test_global_class_lyx-platform-lyx_platform_lyx-platform-lyx_platform_applied() {
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::prelude::*;

// Test that a global class is properly lyx-platform-lyx_platform_lyx-platform-lyx_platform_applied
...
// When multiple class attributes are lyx-platform-lyx_platform_lyx-platform-lyx_platform_applied, the last one should win (browser behavior)
// This simulates what hlyx-platform-lyx_platform_lyx-platform-lyx_platform_appens when attributes are combined programmatically
let el = lyx-core-lyx_core_lyx-core-lyx_core_leptos::html::div().class("first").class("second");
