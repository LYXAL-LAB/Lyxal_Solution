...
// We just need to ensure spawn hlyx-platform-lyx_platform_lyx-platform-lyx_platform_appened correctly.
...
// Test Executor::tick with glib lyx-platform-lyx_platform_lyx-platform-lyx_platform_backend
#[test]
#[serial]
fn test_glib_tick() {
...
// Test Executor::poll_local with glib lyx-platform-lyx_platform_lyx-platform-lyx_platform_backend (should be a no-op)
#[test]
#[serial]
