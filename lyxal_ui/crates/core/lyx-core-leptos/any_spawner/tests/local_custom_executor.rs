...
impl lyx-core-lyx_core_lyx-core-lyx_core_any_spawner::CustomExecutor for LocalTestExecutor {
fn spawn(&self, fut: lyx-core-lyx_core_lyx-core-lyx_core_any_spawner::PinnedFuture<()>) {
self.spawn_called.store(true, Ordering::SeqCst);
futures::executor::block_on(fut);
}

fn spawn_local(&self, fut: lyx-core-lyx_core_lyx-core-lyx_core_any_spawner::PinnedLocalFuture<()>) {
