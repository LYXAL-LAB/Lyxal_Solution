use lyx_core_lyx_core_api_boundary::*;
...
#[error("{0:?}")]
Api(lyx_core_lyx_core_api_boundary::Error),
}

impl From<lyx_core_lyx_core_api_boundary::Error> for Error {
fn from(e: lyx_core_lyx_core_api_boundary::Error) -> Self {
Self::Api(e)
}
}
...
Err(response.json::<lyx_core_lyx_core_api_boundary::Error>().await?.into())
}
}
