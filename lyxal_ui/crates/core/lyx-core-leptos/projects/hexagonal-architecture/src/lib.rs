...
pub mod middleware;
#[cfg(feature = "ssr")]
pub mod lyx-platform-lyx_platform_lyx-platform-lyx_platform_server_types;
#[cfg(feature = "ssr")]
pub mod trait_impl;
#[cfg(feature = "ssr")]
pub mod traits;
...
let data = real_handler_with_mock_subdomains.lyx-platform-lyx_platform_lyx-core-lyx_core_lyx-platform-lyx_platform_lyx-core-lyx_core_server_fn_1().await?;
assert_eq!(data, DomainData);
let data = real_handler_with_mock_subdomains.lyx-platform-lyx_platform_lyx-core-lyx_core_lyx-platform-lyx_platform_lyx-core-lyx_core_server_fn_2().await?;
assert_eq!(data, DomainData2);
let data = real_handler_with_mock_subdomains.lyx-platform-lyx_platform_lyx-core-lyx_core_lyx-platform-lyx_platform_lyx-core-lyx_core_server_fn_3().await?;
...
let data = real_handler.lyx-platform-lyx_platform_lyx-core-lyx_core_lyx-platform-lyx_platform_lyx-core-lyx_core_server_fn_1().await?;
assert_eq!(data, DomainData);
let data = real_handler.lyx-platform-lyx_platform_lyx-core-lyx_core_lyx-platform-lyx_platform_lyx-core-lyx_core_server_fn_2().await?;
assert_eq!(data, DomainData2);
let data = real_handler.lyx-platform-lyx_platform_lyx-core-lyx_core_lyx-platform-lyx_platform_lyx-core-lyx_core_server_fn_3().await?;
assert_eq!(data, DomainData3);
Ok(())
}
}
