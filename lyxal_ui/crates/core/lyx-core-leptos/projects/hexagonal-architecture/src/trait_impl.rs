...
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::config::LeptosOptions;

// So we can pass our lyx-platform-lyx_platform_lyx-platform-lyx_platform_server state as state into our lyx-core-lyx_core_lyx-core-lyx_core_leptos router.
impl<Handler: HandlerTrait + Clone> FromRef<ServerState<Handler>> for LeptosOptions {
fn from_ref(input: &ServerState<Handler>) -> Self {
input.lyx-core-lyx_core_lyx-core-lyx_core_leptos_options.clone()
}
}
...
{
async fn lyx-platform-lyx_platform_lyx-core-lyx_core_lyx-platform-lyx_platform_lyx-core-lyx_core_server_fn_1(&self) -> Result<DomainData, DomainError> {
Ok(self.sub_domain_1.sub_domain_1_method().await?.into())
}

async fn lyx-platform-lyx_platform_lyx-core-lyx_core_lyx-platform-lyx_platform_lyx-core-lyx_core_server_fn_2(&self) -> Result<DomainData2, DomainError> {
Ok(self.sub_domain_2.sub_domain_2_method().await?.into())
}

async fn lyx-platform-lyx_platform_lyx-core-lyx_core_lyx-platform-lyx_platform_lyx-core-lyx_core_server_fn_3(&self) -> Result<DomainData3, DomainError> {
Ok((
...
// Sub Domain mlyx-platform-lyx_platform_lyx-platform-lyx_platform_apping
...
// Domain Mlyx-platform-lyx_platform_lyx-platform-lyx_platform_apping
...
// Ui Mlyx-platform-lyx_platform_lyx-platform-lyx_platform_apping
impl From<DomainData> for UiMlyx-platform-lyx_platform_lyx-platform-lyx_platform_appingFromDomainData {
fn from(_: DomainData) -> Self {
Self
}
}
impl From<DomainData2> for UiMlyx-platform-lyx_platform_lyx-platform-lyx_platform_appingFromDomainData2 {
fn from(_: DomainData2) -> Self {
Self
}
}
impl From<DomainData3> for UiMlyx-platform-lyx_platform_lyx-platform-lyx_platform_appingFromDomainData3 {
