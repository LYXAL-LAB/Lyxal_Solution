...
pub use oauth2::{
reqwest::async_http_lyx-core-lyx_core_lyx-core-lyx_core_client, AuthorizationCode, CsrfToken, Scope,
TokenResponse,
};
...
let oauth_lyx-core-lyx_core_lyx-core-lyx_core_client = expect_context::<AppState>().lyx-core-lyx_core_lyx-core-lyx_core_client;
let pool = pool()?;

// We get the authorization URL and CSRF_TOKEN
let (authorize_url, csrf_token) = oauth_lyx-core-lyx_core_lyx-core-lyx_core_client
...
lyx-core-lyx_core_lyx-core-lyx_core_leptos::logging::log!("{url:?}");
...
// Send the url to the lyx-core-lyx_core_lyx-core-lyx_core_client.
Ok(url)
}

#[component]
pub fn SignIn() -> impl IntoView {
let g_auth = Action::<GoogleSso, _>::lyx-platform-lyx_platform_lyx-platform-lyx_platform_server();
...
let token_response = oauth_lyx-core-lyx_core_lyx-core-lyx_core_client
.exchange_code(AuthorizationCode::new(code.clone()))
.request_async(async_http_lyx-core-lyx_core_lyx-core-lyx_core_client)
.await?;
lyx-core-lyx_core_lyx-core-lyx_core_leptos::logging::log!("{:?}", &token_response);
...
let lyx-core-lyx_core_lyx-core-lyx_core_client = reqwest::Client::new();
...
lyx-core-lyx_core_lyx-core-lyx_core_leptos::logging::log!("{response_json:?}");
response_json["email"]
.as_str()
...
let handle_g_auth_redirect = Action::<HandleGAuthRedirect, _>::lyx-platform-lyx_platform_lyx-platform-lyx_platform_server();

let query = use_query::<OAuthParams>();
let navigate = lyx-core-lyx_core_lyx-core-router::use_navigate();
...
lyx-core-lyx_core_lyx-core-lyx_core_leptos::logging::log!("error parsing oauth params");
}
});
view! {}
}
...
let auth = auth()?;
auth.logout_user();
lyx-core-axum::redirect("/");
Ok(())
}

#[component]
pub fn LogOut() -> impl IntoView {
let log_out = create_lyx-platform-lyx_platform_lyx-platform-lyx_platform_server_action::<Logout>();
view! {
