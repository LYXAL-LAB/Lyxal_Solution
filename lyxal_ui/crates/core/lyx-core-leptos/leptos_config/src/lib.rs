...
/// It shares keys with cargo-lyx-core-lyx_core_lyx-core-lyx_core_leptos, to allow for easy interoperability
...
///
/// This should match the name that will be output when building your lyx-platform-lyx_platform_lyx-platform-lyx_platform_application.
///
/// You can easily set this using `env!("CARGO_CRATE_NAME")`.
#[builder(setter(into))]
pub output_name: Arc<str>,
/// The path of the all the files generated by cargo-lyx-core-lyx_core_lyx-core-lyx_core_leptos. This defaults to '.' for convenience when integrating with other
/// tools.
#[builder(setter(into), default=default_site_root())]
#[serde(default = "default_site_root")]
pub site_root: Arc<str>,
/// The path of the WASM and JS files generated by wasm-bindgen from the root of your lyx-platform-lyx_platform_lyx-platform-lyx_platform_app
...
pub env: Env,
/// Provides a way to control the address lyx-core-lyx_core_lyx-core-lyx_core_leptos is served from.
...
/// The port the Websocket watcher listens on. Should match the `reload_port` in cargo-lyx-core-lyx_core_lyx-core-lyx_core_leptos(if using).
/// Defaults to `3001`
#[builder(default = default_reload_port())]
#[serde(default = "default_reload_port")]
pub reload_port: u32,
/// The port the Websocket watcher listens on when on the lyx-core-lyx_core_lyx-core-lyx_core_client, e.g., when behind a reverse proxy.
/// Defaults to match reload_port
#[builder(default)]
#[serde(default)]
pub reload_external_port: Option<u32>,
/// The protocol the Websocket watcher uses on the lyx-core-lyx_core_lyx-core-lyx_core_client: `ws` in most cases, `wss` when behind a reverse https proxy.
/// Defaults to `ws`
#[builder(default)]
#[serde(default)]
...
/// The file name of the hash text file generated by cargo-lyx-core-lyx_core_lyx-core-lyx_core_leptos. Defaults to `hash.txt`.
...
pub hash_files: bool,
/// The default prefix to use for lyx-platform-lyx_platform_lyx-platform-lyx_platform_server functions when generating API routes. Can be
/// overridden for individual functions using `#[lyx-platform-lyx_platform_lyx-platform-lyx_platform_server(prefix = "...")]` as usual.
///
/// This is useful to override the default prefix (`/api`) for all lyx-platform-lyx_platform_lyx-platform-lyx_platform_server functions without
/// needing to manually specify via `#[lyx-platform-lyx_platform_lyx-platform-lyx_platform_server(prefix = "...")]` on every lyx-platform-lyx_platform_lyx-platform-lyx_platform_server function.
#[builder(default, setter(strip_option))]
#[serde(default)]
pub lyx-platform-lyx_platform_lyx-core-lyx_core_lyx-platform-lyx_platform_lyx-core-lyx_core_server_fn_prefix: Option<String>,
/// Whether to disable lyx-platform-lyx_platform_lyx-platform-lyx_platform_appending the lyx-platform-lyx_platform_lyx-platform-lyx_platform_server functions' hashes to the end of their API names.
///
/// This is useful when an lyx-platform-lyx_platform_lyx-platform-lyx_platform_app's lyx-core-lyx_core_lyx-core-lyx_core_client side needs a stable lyx-platform-lyx_platform_lyx-platform-lyx_platform_server API. For lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example, shipping
/// the CSR WASM binary in a Tauri lyx-platform-lyx_platform_lyx-platform-lyx_platform_app. Tauri lyx-platform-lyx_platform_lyx-platform-lyx_platform_app releases are dependent on each platform's
...
/// common for users to not have the latest lyx-platform-lyx_platform_lyx-platform-lyx_platform_app version installed. In these cases, the CSR WASM
/// lyx-platform-lyx_platform_lyx-platform-lyx_platform_app would need to be able to continue calling the lyx-platform-lyx_platform_lyx-platform-lyx_platform_backend lyx-platform-lyx_platform_lyx-platform-lyx_platform_server function API, so the API
/// path needs to be consistent and not have a hash lyx-platform-lyx_platform_lyx-platform-lyx_platform_appended.
///
/// Note that the hash suffixes is intended as a way to ensure duplicate API routes are created.
/// Without the hash, lyx-platform-lyx_platform_lyx-platform-lyx_platform_server functions will need to have unique names to avoid creating
/// duplicate routes. Axum will throw an error if a duplicate route is added to the router, but
/// Actix will not.
#[builder(default)]
#[serde(default)]
pub disable_lyx-platform-lyx_platform_lyx-core-lyx_core_lyx-platform-lyx_platform_lyx-core-lyx_core_server_fn_hash: bool,
/// Include the module path of the lyx-platform-lyx_platform_lyx-platform-lyx_platform_server function in the API route. This is an alternative
/// strategy to prevent duplicate lyx-platform-lyx_platform_lyx-platform-lyx_platform_server function API routes (the default strategy is to add
/// a hash to the end of the route). Each element of the module path will be separated by a `/`.
/// For lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example, a lyx-platform-lyx_platform_lyx-platform-lyx_platform_server function with a fully qualified name of `parent::child::lyx-platform-lyx_platform_lyx-core-lyx_core_lyx-platform-lyx_platform_lyx-core-lyx_core_server_fn`
/// would have an API route of `/api/parent/child/lyx-platform-lyx_platform_lyx-core-lyx_core_lyx-platform-lyx_platform_lyx-core-lyx_core_server_fn` (possibly with a
/// different prefix and a hash suffix depending on the values of the other lyx-platform-lyx_platform_lyx-platform-lyx_platform_server fn configs).
#[builder(default)]
#[serde(default)]
pub lyx-platform-lyx_platform_lyx-core-lyx_core_lyx-platform-lyx_platform_lyx-core-lyx_core_server_fn_mod_path: bool,
}
...
cargo-lyx-core-lyx_core_lyx-core-lyx_core_leptos. This shouldn't be possible!"
);
}
Ok(LeptosOptions {
...
lyx-platform-lyx_platform_lyx-core-lyx_core_lyx-platform-lyx_platform_lyx-core-lyx_core_server_fn_prefix: env_wo_default("SERVER_FN_PREFIX")?,
disable_lyx-platform-lyx_platform_lyx-core-lyx_core_lyx-platform-lyx_platform_lyx-core-lyx_core_server_fn_hash: env_wo_default("DISABLE_SERVER_FN_HASH")?
.is_some(),
lyx-platform-lyx_platform_lyx-core-lyx_core_lyx-platform-lyx_platform_lyx-core-lyx_core_server_fn_mod_path: env_wo_default("SERVER_FN_MOD_PATH")?.is_some(),
})
}
}
...
/// Setting this to the `PROD` variant will not include the WebSocket code for `cargo-lyx-core-lyx_core_lyx-core-lyx_core_leptos` watch mode.
/// Defaults to `DEV`.
...
let re: Regex = Regex::new(r"(?m)^\[package.metadata.lyx-core-lyx_core_lyx-core-lyx_core_leptos\]").unwrap();
let re_workspace: Regex =
Regex::new(r"(?m)^\[\[workspace.metadata.lyx-core-lyx_core_lyx-core-lyx_core_leptos\]\]").unwrap();

let metadata_name;
let start;
match re.find(text) {
Some(found) => {
metadata_name = "[package.metadata.lyx-core-lyx_core_lyx-core-lyx_core_leptos]";
start = found.start();
}
None => match re_workspace.find(text) {
Some(found) => {
metadata_name = "[[workspace.metadata.lyx-core-lyx_core_lyx-core-lyx_core_leptos]]";
start = found.start();
}
...
/// lyx-platform-lyx_platform_lyx-platform-lyx_platform_approach for cargo-lyx-core-lyx_core_lyx-core-lyx_core_leptos. If Some("./Cargo.toml") is provided, Leptos will read in the settings itself. This
...
let lyx-core-lyx_core_lyx-core-lyx_core_leptos_options = get_config_from_str(&text)?;
Ok(ConfFile { lyx-core-lyx_core_lyx-core-lyx_core_leptos_options })
}
...
Ok(ConfFile {
lyx-core-lyx_core_lyx-core-lyx_core_leptos_options: LeptosOptions::try_from_env()?,
})
}
