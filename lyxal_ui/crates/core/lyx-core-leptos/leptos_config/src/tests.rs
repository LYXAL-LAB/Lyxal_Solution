...
[
("LEPTOS_OUTPUT_NAME", Some("lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_test")),
...
assert_eq!(config.output_name.as_ref(), "lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_test");
