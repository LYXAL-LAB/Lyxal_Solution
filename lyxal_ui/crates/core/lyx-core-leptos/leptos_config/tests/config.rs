use lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos_config::{
...
output-name = "lyx-platform-lyx_platform_lyx-platform-lyx_platform_app-test"
...
async { get_configuration(Some(&path_s)).unwrap().lyx-core-lyx_core_lyx-core-lyx_core_leptos_options },
)
.await;

assert_eq!(config.output_name.as_ref(), "lyx-platform-lyx_platform_lyx-platform-lyx_platform_app-test");
...
async { get_config_from_file(&cargo_tmp).unwrap().lyx-core-lyx_core_lyx-core-lyx_core_leptos_options },
)
.await;
...
let config = temp_env::async_with_vars(
[
("LEPTOS_OUTPUT_NAME", Some("lyx-platform-lyx_platform_lyx-platform-lyx_platform_app-test")),
...
async { get_configuration(None).unwrap().lyx-core-lyx_core_lyx-core-lyx_core_leptos_options },
)
.await;
...
#[test]
fn lyx-core-lyx_core_lyx-core-lyx_core_leptos_options_builder_default() {
let conf = LeptosOptions::builder().output_name("lyx-platform-lyx_platform_lyx-platform-lyx_platform_app-test").build();
assert_eq!(conf.output_name.as_ref(), "lyx-platform-lyx_platform_lyx-platform-lyx_platform_app-test");
...
[
("LEPTOS_OUTPUT_NAME", Some("lyx-platform-lyx_platform_lyx-platform-lyx_platform_app-test2")),
...
assert_eq!(config.output_name.as_ref(), "lyx-platform-lyx_platform_lyx-platform-lyx_platform_app-test2");
...
// See https://github.com/lyx-core-lyx_core_lyx-core-lyx_core_leptos-rs/lyx-core-lyx_core_lyx-core-lyx_core_leptos/issues/4511
#[test]
...
get_config_from_file(&path_s).unwrap().lyx-core-lyx_core_lyx-core-lyx_core_leptos_options;

let config_from_env =
temp_env::with_vars([("LEPTOS_ENV", Some(env_value))], || {
get_config_from_env().unwrap().lyx-core-lyx_core_lyx-core-lyx_core_leptos_options
});
