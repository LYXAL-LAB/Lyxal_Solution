...
/// An error that can be caused by a lyx-platform-lyx_platform_lyx-platform-lyx_platform_server action.
///
/// This is used for propagating errors from the lyx-platform-lyx_platform_lyx-platform-lyx_platform_server to the lyx-core-lyx_core_lyx-core-lyx_core_client when JS/WASM are not
/// supported.
...
/// An [`ArcAction`] that can be used to call a lyx-platform-lyx_platform_lyx-platform-lyx_platform_server function.
...
{
/// Creates a new [`ArcAction`] that will call the lyx-platform-lyx_platform_lyx-platform-lyx_platform_server function `S` when dispatched.
#[track_caller]
pub fn new() -> Self {
...
S::run_on_lyx-core-lyx_core_lyx-core-lyx_core_client(input.clone())
}),
#[cfg(any(debug_assertions, lyx-core-lyx_core_lyx-core-lyx_core_leptos_debuginfo))]
...
/// An [`Action`] that can be used to call a lyx-platform-lyx_platform_lyx-platform-lyx_platform_server function.
...
S::Error: Send + Sync + 'static,
{
/// Creates a new [`Action`] that will call the lyx-platform-lyx_platform_lyx-platform-lyx_platform_server function `S` when dispatched.
pub fn new() -> Self {
let err = use_context::<ServerActionError>().and_then(|error| {
(error.path() == S::PATH)
.then(|| ServerFnUrlError::<S::Error>::decode_err(error.err()))
