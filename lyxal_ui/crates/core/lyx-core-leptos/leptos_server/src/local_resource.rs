...
signal::{
guards::{AsyncPlain, Mlyx-platform-lyx_platform_lyx-platform-lyx_platform_apped, ReadGuard},
...
/// A reference-counted resource that only loads its data locally on the lyx-core-lyx_core_lyx-core-lyx_core_client.
...
///
/// This will only begin loading data if you are on the lyx-core-lyx_core_lyx-core-lyx_core_client (i.e., if you do not have the
...
// already have been rendered to html on the lyx-platform-lyx_platform_lyx-platform-lyx_platform_server), but in fact was ignored
// on the lyx-platform-lyx_platform_lyx-platform-lyx_platform_server. the simplest way to avoid this is to ensure that we always
...
/// Synchronously, reactively reads the current value of the resource and lyx-platform-lyx_platform_lyx-platform-lyx_platform_applies the function
...
///
/// This is useful when used with features like lyx-platform-lyx_platform_lyx-platform-lyx_platform_server functions, in conjunction
...
always pending on the lyx-platform-lyx_platform_lyx-platform-lyx_platform_server."
);
}
...
/// A resource that only loads its data locally on the lyx-core-lyx_core_lyx-core-lyx_core_client.
