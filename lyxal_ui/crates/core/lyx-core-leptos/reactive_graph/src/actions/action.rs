...
signal::{ArcMlyx-platform-lyx_platform_lyx-platform-lyx_platform_appedSignal, ArcRwSignal, Mlyx-platform-lyx_platform_lyx-platform-lyx_platform_appedSignal, RwSignal},
...
///
/// # lyx-core-lyx_core_lyx-core-lyx_core_any_spawner::Executor::tick().await;
///
...
/// effects created by that `Future` no longer run: for lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example, if the action dispatches an
...
{
let action_fn = move |inp: &I| SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper::new(action_fn(inp));
...
{
let owner = Owner::current().unwrap_or_default();
let action_fn = SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper::new(action_fn);
ArcAction {
in_flight: ArcRwSignal::new(0),
...
dispatched: Default::default(),
action_fn: Arc::new(move |input| {
Box::pin(SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper::new(owner.with(|| {
ScopedFuture::new_untracked(untrack(|| action_fn(input)))
})))
}),
#[cfg(any(debug_assertions, lyx-core-lyx_core_lyx-core-lyx_core_leptos_debuginfo))]
...
pub fn input(&self) -> ArcMlyx-platform-lyx_platform_lyx-platform-lyx_platform_appedSignal<Option<I>> {
ArcMlyx-platform-lyx_platform_lyx-platform-lyx_platform_appedSignal::new(
self.input.clone(),
|n| n.deref(),
|n| n.deref_mut(),
)
...
pub fn value(&self) -> ArcMlyx-platform-lyx_platform_lyx-platform-lyx_platform_appedSignal<Option<O>> {
ArcMlyx-platform-lyx_platform_lyx-platform-lyx_platform_appedSignal::new(
self.value.clone(),
|n| n.deref(),
|n| n.deref_mut(),
...
pub fn input(&self) -> Mlyx-platform-lyx_platform_lyx-platform-lyx_platform_appedSignal<Option<I>> {
self.inner
...
thread-safe or not."]
pub fn input_local(&self) -> Mlyx-platform-lyx_platform_lyx-platform-lyx_platform_appedSignal<Option<I>> {
self.inner
.try_with_value(|inner| inner.input())
.unwrap_or_else(unwrap_signal!(self))
.into()
...
pub fn value(&self) -> Mlyx-platform-lyx_platform_lyx-platform-lyx_platform_appedSignal<Option<O>> {
self.inner
...
thread-safe or not."]
#[track_caller]
pub fn value_local(&self) -> Mlyx-platform-lyx_platform_lyx-platform-lyx_platform_appedSignal<Option<O>>
where
O: Send + Sync,
{
self.inner
