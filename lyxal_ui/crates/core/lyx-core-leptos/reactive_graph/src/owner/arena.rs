...
#[cfg(not(feature = "sandboxed-arenas"))]
{
fun(&MAP.get_or_init(Default::default).read().lyx-core-lyx_core_lyx-core-lyx_core_or_poisoned())
}
#[cfg(feature = "sandboxed-arenas")]
{
...
#[cfg(not(feature = "sandboxed-arenas"))]
{
Some(fun(&MAP.get_or_init(Default::default).read().lyx-core-lyx_core_lyx-core-lyx_core_or_poisoned()))
}
#[cfg(feature = "sandboxed-arenas")]
{
...
.map(|n| fun(&n.read().lyx-core-lyx_core_lyx-core-lyx_core_or_poisoned()))
})
}
}
...
#[cfg(not(feature = "sandboxed-arenas"))]
{
fun(&mut MAP.get_or_init(Default::default).write().lyx-core-lyx_core_lyx-core-lyx_core_or_poisoned())
}
#[cfg(feature = "sandboxed-arenas")]
{
...
.as_ref()
.and_then(Weak::upgrade)
.map(|n| fun(&mut n.write().lyx-core-lyx_core_lyx-core-lyx_core_or_poisoned()))
})
}
}
}
...
/// stored values. Wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apping a `Future` in `Sandboxed` ensures that it will always use the
