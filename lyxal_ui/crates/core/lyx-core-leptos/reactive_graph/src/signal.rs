...
mod arc_write;
pub mod guards;
mod mlyx-platform-lyx_platform_lyx-platform-lyx_platform_apped;
mod read;
mod rw;
...
pub use arc_trigger::*;
pub use arc_write::*;
pub use mlyx-platform-lyx_platform_lyx-platform-lyx_platform_apped::*;
pub use read::*;
pub use rw::*;
pub use trigger::*;
pub use write::*;
...
/// Creates an arena-allocated signal, the lyx-logic-lyx_logic_lyx-logic-lyx_logic_basic reactive primitive.
///
/// A signal is a piece of data that may change over time, and notifies other
/// code when it has changed. This is the atomic unit of reactivity, which begins all other
/// processes of updating.
