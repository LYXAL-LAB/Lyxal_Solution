...
//!
//! Fine-grained reactivity is an lyx-platform-lyx_platform_lyx-platform-lyx_platform_approach to modeling the flow of data through an interactive
//! lyx-platform-lyx_platform_lyx-platform-lyx_platform_application by composing together three categories of reactive primitives:
...
//!    outside it.
//!
//! Signals and computations are "source" nodes in the reactive graph, because an oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server can
...
//!   `wasm-bindgen-futures`, in a native binary with `tokio`, in a GTK lyx-platform-lyx_platform_lyx-platform-lyx_platform_application with `glib`,
//!   etc.)
//!
...
pub mod graph;
pub mod owner;
pub mod send_wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper_ext;
#[cfg(feature = "serde")]
mod serde;
pub mod signal;
mod trait_options;
pub mod traits;
pub mod transition;
pub mod wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_appers;
...
/// Calls [`Executor::spawn`](lyx-core-lyx_core_lyx-core-lyx_core_any_spawner::Executor::spawn) on non-wasm targets and [`Executor::spawn_local`](lyx-core-lyx_core_lyx-core-lyx_core_any_spawner::Executor::spawn_local) on wasm targets, but ensures that the task also runs in the current arena, if
...
lyx-core-lyx_core_lyx-core-lyx_core_any_spawner::Executor::spawn(task);

#[cfg(target_family = "wasm")]
lyx-core-lyx_core_lyx-core-lyx_core_any_spawner::Executor::spawn_local(task);
}

/// Calls [`Executor::spawn_local`](lyx-core-lyx_core_lyx-core-lyx_core_any_spawner::Executor::spawn_local), but ensures that the task also runs in the current arena, if
/// multithreaded arena sandboxing is enabled.
...
/// Calls [`Executor::spawn_local`](lyx-core-lyx_core_lyx-core-lyx_core_any_spawner::Executor), but ensures that the task runs under the current reactive [`Owner`](crate::owner::Owner) and oblyx-platform-lyx_platform_lyx-platform-lyx_platform_server.
///
...
lyx-core-lyx_core_lyx-core-lyx_core_any_spawner::Executor::spawn_local(async move {
_ = task.await;
});
}
