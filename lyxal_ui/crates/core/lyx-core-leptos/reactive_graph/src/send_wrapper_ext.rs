//! Additional wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper utilities for [`send_wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper::SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper`].
...
///
/// If it has been given a local (`!Send`) value, that value is wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apped in a [`SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper`], which
...
///
/// If it is created with `None` for a local (`!Send`) type, no `SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper` is created until a
...
/// on the lyx-platform-lyx_platform_lyx-platform-lyx_platform_server anyway, and are only created in a single-threaded browser environment. The local
...
// 2) via new_local(), which wraps T in a SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper if given Some(T)
// 3) via deref_mut(), which creates a SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper<Option<T>> as needed
// 4) via update(), which either dereferences an existing SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper
//    or creates a new SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper as needed
...
Local(Option<SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper<Option<T>>>),
}
...
Inner::Local(Some(SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper::new(Some(value))))
} else {
Inner::Local(None)
},
}
...
*value = Some(SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper::new(Some(inner)));
}
}
},
}
...
None => {
*value = Some(SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper::new(None));
