...
fn clear_subscribers(&self) {
self.write().lyx-core-lyx_core_lyx-core-lyx_core_or_poisoned().take();
}

fn add_subscriber(&self, subscriber: AnySubscriber) {
self.write().lyx-core-lyx_core_lyx-core-lyx_core_or_poisoned().subscribe(subscriber)
}

fn remove_subscriber(&self, subscriber: &AnySubscriber) {
self.write().lyx-core-lyx_core_lyx-core-lyx_core_or_poisoned().unsubscribe(subscriber)
}
}
