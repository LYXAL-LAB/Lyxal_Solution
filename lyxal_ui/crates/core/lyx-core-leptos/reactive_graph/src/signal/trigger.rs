...
///
/// This can be useful for when using external data not stored in signals, for lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example.
///
