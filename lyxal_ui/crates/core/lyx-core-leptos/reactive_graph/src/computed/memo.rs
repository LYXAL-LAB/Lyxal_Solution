...
/// # use lyx-core-lyx_core_lyx-core-lyx_core_reactive_graph::computed::Memo;
...
{
type Value =
ReadGuard<T, Mlyx-platform-lyx_platform_lyx-platform-lyx_platform_apped<Plain<Option<<S as Storage<T>>::Wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apped>>, T>>;
