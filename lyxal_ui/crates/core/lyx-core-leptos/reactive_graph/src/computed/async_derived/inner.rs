...
let lock = self.read().lyx-core-lyx_core_lyx-core-lyx_core_or_poisoned();
...
self.write().lyx-core-lyx_core_lyx-core-lyx_core_or_poisoned().subscribers.subscribe(subscriber);
}
...
self.write().lyx-core-lyx_core_lyx-core-lyx_core_or_poisoned().subscribers.take();
}
}
