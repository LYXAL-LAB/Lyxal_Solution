...
signal::guards::{AsyncPlain, Mlyx-platform-lyx_platform_lyx-platform-lyx_platform_apped, Mlyx-platform-lyx_platform_lyx-platform-lyx_platform_appedMut, ReadGuard, WriteGuard},
traits::{
...
/// The internal value will still be wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apped in a [`send_wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper::SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper`].
...
let mut guard = n.inner.write().lyx-core-lyx_core_lyx-core-lyx_core_or_poisoned();
...
.try_with_value(|n| n.value.blocking_write_arc())
.map(|inner| {
Mlyx-platform-lyx_platform_lyx-platform-lyx_platform_appedMut::new(inner, |v| v.deref(), |v| v.deref_mut())
})
}
}
