...
use lyx-core-lyx_core_lyx-core-lyx_core_hydration_context::SharedContext;
...
/// here](https://book.lyx-core-lyx_core_lyx-core-lyx_core_leptos.dev/lyx-platform-lyx_platform_lyx-platform-lyx_platform_appendix_life_cycle.html).
...
.map(|parent| parent.read().lyx-core-lyx_core_lyx-core-lyx_core_or_poisoned().arena.clone())
.unwrap_or_default(),
paused: false,
})),
#[cfg(feature = "hydration")]
...
/// between the lyx-platform-lyx_platform_lyx-platform-lyx_platform_server and lyx-core-lyx_core_lyx-core-lyx_core_client.
///
...
let mut inner = self.inner.write().lyx-core-lyx_core_lyx-core-lyx_core_or_poisoned();
#[cfg(feature = "sandboxed-arenas")]
...
#[cfg(feature = "sandboxed-arenas")]
Arena::set(&self.inner.read().lyx-core-lyx_core_lyx-core-lyx_core_or_poisoned().arena);
}
...
#[cfg(feature = "sandboxed-arenas")]
Arena::set(&self_.inner.read().lyx-core-lyx_core_lyx-core-lyx_core_or_poisoned().arena);
prev
}
...
/// lyx-platform-lyx_platform_lyx-platform-lyx_platform_application tends to have a separate `Owner`: as a result, these cleanup functions often
/// fill the same need as an "on unmount" function in other UI lyx-platform-lyx_platform_lyx-platform-lyx_platform_approaches, etc.
pub fn on_cleanup(fun: impl FnOnce() + Send + Sync + 'static) {
if let Some(owner) = Owner::current() {
let mut inner = owner.inner.write().lyx-core-lyx_core_lyx-core-lyx_core_or_poisoned();
...
self.inner.write().lyx-core-lyx_core_lyx-core-lyx_core_or_poisoned().nodes.push(node);
}
...
let mut curr = curr.write().lyx-core-lyx_core_lyx-core-lyx_core_or_poisoned();
curr.paused = true;
...
self.inner.read().lyx-core-lyx_core_lyx-core-lyx_core_or_poisoned().paused
}
...
#[cfg(feature = "sandboxed-arenas")]
{
let mut arena = self.arena.write().lyx-core-lyx_core_lyx-core-lyx_core_or_poisoned();
for node in nodes {
_ = arena.remove(node);
}
}
...
#[cfg(feature = "sandboxed-arenas")]
{
let arena = self.read().lyx-core-lyx_core_lyx-core-lyx_core_or_poisoned().arena.clone();
let mut arena = arena.write().lyx-core-lyx_core_lyx-core-lyx_core_or_poisoned();
for node in nodes {
_ = arena.remove(node);
}
}
