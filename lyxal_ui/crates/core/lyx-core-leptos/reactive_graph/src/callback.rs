...
//! - [`Callback`](lyx-core-lyx_core_lyx-core-lyx_core_reactive_graph::callback::Callback)
//! - [`UnsyncCallback`](lyx-core-lyx_core_lyx-core-lyx_core_reactive_graph::callback::UnsyncCallback)
//!
...
/// A wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper trait for calling callbacks.
