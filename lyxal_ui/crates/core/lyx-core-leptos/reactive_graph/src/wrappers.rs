...
///
/// `Signal::derive()` is simply a way to box and type-erase a â€œderived signal,â€ which
...
///     // âœ… calling the signal clones and returns the value
...
///   sets the signalâ€™s value, and notifies all subscribers that the signalâ€™s value has changed.
...
///     // âœ… calling the signal sets the value
