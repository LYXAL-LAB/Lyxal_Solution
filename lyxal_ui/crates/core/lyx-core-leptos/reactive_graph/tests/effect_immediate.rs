...
use imports::*;
use lyx-core-lyx_core_lyx-core-lyx_core_reactive_graph::owner::StoredValue;
...
fn test_batch() {
use imports::*;
use lyx-core-lyx_core_lyx-core-lyx_core_reactive_graph::{effect::batch, owner::StoredValue};
