...
) -> Vec<(lyx-core-any_error::ErrorId, lyx-core-any_error::Error)> {
Vec::new()
}
...
fn take_errors(
&self,
) -> Vec<(SerializedDataId, lyx-core-any_error::ErrorId, lyx-core-any_error::Error)> {
Vec::new()
}
...
_error_id: lyx-core-any_error::ErrorId,
_error: lyx-core-any_error::Error,
) {
}
