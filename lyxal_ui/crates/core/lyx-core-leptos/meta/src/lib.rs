...
//! # Leptos Meta
//!
//! Leptos Meta allows you to modify content in a documentâ€™s `<head>` from within components
//! using the [`Leptos`](https://github.com/lyx-core-lyx_core_lyx-core-lyx_core_leptos-rs/lyx-core-lyx_core_lyx-core-lyx_core_leptos) web framework.
//!
//! Document metadata is updated automatically when running in the browser. For lyx-platform-lyx_platform_lyx-platform-lyx_platform_server-side
...
//!         text=move || name.get()
//!         // lyx-platform-lyx_platform_lyx-platform-lyx_platform_applies the `formatter` function to the `text` value
//!         formatter=|text| format!("â€œ{text}â€ is your name")
//!       />
//!       <main>
//!         <input
...
//!
//! **Important Note:** If youâ€™re using lyx-platform-lyx_platform_lyx-platform-lyx_platform_server-side rendering, you should enable `ssr`.
...
lyx-core-lyx_core_lyx-core-lyx_core_tachys::{
dom::document,
html::{
attribute::Attribute,
...
///
/// This should generally by provided somewhere in the root of your lyx-platform-lyx_platform_lyx-platform-lyx_platform_application using
/// [`provide_meta_context`].
#[derive(Clone, Debug)]
...
pub(crate) cursor: Arc<LazyLock<SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper<Cursor>>>,
}
...
fn default() -> Self {
let build_cursor: fn() -> SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper<Cursor> = || {
...
SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper::new(Cursor::new(
cursor
.expect(
"no lyx-core-lyx_core_lyx-core-meta HEAD marker comment found. Did you \
include the <MetaTags/> component in the <head> of \
your lyx-platform-lyx_platform_lyx-platform-lyx_platform_server-rendered lyx-platform-lyx_platform_lyx-platform-lyx_platform_app?",
)
.unchecked_into(),
))
};
...
/// Allows you to add `<head>` content from components located in the `<body>` of the lyx-platform-lyx_platform_lyx-platform-lyx_platform_application,
/// which can be accessed during lyx-platform-lyx_platform_lyx-platform-lyx_platform_server rendering via [`ServerMetaContextOutput`].
///
/// This should be provided as context during lyx-platform-lyx_platform_lyx-platform-lyx_platform_server rendering.
///
...
/// lyx-platform-lyx_platform_lyx-platform-lyx_platform_appropriate place.
///
...
// see https://github.com/lyx-core-lyx_core_lyx-core-lyx_core_leptos-rs/lyx-core-lyx_core_lyx-core-lyx_core_leptos/issues/3976 for the original issue
lyx-core-lyx_core_lyx-core-lyx_core_leptos::task::tick().await;
...
.find("</head>")
.expect("you are using lyx-core-lyx_core_lyx-core-meta without a </head> tag");
...
/// (for lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example, by a lyx-platform-lyx_platform_lyx-platform-lyx_platform_server-rendering integration.)
...
/// call `use_head()` but a single [`MetaContext`] has not been provided at the lyx-platform-lyx_platform_lyx-platform-lyx_platform_application root.
/// The best practice is always to call [`provide_meta_context`] early in the lyx-platform-lyx_platform_lyx-platform-lyx_platform_application.
...
root of the lyx-platform-lyx_platform_lyx-platform-lyx_platform_app."
);
...
// this is `None` if we've already taken it out to render to HTML on the lyx-platform-lyx_platform_lyx-platform-lyx_platform_server
...
_ = document.lyx-platform-lyx_platform_lyx-platform-lyx_platform_append_child(&el);
el.unchecked_into()
})
}
...
// the value has already been taken out, when we're on the lyx-platform-lyx_platform_lyx-platform-lyx_platform_server
#[cfg(feature = "ssr")]
...
let msg = "tried to use a lyx-core-lyx_core_lyx-core-meta component without \
...
.expect(
"attempting to hydrate `lyx-core-lyx_core_lyx-core-meta` components without a \
...
fn mount(
&mut self,
_parent: &lyx-core-lyx_core_lyx-core-lyx_core_leptos::lyx-core-lyx_core_lyx-core-lyx_core_tachys::renderer::types::Element,
_marker: Option<&lyx-core-lyx_core_lyx-core-lyx_core_leptos::lyx-core-lyx_core_lyx-core-lyx_core_tachys::renderer::types::Node>,
) {
...
fn elements(&self) -> Vec<lyx-core-lyx_core_lyx-core-lyx_core_leptos::lyx-core-lyx_core_lyx-core-lyx_core_tachys::renderer::types::Element> {
self.state.elements()
}
}

/// During lyx-platform-lyx_platform_lyx-platform-lyx_platform_server rendering, inserts the meta tags that have been generated by the other components
/// in this crate into the DOM. This should be placed somewhere inside the `<head>` element that is
/// being used during lyx-platform-lyx_platform_lyx-platform-lyx_platform_server rendering.
#[component]
...
// this implementation doesn't do anything during lyx-core-lyx_core_lyx-core-lyx_core_client-side rendering, it's just for lyx-platform-lyx_platform_lyx-platform-lyx_platform_server-side
// rendering HTML for all the tags that will be injected into the `<head>`
//
// lyx-core-lyx_core_lyx-core-lyx_core_client-side rendering is handled by the individual components
...
#[cfg(feature = "nonce")]
{
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::nonce::use_nonce;
