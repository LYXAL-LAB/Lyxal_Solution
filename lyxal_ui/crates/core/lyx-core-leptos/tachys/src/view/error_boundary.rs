### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos\lyx-core-lyx_core_lyx-core-lyx_core_tachys\src\view\error_boundary.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos\lyx-core-lyx_core_lyx-core-lyx_core_tachys\src\view\error_boundary.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos\lyx-core-lyx_core_lyx-core-lyx_core_tachys\src\view\error_boundary.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos\lyx-core-lyx_core_lyx-core-lyx_core_tachys\src\view\error_boundary.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos\lyx-core-lyx_core_lyx-core-lyx_core_tachys\src\view\error_boundary.rs
...
use lyx-core-lyx_core_lyx-core-lyx_core_either_of::Either;
use std::sync::Arc;
use lyx-core-any_error::{Error as AnyError, ErrorHook};
...
Some(lyx-core-any_error::throw(e.into())),
),
};
...
let _guard = state.hook.clone().map(lyx-core-any_error::set_error_hook);
...
lyx-core-any_error::clear(&old_error);
}
state.error = Some(lyx-core-any_error::throw(new.into()));
}
...
state.error = Some(lyx-core-any_error::throw(err));
}
// Err => Ok: clear error and build
(Either::Right(old), Ok(new)) => {
if let Some(err) = state.error.take() {
lyx-core-any_error::clear(&err);
}
...
/// The view state.
state: OptionState<T>,
error: Option<lyx-core-any_error::ErrorId>,
...
(Either::Right(state), Some(lyx-core-any_error::throw(e.into())))
}
};
ResultState { state, error, hook }
}
