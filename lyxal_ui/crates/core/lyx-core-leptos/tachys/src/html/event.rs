### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos\lyx-core-lyx_core_lyx-core-lyx_core_tachys\src\html\event.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos\lyx-core-lyx_core_lyx-core-lyx_core_tachys\src\html\event.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos\lyx-core-lyx_core_lyx-core-lyx_core_tachys\src\html\event.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos\lyx-core-lyx_core_lyx-core-lyx_core_tachys\src\html\event.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos\lyx-core-lyx_core_lyx-core-lyx_core_tachys\src\html\event.rs
...
On {
event,
#[cfg(feature = "lyx-core-lyx_core_lyx-core-lyx_core_reactive_graph")]
owner: lyx-core-lyx_core_lyx-core-lyx_core_reactive_graph::owner::Owner::current().unwrap_or_default(),
cb: (!cfg!(feature = "ssr")).then(|| SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper::new(cb)),
}
}
...
event: E,
#[cfg(feature = "lyx-core-lyx_core_lyx-core-lyx_core_reactive_graph")]
owner: lyx-core-lyx_core_lyx-core-lyx_core_reactive_graph::owner::Owner,
cb: Option<SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper<F>>,
}
...
#[cfg(all(debug_assertions, feature = "lyx-core-lyx_core_lyx-core-lyx_core_reactive_graph"))]
let _rx_guard =
lyx-core-lyx_core_lyx-core-lyx_core_reactive_graph::diagnostics::SpecialNonReactiveZone::enter();
#[cfg(feature = "tracing")]
...
#[cfg(not(feature = "lyx-core-lyx_core_lyx-core-lyx_core_reactive_graph"))]
cb.invoke(ev);
...
On {
cb: self.cb.map(|cb| SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper::new(cb.take().into_shared())),
#[cfg(feature = "lyx-core-lyx_core_lyx-core-lyx_core_reactive_graph")]
owner: self.owner,
event: self.event,
}
...
/// Indicates if this event bubbles. For lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example, `click` bubbles,
/// but `focus` does not.
///
...
/// A wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper that tells the framework to handle an event during the capture phase.
...
name: Cow<'static, str>,
options: Option<SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper<web_sys::AddEventListenerOptions>>,
...
/// # use lyx-core-lyx_core_lyx-core-lyx_core_tachys::html;
/// # use lyx-core-lyx_core_lyx-core-lyx_core_tachys::html::event as ev;
...
// It is valid to construct a `SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper` here because
// its inner data will only be accessed in the browser's main thread.
self.options.get_or_insert_with(|| {
SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper::new(web_sys::AddEventListenerOptions::new())
})
}
}
