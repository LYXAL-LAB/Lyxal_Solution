### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos\lyx-core-lyx_core_lyx-core-lyx_core_tachys\src\html\element\elements.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos\lyx-core-lyx_core_lyx-core-lyx_core_tachys\src\html\element\elements.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos\lyx-core-lyx_core_lyx-core-lyx_core_tachys\src\html\element\elements.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos\lyx-core-lyx_core_lyx-core-lyx_core_tachys\src\html\element\elements.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos\lyx-core-lyx_core_lyx-core-lyx_core_tachys\src\html\element\elements.rs
...
/// The `<embed>` HTML element embeds external content at the specified point in the document. This content is provided by an external lyx-platform-lyx_platform_lyx-platform-lyx_platform_application or other source of interactive content such as a browser plug-in.
embed HtmlEmbedElement [height, src, r#type, width] true,
/// The `<hr>` HTML element represents a thematic break between paragraph-level elements: for lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example, a change of scene in a story, or a shift of topic within a section.
...
///	The `<link>` HTML element specifies relationships between the current document and an external resource. This element is most commonly used to link to CSS, but is also used to establish site icons (both "favicon" style icons and icons for the home screen and lyx-platform-lyx_platform_lyx-platform-lyx_platform_apps on mobile devices) among other things.
...
/// The `<article>` HTML element represents a self-contained composition in a document, page, lyx-platform-lyx_platform_lyx-platform-lyx_platform_application, or site, which is intended to be independently distributable or reusable (e.g., in syndication). Examples include: a forum post, a magazine or newspaper article, or a blog entry, a product card, a user-submitted comment, an interactive widget or gadget, or any other independent item of content.
...
/// The `<cite>` HTML element is used to describe a reference to a cited creative work, and must include the title of that work. The reference may be in an abbreviated form according to context-lyx-platform-lyx_platform_lyx-platform-lyx_platform_appropriate conventions related to citation metadata.
...
/// The `<header>` HTML element represents introductory content, typically a group of introductory or navigational alyx-core-lyx_core_lyx-core-lyx_core_ids. It may contain some heading elements but also a logo, a search form, an author name, and other elements.
...
/// The `<main>` HTML element represents the dominant content of the body of a document. The main content area consists of content that is directly related to or expands upon the central topic of a document, or the central functionality of an lyx-platform-lyx_platform_lyx-platform-lyx_platform_application.
...
/// The `<output>` HTML element is a container element into which a site or lyx-platform-lyx_platform_lyx-platform-lyx_platform_app can inject the results of a calculation or the outcome of a user action.
...
/// The `<search>` HTML element is a container representing the parts of the document or lyx-platform-lyx_platform_lyx-platform-lyx_platform_application with form controls or other content related to performing a search or filtering operation.
...
///	The `<style>` HTML element contains style information for a document, or part of a document. It contains CSS, which is lyx-platform-lyx_platform_lyx-platform-lyx_platform_applied to the contents of the document containing the `<style>` element.
...
/// The `<textarea>` HTML element represents a multi-line plain-text editing control, useful when you want to allow users to enter a sizeable amount of free-form text, for lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example a comment on a review or feedback form.
...
/// The `<video>` HTML element embeds a media player which supports video playback into the document. You can use `<video>` for audio content as well, but the audio element may provide a more lyx-platform-lyx_platform_lyx-platform-lyx_platform_appropriate user experience.
