### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos\lyx-core-lyx_core_lyx-core-lyx_core_tachys\src\html\attribute\key.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos\lyx-core-lyx_core_lyx-core-lyx_core_tachys\src\html\attribute\key.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos\lyx-core-lyx_core_lyx-core-lyx_core_tachys\src\html\attribute\key.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos\lyx-core-lyx_core_lyx-core-lyx_core_tachys\src\html\attribute\key.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos\lyx-core-lyx_core_lyx-core-lyx_core_tachys\src\html\attribute\key.rs
...
/// The `accept` attribute specifies a list of types the lyx-platform-lyx_platform_lyx-platform-lyx_platform_server accepts, typically a file type.
accept "accept",
...
alt "alt",
// ARIA
/// The `aria-activedescendant` attribute identifies the currently active element when DOM focus is on a composite widget, textbox, group, or lyx-platform-lyx_platform_lyx-platform-lyx_platform_application.
...
/// The `aria-invalid` attribute indicates the entered value does not conform to the format expected by the lyx-platform-lyx_platform_lyx-platform-lyx_platform_application.
...
//class "class",
/// The `code` attribute specifies the URL of the lyx-platform-lyx_platform_lyx-platform-lyx_platform_applet's class file to be loaded and executed.
code "code",
...
decoding "decoding",
/// The `default` attribute indicates that the track should be enabled unless the user's preferences indicate that another track is more lyx-platform-lyx_platform_lyx-platform-lyx_platform_appropriate.
default "default",
...
is "is",
/// The `ismap` attribute indicates that the image is part of a lyx-platform-lyx_platform_lyx-platform-lyx_platform_server-side image map.
ismap "ismap",
...
nomodule "nomodule",
/// The `nonce` attribute provides a cryptographic nonce to ensure that a script or style is lyx-platform-lyx_platform_lyx-platform-lyx_platform_approved for execution.
nonce "nonce",
...
reversed "reversed",
/// The `role` attribute defines the role of an element in the context of a web lyx-platform-lyx_platform_lyx-platform-lyx_platform_application.
role "role",
...
rowspan "rowspan",
/// The `sandbox` attribute lyx-platform-lyx_platform_lyx-platform-lyx_platform_applies extra restrictions to the content in the `<iframe>`.
sandbox "sandbox",
...
width "width",
/// The `wrap` attribute specifies how the text in a text area is to be wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apped when submitted in a form.
wrap "wrap",
