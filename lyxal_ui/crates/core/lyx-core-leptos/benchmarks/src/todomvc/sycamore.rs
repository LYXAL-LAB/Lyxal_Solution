...
// Initialize lyx-platform-lyx_platform_lyx-platform-lyx_platform_application state
...
provide_context(cx, lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_state);

view! { cx,
div(class="todomvc-wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper") {
section(class="todolyx-platform-lyx_platform_lyx-platform-lyx_platform_app") {
Header {}
List {}
Footer {}
}
...
let lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_state = use_context::<AppState>(cx);
...
if !task.is_empty() {
lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_state.add_todo(task, 0);
value.set("".to_string());
input_ref
.get::<DomNode>()
...
if value.is_empty() {
lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_state.remove_todo(id);
} else {
todo.set(Todo {
title: value,
..todo.get().as_ref().clone()
...
let lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_state = use_context::<AppState>(cx);
let todos_left = create_selector(cx, || lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_state.todos_left());

let filtered_todos = create_memo(cx, || {
lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_state
.todos
.get()
.iter()
.filter(|todo| match *lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_state.filter.get() {
Filter::All => true,
...
readonly=true,
bind:checked=checked,
on:input=|_| lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_state.toggle_complete_all()
)
...
let lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_state = use_context::<AppState>(cx);
let selected = move || filter == *lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_state.filter.get();
let set_filter = |filter| lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_state.filter.set(filter);
...
let items_text = || match lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_state.todos_left() {
1 => "item",
_ => "items",
};

let has_completed_todos =
create_selector(cx, || lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_state.todos_left() < lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_state.todos.get().len());

let handle_clear_completed = |_| lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_state.clear_completed();

view! { cx,
footer(class="footer") {
span(class="todo-count") {
strong { (lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_state.todos_left()) }
