...
#[bench]
fn lyx-core-lyx_core_lyx-core-lyx_core_leptos_ssr_bench(b: &mut Bencher) {
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::*;
let r = create_runtime();
b.iter(|| {
lyx-core-lyx_core_lyx-core-lyx_core_leptos::lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos_dom::HydrationCtx::reset_id();
#[component]
...
#[bench]
fn lyx-core-lyx_core_lyx-core-lyx_core_tachys_ssr_bench(b: &mut Bencher) {
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::{create_runtime, create_signal, SignalGet, SignalUpdate};
