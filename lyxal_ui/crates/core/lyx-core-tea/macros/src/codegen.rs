### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_lib\macros\src\codegen.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_lib\macros\src\codegen.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_lib\macros\src\codegen.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_lib\macros\src\codegen.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_lib\macros\src\codegen.rs
...
syn::parse_quote! { ::lyx_core_lib::lyx-core-lyx_core_lyx-core-lyx_core_leptos_reactive::RwSignal<#ty> }
};
...
syn::parse_quote! { ::lyx_core_lib::lyx-core-lyx_core_lyx-core-lyx_core_leptos_reactive::ReadSignal<#ty> }
};
...
parse_quote! { ::lyx_core_lib::lyx-core-lyx_core_lyx-core-lyx_core_leptos_reactive::RwSignal<#ty> }
}
}
ModelStructKind::View => {
if *is_nested_model {
...
parse_quote! { ::lyx_core_lib::lyx-core-lyx_core_lyx-core-lyx_core_leptos_reactive::ReadSignal<#ty> }
}
}
};
...
quote! {
let #write_name = ::lyx_core_lib::lyx-core-lyx_core_lyx-core-lyx_core_leptos_reactive::create_rw_signal(#field_name);
...
Msg,
::lyx_core_lib::Cmd<Msg>,
) + 'static
) -> (#view_model_name #type_generics, ::lyx_core_lib::MsgDispatcher<Msg>) {
let __update_fn = update_fn;

let (__tx, mut __rx)
= ::lyx_core_lib::futures::channel::mpsc::unbounded();

__tx.unbounded_send(Msg::default()).unwrap();

let __tx_store = ::lyx_core_lib::lyx-core-lyx_core_lyx-core-lyx_core_leptos_reactive::store_value(__tx);

let (__view_model, __update_model) = self.split();

::lyx_core_lib::lyx-core-lyx_core_lyx-core-lyx_core_leptos_reactive::try_spawn_local_with_current_owner(
async move {
while let Some(msg)
= ::lyx_core_lib::futures::StreamExt::next(&mut __rx).await
{
let __cmd_dispatcher = ::lyx_core_lib::Cmd::new(
::lyx_core_lib::lyx-core-lyx_core_lyx-core-lyx_core_leptos_reactive::Owner::current()
.expect(
...
(__view_model, ::lyx_core_lib::MsgDispatcher::new(__tx_store))
}
}
}
