...
```rust
use leptos::*;
use lyx-core-tea::Cmd;

#[derive(Default, lyx-core-tea::Model)]
struct CounterModel {
  counter: usize,
}
...
`lyx-core-tea::Model`, which will derive a few important things:
...
`lyx-core-tea::Model` currently only supports tuple and field structs.
