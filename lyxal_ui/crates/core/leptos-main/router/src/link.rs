...
/// 2) Sets the `aria-current` attribute if this link is the active link (i.e., itâ€™s a link to the page youâ€™re on).
///    This is helpful for accessibility and for styling. For example, maybe you want to set the link a
///    different color if itâ€™s a link to the page youâ€™re currently on.
///
