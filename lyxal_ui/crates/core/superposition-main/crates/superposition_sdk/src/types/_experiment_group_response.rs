...
/// - [`member_experiment_ids`](crate::types::builders::ExperimentGroupResponseBuilder::member_experiment_ids)
...
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("member_experiment_ids", "member_experiment_ids was not specified but it is required when building ExperimentGroupResponse")
)?
,
