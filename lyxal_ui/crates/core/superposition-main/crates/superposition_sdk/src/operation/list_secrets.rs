...
/// Orchestration and serialization glue logic for `ListSecrets`.
...
) -> ::std::result::Result<crate::operation::list_secrets::ListSecretsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_secrets::ListSecretsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::list_secrets::ListSecretsError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::list_secrets::ListSecretsOutput>().expect("correct output type"))
}
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListSecrets {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListSecrets");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListSecretsRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListSecretsResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListSecrets")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(ListSecretsEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_secrets::ListSecretsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_secrets::ListSecretsError>::new());
...
#[derive(Debug)]
struct ListSecretsResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListSecretsResponseDeserializer {
...
crate::protocol_serde::shape_list_secrets::de_list_secrets_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_list_secrets::de_list_secrets_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct ListSecretsRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListSecretsRequestSerializer {
...
let input = input.downcast::<crate::operation::list_secrets::ListSecretsInput>().expect("correct type");
...
::std::write!(output, "/secrets").expect("formatting should succeed");
::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_secrets::ListSecretsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
let builder = crate::protocol_serde::shape_list_secrets::ser_list_secrets_headers(input, builder)?;
...
#[derive(Debug)]
struct ListSecretsEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListSecretsEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"ListSecretsEndpointParamsInterceptor"
}
...
.downcast_ref::<ListSecretsInput>()
.ok_or("failed to downcast to ListSecretsInput")?;
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListSecretsError) for what information is available for the error.")]
...
/// Creates the `ListSecretsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
/// Returns `true` if the error kind is `ListSecretsError::InternalServerError`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListSecretsError {
