...
/// Orchestration and serialization glue logic for `CreateVariable`.
...
) -> ::std::result::Result<crate::operation::create_variable::CreateVariableOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_variable::CreateVariableError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::create_variable::CreateVariableError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::create_variable::CreateVariableOutput>().expect("correct output type"))
}
...
"Superposition.CreateVariable",
"rpc.service" = "Superposition",
"rpc.method" = "CreateVariable",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateVariable {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateVariable");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateVariableRequestSerializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateVariable")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(CreateVariableEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_variable::CreateVariableError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_variable::CreateVariableError>::new());
...
#[derive(Debug)]
struct CreateVariableResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateVariableResponseDeserializer {
...
crate::protocol_serde::shape_create_variable::de_create_variable_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_create_variable::de_create_variable_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct CreateVariableRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateVariableRequestSerializer {
...
let input = input.downcast::<crate::operation::create_variable::CreateVariableInput>().expect("correct type");
...
let builder = crate::protocol_serde::shape_create_variable::ser_create_variable_headers(input, builder)?;
...
let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_variable::ser_create_variable_input(&input)?);
...
#[derive(Debug)]
struct CreateVariableEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateVariableEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"CreateVariableEndpointParamsInterceptor"
}
...
.downcast_ref::<CreateVariableInput>()
.ok_or("failed to downcast to CreateVariableInput")?;
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateVariableError) for what information is available for the error.")]
...
/// Creates the `CreateVariableError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
/// Returns `true` if the error kind is `CreateVariableError::InternalServerError`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateVariableError {
