...
/// Orchestration and serialization glue logic for `GetSecret`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetSecret;
impl GetSecret {
/// Creates a new `GetSecret`
pub fn new() -> Self {
Self
}
pub(crate) async fn orchestrate(
runtime_plugins: &::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins,
input: crate::operation::get_secret::GetSecretInput,
) -> ::std::result::Result<crate::operation::get_secret::GetSecretOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_secret::GetSecretError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::get_secret::GetSecretError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::get_secret::GetSecretOutput>().expect("correct output type"))
}
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetSecret {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetSecret");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetSecretRequestSerializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetSecret")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(GetSecretEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_secret::GetSecretError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_secret::GetSecretError>::new());
...
#[derive(Debug)]
struct GetSecretResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetSecretResponseDeserializer {
...
crate::protocol_serde::shape_get_secret::de_get_secret_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_get_secret::de_get_secret_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct GetSecretRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetSecretRequestSerializer {
...
let input = input.downcast::<crate::operation::get_secret::GetSecretInput>().expect("correct type");
...
let builder = crate::protocol_serde::shape_get_secret::ser_get_secret_headers(input, builder)?;
...
#[derive(Debug)]
struct GetSecretEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetSecretEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"GetSecretEndpointParamsInterceptor"
}
...
.downcast_ref::<GetSecretInput>()
.ok_or("failed to downcast to GetSecretInput")?;
...
/// Error type for the `GetSecretError` operation.
#[non_exhaustive]
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetSecretError) for what information is available for the error.")]
Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GetSecretError {
/// Creates the `GetSecretError::Unhandled` variant from any error type.
...
/// Creates the `GetSecretError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
/// Returns `true` if the error kind is `GetSecretError::ResourceNotFound`.
pub fn is_resource_not_found(&self) -> bool {
matches!(self, Self::ResourceNotFound(_))
}
/// Returns `true` if the error kind is `GetSecretError::InternalServerError`.
pub fn is_internal_server_error(&self) -> bool {
matches!(self, Self::InternalServerError(_))
}
}
impl ::std::error::Error for GetSecretError {
...
impl ::std::fmt::Display for GetSecretError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetSecretError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetSecretError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetSecretError {
