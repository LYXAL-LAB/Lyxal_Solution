...
input: crate::operation::delete_dimension::DeleteDimensionInput,
) -> ::std::result::Result<crate::operation::delete_dimension::DeleteDimensionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_dimension::DeleteDimensionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::delete_dimension::DeleteDimensionError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::delete_dimension::DeleteDimensionOutput>().expect("correct output type"))
}
...
"Superposition.DeleteDimension",
"rpc.service" = "Superposition",
"rpc.method" = "DeleteDimension",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteDimension {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteDimension");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteDimensionRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteDimensionResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteDimension")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(DeleteDimensionEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_dimension::DeleteDimensionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_dimension::DeleteDimensionError>::new());
...
#[derive(Debug)]
struct DeleteDimensionResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteDimensionResponseDeserializer {
...
crate::protocol_serde::shape_delete_dimension::de_delete_dimension_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_delete_dimension::de_delete_dimension_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct DeleteDimensionRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteDimensionRequestSerializer {
...
let input = input.downcast::<crate::operation::delete_dimension::DeleteDimensionInput>().expect("correct type");
...
let builder = crate::protocol_serde::shape_delete_dimension::ser_delete_dimension_headers(input, builder)?;
...
#[derive(Debug)]
struct DeleteDimensionEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteDimensionEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"DeleteDimensionEndpointParamsInterceptor"
}
...
.downcast_ref::<DeleteDimensionInput>()
.ok_or("failed to downcast to DeleteDimensionInput")?;
...
/// Error type for the `DeleteDimensionError` operation.
#[non_exhaustive]
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteDimensionError) for what information is available for the error.")]
...
/// Creates the `DeleteDimensionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
/// Returns `true` if the error kind is `DeleteDimensionError::ResourceNotFound`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteDimensionError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteDimensionError {
