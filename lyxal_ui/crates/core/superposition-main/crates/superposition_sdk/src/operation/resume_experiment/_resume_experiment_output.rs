...
pub struct ResumeExperimentOutput  {
#[allow(missing_docs)] // documentation missing in model
...
impl ResumeExperimentOutput {
/// Creates a new builder-style object to manufacture [`ResumeExperimentOutput`](crate::operation::resume_experiment::ResumeExperimentOutput).
pub fn builder() -> crate::operation::resume_experiment::builders::ResumeExperimentOutputBuilder {
crate::operation::resume_experiment::builders::ResumeExperimentOutputBuilder::default()
}
}

/// A builder for [`ResumeExperimentOutput`](crate::operation::resume_experiment::ResumeExperimentOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ResumeExperimentOutputBuilder {
...
impl ResumeExperimentOutputBuilder {
#[allow(missing_docs)] // documentation missing in model
...
/// Consumes the builder and constructs a [`ResumeExperimentOutput`](crate::operation::resume_experiment::ResumeExperimentOutput).
/// This method will fail if any of the following fields are not set:
/// - [`id`](crate::operation::resume_experiment::builders::ResumeExperimentOutputBuilder::id)
/// - [`created_at`](crate::operation::resume_experiment::builders::ResumeExperimentOutputBuilder::created_at)
/// - [`created_by`](crate::operation::resume_experiment::builders::ResumeExperimentOutputBuilder::created_by)
/// - [`last_modified`](crate::operation::resume_experiment::builders::ResumeExperimentOutputBuilder::last_modified)
/// - [`name`](crate::operation::resume_experiment::builders::ResumeExperimentOutputBuilder::name)
/// - [`experiment_type`](crate::operation::resume_experiment::builders::ResumeExperimentOutputBuilder::experiment_type)
/// - [`override_keys`](crate::operation::resume_experiment::builders::ResumeExperimentOutputBuilder::override_keys)
/// - [`status`](crate::operation::resume_experiment::builders::ResumeExperimentOutputBuilder::status)
/// - [`traffic_percentage`](crate::operation::resume_experiment::builders::ResumeExperimentOutputBuilder::traffic_percentage)
/// - [`context`](crate::operation::resume_experiment::builders::ResumeExperimentOutputBuilder::context)
/// - [`variants`](crate::operation::resume_experiment::builders::ResumeExperimentOutputBuilder::variants)
/// - [`last_modified_by`](crate::operation::resume_experiment::builders::ResumeExperimentOutputBuilder::last_modified_by)
/// - [`description`](crate::operation::resume_experiment::builders::ResumeExperimentOutputBuilder::description)
/// - [`change_reason`](crate::operation::resume_experiment::builders::ResumeExperimentOutputBuilder::change_reason)
pub fn build(self) -> ::std::result::Result<crate::operation::resume_experiment::ResumeExperimentOutput, ::aws_smithy_types::error::operation::BuildError> {
::std::result::Result::Ok(
crate::operation::resume_experiment::ResumeExperimentOutput {
id: self.id
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("id", "id was not specified but it is required when building ResumeExperimentOutput")
)?
,
created_at: self.created_at
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("created_at", "created_at was not specified but it is required when building ResumeExperimentOutput")
)?
,
created_by: self.created_by
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("created_by", "created_by was not specified but it is required when building ResumeExperimentOutput")
)?
,
last_modified: self.last_modified
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("last_modified", "last_modified was not specified but it is required when building ResumeExperimentOutput")
)?
,
name: self.name
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building ResumeExperimentOutput")
)?
,
experiment_type: self.experiment_type
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("experiment_type", "experiment_type was not specified but it is required when building ResumeExperimentOutput")
)?
,
override_keys: self.override_keys
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("override_keys", "override_keys was not specified but it is required when building ResumeExperimentOutput")
)?
,
status: self.status
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building ResumeExperimentOutput")
)?
,
traffic_percentage: self.traffic_percentage
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("traffic_percentage", "traffic_percentage was not specified but it is required when building ResumeExperimentOutput")
)?
,
context: self.context
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("context", "context was not specified but it is required when building ResumeExperimentOutput")
)?
,
variants: self.variants
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("variants", "variants was not specified but it is required when building ResumeExperimentOutput")
)?
,
last_modified_by: self.last_modified_by
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("last_modified_by", "last_modified_by was not specified but it is required when building ResumeExperimentOutput")
)?
,
...
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("description", "description was not specified but it is required when building ResumeExperimentOutput")
)?
,
change_reason: self.change_reason
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("change_reason", "change_reason was not specified but it is required when building ResumeExperimentOutput")
)?
,
