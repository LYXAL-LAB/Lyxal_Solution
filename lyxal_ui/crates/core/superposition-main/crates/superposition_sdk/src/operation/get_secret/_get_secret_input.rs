...
impl GetSecretInput {
/// Creates a new builder-style object to manufacture [`GetSecretInput`](crate::operation::get_secret::GetSecretInput).
pub fn builder() -> crate::operation::get_secret::builders::GetSecretInputBuilder {
crate::operation::get_secret::builders::GetSecretInputBuilder::default()
}
}
