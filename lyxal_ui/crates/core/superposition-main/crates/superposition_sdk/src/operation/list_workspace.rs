...
/// Orchestration and serialization glue logic for `ListWorkspace`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListWorkspace;
impl ListWorkspace {
/// Creates a new `ListWorkspace`
pub fn new() -> Self {
Self
}
pub(crate) async fn orchestrate(
runtime_plugins: &::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins,
input: crate::operation::list_workspace::ListWorkspaceInput,
) -> ::std::result::Result<crate::operation::list_workspace::ListWorkspaceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_workspace::ListWorkspaceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::list_workspace::ListWorkspaceError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::list_workspace::ListWorkspaceOutput>().expect("correct output type"))
}
...
"Superposition.ListWorkspace",
"rpc.service" = "Superposition",
"rpc.method" = "ListWorkspace",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListWorkspace {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListWorkspace");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListWorkspaceRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListWorkspaceResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListWorkspace")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(ListWorkspaceEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_workspace::ListWorkspaceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_workspace::ListWorkspaceError>::new());
...
#[derive(Debug)]
struct ListWorkspaceResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListWorkspaceResponseDeserializer {
...
crate::protocol_serde::shape_list_workspace::de_list_workspace_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_list_workspace::de_list_workspace_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct ListWorkspaceRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListWorkspaceRequestSerializer {
...
let input = input.downcast::<crate::operation::list_workspace::ListWorkspaceInput>().expect("correct type");
...
fn uri_query(_input: &crate::operation::list_workspace::ListWorkspaceInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
let builder = crate::protocol_serde::shape_list_workspace::ser_list_workspace_headers(input, builder)?;
...
#[derive(Debug)]
struct ListWorkspaceEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListWorkspaceEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"ListWorkspaceEndpointParamsInterceptor"
}
...
.downcast_ref::<ListWorkspaceInput>()
.ok_or("failed to downcast to ListWorkspaceInput")?;
...
/// Error type for the `ListWorkspaceError` operation.
#[non_exhaustive]
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListWorkspaceError) for what information is available for the error.")]
Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl ListWorkspaceError {
/// Creates the `ListWorkspaceError::Unhandled` variant from any error type.
...
/// Creates the `ListWorkspaceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
/// Returns `true` if the error kind is `ListWorkspaceError::InternalServerError`.
pub fn is_internal_server_error(&self) -> bool {
matches!(self, Self::InternalServerError(_))
}
}
impl ::std::error::Error for ListWorkspaceError {
...
impl ::std::fmt::Display for ListWorkspaceError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for ListWorkspaceError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListWorkspaceError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListWorkspaceError {
