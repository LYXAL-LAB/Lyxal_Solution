...
let builder = crate::protocol_serde::shape_delete_webhook::ser_delete_webhook_headers(input, builder)?;
...
/// Returns `true` if the error kind is `DeleteWebhookError::ResourceNotFound`.
pub fn is_resource_not_found(&self) -> bool {
matches!(self, Self::ResourceNotFound(_))
}
/// Returns `true` if the error kind is `DeleteWebhookError::InternalServerError`.
