...
fn uri_query(_input: &crate::operation::list_contexts::ListContextsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
let builder = crate::protocol_serde::shape_list_contexts::ser_list_contexts_headers(input, builder)?;
...
/// Returns `true` if the error kind is `ListContextsError::InternalServerError`.
