...
/// Orchestration and serialization glue logic for `AddMembersToGroup`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct AddMembersToGroup;
impl AddMembersToGroup {
/// Creates a new `AddMembersToGroup`
pub fn new() -> Self {
Self
}
...
) -> ::std::result::Result<crate::operation::add_members_to_group::AddMembersToGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::add_members_to_group::AddMembersToGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::add_members_to_group::AddMembersToGroupError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::add_members_to_group::AddMembersToGroupOutput>().expect("correct output type"))
}
...
"Superposition.AddMembersToGroup",
"rpc.service" = "Superposition",
"rpc.method" = "AddMembersToGroup",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AddMembersToGroup {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AddMembersToGroup");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AddMembersToGroupRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AddMembersToGroupResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AddMembersToGroup")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(AddMembersToGroupEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::add_members_to_group::AddMembersToGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::add_members_to_group::AddMembersToGroupError>::new());
...
#[derive(Debug)]
struct AddMembersToGroupResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AddMembersToGroupResponseDeserializer {
...
crate::protocol_serde::shape_add_members_to_group::de_add_members_to_group_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_add_members_to_group::de_add_members_to_group_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct AddMembersToGroupRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AddMembersToGroupRequestSerializer {
...
let input = input.downcast::<crate::operation::add_members_to_group::AddMembersToGroupInput>().expect("correct type");
...
::std::write!(output, "/experiment-groups/{id}/add-members", id = id).expect("formatting should succeed");
...
let builder = crate::protocol_serde::shape_add_members_to_group::ser_add_members_to_group_headers(input, builder)?;
...
let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_add_members_to_group::ser_add_members_to_group_input(&input)?);
...
#[derive(Debug)]
struct AddMembersToGroupEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AddMembersToGroupEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"AddMembersToGroupEndpointParamsInterceptor"
}
...
.downcast_ref::<AddMembersToGroupInput>()
.ok_or("failed to downcast to AddMembersToGroupInput")?;
...
/// Error type for the `AddMembersToGroupError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum AddMembersToGroupError {
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AddMembersToGroupError) for what information is available for the error.")]
Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl AddMembersToGroupError {
/// Creates the `AddMembersToGroupError::Unhandled` variant from any error type.
...
/// Creates the `AddMembersToGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
/// Returns `true` if the error kind is `AddMembersToGroupError::ResourceNotFound`.
pub fn is_resource_not_found(&self) -> bool {
matches!(self, Self::ResourceNotFound(_))
}
/// Returns `true` if the error kind is `AddMembersToGroupError::InternalServerError`.
pub fn is_internal_server_error(&self) -> bool {
matches!(self, Self::InternalServerError(_))
}
}
impl ::std::error::Error for AddMembersToGroupError {
...
impl ::std::fmt::Display for AddMembersToGroupError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for AddMembersToGroupError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for AddMembersToGroupError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AddMembersToGroupError {
...
mod _add_members_to_group_output;
