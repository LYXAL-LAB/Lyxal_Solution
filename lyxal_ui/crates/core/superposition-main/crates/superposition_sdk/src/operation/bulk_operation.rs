...
/// Orchestration and serialization glue logic for `BulkOperation`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct BulkOperation;
impl BulkOperation {
/// Creates a new `BulkOperation`
pub fn new() -> Self {
Self
}
pub(crate) async fn orchestrate(
runtime_plugins: &::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins,
input: crate::operation::bulk_operation::BulkOperationInput,
) -> ::std::result::Result<crate::operation::bulk_operation::BulkOperationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::bulk_operation::BulkOperationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::bulk_operation::BulkOperationError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::bulk_operation::BulkOperationOutput>().expect("correct output type"))
}
...
"Superposition.BulkOperation",
"rpc.service" = "Superposition",
"rpc.method" = "BulkOperation",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BulkOperation {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("BulkOperation");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(BulkOperationRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(BulkOperationResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BulkOperation")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(BulkOperationEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::bulk_operation::BulkOperationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::bulk_operation::BulkOperationError>::new());
...
#[derive(Debug)]
struct BulkOperationResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BulkOperationResponseDeserializer {
...
crate::protocol_serde::shape_bulk_operation::de_bulk_operation_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_bulk_operation::de_bulk_operation_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct BulkOperationRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BulkOperationRequestSerializer {
...
let input = input.downcast::<crate::operation::bulk_operation::BulkOperationInput>().expect("correct type");
...
::std::write!(output, "/context/bulk-operations").expect("formatting should succeed");
...
let builder = crate::protocol_serde::shape_bulk_operation::ser_bulk_operation_headers(input, builder)?;
...
let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_bulk_operation::ser_bulk_operation_input(&input)?);
...
#[derive(Debug)]
struct BulkOperationEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BulkOperationEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"BulkOperationEndpointParamsInterceptor"
}
...
.downcast_ref::<BulkOperationInput>()
.ok_or("failed to downcast to BulkOperationInput")?;
...
/// Error type for the `BulkOperationError` operation.
#[non_exhaustive]
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-BulkOperationError) for what information is available for the error.")]
Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl BulkOperationError {
/// Creates the `BulkOperationError::Unhandled` variant from any error type.
...
/// Creates the `BulkOperationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::retry::ProvideErrorKind for BulkOperationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for BulkOperationError {
