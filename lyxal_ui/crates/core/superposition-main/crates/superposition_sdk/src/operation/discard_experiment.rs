...
/// Orchestration and serialization glue logic for `DiscardExperiment`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DiscardExperiment;
impl DiscardExperiment {
/// Creates a new `DiscardExperiment`
pub fn new() -> Self {
Self
}
...
) -> ::std::result::Result<crate::operation::discard_experiment::DiscardExperimentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::discard_experiment::DiscardExperimentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::discard_experiment::DiscardExperimentError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::discard_experiment::DiscardExperimentOutput>().expect("correct output type"))
}
...
"Superposition.DiscardExperiment",
"rpc.service" = "Superposition",
"rpc.method" = "DiscardExperiment",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DiscardExperiment {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DiscardExperiment");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DiscardExperimentRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DiscardExperimentResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DiscardExperiment")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(DiscardExperimentEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::discard_experiment::DiscardExperimentError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::discard_experiment::DiscardExperimentError>::new());
...
#[derive(Debug)]
struct DiscardExperimentResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DiscardExperimentResponseDeserializer {
...
crate::protocol_serde::shape_discard_experiment::de_discard_experiment_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_discard_experiment::de_discard_experiment_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct DiscardExperimentRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DiscardExperimentRequestSerializer {
...
let input = input.downcast::<crate::operation::discard_experiment::DiscardExperimentInput>().expect("correct type");
...
::std::write!(output, "/experiments/{id}/discard", id = id).expect("formatting should succeed");
...
let builder = crate::protocol_serde::shape_discard_experiment::ser_discard_experiment_headers(input, builder)?;
...
let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_discard_experiment::ser_discard_experiment_input(&input)?);
...
#[derive(Debug)]
struct DiscardExperimentEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DiscardExperimentEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"DiscardExperimentEndpointParamsInterceptor"
}
...
.downcast_ref::<DiscardExperimentInput>()
.ok_or("failed to downcast to DiscardExperimentInput")?;
...
/// Error type for the `DiscardExperimentError` operation.
#[non_exhaustive]
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DiscardExperimentError) for what information is available for the error.")]
Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl DiscardExperimentError {
/// Creates the `DiscardExperimentError::Unhandled` variant from any error type.
...
/// Creates the `DiscardExperimentError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
/// Returns `true` if the error kind is `DiscardExperimentError::ResourceNotFound`.
pub fn is_resource_not_found(&self) -> bool {
matches!(self, Self::ResourceNotFound(_))
}
/// Returns `true` if the error kind is `DiscardExperimentError::InternalServerError`.
pub fn is_internal_server_error(&self) -> bool {
matches!(self, Self::InternalServerError(_))
}
}
impl ::std::error::Error for DiscardExperimentError {
...
impl ::std::fmt::Display for DiscardExperimentError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for DiscardExperimentError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DiscardExperimentError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DiscardExperimentError {
...
mod _discard_experiment_output;
