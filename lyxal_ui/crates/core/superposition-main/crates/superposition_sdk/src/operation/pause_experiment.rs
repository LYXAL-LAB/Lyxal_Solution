...
/// Orchestration and serialization glue logic for `PauseExperiment`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct PauseExperiment;
impl PauseExperiment {
/// Creates a new `PauseExperiment`
pub fn new() -> Self {
Self
}
pub(crate) async fn orchestrate(
runtime_plugins: &::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins,
input: crate::operation::pause_experiment::PauseExperimentInput,
) -> ::std::result::Result<crate::operation::pause_experiment::PauseExperimentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::pause_experiment::PauseExperimentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::pause_experiment::PauseExperimentError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::pause_experiment::PauseExperimentOutput>().expect("correct output type"))
}
...
"Superposition.PauseExperiment",
"rpc.service" = "Superposition",
"rpc.method" = "PauseExperiment",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PauseExperiment {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PauseExperiment");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PauseExperimentRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PauseExperimentResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PauseExperiment")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(PauseExperimentEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::pause_experiment::PauseExperimentError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::pause_experiment::PauseExperimentError>::new());
...
#[derive(Debug)]
struct PauseExperimentResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PauseExperimentResponseDeserializer {
...
crate::protocol_serde::shape_pause_experiment::de_pause_experiment_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_pause_experiment::de_pause_experiment_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct PauseExperimentRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PauseExperimentRequestSerializer {
...
let input = input.downcast::<crate::operation::pause_experiment::PauseExperimentInput>().expect("correct type");
...
::std::write!(output, "/experiments/{id}/pause", id = id).expect("formatting should succeed");
...
let builder = crate::protocol_serde::shape_pause_experiment::ser_pause_experiment_headers(input, builder)?;
...
let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_pause_experiment::ser_pause_experiment_input(&input)?);
...
#[derive(Debug)]
struct PauseExperimentEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PauseExperimentEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"PauseExperimentEndpointParamsInterceptor"
}
...
.downcast_ref::<PauseExperimentInput>()
.ok_or("failed to downcast to PauseExperimentInput")?;
...
/// Error type for the `PauseExperimentError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum PauseExperimentError {
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PauseExperimentError) for what information is available for the error.")]
Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl PauseExperimentError {
/// Creates the `PauseExperimentError::Unhandled` variant from any error type.
...
/// Creates the `PauseExperimentError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
/// Returns `true` if the error kind is `PauseExperimentError::ResourceNotFound`.
pub fn is_resource_not_found(&self) -> bool {
matches!(self, Self::ResourceNotFound(_))
}
/// Returns `true` if the error kind is `PauseExperimentError::InternalServerError`.
pub fn is_internal_server_error(&self) -> bool {
matches!(self, Self::InternalServerError(_))
}
}
impl ::std::error::Error for PauseExperimentError {
...
impl ::std::fmt::Display for PauseExperimentError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for PauseExperimentError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for PauseExperimentError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PauseExperimentError {
