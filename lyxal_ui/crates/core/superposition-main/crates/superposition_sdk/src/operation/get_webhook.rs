...
/// Orchestration and serialization glue logic for `GetWebhook`.
...
input: crate::operation::get_webhook::GetWebhookInput,
) -> ::std::result::Result<crate::operation::get_webhook::GetWebhookOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_webhook::GetWebhookError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::get_webhook::GetWebhookError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::get_webhook::GetWebhookOutput>().expect("correct output type"))
}
...
"Superposition.GetWebhook",
"rpc.service" = "Superposition",
"rpc.method" = "GetWebhook",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetWebhook {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetWebhook");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetWebhookRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetWebhookResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetWebhook")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(GetWebhookEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_webhook::GetWebhookError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_webhook::GetWebhookError>::new());
...
#[derive(Debug)]
struct GetWebhookResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetWebhookResponseDeserializer {
...
crate::protocol_serde::shape_get_webhook::de_get_webhook_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_get_webhook::de_get_webhook_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct GetWebhookRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetWebhookRequestSerializer {
...
let input = input.downcast::<crate::operation::get_webhook::GetWebhookInput>().expect("correct type");
...
::std::write!(output, "/webhook/{name}", name = name).expect("formatting should succeed");
...
let builder = crate::protocol_serde::shape_get_webhook::ser_get_webhook_headers(input, builder)?;
...
#[derive(Debug)]
struct GetWebhookEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetWebhookEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"GetWebhookEndpointParamsInterceptor"
}
...
.downcast_ref::<GetWebhookInput>()
.ok_or("failed to downcast to GetWebhookInput")?;
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetWebhookError) for what information is available for the error.")]
...
/// Creates the `GetWebhookError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetWebhookError {
