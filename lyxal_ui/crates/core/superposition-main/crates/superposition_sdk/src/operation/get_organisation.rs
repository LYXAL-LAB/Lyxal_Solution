...
/// Orchestration and serialization glue logic for `GetOrganisation`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetOrganisation;
impl GetOrganisation {
/// Creates a new `GetOrganisation`
pub fn new() -> Self {
Self
}
pub(crate) async fn orchestrate(
runtime_plugins: &::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins,
input: crate::operation::get_organisation::GetOrganisationInput,
) -> ::std::result::Result<crate::operation::get_organisation::GetOrganisationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_organisation::GetOrganisationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::get_organisation::GetOrganisationError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::get_organisation::GetOrganisationOutput>().expect("correct output type"))
}
...
"Superposition.GetOrganisation",
"rpc.service" = "Superposition",
"rpc.method" = "GetOrganisation",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetOrganisation {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetOrganisation");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetOrganisationRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetOrganisationResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetOrganisation")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(GetOrganisationEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_organisation::GetOrganisationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_organisation::GetOrganisationError>::new());
...
#[derive(Debug)]
struct GetOrganisationResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetOrganisationResponseDeserializer {
...
crate::protocol_serde::shape_get_organisation::de_get_organisation_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_get_organisation::de_get_organisation_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct GetOrganisationRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetOrganisationRequestSerializer {
...
let input = input.downcast::<crate::operation::get_organisation::GetOrganisationInput>().expect("correct type");
...
#[derive(Debug)]
struct GetOrganisationEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetOrganisationEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"GetOrganisationEndpointParamsInterceptor"
}
...
.downcast_ref::<GetOrganisationInput>()
.ok_or("failed to downcast to GetOrganisationInput")?;
...
/// Error type for the `GetOrganisationError` operation.
#[non_exhaustive]
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetOrganisationError) for what information is available for the error.")]
Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GetOrganisationError {
/// Creates the `GetOrganisationError::Unhandled` variant from any error type.
...
/// Creates the `GetOrganisationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetOrganisationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetOrganisationError {
