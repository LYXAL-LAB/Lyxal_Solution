...
/// Orchestration and serialization glue logic for `UpdateOverridesExperiment`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateOverridesExperiment;
impl UpdateOverridesExperiment {
/// Creates a new `UpdateOverridesExperiment`
pub fn new() -> Self {
Self
}
...
) -> ::std::result::Result<crate::operation::update_overrides_experiment::UpdateOverridesExperimentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_overrides_experiment::UpdateOverridesExperimentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::update_overrides_experiment::UpdateOverridesExperimentError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::update_overrides_experiment::UpdateOverridesExperimentOutput>().expect("correct output type"))
}
...
"Superposition.UpdateOverridesExperiment",
"rpc.service" = "Superposition",
"rpc.method" = "UpdateOverridesExperiment",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateOverridesExperiment {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateOverridesExperiment");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateOverridesExperimentRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateOverridesExperimentResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateOverridesExperiment")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(UpdateOverridesExperimentEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_overrides_experiment::UpdateOverridesExperimentError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_overrides_experiment::UpdateOverridesExperimentError>::new());
...
#[derive(Debug)]
struct UpdateOverridesExperimentResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateOverridesExperimentResponseDeserializer {
...
crate::protocol_serde::shape_update_overrides_experiment::de_update_overrides_experiment_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_update_overrides_experiment::de_update_overrides_experiment_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct UpdateOverridesExperimentRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateOverridesExperimentRequestSerializer {
...
let input = input.downcast::<crate::operation::update_overrides_experiment::UpdateOverridesExperimentInput>().expect("correct type");
...
fn uri_base(_input: &crate::operation::update_overrides_experiment::UpdateOverridesExperimentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
::std::write!(output, "/experiments/{id}/overrides", id = id).expect("formatting should succeed");
...
let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_overrides_experiment::ser_update_overrides_experiment_input(&input)?);
...
#[derive(Debug)]
struct UpdateOverridesExperimentEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateOverridesExperimentEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"UpdateOverridesExperimentEndpointParamsInterceptor"
}
...
.downcast_ref::<UpdateOverridesExperimentInput>()
.ok_or("failed to downcast to UpdateOverridesExperimentInput")?;
...
/// Error type for the `UpdateOverridesExperimentError` operation.
#[non_exhaustive]
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateOverridesExperimentError) for what information is available for the error.")]
Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl UpdateOverridesExperimentError {
/// Creates the `UpdateOverridesExperimentError::Unhandled` variant from any error type.
...
/// Creates the `UpdateOverridesExperimentError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::retry::ProvideErrorKind for UpdateOverridesExperimentError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateOverridesExperimentError {
...
mod _update_overrides_experiment_output;
