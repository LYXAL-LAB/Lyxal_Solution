...
/// Orchestration and serialization glue logic for `ListDimensions`.
...
input: crate::operation::list_dimensions::ListDimensionsInput,
) -> ::std::result::Result<crate::operation::list_dimensions::ListDimensionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_dimensions::ListDimensionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::list_dimensions::ListDimensionsError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::list_dimensions::ListDimensionsOutput>().expect("correct output type"))
}
...
"Superposition.ListDimensions",
"rpc.service" = "Superposition",
"rpc.method" = "ListDimensions",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListDimensions {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListDimensions");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListDimensionsRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListDimensionsResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListDimensions")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(ListDimensionsEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_dimensions::ListDimensionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_dimensions::ListDimensionsError>::new());
...
#[derive(Debug)]
struct ListDimensionsResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListDimensionsResponseDeserializer {
...
crate::protocol_serde::shape_list_dimensions::de_list_dimensions_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_list_dimensions::de_list_dimensions_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct ListDimensionsRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListDimensionsRequestSerializer {
...
let input = input.downcast::<crate::operation::list_dimensions::ListDimensionsInput>().expect("correct type");
...
::std::write!(output, "/dimension").expect("formatting should succeed");
::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_dimensions::ListDimensionsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
let builder = crate::protocol_serde::shape_list_dimensions::ser_list_dimensions_headers(input, builder)?;
...
#[derive(Debug)]
struct ListDimensionsEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListDimensionsEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"ListDimensionsEndpointParamsInterceptor"
}
...
.downcast_ref::<ListDimensionsInput>()
.ok_or("failed to downcast to ListDimensionsInput")?;
...
/// Error type for the `ListDimensionsError` operation.
#[non_exhaustive]
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListDimensionsError) for what information is available for the error.")]
...
/// Creates the `ListDimensionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
/// Returns `true` if the error kind is `ListDimensionsError::InternalServerError`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListDimensionsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListDimensionsError {
