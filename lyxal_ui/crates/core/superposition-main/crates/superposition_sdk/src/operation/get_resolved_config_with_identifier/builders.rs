...
pub use crate::operation::get_resolved_config_with_identifier::_get_resolved_config_with_identifier_output::GetResolvedConfigWithIdentifierOutputBuilder;
...
impl crate::operation::get_resolved_config_with_identifier::builders::GetResolvedConfigWithIdentifierInputBuilder {
...
crate::operation::get_resolved_config_with_identifier::GetResolvedConfigWithIdentifierError,
::aws_smithy_runtime_api::client::orchestrator::HttpResponse
>
> {
let mut fluent_builder = client.get_resolved_config_with_identifier();
fluent_builder.inner = self;
fluent_builder.send().await
}
}
/// Fluent builder constructing a request to `GetResolvedConfigWithIdentifier`.
///
...
pub struct GetResolvedConfigWithIdentifierFluentBuilder {
handle: ::std::sync::Arc<crate::client::Handle>,
inner: crate::operation::get_resolved_config_with_identifier::builders::GetResolvedConfigWithIdentifierInputBuilder,
...
crate::operation::get_resolved_config_with_identifier::GetResolvedConfigWithIdentifierOutput,
crate::operation::get_resolved_config_with_identifier::GetResolvedConfigWithIdentifierError,
> for GetResolvedConfigWithIdentifierFluentBuilder
{
fn send(
self,
...
impl GetResolvedConfigWithIdentifierFluentBuilder {
/// Creates a new `GetResolvedConfigWithIdentifierFluentBuilder`.
...
/// Access the GetResolvedConfigWithIdentifier as a reference.
pub fn as_input(&self) -> &crate::operation::get_resolved_config_with_identifier::builders::GetResolvedConfigWithIdentifierInputBuilder {
&self.inner
}
...
pub async fn send(self) -> ::std::result::Result<crate::operation::get_resolved_config_with_identifier::GetResolvedConfigWithIdentifierOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_resolved_config_with_identifier::GetResolvedConfigWithIdentifierError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
let runtime_plugins = crate::operation::get_resolved_config_with_identifier::GetResolvedConfigWithIdentifier::operation_runtime_plugins(
self.handle.runtime_plugins.clone(),
&self.handle.conf,
self.config_override,
);
crate::operation::get_resolved_config_with_identifier::GetResolvedConfigWithIdentifier::orchestrate(&runtime_plugins, input).await
}

/// Consumes this builder, creating a customizable operation that can be modified before being sent.
pub fn customize(
self,
) -> crate::client::customize::CustomizableOperation<crate::operation::get_resolved_config_with_identifier::GetResolvedConfigWithIdentifierOutput, crate::operation::get_resolved_config_with_identifier::GetResolvedConfigWithIdentifierError, Self> {
