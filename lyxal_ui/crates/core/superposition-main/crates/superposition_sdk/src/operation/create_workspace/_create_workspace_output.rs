...
/// - [`organisation_id`](crate::operation::create_workspace::builders::CreateWorkspaceOutputBuilder::organisation_id)
/// - [`organisation_name`](crate::operation::create_workspace::builders::CreateWorkspaceOutputBuilder::organisation_name)
/// - [`workspace_schema_name`](crate::operation::create_workspace::builders::CreateWorkspaceOutputBuilder::workspace_schema_name)
/// - [`workspace_status`](crate::operation::create_workspace::builders::CreateWorkspaceOutputBuilder::workspace_status)
/// - [`workspace_admin_email`](crate::operation::create_workspace::builders::CreateWorkspaceOutputBuilder::workspace_admin_email)
/// - [`created_by`](crate::operation::create_workspace::builders::CreateWorkspaceOutputBuilder::created_by)
/// - [`last_modified_by`](crate::operation::create_workspace::builders::CreateWorkspaceOutputBuilder::last_modified_by)
/// - [`last_modified_at`](crate::operation::create_workspace::builders::CreateWorkspaceOutputBuilder::last_modified_at)
/// - [`created_at`](crate::operation::create_workspace::builders::CreateWorkspaceOutputBuilder::created_at)
/// - [`metrics`](crate::operation::create_workspace::builders::CreateWorkspaceOutputBuilder::metrics)
/// - [`allow_experiment_self_approval`](crate::operation::create_workspace::builders::CreateWorkspaceOutputBuilder::allow_experiment_self_approval)
...
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("workspace_name", "workspace_name was not specified but it is required when building CreateWorkspaceOutput")
)?
,
organisation_id: self.organisation_id
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("organisation_id", "organisation_id was not specified but it is required when building CreateWorkspaceOutput")
)?
,
organisation_name: self.organisation_name
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("organisation_name", "organisation_name was not specified but it is required when building CreateWorkspaceOutput")
)?
,
workspace_schema_name: self.workspace_schema_name
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("workspace_schema_name", "workspace_schema_name was not specified but it is required when building CreateWorkspaceOutput")
)?
,
workspace_status: self.workspace_status
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("workspace_status", "workspace_status was not specified but it is required when building CreateWorkspaceOutput")
)?
,
...
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("created_by", "created_by was not specified but it is required when building CreateWorkspaceOutput")
)?
,
last_modified_by: self.last_modified_by
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("last_modified_by", "last_modified_by was not specified but it is required when building CreateWorkspaceOutput")
)?
,
last_modified_at: self.last_modified_at
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("last_modified_at", "last_modified_at was not specified but it is required when building CreateWorkspaceOutput")
)?
,
created_at: self.created_at
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("created_at", "created_at was not specified but it is required when building CreateWorkspaceOutput")
)?
,
...
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("metrics", "metrics was not specified but it is required when building CreateWorkspaceOutput")
)?
,
allow_experiment_self_approval: self.allow_experiment_self_approval
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("allow_experiment_self_approval", "allow_experiment_self_approval was not specified but it is required when building CreateWorkspaceOutput")
)?
,
auto_populate_control: self.auto_populate_control
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("auto_populate_control", "auto_populate_control was not specified but it is required when building CreateWorkspaceOutput")
)?
,
enable_context_validation: self.enable_context_validation
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("enable_context_validation", "enable_context_validation was not specified but it is required when building CreateWorkspaceOutput")
)?
,
