...
let builder = crate::protocol_serde::shape_get_experiment::ser_get_experiment_headers(input, builder)?;
...
/// Returns `true` if the error kind is `GetExperimentError::ResourceNotFound`.
pub fn is_resource_not_found(&self) -> bool {
matches!(self, Self::ResourceNotFound(_))
}
/// Returns `true` if the error kind is `GetExperimentError::InternalServerError`.
