...
/// Orchestration and serialization glue logic for `UpdateVariable`.
...
) -> ::std::result::Result<crate::operation::update_variable::UpdateVariableOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_variable::UpdateVariableError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::update_variable::UpdateVariableError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::update_variable::UpdateVariableOutput>().expect("correct output type"))
}
...
"Superposition.UpdateVariable",
"rpc.service" = "Superposition",
"rpc.method" = "UpdateVariable",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateVariable {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateVariable");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateVariableRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateVariableResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateVariable")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(UpdateVariableEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_variable::UpdateVariableError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_variable::UpdateVariableError>::new());
...
#[derive(Debug)]
struct UpdateVariableResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateVariableResponseDeserializer {
...
crate::protocol_serde::shape_update_variable::de_update_variable_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_update_variable::de_update_variable_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct UpdateVariableRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateVariableRequestSerializer {
...
let input = input.downcast::<crate::operation::update_variable::UpdateVariableInput>().expect("correct type");
...
fn uri_base(_input: &crate::operation::update_variable::UpdateVariableInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
let builder = crate::protocol_serde::shape_update_variable::ser_update_variable_headers(input, builder)?;
...
let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_variable::ser_update_variable_input(&input)?);
...
#[derive(Debug)]
struct UpdateVariableEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateVariableEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"UpdateVariableEndpointParamsInterceptor"
}
...
.downcast_ref::<UpdateVariableInput>()
.ok_or("failed to downcast to UpdateVariableInput")?;
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateVariableError) for what information is available for the error.")]
...
/// Creates the `UpdateVariableError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
/// Returns `true` if the error kind is `UpdateVariableError::ResourceNotFound`.
pub fn is_resource_not_found(&self) -> bool {
matches!(self, Self::ResourceNotFound(_))
}
/// Returns `true` if the error kind is `UpdateVariableError::InternalServerError`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateVariableError {
