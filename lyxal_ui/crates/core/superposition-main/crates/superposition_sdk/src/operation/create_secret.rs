...
let builder = crate::protocol_serde::shape_create_secret::ser_create_secret_headers(input, builder)?;
...
/// Returns `true` if the error kind is `CreateSecretError::InternalServerError`.
