...
/// Orchestration and serialization glue logic for `DeleteSecret`.
...
) -> ::std::result::Result<crate::operation::delete_secret::DeleteSecretOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_secret::DeleteSecretError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::delete_secret::DeleteSecretError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::delete_secret::DeleteSecretOutput>().expect("correct output type"))
}
...
"Superposition.DeleteSecret",
"rpc.service" = "Superposition",
"rpc.method" = "DeleteSecret",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteSecret {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteSecret");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteSecretRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteSecretResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteSecret")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(DeleteSecretEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_secret::DeleteSecretError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_secret::DeleteSecretError>::new());
...
#[derive(Debug)]
struct DeleteSecretResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteSecretResponseDeserializer {
...
crate::protocol_serde::shape_delete_secret::de_delete_secret_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_delete_secret::de_delete_secret_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct DeleteSecretRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteSecretRequestSerializer {
...
let input = input.downcast::<crate::operation::delete_secret::DeleteSecretInput>().expect("correct type");
...
let builder = crate::protocol_serde::shape_delete_secret::ser_delete_secret_headers(input, builder)?;
...
#[derive(Debug)]
struct DeleteSecretEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteSecretEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"DeleteSecretEndpointParamsInterceptor"
}
...
.downcast_ref::<DeleteSecretInput>()
.ok_or("failed to downcast to DeleteSecretInput")?;
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteSecretError) for what information is available for the error.")]
...
/// Creates the `DeleteSecretError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
/// Returns `true` if the error kind is `DeleteSecretError::ResourceNotFound`.
pub fn is_resource_not_found(&self) -> bool {
matches!(self, Self::ResourceNotFound(_))
}
/// Returns `true` if the error kind is `DeleteSecretError::InternalServerError`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteSecretError {
