...
/// Orchestration and serialization glue logic for `Test`.
...
) -> ::std::result::Result<crate::operation::test::TestOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::test::TestError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::test::TestError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::test::TestOutput>().expect("correct output type"))
}
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for Test {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("Test");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(TestRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(TestResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("Test")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(TestEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::test::TestError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::test::TestError>::new());
...
#[derive(Debug)]
struct TestResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TestResponseDeserializer {
...
crate::protocol_serde::shape_test::de_test_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_test::de_test_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct TestRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TestRequestSerializer {
...
let input = input.downcast::<crate::operation::test::TestInput>().expect("correct type");
...
let input_2 = &_input.stage;
let input_2 = input_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("stage", "cannot be empty or unset"))?;
let stage = ::aws_smithy_http::label::fmt_string(input_2, ::aws_smithy_http::label::EncodingStrategy::Default);
if stage.is_empty() {
return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("stage", "cannot be empty or unset"))
}
::std::write!(output, "/function/{function_name}/{stage}/test", function_name = function_name, stage = stage).expect("formatting should succeed");
...
let builder = crate::protocol_serde::shape_test::ser_test_headers(input, builder)?;
...
let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_test_input::ser_request_http_payload(& input.request)?);
...
#[derive(Debug)]
struct TestEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for TestEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"TestEndpointParamsInterceptor"
}
...
.downcast_ref::<TestInput>()
.ok_or("failed to downcast to TestInput")?;
...
/// Error type for the `TestError` operation.
#[non_exhaustive]
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-TestError) for what information is available for the error.")]
Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl TestError {
/// Creates the `TestError::Unhandled` variant from any error type.
...
/// Creates the `TestError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::retry::ProvideErrorKind for TestError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for TestError {
