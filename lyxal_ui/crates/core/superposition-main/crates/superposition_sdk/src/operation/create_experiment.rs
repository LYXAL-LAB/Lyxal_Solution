...
/// Orchestration and serialization glue logic for `CreateExperiment`.
...
) -> ::std::result::Result<crate::operation::create_experiment::CreateExperimentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_experiment::CreateExperimentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::create_experiment::CreateExperimentError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::create_experiment::CreateExperimentOutput>().expect("correct output type"))
}
...
"Superposition.CreateExperiment",
"rpc.service" = "Superposition",
"rpc.method" = "CreateExperiment",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateExperiment {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateExperiment");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateExperimentRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateExperimentResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateExperiment")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(CreateExperimentEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_experiment::CreateExperimentError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_experiment::CreateExperimentError>::new());
...
#[derive(Debug)]
struct CreateExperimentResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateExperimentResponseDeserializer {
...
crate::protocol_serde::shape_create_experiment::de_create_experiment_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_create_experiment::de_create_experiment_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct CreateExperimentRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateExperimentRequestSerializer {
...
let input = input.downcast::<crate::operation::create_experiment::CreateExperimentInput>().expect("correct type");
...
let builder = crate::protocol_serde::shape_create_experiment::ser_create_experiment_headers(input, builder)?;
...
let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_experiment::ser_create_experiment_input(&input)?);
...
#[derive(Debug)]
struct CreateExperimentEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateExperimentEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"CreateExperimentEndpointParamsInterceptor"
}
...
.downcast_ref::<CreateExperimentInput>()
.ok_or("failed to downcast to CreateExperimentInput")?;
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateExperimentError) for what information is available for the error.")]
...
/// Creates the `CreateExperimentError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
/// Returns `true` if the error kind is `CreateExperimentError::InternalServerError`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateExperimentError {
...
pub use crate::operation::create_experiment::_create_experiment_output::CreateExperimentOutput;

pub use crate::operation::create_experiment::_create_experiment_input::CreateExperimentInput;

mod _create_experiment_input;
