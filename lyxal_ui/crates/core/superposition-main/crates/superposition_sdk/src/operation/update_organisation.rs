...
/// Orchestration and serialization glue logic for `UpdateOrganisation`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateOrganisation;
impl UpdateOrganisation {
/// Creates a new `UpdateOrganisation`
pub fn new() -> Self {
Self
}
...
) -> ::std::result::Result<crate::operation::update_organisation::UpdateOrganisationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_organisation::UpdateOrganisationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::update_organisation::UpdateOrganisationError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::update_organisation::UpdateOrganisationOutput>().expect("correct output type"))
}
...
"Superposition.UpdateOrganisation",
"rpc.service" = "Superposition",
"rpc.method" = "UpdateOrganisation",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateOrganisation {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateOrganisation");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateOrganisationRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateOrganisationResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateOrganisation")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(UpdateOrganisationEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_organisation::UpdateOrganisationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_organisation::UpdateOrganisationError>::new());
...
#[derive(Debug)]
struct UpdateOrganisationResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateOrganisationResponseDeserializer {
...
crate::protocol_serde::shape_update_organisation::de_update_organisation_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_update_organisation::de_update_organisation_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct UpdateOrganisationRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateOrganisationRequestSerializer {
...
let input = input.downcast::<crate::operation::update_organisation::UpdateOrganisationInput>().expect("correct type");
...
::std::write!(output, "/superposition/organisations/{id}", id = id).expect("formatting should succeed");
...
let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_organisation::ser_update_organisation_input(&input)?);
...
#[derive(Debug)]
struct UpdateOrganisationEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateOrganisationEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"UpdateOrganisationEndpointParamsInterceptor"
}
...
.downcast_ref::<UpdateOrganisationInput>()
.ok_or("failed to downcast to UpdateOrganisationInput")?;
...
/// Error type for the `UpdateOrganisationError` operation.
#[non_exhaustive]
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateOrganisationError) for what information is available for the error.")]
Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl UpdateOrganisationError {
/// Creates the `UpdateOrganisationError::Unhandled` variant from any error type.
...
/// Creates the `UpdateOrganisationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::retry::ProvideErrorKind for UpdateOrganisationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateOrganisationError {
...
mod _update_organisation_output;
