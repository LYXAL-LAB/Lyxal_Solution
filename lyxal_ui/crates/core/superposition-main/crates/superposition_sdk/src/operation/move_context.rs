...
/// Orchestration and serialization glue logic for `MoveContext`.
...
) -> ::std::result::Result<crate::operation::move_context::MoveContextOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::move_context::MoveContextError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::move_context::MoveContextError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::move_context::MoveContextOutput>().expect("correct output type"))
}
...
"Superposition.MoveContext",
"rpc.service" = "Superposition",
"rpc.method" = "MoveContext",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for MoveContext {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("MoveContext");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(MoveContextRequestSerializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("MoveContext")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(MoveContextEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::move_context::MoveContextError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::move_context::MoveContextError>::new());
...
#[derive(Debug)]
struct MoveContextResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for MoveContextResponseDeserializer {
...
crate::protocol_serde::shape_move_context::de_move_context_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_move_context::de_move_context_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct MoveContextRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for MoveContextRequestSerializer {
...
let input = input.downcast::<crate::operation::move_context::MoveContextInput>().expect("correct type");
...
::std::write!(output, "/context/move/{id}", id = id).expect("formatting should succeed");
...
let builder = crate::protocol_serde::shape_move_context::ser_move_context_headers(input, builder)?;
...
let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_move_context_input::ser_request_http_payload(& input.request)?);
...
#[derive(Debug)]
struct MoveContextEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for MoveContextEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"MoveContextEndpointParamsInterceptor"
}
...
.downcast_ref::<MoveContextInput>()
.ok_or("failed to downcast to MoveContextInput")?;
...
/// Error type for the `MoveContextError` operation.
#[non_exhaustive]
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-MoveContextError) for what information is available for the error.")]
Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl MoveContextError {
/// Creates the `MoveContextError::Unhandled` variant from any error type.
...
/// Creates the `MoveContextError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
/// Returns `true` if the error kind is `MoveContextError::ResourceNotFound`.
pub fn is_resource_not_found(&self) -> bool {
matches!(self, Self::ResourceNotFound(_))
}
/// Returns `true` if the error kind is `MoveContextError::InternalServerError`.
pub fn is_internal_server_error(&self) -> bool {
matches!(self, Self::InternalServerError(_))
}
}
impl ::std::error::Error for MoveContextError {
...
impl ::std::fmt::Display for MoveContextError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for MoveContextError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for MoveContextError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for MoveContextError {
