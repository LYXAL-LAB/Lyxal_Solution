...
/// Orchestration and serialization glue logic for `ListFunction`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListFunction;
impl ListFunction {
/// Creates a new `ListFunction`
pub fn new() -> Self {
Self
}
pub(crate) async fn orchestrate(
runtime_plugins: &::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins,
input: crate::operation::list_function::ListFunctionInput,
) -> ::std::result::Result<crate::operation::list_function::ListFunctionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_function::ListFunctionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::list_function::ListFunctionError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::list_function::ListFunctionOutput>().expect("correct output type"))
}
...
"Superposition.ListFunction",
"rpc.service" = "Superposition",
"rpc.method" = "ListFunction",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListFunction {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListFunction");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListFunctionRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListFunctionResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListFunction")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(ListFunctionEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_function::ListFunctionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_function::ListFunctionError>::new());
...
#[derive(Debug)]
struct ListFunctionResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListFunctionResponseDeserializer {
...
crate::protocol_serde::shape_list_function::de_list_function_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_list_function::de_list_function_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct ListFunctionRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListFunctionRequestSerializer {
...
let input = input.downcast::<crate::operation::list_function::ListFunctionInput>().expect("correct type");
...
fn uri_query(_input: &crate::operation::list_function::ListFunctionInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
let builder = crate::protocol_serde::shape_list_function::ser_list_function_headers(input, builder)?;
...
#[derive(Debug)]
struct ListFunctionEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListFunctionEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"ListFunctionEndpointParamsInterceptor"
}
...
.downcast_ref::<ListFunctionInput>()
.ok_or("failed to downcast to ListFunctionInput")?;
...
/// Error type for the `ListFunctionError` operation.
#[non_exhaustive]
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListFunctionError) for what information is available for the error.")]
Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl ListFunctionError {
/// Creates the `ListFunctionError::Unhandled` variant from any error type.
...
/// Creates the `ListFunctionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
/// Returns `true` if the error kind is `ListFunctionError::InternalServerError`.
pub fn is_internal_server_error(&self) -> bool {
matches!(self, Self::InternalServerError(_))
}
}
impl ::std::error::Error for ListFunctionError {
...
impl ::std::fmt::Display for ListFunctionError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for ListFunctionError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListFunctionError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListFunctionError {
