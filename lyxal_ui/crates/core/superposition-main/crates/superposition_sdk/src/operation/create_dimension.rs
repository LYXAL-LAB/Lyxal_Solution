...
let builder = crate::protocol_serde::shape_create_dimension::ser_create_dimension_headers(input, builder)?;
...
/// Returns `true` if the error kind is `CreateDimensionError::InternalServerError`.
