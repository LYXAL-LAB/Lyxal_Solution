...
pub(crate) fn de_config_payload(body: &[u8]) -> std::result::Result<::std::option::Option<::aws_smithy_types::Document>, crate::operation::get_resolved_config_with_identifier::GetResolvedConfigWithIdentifierError> {
(!body.is_empty()).then(||{
crate::protocol_serde::shape_document::de_document_payload(body).map_err(crate::operation::get_resolved_config_with_identifier::GetResolvedConfigWithIdentifierError::unhandled)
}).transpose()
}
