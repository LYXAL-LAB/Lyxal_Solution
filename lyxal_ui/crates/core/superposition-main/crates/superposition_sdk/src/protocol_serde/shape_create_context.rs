...
pub fn de_create_context_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_context::CreateContextOutput, crate::operation::create_context::CreateContextError> {
#[allow(unused_mut)]
let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::create_context::CreateContextError::unhandled)?;
...
output = crate::protocol_serde::shape_resource_not_found::de_resource_not_found_json_err(_response_body, output).map_err(crate::operation::create_context::CreateContextError::unhandled)?;
...
output = crate::protocol_serde::shape_internal_server_error::de_internal_server_error_json_err(_response_body, output).map_err(crate::operation::create_context::CreateContextError::unhandled)?;
let output = output.meta(generic);
output.build()
}
;
...
_ => crate::operation::create_context::CreateContextError::generic(generic)
})
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_create_context_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_context::CreateContextOutput, crate::operation::create_context::CreateContextError> {
Ok({
#[allow(unused_mut)]
let mut output = crate::operation::create_context::builders::CreateContextOutputBuilder::default();
output = crate::protocol_serde::shape_create_context::de_create_context(_response_body, output).map_err(crate::operation::create_context::CreateContextError::unhandled)?;
crate::serde_util::create_context_output_output_correct_errors(output).build().map_err(crate::operation::create_context::CreateContextError::unhandled)?
})
}
