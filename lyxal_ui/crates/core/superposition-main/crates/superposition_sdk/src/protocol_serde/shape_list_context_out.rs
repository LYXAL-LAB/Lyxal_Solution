...
pub(crate) fn de_list_context_out<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> ::std::result::Result<Option<::std::vec::Vec::<crate::types::ContextResponse>>, ::aws_smithy_json::deserialize::error::DeserializeError>
