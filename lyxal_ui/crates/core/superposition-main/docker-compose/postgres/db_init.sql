...
ALTER TABLE localorg_dev.experiment_groups ADD COLUMN IF NOT EXISTS buckets JSON[] DEFAULT array_fill(NULL::JSON, ARRAY[100]) NOT NULL CHECK (cardinality(buckets) = 100);

ALTER TABLE localorg_dev.experiment_groups ADD COLUMN IF NOT EXISTS group_type public.group_type DEFAULT 'USER_CREATED';

ALTER TABLE localorg_test.experiment_groups ADD COLUMN IF NOT EXISTS buckets JSON[] DEFAULT array_fill(NULL::JSON, ARRAY[100]) NOT NULL CHECK (cardinality(buckets) = 100);
...
ALTER TABLE localorg_dev.functions
  ...
  USING CASE function_type
        ...
        END,
  ALTER COLUMN function_type SET DEFAULT 'VALUE_VALIDATION';
...
INSERT INTO localorg_dev.functions (
    function_name,
    published_code,
    draft_code,
    description,
...
INSERT INTO localorg_test.functions (
    function_name,
    published_code,
    draft_code,
    description,
