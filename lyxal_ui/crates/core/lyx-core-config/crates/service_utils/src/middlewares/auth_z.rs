### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_service_utils\src\middlewares\auth_z.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_service_utils\src\middlewares\auth_z.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_service_utils\src\middlewares\auth_z.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_service_utils\src\middlewares\auth_z.rs
mod authorization;
...
use no_auth::NoAuth;
use lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_superposition_macros::{forbidden, unexpected_error};
use lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_superposition_types::{InternalUser, User, result as lyx-core-lyx_core_lyx-core-lyx_core_superposition};
...
type Error = lyx-core-lyx_core_lyx-core-lyx_core_superposition::AppError;
...
let resource = match req.lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_data::<Resource>() {
Some(resource) => *resource,
None => {
return Box::pin(async {
Err(unexpected_error!("Resource not found in request lyx-platform-lyx_platform_lyx-platform-lyx_platform_app data."))
});
}
};
...
impl AuthZHandler {
pub async fn init(_kms_lyx-core-lyx_core_lyx-core-lyx_core_client: &Option<Client>, _lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_env: &AppEnv) -> Self {
let ap: Arc<dyn Authorizer> = match get_auth_z_provider().as_str() {
// "CASBIN" => Arc::new(
//     CasbinPolicyEngine::new(kms_lyx-core-lyx_core_lyx-core-lyx_core_client, lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_env, None)
//         .await
//         .unwrap(),
// ),
...
//     CasbinPolicyEngine::management(&kms_lyx-core-lyx_core_lyx-core-lyx_core_client, &lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_env)
//         .await
...
//     &self,
// ) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<Arc<CasbinPolicyEngine>> {
//     match self {
