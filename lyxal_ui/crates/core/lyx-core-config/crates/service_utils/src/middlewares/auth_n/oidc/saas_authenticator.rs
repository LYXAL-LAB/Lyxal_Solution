### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_service_utils\src\middlewares\auth_n\oidc\saas_authenticator.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_service_utils\src\middlewares\auth_n\oidc\saas_authenticator.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_service_utils\src\middlewares\auth_n\oidc\saas_authenticator.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_service_utils\src\middlewares\auth_n\oidc\saas_authenticator.rs
use std::sync::Arc;
...
lyx-core-lyx_core_lyx-core-lyx_core_client: CoreClient,
provider_metadata: CoreProviderMetadata,
lyx-core-lyx_core_lyx-core-lyx_core_client_id: String,
lyx-core-lyx_core_lyx-core-lyx_core_client_secret: String,
base_url: String,
path_prefix: String,
...
issuer_url,
oidcrs::reqwest::async_http_lyx-core-lyx_core_lyx-core-lyx_core_client,
)
.await?;

// Create lyx-core-lyx_core_lyx-core-lyx_core_client
let lyx-core-lyx_core_lyx-core-lyx_core_client = CoreClient::from_provider_metadata(
provider_metadata.clone(),
ClientId::new(lyx-core-lyx_core_lyx-core-lyx_core_client_id.clone()),
Some(ClientSecret::new(lyx-core-lyx_core_lyx-core-lyx_core_client_secret.clone())),
)
...
lyx-core-lyx_core_lyx-core-lyx_core_client_secret,
base_url,
path_prefix,
...
fn get_org_lyx-core-lyx_core_lyx-core-lyx_core_client(&self, org_id: &str) -> Result<CoreClient, String> {
...
provider,
ClientId::new(self.lyx-core-lyx_core_lyx-core-lyx_core_client_id.clone()),
Some(ClientSecret::new(self.lyx-core-lyx_core_lyx-core-lyx_core_client_secret.clone())),
)
...
.claims(&self.lyx-core-lyx_core_lyx-core-lyx_core_client.id_token_verifier(), verify_presence)
...
let lyx-core-lyx_core_lyx-core-lyx_core_client = self
.get_org_lyx-core-lyx_core_lyx-core-lyx_core_client(org_id)
.map_err(|e| format!("Error in getting Org specific lyx-core-lyx_core_lyx-core-lyx_core_client: {e}"))?;
let id_token_verifier = lyx-core-lyx_core_lyx-core-lyx_core_client.id_token_verifier();
...
fn get_lyx-core-lyx_core_lyx-core-lyx_core_client(&self) -> &CoreClient {
&self.lyx-core-lyx_core_lyx-core-lyx_core_client
}
...
web::scope("oidc")
.lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_data(Data::new(self.to_owned()))
...
let lyx-core-lyx_core_lyx-core-lyx_core_client = match self.get_org_lyx-core-lyx_core_lyx-core-lyx_core_client(org_id) {
Ok(lyx-core-lyx_core_lyx-core-lyx_core_client) => lyx-core-lyx_core_lyx-core-lyx_core_client,
Err(e) => {
log::error!("Error in getting Org specific lyx-core-lyx_core_lyx-core-lyx_core_client: {e}");
return Box::pin(async {
Err(ErrorInternalServerError(String::from(
"Error in getting Org specific lyx-core-lyx_core_lyx-core-lyx_core_client",
))
.into())
});
}
...
.request_async(oidcrs::reqwest::async_http_lyx-core-lyx_core_lyx-core-lyx_core_client)
.await
.map_err(|e| {
...
.claims(&lyx-core-lyx_core_lyx-core-lyx_core_client.id_token_verifier(), presence_no_check)
.map_err(|e| {
