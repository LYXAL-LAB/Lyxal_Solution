### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_service_utils\src\service\types.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_service_utils\src\service\types.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_service_utils\src\service\types.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_service_utils\src\service\types.rs
use std::sync::Mutex;
...
use lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_superposition_types::database::models::Workspace;

use crate::db::PgSchemaConnectionPool;

pub struct ExperimentationFlags {
pub allow_same_keys_overllyx-platform-lyx_platform_lyx-platform-lyx_platform_apping_ctx: bool,
pub allow_diff_keys_overllyx-platform-lyx_platform_lyx-platform-lyx_platform_apping_ctx: bool,
pub allow_same_keys_non_overllyx-platform-lyx_platform_lyx-platform-lyx_platform_apping_ctx: bool,
}
...
pub struct AppState {
pub cac_host: String,
pub lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_env: AppEnv,
...
pub lyx-core-lyx_core_lyx-core-lyx_core_superposition_token: String,
#[cfg(feature = "high-performance-mode")]
pub redis: fred::lyx-core-lyx_core_lyx-core-lyx_core_clients::RedisPool,
pub http_lyx-core-lyx_core_lyx-core-lyx_core_client: reqwest::Client,
...
"DEV" => Ok(AppEnv::DEV),
"TEST" => Ok(AppEnv::TEST),
_ => Err("invalid lyx-platform-lyx_platform_lyx-platform-lyx_platform_app env!!".to_string()),
}
}
}
...
fn default() -> Self {
Self(String::from("lyx-core-lyx_core_lyx-core-lyx_core_superposition"))
}
}
...
None => {
log::info!(
"DbConnection-FromRequest: Unable to get lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_data from request"
);
return ready(Err(error::ErrorInternalServerError("")));
}
};

let result = match lyx-platform-lyx_platform_lyx-platform-lyx_platform_app_state.db_pool.get() {
Ok(mut conn) => {
