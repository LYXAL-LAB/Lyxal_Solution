### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_context_aware_config\src\api\config\handlers.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_context_aware_config\src\api\config\handlers.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_context_aware_config\src\api\config\handlers.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_context_aware_config\src\api\config\handlers.rs
...
#[cfg(feature = "high-performance-mode")]
use lyx-core-lyx_core_lyx-core-lyx_core_service_utils::service::types::AppHeader;
...
#[cfg(feature = "high-performance-mode")]
use lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_superposition_macros::response_error;
...
use super::helpers::{lyx-platform-lyx_platform_lyx-platform-lyx_platform_apply_prefix_filter_to_config, resolve, setup_query_data};
...
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<Vec<Map<String, Value>>> {
...
fn get_contextlyx-core-lyx_core_lyx-core-lyx_core_ids_from_overrideid(
contexts: Vec<Context>,
overrides: Map<String, Value>,
key_val: Value,
override_id: &str,
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<Vec<(Context, Map<String, Value>, Value, String)>> {
...
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<PutRequest> {
...
is_lyx-platform-lyx_platform_lyx-platform-lyx_platform_approve: bool,
workspace_context: &WorkspaceContext,
state: &AppState,
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<Config> {
let default_config_val =
default_config
.get(check_key)
.ok_or(lyx-core-lyx_core_lyx-core-lyx_core_superposition::AppError::BadArgument(format!(
...
let context_arr = get_contextlyx-core-lyx_core_lyx-core-lyx_core_ids_from_overrideid(
og_contexts.clone(),
override_value.into(),
...
if *to_be_deleted {
if is_lyx-platform-lyx_platform_lyx-platform-lyx_platform_approve {
...
let is_lyx-platform-lyx_platform_lyx-platform-lyx_platform_approve = req
.headers()
.get("x-lyx-platform-lyx_platform_lyx-platform-lyx_platform_approve")
...
is_lyx-platform-lyx_platform_lyx-platform-lyx_platform_approve,
&workspace_context,
&state,
)
.await?;
...
let lyx-core-lyx_core_lyx-core-lyx_core_client = state.redis.next_connected();
let config = lyx-core-lyx_core_lyx-core-lyx_core_client.get::<String, String>(config_key).await;
let metrics = lyx-core-lyx_core_lyx-core-lyx_core_client.take_latency_metrics();
let network_metrics = lyx-core-lyx_core_lyx-core-lyx_core_client.take_network_latency_metrics();
log::trace!(
...
lyx-core-lyx_core_lyx-core-lyx_core_client.get::<String, String>(last_modified_at_key).await
{
let metrics = lyx-core-lyx_core_lyx-core-lyx_core_client.take_latency_metrics();
let network_metrics = lyx-core-lyx_core_lyx-core-lyx_core_client.take_network_latency_metrics();
log::trace!(
...
if let Ok(audit_id) = lyx-core-lyx_core_lyx-core-lyx_core_client.get::<String, String>(audit_id_key).await {
let metrics = lyx-core-lyx_core_lyx-core-lyx_core_client.take_latency_metrics();
let network_metrics = lyx-core-lyx_core_lyx-core-lyx_core_client.take_network_latency_metrics();
log::trace!(
...
lyx-core-lyx_core_lyx-core-lyx_core_client.get::<Option<i64>, String>(config_version_key).await
{
let metrics = lyx-core-lyx_core_lyx-core-lyx_core_client.take_latency_metrics();
let network_metrics = lyx-core-lyx_core_lyx-core-lyx_core_client.take_network_latency_metrics();
log::trace!(
...
query_filters: lyx-core-lyx_core_lyx-core-lyx_core_superposition_query::Query<ConfigQuery>,
workspace_context: WorkspaceContext,
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<HttpResponse> {
let DbConnection(mut conn) = db_conn;
...
config = lyx-platform-lyx_platform_lyx-platform-lyx_platform_apply_prefix_filter_to_config(&query_filters.prefix, config)?;
let is_smithy: bool;
...
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<Json<PaginatedResponse<ConfigVersionListItem>>> {
let DbConnection(mut conn) = db_conn;
...
db_conn: DbConnection,
version: Path<i64>,
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<Json<ConfigVersion>> {
let DbConnection(mut conn) = db_conn;
