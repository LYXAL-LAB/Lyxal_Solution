### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_context_aware_config\src\api\dimension\validations.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_context_aware_config\src\api\dimension\validations.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_context_aware_config\src\api\dimension\validations.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_context_aware_config\src\api\dimension\validations.rs
...
use lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_superposition_macros::{unexpected_error, validation_error};
...
pub fn allow_primitive_types(schema: &Map<String, Value>) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<()> {
...
fn validate_cohort_jsonschema(schema: &Value) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<Vec<String>> {
...
schema_name: &SchemaName,
conn: &mut DBConnection,
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<Dimension> {
...
return Err(validation_error!(
"Please specify a valid dimension that this cohort can derive from. Refer our API docs for lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples",
));
}
...
"Local cohorts require the jsonlogic rules to be written in the `definitions` field. Refer our API docs for lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_examples",
))?;
