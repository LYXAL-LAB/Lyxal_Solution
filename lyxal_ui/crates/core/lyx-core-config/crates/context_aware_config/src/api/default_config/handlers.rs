### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_context_aware_config\src\api\default_config\handlers.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_context_aware_config\src\api\default_config\handlers.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_context_aware_config\src\api\default_config\handlers.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_context_aware_config\src\api\default_config\handlers.rs
use actix_web::{
...
use lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_superposition_macros::{
...
db_conn: DbConnection,
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<Json<DefaultConfig>> {
let DbConnection(mut conn) = db_conn;
...
.map_err(|e| match e {
lyx-core-lyx_core_lyx-core-lyx_core_superposition::AppError::DbError(diesel::NotFound) => {
bad_argument!(
...
conn: &mut DBConnection,
schema_name: &SchemaName,
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<models::DefaultConfig> {
...
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<Json<PaginatedResponse<DefaultConfig>>> {
let DbConnection(mut conn) = db_conn;
...
pub fn get_key_usage_context_lyx-core-lyx_core_lyx-core-lyx_core_ids(
key: &str,
conn: &mut DBConnection,
schema_name: &SchemaName,
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<Vec<String>> {
...
let mut context_lyx-core-lyx_core_lyx-core-lyx_core_ids = vec![];
for context in result.iter() {
context
.override_
.get(key)
.map_or((), |_| context_lyx-core-lyx_core_lyx-core-lyx_core_ids.push(context.id.to_owned()))
}
Ok(context_lyx-core-lyx_core_lyx-core-lyx_core_ids)
}
...
let context_lyx-core-lyx_core_lyx-core-lyx_core_ids =
get_key_usage_context_lyx-core-lyx_core_lyx-core-lyx_core_ids(&key, &mut conn, &workspace_context.schema_name)
.map_err(|_| unexpected_error!("Something went wrong"))?;
if context_lyx-core-lyx_core_lyx-core-lyx_core_ids.is_empty() {
let resp: Result<HttpResponse, lyx-core-lyx_core_lyx-core-lyx_core_superposition::AppError> =
conn.transaction::<_, lyx-core-lyx_core_lyx-core-lyx_core_superposition::AppError, _>(|transaction_conn| {
...
context_lyx-core-lyx_core_lyx-core-lyx_core_ids.join(",")
))
}
}
