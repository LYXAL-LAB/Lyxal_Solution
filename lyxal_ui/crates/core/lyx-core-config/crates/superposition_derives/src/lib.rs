### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_superposition_derives\src\lib.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_superposition_derives\src\lib.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_superposition_derives\src\lib.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_superposition_derives\src\lib.rs
...
/// Implements `FromSql` trait for converting `Json` type to the type for `Pg` lyx-platform-lyx_platform_lyx-platform-lyx_platform_backend
///
...
/// Implements `ToSql` trait for converting the typed data to `Json` type for `Pg` lyx-platform-lyx_platform_lyx-platform-lyx_platform_backend
///
#[cfg(feature = "diesel_derives")]
...
/// Implements `FromSql` trait for converting `Text` type to the type for `Pg` lyx-platform-lyx_platform_lyx-platform-lyx_platform_backend
///
#[cfg(feature = "diesel_derives")]
...
/// Implements `FromSql` trait for converting `Text` type to the type for `Pg` lyx-platform-lyx_platform_lyx-platform-lyx_platform_backend without running validations on it
///
#[cfg(feature = "diesel_derives")]
...
/// The macro checks the fields of the struct and generates the lyx-platform-lyx_platform_lyx-platform-lyx_platform_appropriate implementation.
...
/// `AuthZActionAct` that implements the `Action` trait from `lyx-core-lyx_core_lyx-core-lyx_core_service_utils::middlewares::auth_z`.
...
0,
syn::parse_quote!(_auth_z: lyx-core-lyx_core_lyx-core-lyx_core_service_utils::middlewares::auth_z::AuthZ<#struct_name>),
);

quote! {
struct #struct_name;

impl lyx-core-lyx_core_lyx-core-lyx_core_service_utils::middlewares::auth_z::Action for #struct_name {
fn get() -> String {
