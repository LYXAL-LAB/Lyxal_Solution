### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_superposition_provider\tests\integration_test.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_superposition_provider\tests\integration_test.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_superposition_provider\tests\integration_test.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_superposition_provider\tests\integration_test.rs
...
/// Helper to create SDK lyx-core-lyx_core_lyx-core-lyx_core_client with bearer token auth
fn create_sdk_lyx-core-lyx_core_lyx-core-lyx_core_client() -> Client {
use lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_superposition_sdk::config::Token;
...
async fn create_organisation(lyx-core-lyx_core_lyx-core-lyx_core_client: &Client) -> String {
let output = lyx-core-lyx_core_lyx-core-lyx_core_client
.create_organisation()
.name("rusttestorg")
...
async fn create_workspace(lyx-core-lyx_core_lyx-core-lyx_core_client: &Client, org_id: &str, workspace_name: &str) {
...
.allow_experiment_self_lyx-platform-lyx_platform_lyx-platform-lyx_platform_approval(true)
...
async fn create_dimensions(lyx-core-lyx_core_lyx-core-lyx_core_client: &Client, org_id: &str, workspace_id: &str) {
...
async fn create_default_configs(lyx-core-lyx_core_lyx-core-lyx_core_client: &Client, org_id: &str, workspace_id: &str) {
...
async fn create_overrides(lyx-core-lyx_core_lyx-core-lyx_core_client: &Client, org_id: &str, workspace_id: &str) {
...
async fn create_experiments(lyx-core-lyx_core_lyx-core-lyx_core_client: &Client, org_id: &str, workspace_id: &str) {
...
.variant_type(lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_superposition_sdk::types::VariantType::Control)
...
.variant_type(lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_superposition_sdk::types::VariantType::Experimental)
...
let lyx-core-lyx_core_lyx-core-lyx_core_client = create_sdk_lyx-core-lyx_core_lyx-core-lyx_core_client();

create_workspace(&lyx-core-lyx_core_lyx-core-lyx_core_client, org_id, workspace_id).await;
create_dimensions(&lyx-core-lyx_core_lyx-core-lyx_core_client, org_id, workspace_id).await;
create_default_configs(&lyx-core-lyx_core_lyx-core-lyx_core_client, org_id, workspace_id).await;
create_overrides(&lyx-core-lyx_core_lyx-core-lyx_core_client, org_id, workspace_id).await;
create_experiments(&lyx-core-lyx_core_lyx-core-lyx_core_client, org_id, workspace_id).await;
...
let price = lyx-core-lyx_core_lyx-core-lyx_core_client
.get_float_value("price", Some(&ctx), None)
.await
.unwrap();
let currency = lyx-core-lyx_core_lyx-core-lyx_core_client
...
assert_eq!(currency, "Rupee", "Currency should be default Rupee");
println!("  âœ“ Experiment test passed ");
}
...
// Create organisation
let lyx-core-lyx_core_lyx-core-lyx_core_client = create_sdk_lyx-core-lyx_core_lyx-core-lyx_core_client();
let org_id = create_organisation(&lyx-core-lyx_core_lyx-core-lyx_core_client).await;
