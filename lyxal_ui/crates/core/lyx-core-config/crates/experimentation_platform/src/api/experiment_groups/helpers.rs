### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_experimentation_platform\src\api\experiment_groups\helpers.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_experimentation_platform\src\api\experiment_groups\helpers.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_experimentation_platform\src\api\experiment_groups\helpers.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_experimentation_platform\src\api\experiment_groups\helpers.rs
...
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<Vec<Experiment>> {
...
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<Vec<i64>> {
let existing_members = HashSet::from_iter(existing_members.to_owned());
...
schema_name: &SchemaName,
user: &User,
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<Json<ExperimentGroup>> {
if req.member_experiment_lyx-core-lyx_core_lyx-core-lyx_core_ids.is_empty() {
return Err(bad_argument!(
...
req.member_experiment_lyx-core-lyx_core_lyx-core-lyx_core_ids = validate_experiment_group_constraints(
member_experiments,
&experiment_group.member_experiment_lyx-core-lyx_core_lyx-core-lyx_core_ids,
...
HashSet::from_iter(experiment_group.member_experiment_lyx-core-lyx_core_lyx-core-lyx_core_ids.clone());
let members_to_remove = HashSet::from_iter(req.member_experiment_lyx-core-lyx_core_lyx-core-lyx_core_ids);
req.member_experiment_lyx-core-lyx_core_lyx-core-lyx_core_ids = current_members
...
let mut member_experiment_lyx-core-lyx_core_lyx-core-lyx_core_ids = experiment_group.member_experiment_lyx-core-lyx_core_lyx-core-lyx_core_ids;
member_experiment_lyx-core-lyx_core_lyx-core-lyx_core_ids.retain(|&id| id != experiment.id);
...
experiment_groups::member_experiment_lyx-core-lyx_core_lyx-core-lyx_core_ids.eq(member_experiment_lyx-core-lyx_core_lyx-core-lyx_core_ids),
experiment_groups::buckets.eq(buckets),
experiment_groups::last_modified_by.eq(user.email.clone()),
experiment_groups::last_modified_at.eq(chrono::Utc::now()),
))
...
schema_name: &SchemaName,
user: &User,
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<ExperimentGroup> {
...
member_experiment_lyx-core-lyx_core_lyx-core-lyx_core_ids: vec![experiment.id],
buckets,
