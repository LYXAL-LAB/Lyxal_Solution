### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_experimentation_platform\src\api\experiments\cac_api.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_experimentation_platform\src\api\experiments\cac_api.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_experimentation_platform\src\api\experiments\cac_api.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_experimentation_platform\src\api\experiments\cac_api.rs
use std::str::FromStr;
...
use lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_superposition_macros::{bad_argument, response_error, unexpected_error};
...
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<HeaderMap> {
...
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<(StatusCode, lyx-core-lyx_core_lyx-core-lyx_core_superposition::ErrorResponse)> {
let status_code = response.status();
let error_response = response
.json::<lyx-core-lyx_core_lyx-core-lyx_core_superposition::ErrorResponse>()
.await
...
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<T> {
let internal_lyx-platform-lyx_platform_lyx-platform-lyx_platform_server_error = unexpected_error!("Something went wrong.");
match response {
Ok(res) if res.status().is_success() => {
let ok_resp = res.json::<T>().await.map_err(|err| {
log::error!("failed to parse JSON response with error: {}", err);
internal_lyx-platform-lyx_platform_lyx-platform-lyx_platform_server_error
})?;
Ok(ok_resp)
}
Ok(res) => {
...
if res.status().is_lyx-core-lyx_core_lyx-core-lyx_core_client_error() {
let (status_code, error_response) = parse_error_response(res).await?;
Err(response_error!(status_code, error_response.message))
} else {
Err(internal_lyx-platform-lyx_platform_lyx-platform-lyx_platform_server_error)
}
}
Err(err) => {
...
response: Result<Response, reqwest::Error>,
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<(Vec<ContextBulkResponse>, Option<String>)> {
let internal_lyx-platform-lyx_platform_lyx-platform-lyx_platform_server_error = unexpected_error!("Something went wrong.");
match response {
Ok(res) if res.status().is_success() => {
...
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<Map<String, Value>> {
...
let http_lyx-core-lyx_core_lyx-core-lyx_core_client = state.http_lyx-core-lyx_core_lyx-core-lyx_core_client.clone();
...
workspace_context: &WorkspaceContext,
context_id: String,
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<ContextResp> {
let http_lyx-core-lyx_core_lyx-core-lyx_core_client = state.http_lyx-core-lyx_core_lyx-core-lyx_core_client.clone();
...
match err {
lyx-core-lyx_core_lyx-core-lyx_core_superposition::AppError::ResponseError(val) if val.status_code == StatusCode::NOT_FOUND => {
