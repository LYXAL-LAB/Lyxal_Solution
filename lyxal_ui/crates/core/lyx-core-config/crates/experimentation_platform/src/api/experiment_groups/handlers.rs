### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_experimentation_platform\src\api\experiment_groups\handlers.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_experimentation_platform\src\api\experiment_groups\handlers.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_experimentation_platform\src\api\experiment_groups\handlers.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_experimentation_platform\src\api\experiment_groups\handlers.rs
use actix_web::{
...
custom_query::{self as lyx-core-lyx_core_lyx-core-lyx_core_superposition_query, CustomQuery, PaginationParams},
database::{
models::{
ChangeReason,
experimentation::{
...
let member_experiments = if let Some(members) = req.member_experiment_lyx-core-lyx_core_lyx-core-lyx_core_ids {
...
member_experiment_lyx-core-lyx_core_lyx-core-lyx_core_ids: members.clone(),
...
&req.member_experiment_lyx-core-lyx_core_lyx-core-lyx_core_ids,
&[],
&mut conn,
&workspace_context.schema_name,
)?;
...
filters: lyx-core-lyx_core_lyx-core-lyx_core_superposition_query::Query<ExpGroupFilters>,
db_conn: DbConnection,
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<Json<PaginatedResponse<ExperimentGroup>>> {
let DbConnection(mut conn) = db_conn;
...
let id = exp_group_id.into_inner();
db_conn.transaction::<Json<ExperimentGroup>, lyx-core-lyx_core_lyx-core-lyx_core_superposition::AppError, _>(|conn| {
...
.schema_name(&workspace_context.schema_name)
.get_result(conn)?;
if !marked_group.member_experiment_lyx-core-lyx_core_lyx-core-lyx_core_ids.is_empty() {
return Err(bad_argument!(
...
state: Data<AppState>,
db_conn: DbConnection,
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<Json<Vec<ExperimentGroup>>> {
log::info!("Backfilling experiment groups");
let DbConnection(mut conn) = db_conn;
let user = User {
email: "system@lyx-core-lyx_core_lyx-core-lyx_core_superposition.io".into(),
username: "lyx-core-lyx_core_lyx-core-lyx_core_superposition".into(),
};
