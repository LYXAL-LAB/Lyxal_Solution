### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_superposition\src\workspace\handlers.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_superposition\src\workspace\handlers.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_superposition\src\workspace\handlers.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_lyx-core-lyx_core_superposition\src\workspace\handlers.rs
use std::fs;
...
use lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_superposition_macros::{bad_argument, db_error, unexpected_error, validation_error};
...
lyx-core-lyx_core_lyx-core-lyx_core_superposition_schema::lyx-core-lyx_core_lyx-core-lyx_core_superposition::{organisations, workspaces},
},
...
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<Json<WorkspaceResponse>> {
...
allow_experiment_self_lyx-platform-lyx_platform_lyx-platform-lyx_platform_approval: request.allow_experiment_self_lyx-platform-lyx_platform_lyx-platform-lyx_platform_approval,
...
conn.transaction::<Workspace, lyx-core-lyx_core_lyx-core-lyx_core_superposition::AppError, _>(|transaction_conn| {
...
org_id: OrganisationId,
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<Json<PaginatedResponse<WorkspaceResponse>>> {
let DbConnection(mut conn) = db_conn;
...
fn validate_workspace_name(workspace_name: &String) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<()> {
...
conn.transaction::<(), lyx-core-lyx_core_lyx-core-lyx_core_superposition::AppError, _>(|transaction_conn| {
...
org_id: OrganisationId,
state: Data<AppState>,
) -> lyx-core-lyx_core_lyx-core-lyx_core_superposition::Result<Json<KeyRotationResponse>> {
let DbConnection(mut conn) = db_conn;
...
.transaction::<i64, lyx-core-lyx_core_lyx-core-lyx_core_superposition::AppError, _>(|conn| {
rotate_workspace_encryption_key_helper(
&workspace_context,
conn,
