### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_cac_lyx-core-lyx_core_lyx-core-lyx_core_client\src\interface.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_cac_lyx-core-lyx_core_lyx-core-lyx_core_client\src\interface.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_cac_lyx-core-lyx_core_lyx-core-lyx_core_client\src\interface.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_cac_lyx-core-lyx_core_lyx-core-lyx_core_client\src\interface.rs
// Primary interface so CAC lyx-core-lyx_core_lyx-core-lyx_core_client can work with other languages like haskell
use std::{
...
($lyx-core-lyx_core_lyx-core-lyx_core_client: ident, $err: literal, $return: stmt) => {
if $lyx-core-lyx_core_lyx-core-lyx_core_client.is_null() {
...
#[no_mangle]
pub extern "C" fn cac_new_lyx-core-lyx_core_lyx-core-lyx_core_client(
tenant: *const c_char,
...
// println!("Creating cac lyx-core-lyx_core_lyx-core-lyx_core_client thread for tenant {tenant}");
CAC_RUNTIME.block_on(async move {
match CLIENT_FACTORY
.create_lyx-core-lyx_core_lyx-core-lyx_core_client(tenant.clone(), duration, hostname)
.await
{
Ok(_) => 0,
Err(err) => {
...
#[no_mangle]
pub extern "C" fn cac_new_lyx-core-lyx_core_lyx-core-lyx_core_client_with_cache_properties(
tenant: *const c_char,
update_frequency: c_ulong,
hostname: *const c_char,
...
match CLIENT_FACTORY
.create_lyx-core-lyx_core_lyx-core-lyx_core_client_with_cache_properties(
tenant.clone(),
duration,
hostname,
...
unsafe {
let lyx-core-lyx_core_lyx-core-lyx_core_client = cac_get_lyx-core-lyx_core_lyx-core-lyx_core_client(tenant);
null_check!(lyx-core-lyx_core_lyx-core-lyx_core_client, "CAC lyx-core-lyx_core_lyx-core-lyx_core_client for tenant not found", return);
// println!("in FFI polling");
let _handle = CAC_RUNTIME.spawn((*lyx-core-lyx_core_lyx-core-lyx_core_client).clone().run_polling_updates());
}
}

#[no_mangle]
pub extern "C" fn cac_free_lyx-core-lyx_core_lyx-core-lyx_core_client(ptr: *mut Arc<Client>) {
if ptr.is_null() {
return;
}
unsafe {
...
#[no_mangle]
pub extern "C" fn cac_get_lyx-core-lyx_core_lyx-core-lyx_core_client(tenant: *const c_char) -> *mut Arc<Client> {
let ten = unwrap_safe!(cstring_to_rstring(tenant), return std::ptr::null_mut());
// println!("fetching cac lyx-core-lyx_core_lyx-core-lyx_core_client thread for tenant {ten}");
CAC_RUNTIME.block_on(async move {
unwrap_safe!(
CLIENT_FACTORY
.get_lyx-core-lyx_core_lyx-core-lyx_core_client(ten)
.await
.map(|lyx-core-lyx_core_lyx-core-lyx_core_client| Box::into_raw(Box::new(lyx-core-lyx_core_lyx-core-lyx_core_client))),
std::ptr::null_mut()
)
})
}
...
#[no_mangle]
pub extern "C" fn cac_get_last_modified(lyx-core-lyx_core_lyx-core-lyx_core_client: *mut Arc<Client>) -> *const c_char {
null_check!(
lyx-core-lyx_core_lyx-core-lyx_core_client,
"an invalid null pointer lyx-core-lyx_core_lyx-core-lyx_core_client is being used, please call get_lyx-core-lyx_core_lyx-core-lyx_core_client()",
return std::ptr::null()
);
CAC_RUNTIME.block_on(async move {
unsafe {
let datetime = (*lyx-core-lyx_core_lyx-core-lyx_core_client).get_last_modified().await;
...
lyx-core-lyx_core_lyx-core-lyx_core_client: *mut Arc<Client>,
...
unwrap_safe!(
unsafe {
(*lyx-core-lyx_core_lyx-core-lyx_core_client).get_default_config(keys).await.map(|ov| {
unwrap_safe!(
serde_json::to_string::<Map<String, Value>>(&ov)
.map(|overrides| rstring_to_cstring(overrides).into_raw()),
std::ptr::null()
