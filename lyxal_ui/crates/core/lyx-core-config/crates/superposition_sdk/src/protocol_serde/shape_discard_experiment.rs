...
"ResourceNotFound" => crate::operation::discard_experiment::DiscardExperimentError::ResourceNotFound({
#[allow(unused_mut)]
let mut tmp =
{
#[allow(unused_mut)]
let mut output = crate::types::error::builders::ResourceNotFoundBuilder::default();
output = crate::protocol_serde::shape_resource_not_found::de_resource_not_found_json_err(_response_body, output).map_err(crate::operation::discard_experiment::DiscardExperimentError::unhandled)?;
