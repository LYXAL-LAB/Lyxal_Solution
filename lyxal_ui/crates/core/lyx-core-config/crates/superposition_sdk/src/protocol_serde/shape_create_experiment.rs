...
output = crate::protocol_serde::shape_internal_server_error::de_internal_server_error_json_err(_response_body, output).map_err(crate::operation::create_experiment::CreateExperimentError::unhandled)?;
...
crate::serde_util::create_experiment_output_output_correct_errors(output).build().map_err(crate::operation::create_experiment::CreateExperimentError::unhandled)?
})
}
...
pub fn ser_create_experiment_input(input: &crate::operation::create_experiment::CreateExperimentInput) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
