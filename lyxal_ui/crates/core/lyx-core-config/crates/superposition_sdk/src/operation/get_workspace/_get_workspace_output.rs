...
/// - [`workspace_name`](crate::operation::get_workspace::builders::GetWorkspaceOutputBuilder::workspace_name)
/// - [`organisation_id`](crate::operation::get_workspace::builders::GetWorkspaceOutputBuilder::organisation_id)
/// - [`organisation_name`](crate::operation::get_workspace::builders::GetWorkspaceOutputBuilder::organisation_name)
/// - [`workspace_schema_name`](crate::operation::get_workspace::builders::GetWorkspaceOutputBuilder::workspace_schema_name)
/// - [`workspace_status`](crate::operation::get_workspace::builders::GetWorkspaceOutputBuilder::workspace_status)
/// - [`workspace_admin_email`](crate::operation::get_workspace::builders::GetWorkspaceOutputBuilder::workspace_admin_email)
/// - [`created_by`](crate::operation::get_workspace::builders::GetWorkspaceOutputBuilder::created_by)
/// - [`last_modified_by`](crate::operation::get_workspace::builders::GetWorkspaceOutputBuilder::last_modified_by)
/// - [`last_modified_at`](crate::operation::get_workspace::builders::GetWorkspaceOutputBuilder::last_modified_at)
/// - [`created_at`](crate::operation::get_workspace::builders::GetWorkspaceOutputBuilder::created_at)
/// - [`metrics`](crate::operation::get_workspace::builders::GetWorkspaceOutputBuilder::metrics)
/// - [`allow_experiment_self_approval`](crate::operation::get_workspace::builders::GetWorkspaceOutputBuilder::allow_experiment_self_approval)
/// - [`auto_populate_control`](crate::operation::get_workspace::builders::GetWorkspaceOutputBuilder::auto_populate_control)
/// - [`enable_context_validation`](crate::operation::get_workspace::builders::GetWorkspaceOutputBuilder::enable_context_validation)
/// - [`enable_change_reason_validation`](crate::operation::get_workspace::builders::GetWorkspaceOutputBuilder::enable_change_reason_validation)
...
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("workspace_name", "workspace_name was not specified but it is required when building GetWorkspaceOutput")
)?
,
organisation_id: self.organisation_id
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("organisation_id", "organisation_id was not specified but it is required when building GetWorkspaceOutput")
)?
,
organisation_name: self.organisation_name
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("organisation_name", "organisation_name was not specified but it is required when building GetWorkspaceOutput")
)?
,
workspace_schema_name: self.workspace_schema_name
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("workspace_schema_name", "workspace_schema_name was not specified but it is required when building GetWorkspaceOutput")
)?
,
workspace_status: self.workspace_status
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("workspace_status", "workspace_status was not specified but it is required when building GetWorkspaceOutput")
)?
,
workspace_admin_email: self.workspace_admin_email
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("workspace_admin_email", "workspace_admin_email was not specified but it is required when building GetWorkspaceOutput")
)?
,
...
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("created_by", "created_by was not specified but it is required when building GetWorkspaceOutput")
)?
,
last_modified_by: self.last_modified_by
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("last_modified_by", "last_modified_by was not specified but it is required when building GetWorkspaceOutput")
)?
,
last_modified_at: self.last_modified_at
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("last_modified_at", "last_modified_at was not specified but it is required when building GetWorkspaceOutput")
)?
,
created_at: self.created_at
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("created_at", "created_at was not specified but it is required when building GetWorkspaceOutput")
)?
,
...
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("metrics", "metrics was not specified but it is required when building GetWorkspaceOutput")
)?
,
allow_experiment_self_approval: self.allow_experiment_self_approval
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("allow_experiment_self_approval", "allow_experiment_self_approval was not specified but it is required when building GetWorkspaceOutput")
)?
,
auto_populate_control: self.auto_populate_control
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("auto_populate_control", "auto_populate_control was not specified but it is required when building GetWorkspaceOutput")
)?
,
enable_context_validation: self.enable_context_validation
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("enable_context_validation", "enable_context_validation was not specified but it is required when building GetWorkspaceOutput")
)?
,
enable_change_reason_validation: self.enable_change_reason_validation
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("enable_change_reason_validation", "enable_change_reason_validation was not specified but it is required when building GetWorkspaceOutput")
)?
,
}
)
