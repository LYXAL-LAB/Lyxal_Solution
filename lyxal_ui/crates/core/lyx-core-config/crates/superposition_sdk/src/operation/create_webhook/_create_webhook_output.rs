...
/// - [`name`](crate::operation::create_webhook::builders::CreateWebhookOutputBuilder::name)
/// - [`description`](crate::operation::create_webhook::builders::CreateWebhookOutputBuilder::description)
/// - [`enabled`](crate::operation::create_webhook::builders::CreateWebhookOutputBuilder::enabled)
/// - [`url`](crate::operation::create_webhook::builders::CreateWebhookOutputBuilder::url)
/// - [`method`](crate::operation::create_webhook::builders::CreateWebhookOutputBuilder::method)
/// - [`version`](crate::operation::create_webhook::builders::CreateWebhookOutputBuilder::version)
/// - [`events`](crate::operation::create_webhook::builders::CreateWebhookOutputBuilder::events)
/// - [`max_retries`](crate::operation::create_webhook::builders::CreateWebhookOutputBuilder::max_retries)
/// - [`change_reason`](crate::operation::create_webhook::builders::CreateWebhookOutputBuilder::change_reason)
/// - [`created_by`](crate::operation::create_webhook::builders::CreateWebhookOutputBuilder::created_by)
/// - [`created_at`](crate::operation::create_webhook::builders::CreateWebhookOutputBuilder::created_at)
/// - [`last_modified_by`](crate::operation::create_webhook::builders::CreateWebhookOutputBuilder::last_modified_by)
/// - [`last_modified_at`](crate::operation::create_webhook::builders::CreateWebhookOutputBuilder::last_modified_at)
pub fn build(self) -> ::std::result::Result<crate::operation::create_webhook::CreateWebhookOutput, ::aws_smithy_types::error::operation::BuildError> {
::std::result::Result::Ok(
crate::operation::create_webhook::CreateWebhookOutput {
name: self.name
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building CreateWebhookOutput")
)?
,
description: self.description
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("description", "description was not specified but it is required when building CreateWebhookOutput")
)?
,
enabled: self.enabled
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("enabled", "enabled was not specified but it is required when building CreateWebhookOutput")
)?
,
url: self.url
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("url", "url was not specified but it is required when building CreateWebhookOutput")
)?
,
method: self.method
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("method", "method was not specified but it is required when building CreateWebhookOutput")
)?
,
version: self.version
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("version", "version was not specified but it is required when building CreateWebhookOutput")
)?
,
...
events: self.events
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("events", "events was not specified but it is required when building CreateWebhookOutput")
)?
,
max_retries: self.max_retries
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("max_retries", "max_retries was not specified but it is required when building CreateWebhookOutput")
)?
,
...
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("change_reason", "change_reason was not specified but it is required when building CreateWebhookOutput")
)?
,
created_by: self.created_by
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("created_by", "created_by was not specified but it is required when building CreateWebhookOutput")
)?
,
created_at: self.created_at
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("created_at", "created_at was not specified but it is required when building CreateWebhookOutput")
)?
,
last_modified_by: self.last_modified_by
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("last_modified_by", "last_modified_by was not specified but it is required when building CreateWebhookOutput")
)?
,
last_modified_at: self.last_modified_at
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("last_modified_at", "last_modified_at was not specified but it is required when building CreateWebhookOutput")
)?
,
}
)
