...
let builder = crate::protocol_serde::shape_delete_context::ser_delete_context_headers(input, builder)?;
...
/// Returns `true` if the error kind is `DeleteContextError::InternalServerError`.
