...
pub struct RemoveMembersFromGroupInput  {
...
impl RemoveMembersFromGroupInput {
/// Creates a new builder-style object to manufacture [`RemoveMembersFromGroupInput`](crate::operation::remove_members_from_group::RemoveMembersFromGroupInput).
pub fn builder() -> crate::operation::remove_members_from_group::builders::RemoveMembersFromGroupInputBuilder {
crate::operation::remove_members_from_group::builders::RemoveMembersFromGroupInputBuilder::default()
}
}

/// A builder for [`RemoveMembersFromGroupInput`](crate::operation::remove_members_from_group::RemoveMembersFromGroupInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct RemoveMembersFromGroupInputBuilder {
...
impl RemoveMembersFromGroupInputBuilder {
#[allow(missing_docs)] // documentation missing in model
...
/// Consumes the builder and constructs a [`RemoveMembersFromGroupInput`](crate::operation::remove_members_from_group::RemoveMembersFromGroupInput).
pub fn build(self) -> ::std::result::Result<crate::operation::remove_members_from_group::RemoveMembersFromGroupInput, ::aws_smithy_types::error::operation::BuildError> {
::std::result::Result::Ok(
crate::operation::remove_members_from_group::RemoveMembersFromGroupInput {
