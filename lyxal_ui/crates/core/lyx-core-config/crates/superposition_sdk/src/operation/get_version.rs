...
/// Orchestration and serialization glue logic for `GetVersion`.
...
) -> ::std::result::Result<crate::operation::get_version::GetVersionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_version::GetVersionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::get_version::GetVersionError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::get_version::GetVersionOutput>().expect("correct output type"))
}
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetVersion {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetVersion");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetVersionRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetVersionResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetVersion")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(GetVersionEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_version::GetVersionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_version::GetVersionError>::new());
...
#[derive(Debug)]
struct GetVersionResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetVersionResponseDeserializer {
...
crate::protocol_serde::shape_get_version::de_get_version_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_get_version::de_get_version_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct GetVersionRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetVersionRequestSerializer {
...
let input = input.downcast::<crate::operation::get_version::GetVersionInput>().expect("correct type");
...
::std::write!(output, "/version/{id}", id = id).expect("formatting should succeed");
...
let builder = crate::protocol_serde::shape_get_version::ser_get_version_headers(input, builder)?;
...
#[derive(Debug)]
struct GetVersionEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetVersionEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"GetVersionEndpointParamsInterceptor"
}
...
.downcast_ref::<GetVersionInput>()
.ok_or("failed to downcast to GetVersionInput")?;
...
/// Error type for the `GetVersionError` operation.
#[non_exhaustive]
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetVersionError) for what information is available for the error.")]
Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GetVersionError {
/// Creates the `GetVersionError::Unhandled` variant from any error type.
...
/// Creates the `GetVersionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
/// Returns `true` if the error kind is `GetVersionError::ResourceNotFound`.
pub fn is_resource_not_found(&self) -> bool {
matches!(self, Self::ResourceNotFound(_))
}
/// Returns `true` if the error kind is `GetVersionError::InternalServerError`.
pub fn is_internal_server_error(&self) -> bool {
matches!(self, Self::InternalServerError(_))
}
}
impl ::std::error::Error for GetVersionError {
...
impl ::std::fmt::Display for GetVersionError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetVersionError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetVersionError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetVersionError {
