...
/// Orchestration and serialization glue logic for `GetContext`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetContext;
impl GetContext {
/// Creates a new `GetContext`
pub fn new() -> Self {
Self
}
...
) -> ::std::result::Result<crate::operation::get_context::GetContextOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_context::GetContextError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::get_context::GetContextError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::get_context::GetContextOutput>().expect("correct output type"))
}
...
"Superposition.GetContext",
"rpc.service" = "Superposition",
"rpc.method" = "GetContext",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetContext {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetContext");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetContextRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetContextResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetContext")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(GetContextEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_context::GetContextError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_context::GetContextError>::new());
...
#[derive(Debug)]
struct GetContextResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetContextResponseDeserializer {
...
crate::protocol_serde::shape_get_context::de_get_context_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_get_context::de_get_context_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct GetContextRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetContextRequestSerializer {
...
let input = input.downcast::<crate::operation::get_context::GetContextInput>().expect("correct type");
...
::std::write!(output, "/context/{id}", id = id).expect("formatting should succeed");
...
let builder = crate::protocol_serde::shape_get_context::ser_get_context_headers(input, builder)?;
...
#[derive(Debug)]
struct GetContextEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetContextEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"GetContextEndpointParamsInterceptor"
}
...
.downcast_ref::<GetContextInput>()
.ok_or("failed to downcast to GetContextInput")?;
...
/// Error type for the `GetContextError` operation.
#[non_exhaustive]
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetContextError) for what information is available for the error.")]
Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GetContextError {
/// Creates the `GetContextError::Unhandled` variant from any error type.
...
/// Creates the `GetContextError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
/// Returns `true` if the error kind is `GetContextError::ResourceNotFound`.
pub fn is_resource_not_found(&self) -> bool {
matches!(self, Self::ResourceNotFound(_))
}
/// Returns `true` if the error kind is `GetContextError::InternalServerError`.
pub fn is_internal_server_error(&self) -> bool {
matches!(self, Self::InternalServerError(_))
}
}
impl ::std::error::Error for GetContextError {
...
impl ::std::fmt::Display for GetContextError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetContextError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetContextError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetContextError {
...
pub use crate::operation::get_context::_get_context_output::GetContextOutput;

pub use crate::operation::get_context::_get_context_input::GetContextInput;

mod _get_context_input;

mod _get_context_output;
