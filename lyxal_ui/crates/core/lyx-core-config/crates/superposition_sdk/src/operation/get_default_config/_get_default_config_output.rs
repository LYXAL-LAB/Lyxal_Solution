...
pub struct GetDefaultConfigOutput  {
#[allow(missing_docs)] // documentation missing in model
...
impl GetDefaultConfigOutput {
/// Creates a new builder-style object to manufacture [`GetDefaultConfigOutput`](crate::operation::get_default_config::GetDefaultConfigOutput).
pub fn builder() -> crate::operation::get_default_config::builders::GetDefaultConfigOutputBuilder {
crate::operation::get_default_config::builders::GetDefaultConfigOutputBuilder::default()
}
}

/// A builder for [`GetDefaultConfigOutput`](crate::operation::get_default_config::GetDefaultConfigOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetDefaultConfigOutputBuilder {
...
impl GetDefaultConfigOutputBuilder {
#[allow(missing_docs)] // documentation missing in model
...
/// Consumes the builder and constructs a [`GetDefaultConfigOutput`](crate::operation::get_default_config::GetDefaultConfigOutput).
/// This method will fail if any of the following fields are not set:
/// - [`key`](crate::operation::get_default_config::builders::GetDefaultConfigOutputBuilder::key)
/// - [`value`](crate::operation::get_default_config::builders::GetDefaultConfigOutputBuilder::value)
/// - [`schema`](crate::operation::get_default_config::builders::GetDefaultConfigOutputBuilder::schema)
/// - [`description`](crate::operation::get_default_config::builders::GetDefaultConfigOutputBuilder::description)
/// - [`change_reason`](crate::operation::get_default_config::builders::GetDefaultConfigOutputBuilder::change_reason)
/// - [`created_at`](crate::operation::get_default_config::builders::GetDefaultConfigOutputBuilder::created_at)
/// - [`created_by`](crate::operation::get_default_config::builders::GetDefaultConfigOutputBuilder::created_by)
/// - [`last_modified_at`](crate::operation::get_default_config::builders::GetDefaultConfigOutputBuilder::last_modified_at)
/// - [`last_modified_by`](crate::operation::get_default_config::builders::GetDefaultConfigOutputBuilder::last_modified_by)
pub fn build(self) -> ::std::result::Result<crate::operation::get_default_config::GetDefaultConfigOutput, ::aws_smithy_types::error::operation::BuildError> {
::std::result::Result::Ok(
crate::operation::get_default_config::GetDefaultConfigOutput {
key: self.key
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("key", "key was not specified but it is required when building GetDefaultConfigOutput")
)?
,
value: self.value
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("value", "value was not specified but it is required when building GetDefaultConfigOutput")
)?
,
schema: self.schema
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("schema", "schema was not specified but it is required when building GetDefaultConfigOutput")
)?
,
description: self.description
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("description", "description was not specified but it is required when building GetDefaultConfigOutput")
)?
,
...
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("created_at", "created_at was not specified but it is required when building GetDefaultConfigOutput")
)?
,
created_by: self.created_by
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("created_by", "created_by was not specified but it is required when building GetDefaultConfigOutput")
)?
,
last_modified_at: self.last_modified_at
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("last_modified_at", "last_modified_at was not specified but it is required when building GetDefaultConfigOutput")
)?
,
last_modified_by: self.last_modified_by
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("last_modified_by", "last_modified_by was not specified but it is required when building GetDefaultConfigOutput")
)?
,
}
)
