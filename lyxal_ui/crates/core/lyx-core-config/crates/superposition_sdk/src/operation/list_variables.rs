...
/// Orchestration and serialization glue logic for `ListVariables`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListVariables;
impl ListVariables {
/// Creates a new `ListVariables`
pub fn new() -> Self {
Self
}
...
) -> ::std::result::Result<crate::operation::list_variables::ListVariablesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_variables::ListVariablesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::list_variables::ListVariablesError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::list_variables::ListVariablesOutput>().expect("correct output type"))
}
...
"Superposition.ListVariables",
"rpc.service" = "Superposition",
"rpc.method" = "ListVariables",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListVariables {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListVariables");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListVariablesRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListVariablesResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListVariables")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(ListVariablesEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_variables::ListVariablesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_variables::ListVariablesError>::new());
...
#[derive(Debug)]
struct ListVariablesResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListVariablesResponseDeserializer {
...
crate::protocol_serde::shape_list_variables::de_list_variables_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_list_variables::de_list_variables_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct ListVariablesRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListVariablesRequestSerializer {
...
let input = input.downcast::<crate::operation::list_variables::ListVariablesInput>().expect("correct type");
...
fn uri_base(_input: &crate::operation::list_variables::ListVariablesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
use ::std::fmt::Write as _;
::std::write!(output, "/variables").expect("formatting should succeed");
::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_variables::ListVariablesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
let builder = crate::protocol_serde::shape_list_variables::ser_list_variables_headers(input, builder)?;
...
#[derive(Debug)]
struct ListVariablesEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListVariablesEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"ListVariablesEndpointParamsInterceptor"
}
...
.downcast_ref::<ListVariablesInput>()
.ok_or("failed to downcast to ListVariablesInput")?;
...
/// Error type for the `ListVariablesError` operation.
#[non_exhaustive]
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListVariablesError) for what information is available for the error.")]
Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl ListVariablesError {
/// Creates the `ListVariablesError::Unhandled` variant from any error type.
...
/// Creates the `ListVariablesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
/// Returns `true` if the error kind is `ListVariablesError::InternalServerError`.
pub fn is_internal_server_error(&self) -> bool {
matches!(self, Self::InternalServerError(_))
}
}
impl ::std::error::Error for ListVariablesError {
...
impl ::std::fmt::Display for ListVariablesError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for ListVariablesError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListVariablesError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListVariablesError {
