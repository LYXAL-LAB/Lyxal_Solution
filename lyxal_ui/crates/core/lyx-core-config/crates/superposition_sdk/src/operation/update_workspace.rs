...
) -> ::std::result::Result<crate::operation::update_workspace::UpdateWorkspaceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_workspace::UpdateWorkspaceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::update_workspace::UpdateWorkspaceError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::update_workspace::UpdateWorkspaceOutput>().expect("correct output type"))
}
...
"Superposition.UpdateWorkspace",
"rpc.service" = "Superposition",
"rpc.method" = "UpdateWorkspace",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateWorkspace {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateWorkspace");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateWorkspaceRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateWorkspaceResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateWorkspace")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(UpdateWorkspaceEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_workspace::UpdateWorkspaceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_workspace::UpdateWorkspaceError>::new());
...
#[derive(Debug)]
struct UpdateWorkspaceResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateWorkspaceResponseDeserializer {
...
crate::protocol_serde::shape_update_workspace::de_update_workspace_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_update_workspace::de_update_workspace_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct UpdateWorkspaceRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateWorkspaceRequestSerializer {
...
let input = input.downcast::<crate::operation::update_workspace::UpdateWorkspaceInput>().expect("correct type");
...
fn uri_base(_input: &crate::operation::update_workspace::UpdateWorkspaceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
::std::write!(output, "/workspaces/{workspace_name}", workspace_name = workspace_name).expect("formatting should succeed");
...
let builder = crate::protocol_serde::shape_update_workspace::ser_update_workspace_headers(input, builder)?;
...
let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_workspace::ser_update_workspace_input(&input)?);
...
#[derive(Debug)]
struct UpdateWorkspaceEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateWorkspaceEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"UpdateWorkspaceEndpointParamsInterceptor"
}
...
.downcast_ref::<UpdateWorkspaceInput>()
.ok_or("failed to downcast to UpdateWorkspaceInput")?;
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateWorkspaceError) for what information is available for the error.")]
...
/// Creates the `UpdateWorkspaceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
/// Returns `true` if the error kind is `UpdateWorkspaceError::ResourceNotFound`.
pub fn is_resource_not_found(&self) -> bool {
matches!(self, Self::ResourceNotFound(_))
}
/// Returns `true` if the error kind is `UpdateWorkspaceError::InternalServerError`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateWorkspaceError {
