...
/// Orchestration and serialization glue logic for `RotateWorkspaceEncryptionKey`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct RotateWorkspaceEncryptionKey;
impl RotateWorkspaceEncryptionKey {
/// Creates a new `RotateWorkspaceEncryptionKey`
pub fn new() -> Self {
Self
}
...
) -> ::std::result::Result<crate::operation::rotate_workspace_encryption_key::RotateWorkspaceEncryptionKeyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::rotate_workspace_encryption_key::RotateWorkspaceEncryptionKeyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::rotate_workspace_encryption_key::RotateWorkspaceEncryptionKeyError>().expect("correct error type")
})
};
...
"Superposition.RotateWorkspaceEncryptionKey",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RotateWorkspaceEncryptionKey {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RotateWorkspaceEncryptionKey");
...
crate::protocol_serde::shape_rotate_workspace_encryption_key::de_rotate_workspace_encryption_key_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct RotateWorkspaceEncryptionKeyRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RotateWorkspaceEncryptionKeyRequestSerializer {
...
::std::write!(output, "/workspaces/{workspace_name}/rotate-encryption-key", workspace_name = workspace_name).expect("formatting should succeed");
...
pub enum RotateWorkspaceEncryptionKeyError {
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RotateWorkspaceEncryptionKeyError) for what information is available for the error.")]
Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl RotateWorkspaceEncryptionKeyError {
/// Creates the `RotateWorkspaceEncryptionKeyError::Unhandled` variant from any error type.
...
/// Returns `true` if the error kind is `RotateWorkspaceEncryptionKeyError::InternalServerError`.
pub fn is_internal_server_error(&self) -> bool {
matches!(self, Self::InternalServerError(_))
}
}
impl ::std::error::Error for RotateWorkspaceEncryptionKeyError {
...
impl ::std::fmt::Display for RotateWorkspaceEncryptionKeyError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for RotateWorkspaceEncryptionKeyError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RotateWorkspaceEncryptionKeyError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RotateWorkspaceEncryptionKeyError {
...
mod _rotate_workspace_encryption_key_output;
