...
let builder = crate::protocol_serde::shape_update_dimension::ser_update_dimension_headers(input, builder)?;
...
/// Returns `true` if the error kind is `UpdateDimensionError::ResourceNotFound`.
