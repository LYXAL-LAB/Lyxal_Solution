...
/// Orchestration and serialization glue logic for `CreateContext`.
...
) -> ::std::result::Result<crate::operation::create_context::CreateContextOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_context::CreateContextError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::create_context::CreateContextError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::create_context::CreateContextOutput>().expect("correct output type"))
}
...
"Superposition.CreateContext",
"rpc.service" = "Superposition",
"rpc.method" = "CreateContext",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateContext {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateContext");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateContextRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateContextResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateContext")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(CreateContextEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_context::CreateContextError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_context::CreateContextError>::new());
...
#[derive(Debug)]
struct CreateContextResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateContextResponseDeserializer {
...
crate::protocol_serde::shape_create_context::de_create_context_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_create_context::de_create_context_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct CreateContextRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateContextRequestSerializer {
...
let input = input.downcast::<crate::operation::create_context::CreateContextInput>().expect("correct type");
...
::std::write!(output, "/context").expect("formatting should succeed");
...
let builder = crate::protocol_serde::shape_create_context::ser_create_context_headers(input, builder)?;
...
let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_context_input::ser_request_http_payload(& input.request)?);
...
#[derive(Debug)]
struct CreateContextEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateContextEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"CreateContextEndpointParamsInterceptor"
}
...
.downcast_ref::<CreateContextInput>()
.ok_or("failed to downcast to CreateContextInput")?;
...
/// Error type for the `CreateContextError` operation.
#[non_exhaustive]
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateContextError) for what information is available for the error.")]
...
/// Creates the `CreateContextError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
/// Returns `true` if the error kind is `CreateContextError::ResourceNotFound`.
pub fn is_resource_not_found(&self) -> bool {
matches!(self, Self::ResourceNotFound(_))
}
/// Returns `true` if the error kind is `CreateContextError::InternalServerError`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateContextError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateContextError {
