...
/// Orchestration and serialization glue logic for `UpdateSecret`.
...
) -> ::std::result::Result<crate::operation::update_secret::UpdateSecretOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_secret::UpdateSecretError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::update_secret::UpdateSecretError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::update_secret::UpdateSecretOutput>().expect("correct output type"))
}
...
"Superposition.UpdateSecret",
"rpc.service" = "Superposition",
"rpc.method" = "UpdateSecret",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateSecret {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateSecret");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateSecretRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateSecretResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateSecret")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(UpdateSecretEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_secret::UpdateSecretError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_secret::UpdateSecretError>::new());
...
#[derive(Debug)]
struct UpdateSecretResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateSecretResponseDeserializer {
...
crate::protocol_serde::shape_update_secret::de_update_secret_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_update_secret::de_update_secret_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct UpdateSecretRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateSecretRequestSerializer {
...
let input = input.downcast::<crate::operation::update_secret::UpdateSecretInput>().expect("correct type");
...
::std::write!(output, "/secrets/{name}", name = name).expect("formatting should succeed");
...
let builder = crate::protocol_serde::shape_update_secret::ser_update_secret_headers(input, builder)?;
...
let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_secret::ser_update_secret_input(&input)?);
...
#[derive(Debug)]
struct UpdateSecretEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateSecretEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"UpdateSecretEndpointParamsInterceptor"
}
...
.downcast_ref::<UpdateSecretInput>()
.ok_or("failed to downcast to UpdateSecretInput")?;
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateSecretError) for what information is available for the error.")]
...
/// Creates the `UpdateSecretError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
/// Returns `true` if the error kind is `UpdateSecretError::ResourceNotFound`.
pub fn is_resource_not_found(&self) -> bool {
matches!(self, Self::ResourceNotFound(_))
}
/// Returns `true` if the error kind is `UpdateSecretError::InternalServerError`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateSecretError {
