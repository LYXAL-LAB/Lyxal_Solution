...
/// Orchestration and serialization glue logic for `RampExperiment`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct RampExperiment;
impl RampExperiment {
/// Creates a new `RampExperiment`
pub fn new() -> Self {
Self
}
...
) -> ::std::result::Result<crate::operation::ramp_experiment::RampExperimentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::ramp_experiment::RampExperimentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::ramp_experiment::RampExperimentError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::ramp_experiment::RampExperimentOutput>().expect("correct output type"))
}
...
"Superposition.RampExperiment",
"rpc.service" = "Superposition",
"rpc.method" = "RampExperiment",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RampExperiment {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RampExperiment");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RampExperimentRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RampExperimentResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RampExperiment")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(RampExperimentEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::ramp_experiment::RampExperimentError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::ramp_experiment::RampExperimentError>::new());
...
#[derive(Debug)]
struct RampExperimentResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RampExperimentResponseDeserializer {
...
crate::protocol_serde::shape_ramp_experiment::de_ramp_experiment_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_ramp_experiment::de_ramp_experiment_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct RampExperimentRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RampExperimentRequestSerializer {
...
let input = input.downcast::<crate::operation::ramp_experiment::RampExperimentInput>().expect("correct type");
...
::std::write!(output, "/experiments/{id}/ramp", id = id).expect("formatting should succeed");
...
let builder = crate::protocol_serde::shape_ramp_experiment::ser_ramp_experiment_headers(input, builder)?;
...
let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_ramp_experiment::ser_ramp_experiment_input(&input)?);
...
#[derive(Debug)]
struct RampExperimentEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RampExperimentEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"RampExperimentEndpointParamsInterceptor"
}
...
.downcast_ref::<RampExperimentInput>()
.ok_or("failed to downcast to RampExperimentInput")?;
...
/// Error type for the `RampExperimentError` operation.
#[non_exhaustive]
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RampExperimentError) for what information is available for the error.")]
Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl RampExperimentError {
/// Creates the `RampExperimentError::Unhandled` variant from any error type.
...
/// Creates the `RampExperimentError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
/// Returns `true` if the error kind is `RampExperimentError::ResourceNotFound`.
pub fn is_resource_not_found(&self) -> bool {
matches!(self, Self::ResourceNotFound(_))
}
/// Returns `true` if the error kind is `RampExperimentError::InternalServerError`.
pub fn is_internal_server_error(&self) -> bool {
matches!(self, Self::InternalServerError(_))
}
}
impl ::std::error::Error for RampExperimentError {
...
impl ::std::fmt::Display for RampExperimentError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for RampExperimentError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RampExperimentError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RampExperimentError {
