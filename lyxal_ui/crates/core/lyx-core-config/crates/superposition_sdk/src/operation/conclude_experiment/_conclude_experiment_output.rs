...
pub struct ConcludeExperimentOutput  {
#[allow(missing_docs)] // documentation missing in model
...
impl ConcludeExperimentOutput {
/// Creates a new builder-style object to manufacture [`ConcludeExperimentOutput`](crate::operation::conclude_experiment::ConcludeExperimentOutput).
pub fn builder() -> crate::operation::conclude_experiment::builders::ConcludeExperimentOutputBuilder {
crate::operation::conclude_experiment::builders::ConcludeExperimentOutputBuilder::default()
}
}

/// A builder for [`ConcludeExperimentOutput`](crate::operation::conclude_experiment::ConcludeExperimentOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ConcludeExperimentOutputBuilder {
...
impl ConcludeExperimentOutputBuilder {
#[allow(missing_docs)] // documentation missing in model
...
/// Consumes the builder and constructs a [`ConcludeExperimentOutput`](crate::operation::conclude_experiment::ConcludeExperimentOutput).
/// This method will fail if any of the following fields are not set:
/// - [`id`](crate::operation::conclude_experiment::builders::ConcludeExperimentOutputBuilder::id)
/// - [`created_at`](crate::operation::conclude_experiment::builders::ConcludeExperimentOutputBuilder::created_at)
/// - [`created_by`](crate::operation::conclude_experiment::builders::ConcludeExperimentOutputBuilder::created_by)
/// - [`last_modified`](crate::operation::conclude_experiment::builders::ConcludeExperimentOutputBuilder::last_modified)
/// - [`name`](crate::operation::conclude_experiment::builders::ConcludeExperimentOutputBuilder::name)
/// - [`experiment_type`](crate::operation::conclude_experiment::builders::ConcludeExperimentOutputBuilder::experiment_type)
/// - [`override_keys`](crate::operation::conclude_experiment::builders::ConcludeExperimentOutputBuilder::override_keys)
/// - [`status`](crate::operation::conclude_experiment::builders::ConcludeExperimentOutputBuilder::status)
/// - [`traffic_percentage`](crate::operation::conclude_experiment::builders::ConcludeExperimentOutputBuilder::traffic_percentage)
/// - [`context`](crate::operation::conclude_experiment::builders::ConcludeExperimentOutputBuilder::context)
/// - [`variants`](crate::operation::conclude_experiment::builders::ConcludeExperimentOutputBuilder::variants)
/// - [`last_modified_by`](crate::operation::conclude_experiment::builders::ConcludeExperimentOutputBuilder::last_modified_by)
/// - [`description`](crate::operation::conclude_experiment::builders::ConcludeExperimentOutputBuilder::description)
/// - [`change_reason`](crate::operation::conclude_experiment::builders::ConcludeExperimentOutputBuilder::change_reason)
pub fn build(self) -> ::std::result::Result<crate::operation::conclude_experiment::ConcludeExperimentOutput, ::aws_smithy_types::error::operation::BuildError> {
::std::result::Result::Ok(
crate::operation::conclude_experiment::ConcludeExperimentOutput {
id: self.id
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("id", "id was not specified but it is required when building ConcludeExperimentOutput")
)?
,
created_at: self.created_at
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("created_at", "created_at was not specified but it is required when building ConcludeExperimentOutput")
)?
,
created_by: self.created_by
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("created_by", "created_by was not specified but it is required when building ConcludeExperimentOutput")
)?
,
last_modified: self.last_modified
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("last_modified", "last_modified was not specified but it is required when building ConcludeExperimentOutput")
)?
,
name: self.name
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building ConcludeExperimentOutput")
)?
,
experiment_type: self.experiment_type
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("experiment_type", "experiment_type was not specified but it is required when building ConcludeExperimentOutput")
)?
,
override_keys: self.override_keys
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("override_keys", "override_keys was not specified but it is required when building ConcludeExperimentOutput")
)?
,
status: self.status
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building ConcludeExperimentOutput")
)?
,
traffic_percentage: self.traffic_percentage
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("traffic_percentage", "traffic_percentage was not specified but it is required when building ConcludeExperimentOutput")
)?
,
context: self.context
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("context", "context was not specified but it is required when building ConcludeExperimentOutput")
)?
,
variants: self.variants
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("variants", "variants was not specified but it is required when building ConcludeExperimentOutput")
)?
,
last_modified_by: self.last_modified_by
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("last_modified_by", "last_modified_by was not specified but it is required when building ConcludeExperimentOutput")
)?
,
...
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("description", "description was not specified but it is required when building ConcludeExperimentOutput")
)?
,
change_reason: self.change_reason
.ok_or_else(||
::aws_smithy_types::error::operation::BuildError::missing_field("change_reason", "change_reason was not specified but it is required when building ConcludeExperimentOutput")
)?
,
