...
/// Orchestration and serialization glue logic for `WeightRecompute`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct WeightRecompute;
impl WeightRecompute {
/// Creates a new `WeightRecompute`
pub fn new() -> Self {
Self
}
...
) -> ::std::result::Result<crate::operation::weight_recompute::WeightRecomputeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::weight_recompute::WeightRecomputeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::weight_recompute::WeightRecomputeError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::weight_recompute::WeightRecomputeOutput>().expect("correct output type"))
}
...
"Superposition.WeightRecompute",
"rpc.service" = "Superposition",
"rpc.method" = "WeightRecompute",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for WeightRecompute {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("WeightRecompute");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(WeightRecomputeRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(WeightRecomputeResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("WeightRecompute")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(WeightRecomputeEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::weight_recompute::WeightRecomputeError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::weight_recompute::WeightRecomputeError>::new());
...
#[derive(Debug)]
struct WeightRecomputeResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for WeightRecomputeResponseDeserializer {
...
crate::protocol_serde::shape_weight_recompute::de_weight_recompute_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_weight_recompute::de_weight_recompute_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct WeightRecomputeRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for WeightRecomputeRequestSerializer {
...
let input = input.downcast::<crate::operation::weight_recompute::WeightRecomputeInput>().expect("correct type");
...
fn uri_base(_input: &crate::operation::weight_recompute::WeightRecomputeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
use ::std::fmt::Write as _;
::std::write!(output, "/context/weight/recompute").expect("formatting should succeed");
...
let builder = crate::protocol_serde::shape_weight_recompute::ser_weight_recompute_headers(input, builder)?;
...
#[derive(Debug)]
struct WeightRecomputeEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for WeightRecomputeEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"WeightRecomputeEndpointParamsInterceptor"
}
...
.downcast_ref::<WeightRecomputeInput>()
.ok_or("failed to downcast to WeightRecomputeInput")?;
...
/// Error type for the `WeightRecomputeError` operation.
#[non_exhaustive]
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-WeightRecomputeError) for what information is available for the error.")]
Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl WeightRecomputeError {
/// Creates the `WeightRecomputeError::Unhandled` variant from any error type.
...
/// Creates the `WeightRecomputeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::retry::ProvideErrorKind for WeightRecomputeError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for WeightRecomputeError {
