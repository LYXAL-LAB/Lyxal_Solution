...
fn uri_query(_input: &crate::operation::get_config::GetConfigInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
let builder = crate::protocol_serde::shape_get_config::ser_get_config_headers(input, builder)?;
...
let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_config::ser_get_config_input(&input)?);
...
/// Returns `true` if the error kind is `GetConfigError::InternalServerError`.
