...
/// Orchestration and serialization glue logic for `GetWorkspace`.
...
) -> ::std::result::Result<crate::operation::get_workspace::GetWorkspaceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_workspace::GetWorkspaceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
...
err.downcast::<crate::operation::get_workspace::GetWorkspaceError>().expect("correct error type")
})
};
...
::std::result::Result::Ok(output.downcast::<crate::operation::get_workspace::GetWorkspaceOutput>().expect("correct output type"))
}
...
"Superposition.GetWorkspace",
"rpc.service" = "Superposition",
"rpc.method" = "GetWorkspace",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetWorkspace {
fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetWorkspace");

cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetWorkspaceRequestSerializer));
cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetWorkspaceResponseDeserializer));
...
#[allow(unused_mut)]
let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetWorkspace")
.with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(GetWorkspaceEndpointParamsInterceptor)
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_workspace::GetWorkspaceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_workspace::GetWorkspaceError>::new());
...
#[derive(Debug)]
struct GetWorkspaceResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetWorkspaceResponseDeserializer {
...
crate::protocol_serde::shape_get_workspace::de_get_workspace_http_error(status, headers, body)
} else {
crate::protocol_serde::shape_get_workspace::de_get_workspace_http_response(status, headers, body)
};
crate::protocol_serde::type_erase_result(parse_result)
}
}
#[derive(Debug)]
struct GetWorkspaceRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetWorkspaceRequestSerializer {
...
let input = input.downcast::<crate::operation::get_workspace::GetWorkspaceInput>().expect("correct type");
...
let builder = crate::protocol_serde::shape_get_workspace::ser_get_workspace_headers(input, builder)?;
...
#[derive(Debug)]
struct GetWorkspaceEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetWorkspaceEndpointParamsInterceptor {
fn name(&self) -> &'static str {
"GetWorkspaceEndpointParamsInterceptor"
}
...
.downcast_ref::<GetWorkspaceInput>()
.ok_or("failed to downcast to GetWorkspaceInput")?;
...
\
See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetWorkspaceError) for what information is available for the error.")]
...
/// Creates the `GetWorkspaceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
/// Returns `true` if the error kind is `GetWorkspaceError::ResourceNotFound`.
pub fn is_resource_not_found(&self) -> bool {
matches!(self, Self::ResourceNotFound(_))
}
/// Returns `true` if the error kind is `GetWorkspaceError::InternalServerError`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetWorkspaceError {
