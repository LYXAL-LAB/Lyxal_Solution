...
///   - [`published_runtime_version(Option<FunctionRuntimeVersion>)`](crate::operation::publish::PublishOutput::published_runtime_version): (undocumented)
///   - [`draft_runtime_version(FunctionRuntimeVersion)`](crate::operation::publish::PublishOutput::draft_runtime_version): (undocumented)
