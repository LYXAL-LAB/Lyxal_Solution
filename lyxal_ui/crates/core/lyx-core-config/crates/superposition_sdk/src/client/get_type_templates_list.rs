...
///   - [`count(i32)`](crate::operation::get_type_templates_list::builders::GetTypeTemplatesListFluentBuilder::count) / [`set_count(Option<i32>)`](crate::operation::get_type_templates_list::builders::GetTypeTemplatesListFluentBuilder::set_count):<br>required: **false**<br>Number of items to be returned in each page.<br>
///   - [`page(i32)`](crate::operation::get_type_templates_list::builders::GetTypeTemplatesListFluentBuilder::page) / [`set_page(Option<i32>)`](crate::operation::get_type_templates_list::builders::GetTypeTemplatesListFluentBuilder::set_page):<br>required: **false**<br>Page number to retrieve, starting from 1.<br>
///   - [`all(bool)`](crate::operation::get_type_templates_list::builders::GetTypeTemplatesListFluentBuilder::all) / [`set_all(Option<bool>)`](crate::operation::get_type_templates_list::builders::GetTypeTemplatesListFluentBuilder::set_all):<br>required: **false**<br>If true, returns all requested items, ignoring pagination parameters page and count.<br>
