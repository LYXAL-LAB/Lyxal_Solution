...
/// use superposition_sdk::config::Config;
...
/// # fn example() {
/// use std::time::Duration;
/// use superposition_sdk::config::{Builder, Config};
/// use aws_smithy_runtime::client::http::hyper_014::HyperClientBuilder;
///
...
/// }
///
/// let mut builder = superposition_sdk::Config::builder();
...
/// no_run
/// use superposition_sdk::config::endpoint::{ResolveEndpoint, EndpointFuture, Params, Endpoint};
/// #[derive(Debug)]
...
/// let config = superposition_sdk::Config::builder().endpoint_resolver(resolver).build();
...
/// no_run
/// use superposition_sdk::config::Config;
/// use superposition_sdk::config::retry::RetryConfig;
///
...
///
/// no_run
/// use superposition_sdk::config::{AsyncSleep, Config, SharedAsyncSleep, Sleep};
///
/// #[derive(Debug)]
...
///
/// no_run
/// use superposition_sdk::config::{AsyncSleep, Builder, Config, SharedAsyncSleep, Sleep};
///
/// #[derive(Debug)]
/// pub struct ForeverSleep;
///
...
/// # use std::time::Duration;
/// use superposition_sdk::config::Config;
/// use superposition_sdk::config::timeout::TimeoutConfig;
///
...
/// no_run
/// use superposition_sdk::config::IdentityCache;
///
...
/// no_run
/// use superposition_sdk::config::BehaviorVersion;
///
/// let config = superposition_sdk::Config::builder()
...
Config {
config: crate::config::Layer::from(layer.clone()).with_name("superposition_sdk::config::Config").freeze(),
cloneable: layer,
...
.with_name("superposition_sdk::config::ConfigOverrideRuntimePlugin").freeze(),
components,
}
}
}
