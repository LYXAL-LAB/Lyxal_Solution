### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_experimentation_lyx-core-lyx_core_lyx-core-lyx_core_client\src\interface.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_experimentation_lyx-core-lyx_core_lyx-core-lyx_core_client\src\interface.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_experimentation_lyx-core-lyx_core_lyx-core-lyx_core_client\src\interface.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\lyx-core-lyx_core_experimentation_lyx-core-lyx_core_lyx-core-lyx_core_client\src\interface.rs
use std::{
...
#[no_mangle]
pub extern "C" fn expt_new_lyx-core-lyx_core_lyx-core-lyx_core_client(
tenant: *const c_char,
...
.create_lyx-core-lyx_core_lyx-core-lyx_core_client(tenant.clone(), update_frequency.into(), hostname)
.await
{
Ok(_) => 0,
Err(err) => {
...
unsafe {
let lyx-core-lyx_core_lyx-core-lyx_core_client = expt_get_lyx-core-lyx_core_lyx-core-lyx_core_client(tenant);
let local = task::LocalSet::new();
// println!("in FFI polling");
local.block_on(&EXP_RUNTIME, (*lyx-core-lyx_core_lyx-core-lyx_core_client).clone().run_polling_updates());
}
}

#[no_mangle]
pub extern "C" fn expt_free_lyx-core-lyx_core_lyx-core-lyx_core_client(ptr: *mut Arc<Client>) {
...
#[no_mangle]
pub extern "C" fn expt_get_lyx-core-lyx_core_lyx-core-lyx_core_client(tenant: *const c_char) -> *mut Arc<Client> {
let ten = unwrap_safe!(cstring_to_rstring(tenant), return std::ptr::null_mut());
EXP_RUNTIME.block_on(async move {
match CLIENT_FACTORY.get_lyx-core-lyx_core_lyx-core-lyx_core_client(ten).await {
Ok(lyx-core-lyx_core_lyx-core-lyx_core_client) => Box::into_raw(Box::new(lyx-core-lyx_core_lyx-core-lyx_core_client)),
Err(err) => {
...
#[no_mangle]
pub extern "C" fn expt_get_lyx-platform-lyx_platform_lyx-platform-lyx_platform_applicable_variant(
...
(*lyx-core-lyx_core_lyx-core-lyx_core_client).get_lyx-platform-lyx_platform_lyx-platform-lyx_platform_applicable_variant(&dimensions, &context, &identifier, prefix_list)
});
variants_result
.map(|result| {
...
#[no_mangle]
pub extern "C" fn expt_get_running_experiments(lyx-core-lyx_core_lyx-core-lyx_core_client: *mut Arc<Client>) -> *mut c_char {
let local = task::LocalSet::new();
local.block_on(&Runtime::new().unwrap(), async move {
unsafe {
unwrap_safe!(
(*lyx-core-lyx_core_lyx-core-lyx_core_client).get_running_experiments().await.map(|exp| {
rstring_to_cstring(serde_json::to_value(exp).unwrap().to_string())
.into_raw()
}),
std::ptr::null_mut()
