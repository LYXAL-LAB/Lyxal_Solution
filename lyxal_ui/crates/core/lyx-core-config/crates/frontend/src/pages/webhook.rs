### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\frontend\src\pages\webhook.rs
```rust
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\frontend\src\pages\webhook.rs
```rust
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\core\lyx_core_config\crates\frontend\src\pages\webhook.rs
        ...
        spawn_local(async move {
            ...
            match result {
                Ok(_) => {
                    ...
                    let redirect_url =
                        format!("/admin/{}/{}/webhooks", org.get().0, workspace.get().0,);
