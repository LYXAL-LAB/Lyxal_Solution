### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\viz\lyx_viz_map\leptos-leaflet\src\components\map_container.rs
```rust
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\viz\lyx_viz_map\leptos-leaflet\src\components\map_container.rs
```rust
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\viz\lyx_viz_map\leptos-leaflet\src\components\map_container.rs
...
pub fn MapContainer(
    ...
    #[prop(optional)]
    locate: bool,
    /// Shows the attribution on the map.
    ...
    #[prop(optional)]
    set_view: bool,
    #[prop(optional, default = true)] dragging: bool,
    ...
    Effect::new(move |_| {
        if let Some(map_div) = map_load.get() {
            ...
            options.set_attribution_control(use_attribution);
            ...
            let Ok(leaflet_map) = Map::new(&html_node.id(), &options) else {
                tracing::error!("Failed to create map");
                return;
            };
