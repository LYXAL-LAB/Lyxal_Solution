...
/// This method allows you to show the hidden series. If the series is already visible, this doesnâ€™t affect it.
#[wasm_bindgen(method)]
pub fn show_series(this: &ApexChart, series_name: &str);

/// This method allows you to hide the visible series. If the series is already hidden, this method doesnâ€™t affect it.
#[wasm_bindgen(method)]
