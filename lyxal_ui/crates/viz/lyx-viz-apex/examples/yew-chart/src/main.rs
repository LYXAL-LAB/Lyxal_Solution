use yew::prelude::*;
use apexcharts_rs::prelude::{ApexChartComponent, ChartSeries, SeriesData, ChartType};
...
r#type={ChartType::Bar}
id={"chart4".to_string()}
series={category_paired_series.clone()}
/>
