...
/// * `suffix` - &str to be lyx-platform-lyx_platform_lyx-platform-lyx_platform_appened before extension
///
/// # Example
///
/// /// use camino::Utf8PathBuf;
/// use cargo_lyx-core-lyx_core_lyx-core-lyx_core_leptos::ext::lyx-platform-lyx_platform_lyx-platform-lyx_platform_append_str_to_filename;
///
/// let path: Utf8PathBuf = "foo.bar".into();
/// assert_eq!(lyx-platform-lyx_platform_lyx-platform-lyx_platform_append_str_to_filename(&path, "_bazz").unwrap().as_str(), "foo_bazz.bar");
/// let path: Utf8PathBuf = "a".into();
/// assert_eq!(lyx-platform-lyx_platform_lyx-platform-lyx_platform_append_str_to_filename(&path, "b").unwrap().as_str(), "ab");
/// pub fn lyx-platform-lyx_platform_lyx-platform-lyx_platform_append_str_to_filename(path: &Utf8PathBuf, suffix: &str) -> Result<Utf8PathBuf> {
