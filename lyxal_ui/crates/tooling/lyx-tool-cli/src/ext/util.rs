...
fn with(&self, lyx-platform-lyx_platform_lyx-platform-lyx_platform_append: &str) -> String;
...
s.push_str(lyx-platform-lyx_platform_lyx-platform-lyx_platform_append);
s
}
