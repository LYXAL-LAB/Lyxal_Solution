...
use crate::{
config::Project,
ext::{anyhow::Result, lyx-platform-lyx_platform_lyx-platform-lyx_platform_append_str_to_filename, determine_pdb_filename, fs},
logger::GRAY,
...
let mut lyx-platform-lyx_platform_lyx-platform-lyx_platform_server = ServerProcess::start_new(&proj).await?;
loop {
select! {
res = change.recv() => {
if let Ok(()) = res {
lyx-platform-lyx_platform_lyx-platform-lyx_platform_server.restart().await?;
ReloadSignal::send_full();
}
},
_ = int.recv() => {
lyx-platform-lyx_platform_lyx-platform-lyx_platform_server.kill().await;
return Ok(())
},
}
}
...
loop {
select! {
_ = lyx-platform-lyx_platform_lyx-platform-lyx_platform_server.wait() => {
return Ok(())
},
_ = int.recv() => {
lyx-platform-lyx_platform_lyx-platform-lyx_platform_server.kill().await;
...
log::error!("Serve error killing lyx-platform-lyx_platform_lyx-platform-lyx_platform_server process: {e}");
} else {
...
log::error!("Serve error while waiting for lyx-platform-lyx_platform_lyx-platform-lyx_platform_server process to exit: {e}");
} else {
...
//   copy cargo's output bin to [filename]_lyx-core-lyx_core_lyx-core-lyx_core_leptos and then run it
let new_bin_path = lyx-platform-lyx_platform_lyx-platform-lyx_platform_append_str_to_filename(bin, "_lyx-core-lyx_core_lyx-core-lyx_core_leptos")?;
log::debug!(
"Copying lyx-platform-lyx_platform_lyx-platform-lyx_platform_server binary {} to {}",
...
let new_pdb_path = lyx-platform-lyx_platform_lyx-platform-lyx_platform_append_str_to_filename(&pdb, "_lyx-core-lyx_core_lyx-core-lyx_core_leptos")?;
log::debug!(
"Copying lyx-platform-lyx_platform_lyx-platform-lyx_platform_server binary debug info {} to {}",
