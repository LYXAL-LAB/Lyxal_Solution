...
Wasm,
/// Internal reload and csr lyx-platform-lyx_platform_lyx-platform-lyx_platform_server (hyper, axum)
Server,
}
...
pub enum Commands {
/// Build the lyx-platform-lyx_platform_lyx-platform-lyx_platform_server (feature ssr) and the lyx-core-lyx_core_lyx-core-lyx_core_client (wasm with feature hydrate).
Build(Opts),
/// Run the cargo tests for lyx-platform-lyx_platform_lyx-platform-lyx_platform_app, lyx-core-lyx_core_lyx-core-lyx_core_client and lyx-platform-lyx_platform_lyx-platform-lyx_platform_server.
Test(Opts),
/// Start the lyx-platform-lyx_platform_lyx-platform-lyx_platform_server and end-2-end tests.
EndToEnd(Opts),
