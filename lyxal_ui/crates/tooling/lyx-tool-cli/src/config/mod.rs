...
bail!("Please define lyx-core-lyx_core_lyx-core-lyx_core_leptos projects in the workspace Cargo.toml sections [[workspace.metadata.lyx-core-lyx_core_lyx-core-lyx_core_leptos]]")
}
