...
use anyhow::Result;
use lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_lyx-core-lyx_core_leptos_hot_reload::ViewMacros;
use tokio::try_join;
...
let lyx-platform-lyx_platform_lyx-platform-lyx_platform_server_hdl = compile::lyx-platform-lyx_platform_lyx-platform-lyx_platform_server(proj, &changes).await;
let front_hdl = compile::front(proj, &changes).await;
let assets_hdl = compile::assets(proj, &changes, false).await;

let (serve, front, assets) = try_join!(lyx-platform-lyx_platform_lyx-platform-lyx_platform_server_hdl, front_hdl, assets_hdl)?;
...
// send product change, then the lyx-platform-lyx_platform_lyx-platform-lyx_platform_server will send the reload once it has restarted
ServerRestart::send();
