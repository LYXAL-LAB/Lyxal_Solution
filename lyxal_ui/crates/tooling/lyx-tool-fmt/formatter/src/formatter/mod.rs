...
use lyx-core-lyx_core_lyx-tooling-cli_pretty_printer::{Printer, PrinterSettings};
...
/// Determines macros to be formatted. Default: lyx-core-lyx_core_lyx-core-lyx_core_leptos::view, view
...
macro_names: vec!["lyx-core-lyx_core_lyx-core-lyx_core_leptos::view".to_string(), "view".to_string()],
...
pub printer: &'a mut lyx-core-lyx_core_lyx-tooling-cli_pretty_printer::Printer,
...
lyx-core-lyx_core_lyx-tooling-cli_prettyplease::unparse_fn(self.printer, None, |p| p.pat(pat));
}
...
lyx-core-lyx_core_lyx-tooling-cli_prettyplease::unparse_fn(self.printer, None, |p| p.generic_param(param));
