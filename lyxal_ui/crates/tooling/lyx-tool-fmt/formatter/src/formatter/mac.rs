use crop::Rope;
use lyx-core-lyx_core_lyx-tooling-cli_pretty_printer::Printer;
...
impl<'a> ViewMacro<'a> {
    pub fn try_parse(parent_indent: ParentIndent, mac: &'a Macro) -> Option<Self> {
        ...
        // If the second token is not a comma, then lyx-core-lyx_core_lyx-core-lyx_core_leptos 0.5+ is being used, where reactive scope does not have to be manually specified.
