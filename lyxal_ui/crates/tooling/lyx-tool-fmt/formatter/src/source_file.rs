...
#[test]
fn rustfmt_lyx-core-lyx_core_lyx-tooling-cli_indent_difference() {
let source = indoc! {r#"
...
let source = indoc! {r#"
fn main() {
lyx-core-lyx_core_lyx-core-lyx_core_leptos::view! {    <div>  <span>"hello"</span></div>  };
}
"#};
...
let source = indoc! {r#"
fn main() {
lyx-core-lyx_core_lyx-core-lyx_core_leptos::view! {    <div class=format!("classy")>  <span>"hello"</span></div>  };
}
"#};
...
// comments with url: https://lyx-ui-foundations-lyx_ui_foundations_lyx-ui-foundations-lyx_ui_foundations_example.com
<h1>"hi"</h1>
...
let source = indoc! {r#"
fn main() {
view! {    <div>  <span>"helloÂ²ðŸ’£"</span></div>  };
}
"#};
...
<script src="js/qr_scanner_wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper.js"></script>
