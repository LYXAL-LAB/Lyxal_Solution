### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_drag_reorder\src\lib.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_drag_reorder\src\lib.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_drag_reorder\src\lib.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_drag_reorder\src\lib.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_drag_reorder\src\lib.rs
...
use js_sys::Function;
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::{ev, html::ElementType, prelude::*, lyx-core-lyx_core_lyx-core-lyx_core_tachys::dom::event_target};
...
panels
.write()
.insert(id.clone(), SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper::new(node_ref.into()));
}
None => {
...
let mouse_x = ev.lyx-core-lyx_core_lyx-core-lyx_core_client_x() as f64;
let mouse_y = ev.lyx-core-lyx_core_lyx-core-lyx_core_client_y() as f64;
let rect = dragged_el.get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect();
...
let mouse_x = ev.lyx-core-lyx_core_lyx-core-lyx_core_client_x() as f64 - offset_x;
let mouse_y = ev.lyx-core-lyx_core_lyx-core-lyx_core_client_y() as f64 - offset_y;
...
let rect = column_ref.get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect();
...
let rect = panel_ref.get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect();
...
column_refs: Vec<Signal<Option<SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper<web_sys::Element>>>>,
...
panels: RwSignal<HashMap<Oco<'static, str>, SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper<web_sys::Element>>>,
}
...
column_ref
.get()
.map(|column_ref| SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper::new(column_ref.into()))
})
})
.collect(),
...
on_cleanup({
let on_dragend = SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper::new(on_dragend.clone());
move || {
let _ = document()
