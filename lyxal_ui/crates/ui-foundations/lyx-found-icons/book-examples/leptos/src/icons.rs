...
(view! { <Calendars /> }.into_any(), "Calendars"),
...
(view! { <ChessBishop /> }.into_any(), "Chess Bishop"),
(view! { <ChessKing /> }.into_any(), "Chess King"),
(view! { <ChessKnight /> }.into_any(), "Chess Knight"),
(view! { <ChessPawn /> }.into_any(), "Chess Pawn"),
(view! { <ChessQueen /> }.into_any(), "Chess Queen"),
(view! { <ChessRook /> }.into_any(), "Chess Rook"),
...
(view! { <FileBraces /> }.into_any(), "File Braces"),
(view! { <FileBracesCorner /> }.into_any(), "File Braces Corner"),
...
(view! { <FileCheckCorner /> }.into_any(), "File Check Corner"),
(view! { <FileClock /> }.into_any(), "File Clock"),
(view! { <FileCode /> }.into_any(), "File Code"),
(view! { <FileCodeCorner /> }.into_any(), "File Code Corner"),
...
(view! { <FileExclamationPoint /> }.into_any(), "File Exclamation Point"),
(view! { <FileHeadphone /> }.into_any(), "File Headphone"),
...
(view! { <FileMinusCorner /> }.into_any(), "File Minus Corner"),
...
(view! { <FilePlusCorner /> }.into_any(), "File Plus Corner"),
(view! { <FileQuestionMark /> }.into_any(), "File Question Mark"),
(view! { <FileScan /> }.into_any(), "File Scan"),
(view! { <FileSearch /> }.into_any(), "File Search"),
(view! { <FileSearchCorner /> }.into_any(), "File Search Corner"),
(view! { <FileSignal /> }.into_any(), "File Signal"),
...
(view! { <FileTypeCorner /> }.into_any(), "File Type Corner"),
...
(view! { <FileXCorner /> }.into_any(), "File X Corner"),
(view! { <Files /> }.into_any(), "Files"),
(view! { <Film /> }.into_any(), "Film"),
(view! { <FingerprintPattern /> }.into_any(), "Fingerprint Pattern"),
...
(view! { <HandFist /> }.into_any(), "Hand Fist"),
(view! { <HandGrab /> }.into_any(), "Hand Grab"),
...
(view! { <SolarPanel /> }.into_any(), "Solar Panel"),
...
(view! { <WavesArrowDown /> }.into_any(), "Waves Arrow Down"),
(view! { <WavesArrowUp /> }.into_any(), "Waves Arrow Up"),
