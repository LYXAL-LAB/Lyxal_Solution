### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx-found-floating\packages\dom\src\platform\convert_offset_parent_relative_rect_to_viewport_relative_rect.rs
```rust
