### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\dom\src\platform\get_clipping_rect.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\dom\src\platform\get_clipping_rect.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\dom\src\platform\get_clipping_rect.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\dom\src\platform\get_clipping_rect.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\dom\src\platform\get_clipping_rect.rs
...
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\dom\src\platform\get_clipping_rect.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\dom\src\platform\get_clipping_rect.rs
use lyx_ui_foundations_core::{GetClippingRectArgs, RootBoundary};
...
rect_to_lyx-core-lyx_core_lyx-core-lyx_core_client_rect,
};
...
types::Boundary,
utils::{
get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect::get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect, get_document_rect::get_document_rect,
...
fn get_inner_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect(element: &Element, strategy: Strategy) -> Rect {
let lyx-core-lyx_core_lyx-core-lyx_core_client_rect =
get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect(element.into(), true, strategy == Strategy::Fixed, None);
let top = lyx-core-lyx_core_lyx-core-lyx_core_client_rect.top + element.lyx-core-lyx_core_lyx-core-lyx_core_client_top() as f64;
let left = lyx-core-lyx_core_lyx-core-lyx_core_client_rect.left + element.lyx-core-lyx_core_lyx-core-lyx_core_client_left() as f64;
let scale = get_scale(element.into());

Rect {
x: left * scale.x,
y: top * scale.y,
width: element.lyx-core-lyx_core_lyx-core-lyx_core_client_width() as f64 * scale.x,
height: element.lyx-core-lyx_core_lyx-core-lyx_core_client_height() as f64 * scale.y,
}
}

fn get_lyx-core-lyx_core_lyx-core-lyx_core_client_rect_from_clipping_ancestor(
element: &Element,
...
get_inner_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect(&element, strategy)
}
...
rect_to_lyx-core-lyx_core_lyx-core-lyx_core_client_rect(rect)
}
...
let init =
get_lyx-core-lyx_core_lyx-core-lyx_core_client_rect_from_clipping_ancestor(element, clipping_ancestors[0].clone(), strategy);
let clipping_rect = clipping_ancestors
.into_iter()
.fold(init, |mut acc, clipping_ancestor| {
let rect = get_lyx-core-lyx_core_lyx-core-lyx_core_client_rect_from_clipping_ancestor(element, clipping_ancestor, strategy);
