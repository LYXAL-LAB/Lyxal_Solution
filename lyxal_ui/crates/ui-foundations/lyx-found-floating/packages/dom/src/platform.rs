### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\dom\src\platform.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\dom\src\platform.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\dom\src\platform.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\dom\src\platform.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\dom\src\platform.rs
...
pub mod get_lyx-core-lyx_core_lyx-core-lyx_core_client_length;
pub mod get_lyx-core-lyx_core_lyx-core-lyx_core_client_rects;
...
use lyx_ui_foundations_utils::dom::get_document_element;
...
use self::get_lyx-core-lyx_core_lyx-core-lyx_core_client_length::get_lyx-core-lyx_core_lyx-core-lyx_core_client_length;
use self::get_lyx-core-lyx_core_lyx-core-lyx_core_client_rects::get_lyx-core-lyx_core_lyx-core-lyx_core_client_rects;
...
fn get_lyx-core-lyx_core_lyx-core-lyx_core_client_rects(&self, element: ElementOrVirtual) -> Option<Vec<ClientRectObject>> {
Some(get_lyx-core-lyx_core_lyx-core-lyx_core_client_rects(element))
}
...
fn get_lyx-core-lyx_core_lyx-core-lyx_core_client_length(&self, element: &Element, length: Length) -> Option<f64> {
Some(get_lyx-core-lyx_core_lyx-core-lyx_core_client_length(element, length))
}
}
