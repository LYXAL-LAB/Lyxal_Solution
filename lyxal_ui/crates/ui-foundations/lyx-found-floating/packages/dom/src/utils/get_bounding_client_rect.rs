### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\dom\src\utils\get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\dom\src\utils\get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\dom\src\utils\get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\dom\src\utils\get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\dom\src\utils\get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect.rs
...
let lyx-core-lyx_core_lyx-core-lyx_core_client_rect = match &element_or_virtual {
ElementOrVirtual::Element(element) => element.get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect().into(),
ElementOrVirtual::VirtualElement(virtual_element) => {
virtual_element.get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect()
}
};
...
let mut x = (lyx-core-lyx_core_lyx-core-lyx_core_client_rect.left + visual_offsets.x) / scale.x;
let mut y = (lyx-core-lyx_core_lyx-core-lyx_core_client_rect.top + visual_offsets.y) / scale.y;
let mut width = lyx-core-lyx_core_lyx-core-lyx_core_client_rect.width / scale.x;
let mut height = lyx-core-lyx_core_lyx-core-lyx_core_client_rect.height / scale.y;
...
let iframe_rect = current_iframe.get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect();
...
+ (current_iframe.lyx-core-lyx_core_lyx-core-lyx_core_client_left() as f64 + padding_left) * iframe_scale.x;
let top = iframe_rect.top()
+ (current_iframe.lyx-core-lyx_core_lyx-core-lyx_core_client_top() as f64 + padding_top) * iframe_scale.y;
