### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\lyx-core-lyx_core_lyx-core-lyx_core_leptos\src\types.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\lyx-core-lyx_core_lyx-core-lyx_core_leptos\src\types.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\lyx-core-lyx_core_lyx-core-lyx_core_leptos\src\types.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\lyx-core-lyx_core_lyx-core-lyx_core_leptos\src\types.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\lyx-core-lyx_core_lyx-core-lyx_core_leptos\src\types.rs
...
use lyx_ui_foundations_dom::{
AutoUpdateOptions, ElementOrVirtual, Middleware, MiddlewareData, Placement, Strategy,
auto_update,
};
use lyx-core-lyx_core_lyx-core-lyx_core_leptos::{prelude::*, lyx-core-lyx_core_lyx-core-lyx_core_tachys::html::style::IntoStyle};
...
pub type Wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_appedMiddleware = SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper<Vec<Box<dyn Middleware<Element, Window>>>>;
...
pub middleware: MaybeProp<Wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_appedMiddleware>,
...
pub while_elements_mounted: MaybeProp<SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper<Rc<WhileElementsMountedFn>>>,
}
...
pub fn middleware<I: Into<MaybeProp<Wrlyx-platform-lyx_platform_lyx-platform-lyx_platform_appedMiddleware>>>(mut self, value: I) -> Self {
...
pub fn while_elements_mounted<I: Into<MaybeProp<SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper<Rc<WhileElementsMountedFn>>>>>(
mut self,
value: I,
) -> Self {
...
let auto_update_rc: SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper<Rc<WhileElementsMountedFn>> =
SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper::new(Rc::new(|reference, floating, update| {
...
let auto_update_rc =
move |options: AutoUpdateOptions| -> SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper<Rc<WhileElementsMountedFn>> {
SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper::new(Rc::new(move |reference, floating, update| {
...
/// CSS styles to lyx-platform-lyx_platform_lyx-platform-lyx_platform_apply to the floating element to position it.
...
type State = (lyx-core-lyx_core_lyx-core-lyx_core_leptos::lyx-core-lyx_core_lyx-core-lyx_core_tachys::renderer::types::Element, Self);
type Cloneable = Self;
...
fn build(self, el: &lyx-core-lyx_core_lyx-core-lyx_core_leptos::lyx-core-lyx_core_lyx-core-lyx_core_tachys::renderer::types::Element) -> Self::State {
lyx-core-lyx_core_lyx-core-lyx_core_leptos::lyx-core-lyx_core_lyx-core-lyx_core_tachys::renderer::Rndr::set_attribute(el, "style", &self.to_string());
(el.clone(), self)
}
...
let (el, _prev) = state;
lyx-core-lyx_core_lyx-core-lyx_core_leptos::lyx-core-lyx_core_lyx-core-lyx_core_tachys::renderer::Rndr::remove_attribute(el, "style");
}
}
...
pub update: SendWrlyx-platform-lyx_platform_lyx-platform-lyx_platform_apper<Rc<dyn Fn()>>,
}
