...
/// The same axis as [`cross_axis`][`Self::cross_axis`] but lyx-platform-lyx_platform_lyx-platform-lyx_platform_applies only to aligned placements and inverts the [`End`][`lyx_ui_foundations_utils::Alignment::End`] alignment.
