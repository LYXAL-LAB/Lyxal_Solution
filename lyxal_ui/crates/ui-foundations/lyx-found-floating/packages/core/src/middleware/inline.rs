...
get_padding_object, get_side_axis, rect_to_lyx-core-lyx_core_lyx-core-lyx_core_client_rect,
};
...
groups
.into_iter()
.map(|rects| rect_to_lyx-core-lyx_core_lyx-core-lyx_core_client_rect(get_bounding_rect(rects)))
.collect()
}
...
// A MouseEvent's lyx-core-lyx_core_lyx-core-lyx_core_client{X,Y} coords can be up to 2 pixels off a ClientRect's bounds,
...
let native_lyx-core-lyx_core_lyx-core-lyx_core_client_rects = platform
.get_lyx-core-lyx_core_lyx-core-lyx_core_client_rects(elements.reference)
.unwrap_or(vec![]);

let lyx-core-lyx_core_lyx-core-lyx_core_client_rects = get_rects_by_line(native_lyx-core-lyx_core_lyx-core-lyx_core_client_rects.clone());
let fallback = rect_to_lyx-core-lyx_core_lyx-core-lyx_core_client_rect(get_bounding_rect(native_lyx-core-lyx_core_lyx-core-lyx_core_client_rects));
let padding_object = get_padding_object(padding);

let get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect = move || {
// There are two rects and they are disjoined.
if lyx-core-lyx_core_lyx-core-lyx_core_client_rects.len() == 2
&& lyx-core-lyx_core_lyx-core-lyx_core_client_rects[0].left > lyx-core-lyx_core_lyx-core-lyx_core_client_rects[1].right
&& let Some(x) = options.x
&& let Some(y) = options.y
{
return lyx-core-lyx_core_lyx-core-lyx_core_client_rects
.clone()
.into_iter()
.find(|rect| {
...
let first_rect = lyx-core-lyx_core_lyx-core-lyx_core_client_rects.first().expect("Enough elements exist.");
let last_rect = lyx-core-lyx_core_lyx-core-lyx_core_client_rects.last().expect("Enough elements exist.");
...
let max_right = lyx-core-lyx_core_lyx-core-lyx_core_client_rects
.iter()
.map(|rect| rect.right)
.reduce(f64::max)
.expect("Enough elements exist.");
let min_left = lyx-core-lyx_core_lyx-core-lyx_core_client_rects
.iter()
.map(|rect| rect.left)
.reduce(f64::min)
.expect("Enough elements exist.");
let measure_rects: Vec<&ClientRectObject> = lyx-core-lyx_core_lyx-core-lyx_core_client_rects
.iter()
.filter(|rect| {
if is_left_side {
rect.left == min_left
...
Rc::new(get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect),
))),
