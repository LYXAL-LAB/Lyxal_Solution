### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\core\src\middleware\size.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\core\src\middleware\size.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\core\src\middleware\size.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\core\src\middleware\size.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\core\src\middleware\size.rs
...
use lyx_ui_foundations_utils::{Alignment, Axis, Rect, Side, get_side_axis};
...
/// State passed to [`SizeOptions::lyx-platform-lyx_platform_lyx-platform-lyx_platform_apply`].
#[derive(Clone)]
...
pub lyx-platform-lyx_platform_lyx-platform-lyx_platform_apply: Option<&'a ApplyFn<Element, Window>>,
}
...
lyx-platform-lyx_platform_lyx-platform-lyx_platform_apply: None,
}
}
...
/// Set `lyx-platform-lyx_platform_lyx-platform-lyx_platform_apply` option.
pub fn lyx-platform-lyx_platform_lyx-platform-lyx_platform_apply(mut self, value: &'a ApplyFn<Element, Window>) -> Self {
self.lyx-platform-lyx_platform_lyx-platform-lyx_platform_apply = Some(value);
self
}
}
...
lyx-platform-lyx_platform_lyx-platform-lyx_platform_apply: Default::default(),
}
}
}
...
&& match (self.lyx-platform-lyx_platform_lyx-platform-lyx_platform_apply, other.lyx-platform-lyx_platform_lyx-platform-lyx_platform_apply) {
...
if let Some(lyx-platform-lyx_platform_lyx-platform-lyx_platform_apply) = options.lyx-platform-lyx_platform_lyx-platform-lyx_platform_apply {
lyx-platform-lyx_platform_lyx-platform-lyx_platform_apply(ApplyState {
