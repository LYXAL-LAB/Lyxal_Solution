...
fn get_lyx-core-lyx_core_lyx-core-lyx_core_client_rects(
&self,
...
fn get_lyx-core-lyx_core_lyx-core-lyx_core_client_length(&self, _element: &Element, _length: Length) -> Option<f64> {
None
}
}
