### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\utils\src\lib.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\utils\src\lib.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\utils\src\lib.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\utils\src\lib.rs
### C:\Users\Administrator\Downloads\zed-0.222.1-pre\lyxal_ui\crates\ui-foundations\lyx_found_floating\packages\utils\src\lib.rs
...
fn get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect(&self) -> ClientRectObject;

fn get_lyx-core-lyx_core_lyx-core-lyx_core_client_rects(&self) -> Option<Vec<ClientRectObject>>;
...
pub get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect: Rc<dyn GetBoundingClientRectCloneable>,
pub get_lyx-core-lyx_core_lyx-core-lyx_core_client_rects: Option<Rc<dyn GetClientRectsCloneable>>,
pub context_element: Option<Element>,
}

impl<Element: Clone> DefaultVirtualElement<Element> {
pub fn new(get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect: Rc<dyn GetBoundingClientRectCloneable>) -> Self {
DefaultVirtualElement {
get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect,
get_lyx-core-lyx_core_lyx-core-lyx_core_client_rects: None,
context_element: None,
}
}

pub fn get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect(
mut self,
get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect: Rc<dyn GetBoundingClientRectCloneable>,
) -> Self {
self.get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect = get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect;
self
}

pub fn get_lyx-core-lyx_core_lyx-core-lyx_core_client_rects(mut self, get_lyx-core-lyx_core_lyx-core-lyx_core_client_rects: Rc<dyn GetClientRectsCloneable>) -> Self {
self.get_lyx-core-lyx_core_lyx-core-lyx_core_client_rects = Some(get_lyx-core-lyx_core_lyx-core-lyx_core_client_rects);
self
}
...
{
fn get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect(&self) -> ClientRectObject {
(self.get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect).call()
}

fn get_lyx-core-lyx_core_lyx-core-lyx_core_client_rects(&self) -> Option<Vec<ClientRectObject>> {
self.get_lyx-core-lyx_core_lyx-core-lyx_core_client_rects
.as_ref()
.map(|get_lyx-core-lyx_core_lyx-core-lyx_core_client_rects| get_lyx-core-lyx_core_lyx-core-lyx_core_client_rects.call())
}
...
Rc::ptr_eq(
&self.get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect,
&other.get_bounding_lyx-core-lyx_core_lyx-core-lyx_core_client_rect,
) && match (
self.get_lyx-core-lyx_core_lyx-core-lyx_core_client_rects.as_ref(),
other.get_lyx-core-lyx_core_lyx-core-lyx_core_client_rects.as_ref(),
) {
...
list.lyx-platform-lyx_platform_lyx-platform-lyx_platform_append(&mut opposite_list);
}
...
pub fn rect_to_lyx-core-lyx_core_lyx-core-lyx_core_client_rect(rect: Rect) -> ClientRectObject {
ClientRectObject {
x: rect.x,
y: rect.y,
width: rect.width,
