...
### Basic Usage
```rust
use lyx_ui_shadcn_performance_audit::{run_performance_audit, PerformanceConfig};
...
**Example:**
```rust
use lyx_ui_shadcn_performance_audit::bundle_analysis::BundleAnalyzer;
...
**Example:**
```rust
use lyx_ui_shadcn_performance_audit::performance_monitoring::PerformanceMonitor;
...
**Example:**
```rust
use lyx_ui_shadcn_performance_audit::optimization_roadmap::OptimizationRoadmapGenerator;
...
**Example:**
```rust
use lyx_ui_shadcn_performance_audit::PerformanceAuditError;
...
```rust
use lyx_ui_shadcn_performance_audit::{
    run_performance_audit, 
    PerformanceConfig,
    PerformanceAuditError
};
