...
println!("ðŸš€ Leptos ShadCN UI Demo running at http://{}", addr);
...
<Input input_type="password" placeholder="â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢"/>
</div>
<div>
...
<p>"Built with â¤ï¸ using Leptos and Tailwind CSS"</p>
