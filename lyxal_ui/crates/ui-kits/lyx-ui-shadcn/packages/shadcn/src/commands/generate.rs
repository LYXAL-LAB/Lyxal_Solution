...
println!("ðŸ”§ Generating {} component for {}...", args.name, args.framework);
...
println!("âœ… Successfully generated {} component!", args.name);
println!("ðŸ“ Files created in: {}", output_dir.join(&args.name).display());
