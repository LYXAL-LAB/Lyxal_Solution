...
//! ## Features
//!
//! - ðŸš€ **WASM-Optimized**: Minimal dependencies, fast compilation
//! - ðŸ“¦ **Small Bundle Size**: Optimized for web deployment
//! - ðŸŽ¯ **50+ Components**: Complete ShadCN UI component library
//! - ðŸ”§ **Easy Integration**: Simple API, works with existing Leptos apps
//! - âš¡ **Feature Flags**: Include only the components you need
//! - ðŸ” **Proper WASM Initialization**: Comprehensive state management and error handling
//!
//! ## Usage
//!
//! toml
