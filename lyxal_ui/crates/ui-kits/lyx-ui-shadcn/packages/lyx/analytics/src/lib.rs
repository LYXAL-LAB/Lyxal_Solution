...
//! ```rust
//! use leptos::prelude::*;
//! use lyx_ui_shadcn_analytics::{AnalyticsProvider, dashboard::AnalyticsDashboard, hooks::use_track_component};
//!
//! #[component]
...
//!
//! ```rust
//! use lyx_ui_shadcn_analytics::types::{AnalyticsConfig, StorageMode};
//!
