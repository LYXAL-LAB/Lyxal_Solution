//! Signal-managed version of the progress component using leptos-shadcn-signal-management

use leptos::prelude::*;
use leptos_style::Style;
use lyx_ui_signal_management::*;
...
pub fn SignalManagedProgress(
    ...
    let _progress_state_for_disabled = progress_state.clone();
    view! {
        <div
