...
use lyx_ui_card::{Card, CardHeader, CardTitle, CardDescription, CardContent};
use lyx_ui_alert::{Alert, AlertTitle, AlertDescription, AlertVariant};
use lyx_ui_label::Label;
use lyx_ui_separator::Separator;
...
<Button size=ButtonSize::Icon>"ðŸ”"</Button>
</div>
</CardContent>
</Card>
...
<code>
"[dependencies]\nlyx-ui-shadcn-leptos-button = { path = \"path/to/button\" }\nlyx-ui-shadcn-leptos-input = { path = \"path/to/input\" }\nlyx-ui-shadcn-leptos-card = { path = \"path/to/card\" }"
</code>
</pre>
...
<pre class="bg-muted p-3 rounded text-sm overflow-x-auto">
<code>
"use lyx_ui_leptos_button::Button;\nuse lyx_ui_leptos_input::Input;\n\nview! {\n    <Button>\"Click me\"</Button>\n    <Input placeholder=\"Type here...\" />\n}"
</code>
</pre>
</div>
</CardContent>
