...
">
{move || if is_landscape.get() { "ðŸŒ… Landscape" } else { "ðŸ“± Portrait" }}
</div>
</div>
}
}
...
gap-2
">
<NavItemHorizontal icon="ðŸ " label="Home" active=true />
<NavItemHorizontal icon="ðŸ“Š" label="Dashboard" active=false />
<NavItemHorizontal icon="âš™ï¸" label="Settings" active=false />
<NavItemHorizontal icon="ðŸ‘¤" label="Profile" active=false />
</nav>
