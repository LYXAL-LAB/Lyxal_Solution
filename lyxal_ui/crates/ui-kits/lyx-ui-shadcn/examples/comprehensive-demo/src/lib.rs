...
// For production: use leptos-lyx-ui-shadcn-wasm for proper WASM initialization
#[cfg(feature = "wasm")]
use leptos_lyx_ui_wasm::init::{init_wasm_with_config, WasmInitConfig};
...
<span class="text-lg">{move || if sidebar_open.get() { "â˜°" } else { "â˜°" }}</span>
</Button>
...
<Card class="p-6">
<CardHeader>
<CardTitle>"ðŸ“ Input Component"</CardTitle>
...
<Card class="p-6">
<CardHeader>
<CardTitle>"ðŸŽ¨ Tailwind-RS-WASM Demo"</CardTitle>
