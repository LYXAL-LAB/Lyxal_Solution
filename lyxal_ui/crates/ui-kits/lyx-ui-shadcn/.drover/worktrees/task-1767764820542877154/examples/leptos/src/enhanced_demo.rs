...
// Import components
use lyx_ui_button::{Button, ButtonVariant, ButtonSize};
use lyx_ui_input::Input;
use lyx_ui_card::{Card, CardHeader, CardTitle, CardContent};
...
set_timeout(move || {
set_performance_metrics.set("âœ… Performance Test Complete!\nâ€¢ Click Response: 0.8ms\nâ€¢ Render Time: 1.2ms\nâ€¢ Memory Usage: 8.2MB".to_string());
...
set_timeout(move || {
set_performance_metrics.set("âœ… Speed Test Complete!\nâ€¢ Button Render: 0.8ms\nâ€¢ Input Render: 1.2ms\nâ€¢ Card Render: 2.1ms".to_string());
set_is_loading.set(false);
...
<CardHeader>
<CardTitle class="text-2xl font-bold mb-6">"ðŸš€ Performance Test"</CardTitle>
</CardHeader>
<CardContent>
...
<Card class="bg-white shadow-xl p-8">
<CardHeader>
<CardTitle class="text-2xl font-bold mb-6">"ðŸ“Š Memory Monitor"</CardTitle>
</CardHeader>
<CardContent>
<p class="text-gray-600 mb-6">
...
<Card class="bg-white shadow-xl p-8">
<CardHeader>
<CardTitle class="text-2xl font-bold mb-6">"âš¡ Speed Test"</CardTitle>
</CardHeader>
<CardContent>
<p class="text-gray-600 mb-6">
...
"Join the performance revolution with leptos-lyx-ui-shadcn.
