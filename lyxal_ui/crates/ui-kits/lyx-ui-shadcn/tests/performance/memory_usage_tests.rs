...
mod memory_usage_tests {
    ...
    use lyx_ui_button::default::Button;
    use lyx_ui_input::default::Input;
    use lyx_ui_card::default::{Card, CardHeader, CardTitle, CardContent};
                            ...
                            {signals.into_iter().enumerate().map(|(i, signal)| {
                                view! {
                                    <div key=i class="signal-item">
                                        ...
                                        <Button on_click=move |_| signal.update(|val| *val = format!("Updated {}", i))>
                                            "Update"
                                        </Button>
                                    </div>
                                }
