...
<div class="controls">
<Button
on_click=Callback::new(move |_| refresh_data.set(!refresh_data.get()))
>
"Refresh Data"
</Button>
</div>
...
on_click=Callback::new(move |_| selected_timeframe.set("24h".to_string()))
>
"24 Hours"
</Button>
<Button
class=if selected_timeframe.get() == "7d" { "active" } else { "" }
on_click=Callback::new(move |_| selected_timeframe.set("7d".to_string()))
>
"7 Days"
</Button>
<Button
class=if selected_timeframe.get() == "30d" { "active" } else { "" }
on_click=Callback::new(move |_| selected_timeframe.set("30d".to_string()))
>
"30 Days"
</Button>
</div>
...
on_click=Callback::new(move |_| sort_by.set("name".to_string()))
>
"Sort by Name"
</Button>
<Button
class=if sort_by.get() == "value" { "active" } else { "" }
on_click=Callback::new(move |_| sort_by.set("value".to_string()))
>
"Sort by Value"
</Button>
</div>
