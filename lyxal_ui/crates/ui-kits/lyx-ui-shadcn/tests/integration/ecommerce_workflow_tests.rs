            ...
            view! {
                <div class="ecommerce-app">
                    <div class="search-section">
                        ...
                        />
                        <Button on_click=Callback::new(move |_| selected_category.set("in_stock".to_string()))>
                            "Show In Stock Only"
                        </Button>
                    </div>
                ...
                <div class="checkout-form">
                    ...
                    <div class="payment-section">
                        ...
                        <Button 
                            ...
                            on_click=Callback::new(move |_| payment_method.set("credit_card".to_string()))
                        >
                            "Credit Card"
                        </Button>
                        <Button 
                            class=if payment_method.get() == "paypal" { "selected" } else { "" }
                            on_click=Callback::new(move |_| payment_method.set("paypal".to_string()))
                        >
                            "PayPal"
                        </Button>
                    </div>
                    ...
                    <Button 
                        ...
                        on_click=Callback::new(move |_| order_placed.set(true))
                    >
                        "Place Order"
                    </Button>
