...
println!("ðŸ” Running comprehensive performance audit...");
...
println!("â³ Analyzing components...");
...
println!("âœ… Performance audit passed!");
std::process::exit(0);
} else {
println!("âŒ Performance audit failed!");
std::process::exit(1);
}
}
...
println!("ðŸ“¦ Analyzing bundle sizes...");
...
if results.meets_targets() {
println!("âœ… Bundle analysis passed!");
std::process::exit(0);
} else {
println!("âŒ Bundle analysis failed!");
std::process::exit(1);
}
}
...
println!("ðŸ“Š Monitoring performance for {} seconds...", duration);
...
if results.meets_targets() {
println!("âœ… Performance monitoring passed!");
std::process::exit(0);
} else {
println!("âŒ Performance monitoring failed!");
std::process::exit(1);
}
}
...
println!("ðŸƒ Running benchmarks with {} iterations...", iterations);
...
if results.meets_targets() {
println!("âœ… Benchmarks passed!");
std::process::exit(0);
} else {
println!("âŒ Benchmarks failed!");
std::process::exit(1);
}
}
...
println!("ðŸ—ºï¸ Generating optimization roadmap...");
...
println!("âœ… Optimization roadmap generated!");
Ok(())
}
...
println!("ðŸ“Š Performance Audit Results");
println!("Overall Score: {:.1}/100 ({})", results.overall_score, results.get_grade());
println!("Meets Targets: {}", if results.meets_targets() { "âœ… Yes" } else { "âŒ No" });
println!();

println!("ðŸ“¦ Bundle Analysis:");
...
println!("ðŸ—ºï¸ Optimization Roadmap:");
...
println!("ðŸ“¦ Bundle Analysis Results");
...
println!("ðŸ“Š Performance Monitoring Results");
...
println!("ðŸƒ Benchmark Results");
