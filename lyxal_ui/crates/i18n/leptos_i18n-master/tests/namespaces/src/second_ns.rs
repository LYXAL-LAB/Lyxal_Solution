...
assert_eq_rendered!(fr, "deuxi̬me namespace");
}
...
assert_eq_rendered!(fr, format!("Vous avez cliqu̩ {} fois", i));
}
}
...
assert_eq_rendered!(fr, "Cliquez pour incr̩menter le compteur");
}
...
assert_eq_rendered!(fr, "before deuxi̬me namespace after");
}
