    ...
    <div class="relative flex items-center justify-center px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-base-100 shadow-base-300/20 z-1 w-full space-y-6 rounded-xl p-6 shadow-md sm:min-w-md lg:p-8">
        ...
        <p class="text-base-content/80">
          Login with
          <a href="#" class="link link-animated link-primary font-normal">Magic Link</a>
        </p>
        <div class="flex flex-wrap gap-4 sm:gap-6">
          <a href="#" class="btn btn-outline btn-primary grow">Login as User</a>
          <a href="#" class="btn btn-outline btn-primary grow">Login as Admin</a>
        </div>
        <div class="space-y-4">
  ...
  <div class="lg:grid lg:grid-cols-2">
    <div class="bg-base-100 flex h-screen jz3o6 items-center justify-center o63tj">
      <div class="flex w-full jz3o6 o63tj max-sm:px-10 sm:max-w-md">
        ...
        <div>
          <h3 class="text-base-content axeut waiii t3mfo">Welcome Back</h3>
          <p class="text-base-content/80">Welcome back! Select method to login:</p>
        </div>
        <div class="flex w-full sly4q max-sm:flex-col">
          ...
          <button class="btn g2v48 gnw6d sxihv">
            <img src="https://cdn.flyonui.com/fy-assets/blocks/marketing-ui/brand-logo/facebook-icon.png" alt="facebook icon" class="size-5 c7ys3">
            Login with Facebook
          </button>
        </div>
        <div class="ck7pw">Or Continue with Email</div>
        <form class="w3dp6 hqh7v" onsubmit="return false;">
          ...
          <div class="flex items-center justify-between nt63s">
            <div class="flex items-center bglhu">
              <input type="checkbox" class="d5jfq dlggn" id="rememberMe">
              <label class="wqwbi text-base-content/80 cbpaz text-base" for="rememberMe">Remember Me</label>
            </div>
            <a href="#" class="mnco6 kwr8s o85nv ejsm2">Forgot Password?</a>
          </div>
          <button class="btn kqeru btn-primary y1dss rhmi6">Sign in to FlyonUI</button>
        </form>
        <p class="text-base-content/80 rdi5h">
          New on our platform?
          <a href="#" class="mnco6 kwr8s o85nv ejsm2">Create an account</a>
        </p>
      </div>
    </div>
    <div class="dhabr h-screen uzipw max-lg:hidden">
      <div class="m4hp4 jfin8 flex n85ea jz3o6 justify-between z9y4i o9xn4">
        <div>
          <h1 class="zqxh1 pifxk fl9z1 lmn89">Welcome back! Please sign in to your FlyonUI account</h1>
          <p class="bk5oo u7qxt">
        ...
        <div class="bg-base-100 relative o63tj z9y4i o9xn4">
          ...
          <div class="flex items-center justify-between">
            <p class="ay6fz fl9z1">Please enter your login details</p>
          ...
          <p class="chsc8 c9rvi">Stay connected with FlyonUI Subscribe now for the latest updates and news.</p>
    ...
    <div class="bg-base-100 flex jz3o6 items-center justify-center lg:col-span-3 xl:col-span-2">
      <div class="w-full tkfom s751q">
        ...
        <div class="flex jz3o6 o63tj">
          ...
          <div>
            <h3 class="text-base-content axeut waiii t3mfo">Sign in to FlyonUI</h3>
            <p class="text-base-content/80">Ship Faster and Focus on Growth.</p>
          </div>
          <p class="text-base-content/80">
            Login with
            <a href="#" class="mnco6 kwr8s o85nv ejsm2">Magic Link</a>
          </p>
          <div class="flex mnhlk njdg2 sm:gap-6">
            <a href="#" class="btn g2v48 btn-primary sxihv">Login as User</a>
            <a href="#" class="btn g2v48 btn-primary sxihv">Login as Admin</a>
          </div>
          <form class="w3dp6 hqh7v" onsubmit="return false;">
            <div>
              <label class="wqwbi" for="userEmail">Email address*</label>
...
<body data-vh-checked="true">
  <div class="lg:grid lg:grid-cols-2">
    <div class="flex jz3o6 items-center justify-between v3npj jn469 s751q max-lg:hidden">
      <div>
        <h1 class="zqxh1 fl9z1 lmn89 lg:text-4xl">Welcome back! Please sign in to your FlyonUI account</h1>
        <p class="bk5oo u7qxt">
          Thank you for registering! Please check your inbox and click the verification link to activate your account.
        </p>
      </div>
    ...
    <div class="bg-base-100 flex h-screen jz3o6 items-center justify-center">
      <div class="flex w-full jz3o6 items-center j2n3c max-sm:p-10 sm:max-w-md">
        <div class="rdi5h">
          <h3 class="text-base-content oobh7 waiii t3mfo md:text-3xl lg:text-4xl">Welcome Back 👋</h3>
        ...
        <form class="zqxh1 w-full o63tj" onsubmit="return false;">
          <div>
            <label class="wqwbi rui3g" for="userName">Email address*</label>
          ...
          <button class="btn btn-primary kqeru y1dss rhmi6">Sign in to FlyonUI</button>
        </form>
        <p class="text-base-content/80 rdi5h">
          Don’t have an account yet ?
          <a href="#" class="mnco6 kwr8s o85nv">Sign Up</a>
        </p>
      </div>
    </div>
  </div>
