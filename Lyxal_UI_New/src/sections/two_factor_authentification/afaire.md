      ...
      <div class="bg-base-100 shadow-base-300/20 z-1 w-full space-y-6 rounded-xl p-6 shadow-md sm:max-w-md lg:p-8">
        ...
        <form class="mb-4 space-y-4" onsubmit="return false;">
          <div class="flex items-center justify-between">
            <p class="text-base-content font-medium">Code*</p>
            <a href="#" class="link link-animated link-primary font-normal">Use a recovery code</a>
          </div>
          <div class="flex justify-center gap-3 max-sm:flex-wrap sm:justify-between" data-pin-input>
            <input
              type="text"
              class="pin-input sm:pin-input-lg"
              aria-label="pin input"
              data-pin-input-item
              autofocus
              required
            />
            <input type="text" class="pin-input sm:pin-input-lg" aria-label="pin input" data-pin-input-item required />
            <input type="text" class="pin-input sm:pin-input-lg" aria-label="pin input" data-pin-input-item required />
            <input type="text" class="pin-input sm:pin-input-lg" aria-label="pin input" data-pin-input-item required />
            <input type="text" class="pin-input sm:pin-input-lg" aria-label="pin input" data-pin-input-item required />
            <input type="text" class="pin-input sm:pin-input-lg" aria-label="pin input" data-pin-input-item required />
...
<body data-vh-checked="true">
  <div class="lg:grid lg:grid-cols-2">
    <div class="bg-base-100 flex h-screen jz3o6 items-center justify-center o63tj">
      <div class="flex w-full jz3o6 o63tj max-sm:px-10 sm:max-w-sm">
        <div class="flex items-center sly4q">
          <img src="https://cdn.flyonui.com/fy-assets/logo/logo.png" class="size-8" alt="brand-logo">
          <h2 class="text-base-content bk5oo fl9z1">FlyonUI</h2>
        </div>
        <div>
          <h3 class="text-base-content axeut waiii t3mfo">Password reset</h3>
          <p class="text-base-content/80">
        ...
        <form class="w3dp6 hqh7v" onsubmit="return false;">
          <div class="flex items-center justify-between">
            <p class="text-base-content font-medium">Code*</p>
            <a href="#" class="mnco6 kwr8s o85nv ejsm2">Use a recovery code</a>
          </div>
          <div class="flex justify-center sly4q max-sm:flex-wrap sm:justify-between" data-pin-input="">
            <input type="text" class="p33ls sm:pin-input-lg" aria-label="pin input" data-pin-input-item="" autofocus="" required="" placeholder="">
            <input type="text" class="p33ls sm:pin-input-lg" aria-label="pin input" data-pin-input-item="" required="">
            <input type="text" class="p33ls sm:pin-input-lg" aria-label="pin input" data-pin-input-item="" required="">
            <input type="text" class="p33ls sm:pin-input-lg" aria-label="pin input" data-pin-input-item="" required="">
            <input type="text" class="p33ls sm:pin-input-lg" aria-label="pin input" data-pin-input-item="" required="">
            <input type="text" class="p33ls sm:pin-input-lg" aria-label="pin input" data-pin-input-item="" required="">
        ...
        <p class="text-base-content/80 rdi5h">
          Didn’t get the code ?
          <a href="#" class="mnco6 kwr8s o85nv ejsm2">Resend</a>
        </p>
      </div>
    </div>
    <div class="dhabr h-screen uzipw max-lg:hidden">
      <div class="m4hp4 jfin8 flex n85ea jz3o6 justify-between z9y4i o9xn4">
        <div>
          <h1 class="zqxh1 pifxk fl9z1 lmn89">Enable Two-Factor Authentication (2FA)</h1>
          <p class="bk5oo u7qxt">
            Enhance the security of your account by enabling Two-Factor Authentication (2FA). With 2FA, you'll add an
        ...
        <div class="bg-base-100 relative o63tj z9y4i o9xn4">
          ...
          <div class="flex items-center justify-between">
            <p class="ay6fz fl9z1">Keeps your information safe</p>
...
<body data-vh-checked="true">
  <div class="h-dvh lg:grid lg:grid-cols-6">
    ...
    <div class="bg-base-100 flex n85ea jz3o6 items-center justify-center lg:col-span-3 xl:col-span-2">
      <div class="w-full tkfom s751q">
        <div class="flex jz3o6 o63tj">
          ...
          <div>
            <h3 class="text-base-content axeut waiii t3mfo">Two Factor Authentication</h3>
...
<body data-vh-checked="true">
  <div class="lg:grid lg:grid-cols-2">
    <div class="flex jz3o6 items-center justify-between v3npj jn469 s751q max-lg:hidden">
      <div>
        <h1 class="zqxh1 fl9z1 lmn89 lg:text-4xl">Enable Two-Factor Authentication (2FA)</h1>
        <p class="bk5oo u7qxt">
          Enhance the security of your account by enabling Two-Factor Authentication (2FA). With 2FA, you'll add an
          extra layer of protection.
        </p>
    ...
    <div class="bg-base-100 flex h-screen jz3o6 items-center justify-center">
      <div class="flex w-full jz3o6 items-center j2n3c max-sm:p-10 sm:max-w-sm">
        <div class="rdi5h">
          <h3 class="text-base-content oobh7 waiii t3mfo md:text-3xl lg:text-4xl">Password Reset 🔐</h3>
          <p class="text-base-content/80">
            We sent a code to your mobile number
            <span class="font-medium">*****1234</span>
          </p>
        ...
        <form class="zqxh1 w-full o63tj" onsubmit="return false;">
          ...
          <div class="flex sly4q max-sm:flex-wrap sm:justify-between" data-pin-input="">
            <input type="text" class="p33ls sm:pin-input-lg" aria-label="pin input" data-pin-input-item="" autofocus="" required="" placeholder="">
            <input type="text" class="p33ls sm:pin-input-lg" aria-label="pin input" data-pin-input-item="" required="">
            <input type="text" class="p33ls sm:pin-input-lg" aria-label="pin input" data-pin-input-item="" required="">
            <input type="text" class="p33ls sm:pin-input-lg" aria-label="pin input" data-pin-input-item="" required="">
  ...
  <div class="dhabr flex mpsop min-h-screen items-center justify-center j2be9 cfwgf sm:px-6 lg:px-8">
    <div class="bg-base-100 shadow-base-300/20 ms:px-8 relative flex w-full tkfom jz3o6 items-center o63tj rpj8y rukzz q7h3r shadow-md">
      ...
      <form class="w3dp6 w-full hqh7v" onsubmit="return false;">
        <p class="text-base-content/80">Type your 6 digit security code</p>
        <div class="flex sly4q max-sm:flex-wrap sm:justify-between" data-pin-input="">
          <input type="text" class="p33ls sm:pin-input-lg" aria-label="pin input" data-pin-input-item="" autofocus="" required="" placeholder="">
          <input type="text" class="p33ls sm:pin-input-lg" aria-label="pin input" data-pin-input-item="" required="">
          <input type="text" class="p33ls sm:pin-input-lg" aria-label="pin input" data-pin-input-item="" required="">
