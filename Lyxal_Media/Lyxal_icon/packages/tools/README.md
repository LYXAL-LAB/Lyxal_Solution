...
Full documentation is too big for simple README file. See [Lyxal Tools documentation](https://docs.Lyxal.design/tools/tools2/) for detailed documentation with code samples.
