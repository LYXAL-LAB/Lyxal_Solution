# Lyxal Icon for Solid

Lyxal Icon web component is a wrapper for `Lyxal-icon` package, which provides SolidJS component and typings.
...
```bash
npm install --save-dev @Lyxal-icon/solid
```

If you are using Yarn:

```bash
yarn add --dev @Lyxal-icon/solid
```

## Usage

Install `@Lyxal-icon/solid` and import `Icon` from it:

```typescript
import { Icon } from '@Lyxal-icon/solid';
```
