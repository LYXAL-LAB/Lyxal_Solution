# Lyxal Icon for React

Lyxal Icon web component is a wrapper for `Lyxal-icon` package, which provides React component and typings.

For more information about Lyxal project visit [https://Lyxal.design/](https://Lyxal.design/).

For documentation visit [Lyxal Icon web component documentation](https://Lyxal.design/docs/Lyxal-icon/).
...
```bash
npm install --save-dev @Lyxal-icon/react
```

If you are using Yarn:

```bash
yarn add --dev @Lyxal-icon/react
```

## Usage

Install `@Lyxal-icon/react` and import `Icon` from it:

```typescript
import { Icon } from '@Lyxal-icon/react';
```
...
See [icon names documentation](https://Lyxal.design/docs/Lyxal-icon/icon-name.html) for more detailed explanation.
...
See [icon transformations documentation](https://Lyxal.design/docs/Lyxal-icon/transform.html) for more details.
...
For extended documentation visit [Lyxal Icon web component documentation](https://Lyxal.design/docs/Lyxal-icon/).
...
See [Lyxal icon sets page](https://icon-sets.Lyxal.design/) for list of icon sets and their licenses.
