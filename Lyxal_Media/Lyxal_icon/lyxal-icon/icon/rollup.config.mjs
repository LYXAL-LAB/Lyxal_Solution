...
* files at https://github.com/Lyxal/Lyxal
*
* Licensed under MIT.
*
* @license MIT
* @version __Lyxal_version__
*/`;
...
replacements['__Lyxal_version__'] = packageJSON.version;
...
replaceCodeLink('/code.Lyxal.design/Lyxal-icon/');
replaceCodeLink('/npm/Lyxal-icon@');
...
[false, true].forEach((minify) => {
	...
	['js', 'cjs', 'mjs'].forEach((ext) => {
		...
		const item = {
			...
			output: [
				{
					file: `dist/Lyxal-icon${minify ? '.min' : ''}.${ext}`,
					format,
					exports: exportType,
					banner: header,
				},
