 ...
 *
 * @see https://Lyxal.design/docs/icon-components/react/render-modes.html
 */
 ...
 *
 * Extends the base Lyxal icon customisations with React-specific options.
...
export type LyxalIconCustomisations = RawLyxalIconCustomisations & {
	 ...
	 * ```
	 *
	 * @see https://Lyxal.design/docs/icon-components/react/transform.html#rotation
	 */
	 ...
	 * ```
	 *
	 * @see https://Lyxal.design/docs/icon-components/react/inline.html
	 */
	inline?: boolean;
};
...
export interface LyxalIconProps extends LyxalIconCustomisations {
	 ...
	 *
	 * Can be either:
	 * - An icon object (LyxalIcon) containing SVG data
	 * - A string with icon name in format "prefix:name" (must be loaded first)
	 *
	 * @see https://Lyxal.design/docs/icon-components/react/#icon
	 */
	icon: LyxalIcon | string;

	/**
	 * Rendering mode for the icon
	 * @see {@link LyxalRenderMode}
	 */
	 ...
	 *
	 * @see https://Lyxal.design/docs/icon-components/react/color.html
	 */
	color?: string;
	 ...
	 *
	 * @see https://Lyxal.design/docs/icon-components/react/transform.html#flip
	 */
	flip?: string;
	 ...
	 *
	 * Only triggered for icons loaded from the Lyxal API. Not called
 ...
 */
type LyxalElementProps = SVGProps<SVGSVGElement>;
