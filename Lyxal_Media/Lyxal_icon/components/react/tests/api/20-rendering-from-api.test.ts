...
import { Icon, loadIcons, iconLoaded } from '../../dist/Lyxal';
import { mockAPIData } from '@lyxal-icon/core/lib/api/modules/mock';
...
describe('Rendering icon', () => {
	test('rendering icon after loading it', () => {
		return new Promise((resolve, reject) => {
			...
			const className = `Lyxal Lyxal--${provider} Lyxal--${prefix}`;
