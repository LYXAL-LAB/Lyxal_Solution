...
Its main purpose is to convert icon sets and fonts to Lyxal JSON collections, but it can be used for other purposes.
...
If you need to use CommonJS, install version 4: `npm install @Lyxal/tools@cjs`.

## Functions

Functions incuded in Lyxal Tools:
...
See [Lyxal Tools documentation](https://Lyxal.design/docs/libraries/tools/).
...
Lyxal Tools library is designed to export icons that are safe to use in any environment and render identically for all users.
...
- Optimises icons.
- Exports icons as `LyxalJSON` icon set.

```js
import { promises as fs } from 'fs';
import { importDirectory } from '@Lyxal/tools/lib/import/directory';
import { cleanupSVG } from '@Lyxal/tools/lib/svg/cleanup';
import { runSVGO } from '@Lyxal/tools/lib/optimise/svgo';
import { parseColors, isEmptyColor } from '@Lyxal/tools/lib/colors/parse';
...
Full documentation is too big for simple README file. See [Lyxal Tools documentation](https://Lyxal.design/docs/libraries/tools/) for detailed documentation with code samples.
