...
import type { DownloadNPMPackageResult } from '@Lyxal/tools/lib/download/npm';
import type { LyxalInfo } from '@Lyxal/types';
...
const iconSetPackage: string | null = `@Lyxal-json/${prefix}`;

// Icon set information
const info: LyxalInfo = {
