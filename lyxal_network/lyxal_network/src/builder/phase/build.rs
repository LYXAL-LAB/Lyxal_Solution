...
use lyxal_network_core::{transport::timeout::TransportTimeout, Transport};
...
pub struct BuildPhase<T, B> {
    ...
    pub(crate) swarm_config: lyxal_network_swarm::Config,
    pub(crate) connection_timeout: Duration,
}

impl<Provider, T: AuthenticatedMultiplexedTransport, B: lyxal_network_swarm::NetworkBehaviour>
