...
#[cfg(feature = "relay")]
use lyxal_network_core::muxing::StreamMuxerBox;
...
use lyxal_network_core::{InboundUpgrade, Negotiated, OutboundUpgrade, StreamMuxer, UpgradeInfo};
#[cfg(feature = "relay")]
...
impl<Provider, T: AuthenticatedMultiplexedTransport> SwarmBuilder<Provider, RelayPhase<T>> {
    ...
    <<MuxUpgrade as IntoMultiplexerUpgrade<SecStream>>::Upgrade as UpgradeInfo>::Info: Send,
    {
        let (relay_transport, relay_behaviour) =
            lyxal_network_relay::client::new(self.keypair.public().to_peer_id());
