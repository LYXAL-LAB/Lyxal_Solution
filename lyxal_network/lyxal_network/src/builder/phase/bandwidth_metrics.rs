    ...
    pub fn with_bandwidth_metrics(
        ...
        SwarmBuilder {
            phase: BehaviourPhase {
                ...
                transport: lyxal_network_metrics::BandwidthTransport::new(self.phase.transport, registry)
...
impl<Provider, T: AuthenticatedMultiplexedTransport>
    SwarmBuilder<Provider, BandwidthMetricsPhase<T, lyxal_network_relay::client::Behaviour>>
{
    pub fn with_behaviour<B, R: TryIntoBehaviour<B>>(
        self,
        constructor: impl FnOnce(&lyxal_network_identity::Keypair, lyxal_network_relay::client::Behaviour) -> R,
