...
pub async fn run_test(
    ...
    // See https://github.com/lyxal_network/lyxal_network/issues/4071.
    ...
    match is_dialer {
        ...
        false => {
            ...
            // This is a hack until https://github.com/lyxal_network/lyxal_network/issues/4071 is fixed at which point we can do this unconditionally here.
...
/// Supported transports by lyxal_network.
...
/// Supported stream multiplexers by lyxal_network.
#[derive(Clone, Debug)]
pub enum Muxer {
    Mplex,
    Yamux,
...
/// Supported security protocols by lyxal_network.
#[derive(Clone, Debug)]
...
pub(crate) fn build_behaviour(key: &Keypair) -> Behaviour {
    Behaviour {
        ...
        // Need to include identify until https://github.com/status-im/nim-lyxal_network/issues/924 is resolved.
