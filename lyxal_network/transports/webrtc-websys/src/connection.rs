//! A lyxal_network connection backed by an [RtcPeerConnection](https://developer.mozilla.org/en-US/docs/Web/API/RTCPeerConnection).
...
use lyxal_network_core::muxing::{StreamMuxer, StreamMuxerEvent};
use lyxal_network_webrtc_utils::Fingerprint;
