...
impl ConnectionInner {
    ...
    /// of the server.
    ///
    /// [1]: https://github.com/lyxal_network/specs/tree/master/webtransport#security-handshake
    async fn authenticate(
        ...
        let mut noise = lyxal_network_noise::Config::new(keypair)?;
        ...
        // TODO: This should be part lyxal_network-noise
