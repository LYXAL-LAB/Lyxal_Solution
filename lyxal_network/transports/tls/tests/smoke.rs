...
use lyxal_network_core::{multiaddr::Protocol, transport::MemoryTransport, upgrade::Version, Transport};
use lyxal_network_swarm::{dummy, Config, Swarm, SwarmEvent};
...
fn make_swarm() -> Swarm<dummy::Behaviour> {
    ...
    let transport = MemoryTransport::default()
        .upgrade(Version::V1)
        .authenticate(lyxal_network_tls::Config::new(&identity).unwrap())
