...
Below is a set of coding guidelines followed across the lyxal_network code base.

## Hierarchical State Machines

If you squint, lyxal_network is just a big hierarchy of [state
...
lyxal_network code base. It makes reasoning about control and data flow simple. It
...
trading for correctness and performance which aligns with Rust's and lyxal_network's goals.
...
Note that lyxal_network fails at this guideline, i.e. still has many unbounded
local queues.
...
Simply put, lyxal_network spawns one task per connection but limits the overall
...
The majority of lyxal_network's code base follows the above Golang philosophy,
