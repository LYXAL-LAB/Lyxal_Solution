...
use lyxal_network_identity::{Keypair, PublicKey, SigningError};
...
///
/// For more details see lyxal_network RFC0002: <https://github.com/lyxal_network/specs/blob/master/RFC/0002-signed-envelopes.md>
...
pub enum DecodingError {
    ...
    InvalidPublicKey(#[from] lyxal_network_identity::DecodingError),
    /// The public key in the envelope could not be converted to our internal public key type.
