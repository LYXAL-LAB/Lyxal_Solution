...
use lyxal_network_core::{muxing::SubstreamBox, Negotiated};
...
impl Stream {
    ...
    /// Some protocols like lyxal_network's [ping](https://github.com/lyxal_network/specs/blob/master/ping/ping.md)
