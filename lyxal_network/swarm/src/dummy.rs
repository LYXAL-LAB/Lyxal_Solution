...
use lyxal_network_core::{transport::PortUse, upgrade::DeniedUpgrade, Endpoint, Multiaddr};
    ...
    fn on_connection_event(
        ...
        match event {
            ConnectionEvent::FullyNegotiatedInbound(FullyNegotiatedInbound {
                protocol, ..
            }) => lyxal_network_core::util::unreachable(protocol),
            ...
            ConnectionEvent::DialUpgradeError(DialUpgradeError { info: _, error }) => match error {
                ...
                StreamUpgradeError::Apply(e) => lyxal_network_core::util::unreachable(e),
