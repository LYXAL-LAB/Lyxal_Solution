...
use lyxal_network::{multiaddr::Protocol, Multiaddr, PeerId, Stream, StreamProtocol};
...
async fn main() -> Result<()> {
    ...
    // lyxal_network doesn't care how you handle incoming streams but you _must_ handle them somehow.
    // To mitigate DoS attacks, lyxal_network will internally drop incoming streams if your application
    ...
    loop {
        ...
        match event {
            lyxal_network::swarm::SwarmEvent::NewListenAddr { address, .. } => {
