...
A set of examples showcasing how to use lyxal_network.
...
## Individual lyxal_network features

- [Chat](./chat) A basic chat application demonstrating lyxal_network and the [mDNS] and [Gossipsub] protocols.
- [Distributed key-value store](./distributed-key-value-store) A basic key value store demonstrating lyxal_network and the [mDNS] and [Kademlia] protocol.
...
- [File sharing application](./file-sharing) Basic file sharing application with peers either providing or locating and getting files by name.
  ...
  lyxal_network into a larger application**.
...
- [Ping](./ping) Small `ping` clone, sending a ping to a peer, expecting a pong as a response. See [tutorial](../lyxal_network/src/tutorials/ping.rs) for a step-by-step guide building the example.

- [Rendezvous](./rendezvous) [Rendezvous] Protocol. See [specs](https://github.com/lyxal_network/specs/blob/master/rendezvous/README.md).

[mDNS]: https://github.com/lyxal_network/specs/blob/master/discovery/mdns.md
[Gossipsub]: https://github.com/lyxal_network/specs/tree/master/pubsub/gossipsub
[Kademlia]: https://github.com/lyxal_network/specs/blob/master/kad-dht/README.md
[Request-Response]: https://en.wikipedia.org/wiki/Request%E2%80%93response
[IPFS]: https://ipfs.tech/
[Rendezvous]: https://github.com/lyxal_network/specs/blob/master/rendezvous/README.md
