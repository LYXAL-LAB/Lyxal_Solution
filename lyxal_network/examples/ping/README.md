...
The ping example demonstrates the basic usage of **lyxal_network** to create a simple p2p network and implement a ping protocol.
By running multiple nodes and observing the ping behavior, users can gain insights into how **lyxal_network** facilitates communication and interaction between peers.
