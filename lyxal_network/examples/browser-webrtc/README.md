# Rust-lyxal_network Browser-Server WebRTC Example

This example demonstrates how to use the `lyxal_network-webrtc-websys` transport library in a browser to ping the WebRTC Server.
