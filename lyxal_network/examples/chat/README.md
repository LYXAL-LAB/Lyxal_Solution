...
A basic chat application with logs demonstrating lyxal_network and the gossipsub protocol combined with mDNS for the discovery of peers to gossip with.
...
This chat application demonstrates the usage of **lyxal_network** and the gossipsub protocol for building a decentralized chat system.
By leveraging mDNS for peer discovery, users can easily connect with other peers and engage in real-time conversations.
The example provides a starting point for developing more sophisticated chat applications using **lyxal_network** and exploring the capabilities of decentralized communication.
