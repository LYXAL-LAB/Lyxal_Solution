...
import (
    ...
    "github.com/lyxal_network/go-lyxal_network/core/crypto"
    "github.com/lyxal_network/go-lyxal_network/core/peer"
    "github.com/lyxal_network/go-lyxal_network/core/transport"
    "github.com/lyxal_network/go-lyxal_network/p2p/transport/quicreuse"
    webtransport "github.com/lyxal_network/go-lyxal_network/p2p/transport/webtransport"
...
func serveConn(conn transport.CapableConn) {
    go func() {
        for {
            ...
            // initiate the stream.
            //
            // Ref: https://github.com/lyxal_network/go-lyxal_network/issues/2343
            stream.Write([]byte("1"))
