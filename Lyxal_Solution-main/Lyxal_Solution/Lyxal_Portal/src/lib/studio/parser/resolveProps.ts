 ...
 */
let actionContext: { handleAction?: (action: any, event?: any) => Promise<any> } = {};

/**
 * Définit le contexte d'actions pour la résolution des props
 */
export const setActionContext = (context: { handleAction: (action: any, event?: any) => Promise<any> }) => {
