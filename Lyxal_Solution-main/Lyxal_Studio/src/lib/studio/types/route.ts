...
export type RouteStatus =
  ...
  | 'draft'      // Route en brouillon
  | 'deprecated'; // Route dépréciée
 ...
 */
export type UpdateStudioRouteInput = Partial<Pick<StudioRoute, 'identity' | 'page' | 'permissions' | 'guards' | 'metadata' | 'status'>> & { id: string };
