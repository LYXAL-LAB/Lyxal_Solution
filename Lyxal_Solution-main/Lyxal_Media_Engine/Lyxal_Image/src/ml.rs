...
impl FaceDetector {
    ...
    // Retourne (x, y, w, h)
    pub fn detect_primary_face(&self, _img: &LyxalImage) -> LyxalResult<Option<(u32, u32, u32, u32)>> {
        // NETTOYAGE CTO : Pas de fausse bbox. Feature désactivée pour l'instant.
        Err(LyxalError::FeatureUnavailable("Face Detection not implemented yet".into()))
    }
}
