...
class PDFParser extends PDFObjectParser {
  static forBytesWithOptions = (
    ...
    new PDFParser(pdfBytes, undefined, objectsPerTick, throwOnInvalidObject, capNumbers);
  ...
  constructor(
    ...
    super(ByteStream.of(pdfBytes), context || PDFContext.create(), capNumbers);
  ...
  public async parseIndirectObject(): Promise<[PDFRef, PDFObject]> {
