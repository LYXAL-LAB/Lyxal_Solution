...
class SingleIntersector {
  ...
  addGlyph(x: number, y: number, glyph: string) {
...
export class Intersector {
  #intersectors: SingleIntersector[] = [];
  ...
  addGlyph(transform: number[], width: number, height: number, glyph: string) {
