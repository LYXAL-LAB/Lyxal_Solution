...
import { CmykICCBasedCS, IccColorSpace } from "./icc_colorspace";
import { Dict, Name, Ref } from "./primitives";
import { MathClamp, shadow, unreachable, warn } from "../shared/util";
...
export class ColorSpaceUtils {
  static parse({
    ...
    let csName: string | undefined, csRef: Ref | undefined, parsedCS;
   ...
   */
  static #subParse(cs: any, options: any): ColorSpace {
  ...
  static #parse(cs: any, options: any): ColorSpace {
