...
import { XMLParserBase, XMLParserErrorCode } from "../xml_parser.ts";
...
class XFAParser extends XMLParserBase {
  ...
  constructor(rootNameSpace: any = null, richText = false) {
    super();
    // @ts-ignore
  ...
  _mkAttributes(attributes: any[], tagName: string) {
    // Transform attributes into an object and get out
    // namespaces information.
    let namespace = null;
    let prefixes: any = null;
    const attributeObj: any = Object.create({});
  ...
  onBeginElement(tagName: string, attributes: any[], isEmpty: boolean) {
