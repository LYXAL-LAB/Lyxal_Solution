...
class FontFinder {
  ...
  add(pdfFonts: any[], reallyMissingFonts: Set<string> | null = null) {
...
function selectFont(xfaFont: any, typeface: any) {
...
function getMetrics(xfaFont: any, real = false) {
  let pdfFont = null;
  if (xfaFont) {
