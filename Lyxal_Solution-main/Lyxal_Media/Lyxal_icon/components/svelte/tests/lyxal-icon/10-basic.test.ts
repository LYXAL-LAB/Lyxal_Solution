...
describe('Creating component', () => {
	...
	test('custom loader', async () => {
		...
		// Check HTML
		expect(html.replace(/<!--(.*?)-->/gm, '')).toBe(
			`<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" viewBox="0 0 24 24" class="Lyxal Lyxal--${prefix}"><path d="M4 19h16v2H4zm5-4h11v2H9zm-5-4h16v2H4zm0-8h16v2H4zm5 4h11v2H9z" fill="currentColor"></path></svg>`
		);
