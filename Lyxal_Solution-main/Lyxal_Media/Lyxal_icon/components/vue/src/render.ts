...
import { mergeCustomisations } from '@Lyxal/utils/lib/customisations/merge';
import { flipFromString } from '@Lyxal/utils/lib/customisations/flip';
import { rotateFromString } from '@Lyxal/utils/lib/customisations/rotate';
import { iconToSVG } from '@Lyxal/utils/lib/svg/build';
import { replaceIDs } from '@Lyxal/utils/lib/svg/id';
import { iconToHTML } from '@Lyxal/utils/lib/svg/html';
import { svgToURL } from '@Lyxal/utils/lib/svg/url';
import type {
