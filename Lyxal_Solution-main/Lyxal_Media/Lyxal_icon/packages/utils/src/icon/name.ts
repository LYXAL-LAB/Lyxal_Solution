 ...
 * Icon name
 */
export interface LyxalIconName {
 ...
 */
export type LyxalIconSource = Omit<LyxalIconName, 'name'>;

/**
 * Expression to test part of icon name.
 *
 * Used when loading icons from Lyxal API due to project naming convension.
 * Ignored when using custom icon sets - convension does not apply.
 */
export const matchIconName = /^[a-z0-9]+(-[a-z0-9]+)*$/;

/**
 * Convert string icon name to LyxalIconName object.
 */
