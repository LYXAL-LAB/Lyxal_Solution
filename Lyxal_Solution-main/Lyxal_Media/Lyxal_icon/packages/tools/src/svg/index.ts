...
import { iconToSVG, trimSVG } from '@lyxal-icon/utils';
...
} from '@lyxal-icon/utils';
import type { IconViewBox } from '@lyxal-icon/utils/lib/svg/viewbox/types.js';
import { parseViewBox } from '@lyxal-icon/utils/lib/svg/viewbox/parse.js';

type ViewBox = IconViewBox;

// Re-export types
export type { LyxalIconCustomisations, LyxalIcon, ViewBox };
...
export class SVG {
	 ...
	 */
	toMinifiedString(customisations?: LyxalIconCustomisations): string {
	 ...
	 */
	toPrettyString(customisations?: LyxalIconCustomisations): string {
