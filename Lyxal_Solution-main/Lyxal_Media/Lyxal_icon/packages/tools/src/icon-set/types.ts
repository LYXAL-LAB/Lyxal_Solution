...
/**
 * Get common properties: LyxalOptional + APIIconAttributes
 */
...
/**
 * Exclude LyxalOptional from CommonIconProps
 */
export type ExtraIconProps = Omit<CommonIconProps, keyof LyxalOptional>;
 ...
 */
export interface ResolvedLyxalIcon extends LyxalIcon, ExtraIconProps { }
