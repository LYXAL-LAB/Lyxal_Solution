...
describe('Loading icon set', () => {
	...
	test('With properties', () => {
		...
		// Resolve icons
		const expected1: ResolvedLyxalIcon = {
			body: '<g/>',
			width: 32,
			height: 24,
			hFlip: true,
		...
		const expected1Full: Required<ResolvedLyxalIcon> = {
			body: '<g/>',
			width: 32,
			height: 24,
			left: 0,
