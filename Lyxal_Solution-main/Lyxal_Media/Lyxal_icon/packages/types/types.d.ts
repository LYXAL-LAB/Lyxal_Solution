 ...
 */
export interface LyxalDimenisons {
	/**
 ...
 */
export interface LyxalTransformations {
	/**
 ...
 */
export interface LyxalOptional
	extends LyxalDimenisons,
		LyxalTransformations {}

/**
 * Icon alias definition.
 */
export interface LyxalAlias extends LyxalOptional {
	/**
	...
	/*
	 * Optional properties from LyxalOptional can be used to override
	 * the parent icon's properties. Transformations are merged rather than overridden.
	 * @see LyxalTransformations for transformation merging behavior
	 */
}
 ...
 */
export interface LyxalIcon extends LyxalOptional {
	/**
	...
	/*
	 * Optional properties from LyxalOptional can be used to define
 ...
 *
 * Additional properties provided by the Lyxal API that affect icon discovery and search behavior.
 ...
 */
export interface ExtendedLyxalIcon extends LyxalIcon, APIIconAttributes {}

/**
 * Extended alias definition with API attributes.
 */
export interface ExtendedLyxalAlias extends LyxalAlias, APIIconAttributes {}
 ...
 */
export interface LyxalAliases {
	/**
	 * Alias definitions indexed by name without prefix.
	 */
	[iconName: string]: ExtendedLyxalAlias;
}

/**
 * Icon set information and metadata.
 */
export interface LyxalInfo {
	/**
	...
	/**
	 * Category classification for the Lyxal collections list.
	 */
	category?: string;
 ...
 * format in LyxalMetaData instead.
 */
export interface LegacyLyxalThemes {
	/**
 ...
 */
export interface LyxalCategories {
	/**
 ...
 */
export interface LyxalMetaData {
	/**
 ...
 */
export interface LyxalJSONIconsData extends LyxalDimenisons {
	/**
	 ...
	 */
	aliases?: LyxalAliases;

	/*
	 * Default viewBox dimensions inherited from LyxalDimenisons.
	 *
 ...
 */
export interface LyxalJSON extends LyxalJSONIconsData, LyxalMetaData {
	/**
	 ...
	 *
	 * Returned by the Lyxal API when querying for non-existent icons
...
/**
 * Structure of '@lyxal-json/*' package exports.
 *
 ...
 */
export interface LyxalJSONPackageExports {
	/**
	 * Icon set information and metadata.
	 */
	info: LyxalInfo;
