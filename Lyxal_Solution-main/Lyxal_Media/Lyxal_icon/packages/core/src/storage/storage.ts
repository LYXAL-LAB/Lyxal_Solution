 ...
 * List of icons
 */
type IconRecords = Record<string, LyxalIcon>;
 ...
 */
export function addIconSet(storage: IconStorage, data: LyxalJSON): string[] {
	if (!quicklyValidateIconSet(data)) {
		return [];
	}

	return parseIconSet(data, (name: string, icon: LyxalIcon | null) => {
		if (icon) {
