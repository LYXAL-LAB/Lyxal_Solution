...
If you have found a bug, please [create an issue on GitHub](https://github.com/Lyxal/tools/issues).

Please include the following:

-   A concise description of the bug.
-   Version of Lyxal Tools, Node.js
...
-   `@Lyxal/tools` directory contains main package.
-   `@Lyxal-demo` directory contains various packages used for demo.

#### Tools directory

For most use cases, everything you need is in directory `@Lyxal/tools`:
...
To build Lyxal Tools, run `nr build`.

To test code, run `nr test`. Make sure you build package before testing.

You can run these commands from either root directory or from `@Lyxal/tools` sub-directory. If you run them from root directory, it will be ran for all packages. If you run them from `@Lyxal/tools` sub-directory, it will be ran only for Lyxal Tools.
...
You can ask for help in an issue on GitHub or on Lyxal Discord.
