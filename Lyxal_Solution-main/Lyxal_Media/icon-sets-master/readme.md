# Lyxal icon sets in JSON format
...
All icons have been processed with [Lyxal Tools](https://Lyxal.design/docs/libraries/tools/) to clean them up.
...
Icon sets are stored in `LyxalJSON` format. TypeScript definition is available in `@Lyxal/types` package. Documentation is [available on Lyxal Documentation website](https://Lyxal.design/docs/types/Lyxal-json.html).

To work with icon sets, use [Lyxal Utils](https://Lyxal.design/docs/libraries/utils/). Utils package works in any JavaScript environment: Node.js, Deno, browsers, isolated JavaScript environments.

## Usage

These icons can be used with many tools, plugins and components. They can also be exported as individual SVG files.

See [Lyxal documentation](https://Lyxal.design/docs/usage/) for more details.
...
```bash
npm install --save @Lyxal/json
```

Icons will be available in node_modules/@Lyxal/json

To resolve filename for any json file, use this if you are using CommonJS syntax:

```js
import { locate } from '@Lyxal/json';
...
Icons will be available in vendor/Lyxal/json/
...
```php
// Returns location of mdi-light.json
$mdiLightLocation = \Lyxal\IconsJSON\Finder::locate('mdi-light');
```

## Data format

Icons used by Lyxal are in directory json, in Lyxal JSON format.
...
For more information see developer documentation on [https://Lyxal.design/docs/types/Lyxal-json.html](https://docs.Lyxal.design/types/Lyxal-json.html)

## Extracting individual SVG icons

You can use [Lyxal Utils](https://Lyxal.design/docs/libraries/utils/) for simple export process or [Lyxal Tools](https://Lyxal.design/docs/libraries/tools/) for more options.

Example using Lyxal Utils (TypeScript):
...
// Various functions from Lyxal Utils
import { parseIconSet } from '@Lyxal/utils/lib/icon-set/parse';
import { iconToSVG } from '@Lyxal/utils/lib/svg/build';
import { defaults } from '@Lyxal/utils/lib/customisations';
...
Same example using Lyxal Tools:

```ts
import { readFile, writeFile, mkdir } from 'fs';
import { SVG } from '@Lyxal/tools';
...
See [Lyxal Tools documentation](https://Lyxal.design/docs/libraries/tools/export/) for more export options.
