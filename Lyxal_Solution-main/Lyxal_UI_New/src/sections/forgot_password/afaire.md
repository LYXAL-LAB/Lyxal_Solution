  ...
  <div class="lg:grid lg:grid-cols-2">
    <div class="bg-base-100 flex h-screen jz3o6 items-center justify-center o63tj">
      <div class="flex w-full jz3o6 o63tj max-sm:px-10 sm:max-w-md">
        ...
        <div>
          <h3 class="text-base-content axeut waiii t3mfo">Forgot Password?</h3>
          <p class="text-base-content/80">Enter your email and we'll send you instructions to reset your password</p>
        </div>
        <form class="w3dp6 hqh7v" onsubmit="return false;">
          ...
          <button class="btn kqeru btn-primary y1dss rhmi6">Send Reset Link</button>
        </form>
      ...
      <div class="m4hp4 jfin8 flex n85ea jz3o6 justify-between z9y4i o9xn4">
        ...
        <div class="bg-base-100 relative o63tj z9y4i o9xn4">
          ...
          <div class="flex items-center justify-between">
            <p class="ay6fz fl9z1">Follow the instructions</p>
          ...
          <p class="c9rvi">If you don’t see the email in your inbox, be sure to check your spam or junk folder.</p>
  ...
  <div class="lg:grid lg:grid-cols-2">
    ...
    <div class="bg-base-100 flex h-screen jz3o6 items-center justify-center">
      <div class="flex w-full jz3o6 items-center j2n3c max-sm:p-10 sm:max-w-md">
        <div class="rdi5h">
          <h3 class="text-base-content oobh7 waiii t3mfo md:text-3xl lg:text-4xl">Forgot Password ? 🔒</h3>
          <p class="text-base-content/80">No worries, we’ll send you reset instructions.</p>
        </div>
        <form class="zqxh1 w-full o63tj" onsubmit="return false;">
          <div>
            <label class="wqwbi rui3g" for="userEmail">Email address*</label>
            <input type="email" placeholder="Enter your email address" class="ljn0d fo8mv" id="userEmail" required="">
          </div>
          <button class="btn btn-primary kqeru y1dss rhmi6">Send Reset Link</button>
        </form>
        <div class="dh3pr flex items-center justify-center bglhu">
          <span class="icon-[tabler--chevron-left] text-primary size-5 shrink-0 ciihs group-hover:-translate-x-1 rtl:rotate-180"></span>
          <a href="#" class="mnco6 kwr8s o85nv ejsm2">Back to login</a>
...
<body data-vh-checked="true">
  <div class="dhabr flex mpsop min-h-screen items-center justify-center j2be9 cfwgf sm:px-6 lg:px-8">
    <div class="bg-base-100 shadow-base-300/20 ms:px-8 relative flex w-full tkfom jz3o6 items-center o63tj rpj8y rukzz q7h3r shadow-md">
      ...
      <div class="rdi5h">
        <h3 class="text-base-content axeut waiii t3mfo">Forgot Password?</h3>
        <p class="text-base-content/80 tkfom">
          Enter your email and we’ll send you instructions to reset your password
        </p>
      </div>
