    ...
    <div class="relative flex items-center justify-center px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-base-100 shadow-base-300/20 z-1 w-full space-y-6 rounded-xl p-6 shadow-md sm:max-w-md lg:p-8">
        ...
        <form class="mb-4 space-y-4" onsubmit="return false;">
          ...
          <div>
            <label class="label-text" for="userNewPassword">New Password*</label>
            <div class="input">
              <input id="userNewPassword" type="password" placeholder="············" required />
              <button
                type="button"
                data-toggle-password='{ "target": "#userNewPassword" }'
        ...
        <div class="group flex items-center justify-center gap-2">
          ...
          ></span>
          <a href="#" class="link link-animated link-primary font-normal">Back to login</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="lg:grid lg:grid-cols-2">
    <div class="bg-base-100 flex h-screen jz3o6 items-center justify-center o63tj">
      <div class="flex w-full jz3o6 o63tj max-sm:px-10 sm:max-w-md">
        ...
        <div>
          <h3 class="text-base-content axeut waiii t3mfo">Set new password</h3>
          <p class="text-base-content/80">Must be at least 8 characters.</p>
        </div>
        <form class="w3dp6 hqh7v" onsubmit="return false;">
          <div>
            <label class="wqwbi" for="userNewPassword">New Password*</label>
            <div class="ljn0d">
              <input id="userNewPassword" type="password" placeholder="············" required="">
              <button type="button" data-toggle-password="{ &quot;target&quot;: &quot;#userNewPassword&quot; }" class="block lx78o" aria-label="userNewPassword">
                <span class="icon-[tabler--eye] password-active:block hidden size-5 shrink-0"></span>
                <span class="icon-[tabler--eye-off] password-active:hidden block size-5 shrink-0"></span>
              </button>
            </div>
          ...
          <button class="btn kqeru btn-primary y1dss rhmi6">Reset Password</button>
        </form>
        <div class="dh3pr flex items-center justify-center bglhu">
          <span class="icon-[tabler--chevron-left] text-primary size-5 shrink-0 ciihs group-hover:-translate-x-1 rtl:rotate-180"></span>
          <a href="#" class="mnco6 kwr8s o85nv ejsm2">Back to login</a>
        </div>
      </div>
    </div>
    <div class="dhabr h-screen uzipw max-lg:hidden">
      <div class="m4hp4 jfin8 flex n85ea jz3o6 justify-between z9y4i o9xn4">
        <div>
          <h1 class="zqxh1 pifxk fl9z1 lmn89">
        ...
        <div class="bg-base-100 relative o63tj z9y4i o9xn4">
          ...
          <div class="flex items-center justify-between">
            <p class="ay6fz fl9z1">Reset Your Password</p>
          ...
          <p class="chsc8 c9rvi">You're just one step away from regaining access to your account.</p>
    ...
    <div class="bg-base-100 flex jz3o6 items-center justify-center lg:col-span-3 xl:col-span-2">
      <div class="w-full tkfom s751q">
        ...
        <div class="flex jz3o6 o63tj">
          ...
          <div>
            <h3 class="text-base-content axeut waiii t3mfo">Reset Password</h3>
            <p class="text-base-content/80 ka2aa">
              Please enter your current password and choose a new password to update your account security.
            </p>
          </div>
          <form class="w3dp6 hqh7v" onsubmit="return false;">
            ...
            <button class="btn kqeru btn-primary y1dss rhmi6">Set new password</button>
          </form>
          <div class="dh3pr flex items-center justify-center bglhu">
            <span class="icon-[tabler--chevron-left] text-primary size-5 shrink-0 ciihs group-hover:-translate-x-1 rtl:rotate-180"></span>
            <a href="#" class="mnco6 kwr8s o85nv ejsm2">Back to login</a>
...
<body data-vh-checked="true">
  <div class="lg:grid lg:grid-cols-2">
    <div class="flex jz3o6 items-center justify-between v3npj jn469 s751q max-lg:hidden">
      <div>
        <h1 class="zqxh1 fl9z1 lmn89 lg:text-4xl">
          You're just one step away from regaining access to your account.
        </h1>
        <p class="bk5oo u7qxt">
          Please create a new password below. Make sure it’s strong and secure, combining letters, numbers, and special
          characters.
        </p>
      </div>
    ...
    <div class="bg-base-100 flex h-screen jz3o6 items-center justify-center">
      <div class="flex w-full jz3o6 items-center j2n3c max-sm:p-10 sm:max-w-md">
        <div class="rdi5h">
          <h3 class="text-base-content oobh7 waiii t3mfo md:text-3xl lg:text-4xl">Set new password 🔑</h3>
          <p class="text-base-content/80">Must be at last 8 characters.</p>
        </div>
        <form class="zqxh1 w-full o63tj" onsubmit="return false;">
          <div>
            <label class="wqwbi rui3g" for="userNewPassword">New Password*</label>
            <div class="ljn0d fo8mv">
              <input id="userNewPassword" type="password" placeholder="New password" required="">
              <button type="button" data-toggle-password="{ &quot;target&quot;: &quot;#userNewPassword&quot; }" class="block lx78o" aria-label="userNewPassword">
                <span class="icon-[tabler--eye] password-active:block hidden size-5 shrink-0"></span>
                <span class="icon-[tabler--eye-off] password-active:hidden block size-5 shrink-0"></span>
              </button>
          ...
          <div>
            <label class="wqwbi rui3g" for="confirmUserNewPassword">Confirm New Password*</label>
            <div class="ljn0d fo8mv">
              <input id="confirmUserNewPassword" type="password" placeholder="Confirm New Password" required="">
              <button type="button" data-toggle-password="{ &quot;target&quot;: &quot;#confirmUserNewPassword&quot; }" class="block lx78o" aria-label="confirmUserNewPassword">
                <span class="icon-[tabler--eye] password-active:block hidden size-5 shrink-0"></span>
                <span class="icon-[tabler--eye-off] password-active:hidden block size-5 shrink-0"></span>
              </button>
            </div>
          </div>
          <button class="btn kqeru btn-primary kqeru y1dss rhmi6">Reset Password</button>
        </form>
        <div class="dh3pr flex items-center justify-center bglhu">
          <span class="icon-[tabler--chevron-left] text-primary size-5 shrink-0 ciihs group-hover:-translate-x-1 rtl:rotate-180"></span>
          <a href="#" class="mnco6 kwr8s o85nv ejsm2">Back to login</a>
...
<body data-vh-checked="true">
  <div class="dhabr flex mpsop min-h-screen items-center justify-center j2be9 cfwgf sm:px-6 lg:px-8">
    <div class="bg-base-100 shadow-base-300/20 ms:px-8 relative flex w-full tkfom jz3o6 items-center o63tj rpj8y rukzz q7h3r shadow-md">
      ...
      <div class="rdi5h">
        <h3 class="text-base-content axeut waiii t3mfo">Reset Password</h3>
        <p class="text-base-content/80 tkfom">Time for a fresh start! Go ahead and set a new password.</p>
      </div>
      ...
      <form class="w3dp6 w-full hqh7v" onsubmit="return false;">
        ...
        <button class="btn kqeru btn-primary y1dss rhmi6">Save Changes</button>
      </form>
      <div class="dh3pr flex items-center justify-center bglhu">
        <span class="icon-[tabler--chevron-left] text-primary size-5 shrink-0 ciihs group-hover:-translate-x-1 rtl:rotate-180"></span>
        <a href="#" class="mnco6 kwr8s o85nv ejsm2">Back to login</a>
