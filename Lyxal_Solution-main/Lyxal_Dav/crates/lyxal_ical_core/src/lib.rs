...
pub use timezone::{TimeSpec, VTimezoneDef, extract_vtimezones};
...
/// Occurrences en fournissant des définitions VTIMEZONE pré-parsées.
pub fn occurrences_with_vtimezones(
    ...
    recur::occurrences_with_vtimezones(rrule, dtstart, tz, range_start, range_end, exdates, rdates, vtimezones)
}
