...
// packages/lyxalui/index.ts
var exports_lyxalui = {};
__export(exports_lyxalui, {
  default: () => lyxalui_default
});
module.exports = __toCommonJS(exports_lyxalui);

// packages/lyxalui/functions/themeOrder.ts
var themeOrder = [
  "light",
  "dark",
  "cupcake",
...
var themeOrder_default = themeOrder;

// packages/lyxalui/functions/pluginOptionsHandler.ts
...
// packages/lyxalui/functions/plugin.ts
var plugin = {
...
// packages/lyxalui/functions/variables.ts
var variables = {
  colors: {
...
// packages/lyxalui/functions/addPrefix.ts
...
// packages/lyxalui/base/rootscrollgutter/index.ts
...
// packages/lyxalui/base/rootscrolllock/object.ts
var object_default5 = {
  ":root:not(span)": {
...
// packages/lyxalui/base/rootscrolllock/index.ts
...
// packages/lyxalui/base/scrollbar/object.ts
var object_default6 = {
  ":root": {
...
// packages/lyxalui/base/svg/index.ts
var svg_default = ({ addBase, prefix = "" }) => {
  const prefixedsvg = addPrefix(object_default7, prefix);
  addBase({ ...prefixedsvg });
};

// packages/lyxalui/components/alert/object.ts
var object_default8 = {
  ".alert": {
    "border-width": "var(--border)",
    "border-color": "var(--alert-border-color, var(--color-base-200))",
    "@layer lyxalui.l1.l2.l3": {
      "border-style": "solid",
...
// packages/lyxalui/components/alert/index.ts
var alert_default = ({ addComponents, prefix = "" }) => {
  const prefixedalert = addPrefix(object_default8, prefix);
  addComponents({ ...prefixedalert });
};

// packages/lyxalui/components/avatar/object.ts
var object_default9 = {
  ".avatar-group": {
    "@layer lyxalui.l1.l2.l3": {
      display: "flex",
...
// packages/lyxalui/components/avatar/index.ts
var avatar_default = ({ addComponents, prefix = "" }) => {
  const prefixedavatar = addPrefix(object_default9, prefix);
  addComponents({ ...prefixedavatar });
};

// packages/lyxalui/components/badge/object.ts
...
// packages/lyxalui/components/badge/index.ts
var badge_default = ({ addComponents, prefix = "" }) => {
  const prefixedbadge = addPrefix(object_default10, prefix);
  addComponents({ ...prefixedbadge });
};

// packages/lyxalui/components/breadcrumbs/object.ts
...
// packages/lyxalui/components/breadcrumbs/index.ts
var breadcrumbs_default = ({ addComponents, prefix = "" }) => {
  const prefixedbreadcrumbs = addPrefix(object_default11, prefix);
  addComponents({ ...prefixedbreadcrumbs });
};

// packages/lyxalui/components/button/object.ts
...
// packages/lyxalui/components/button/index.ts
var button_default = ({ addComponents, prefix = "" }) => {
  const prefixedbutton = addPrefix(object_default12, prefix);
  addComponents({ ...prefixedbutton });
};

// packages/lyxalui/components/calendar/object.ts
...
// packages/lyxalui/components/calendar/index.ts
var calendar_default = ({ addComponents, prefix = "" }) => {
  const prefixedcalendar = addPrefix(object_default13, prefix);
  addComponents({ ...prefixedcalendar });
};

// packages/lyxalui/components/card/object.ts
...
// packages/lyxalui/components/card/index.ts
var card_default = ({ addComponents, prefix = "" }) => {
  const prefixedcard = addPrefix(object_default14, prefix);
  addComponents({ ...prefixedcard });
};

// packages/lyxalui/components/carousel/object.ts
...
// packages/lyxalui/components/carousel/index.ts
var carousel_default = ({ addComponents, prefix = "" }) => {
  const prefixedcarousel = addPrefix(object_default15, prefix);
  addComponents({ ...prefixedcarousel });
};

// packages/lyxalui/components/chat/object.ts
...
// packages/lyxalui/components/chat/index.ts
var chat_default = ({ addComponents, prefix = "" }) => {
  const prefixedchat = addPrefix(object_default16, prefix);
  addComponents({ ...prefixedchat });
};

// packages/lyxalui/components/checkbox/object.ts
...
// packages/lyxalui/components/checkbox/index.ts
...
// packages/lyxalui/components/collapse/object.ts
...
// packages/lyxalui/components/collapse/index.ts
var collapse_default = ({ addComponents, prefix = "" }) => {
  const prefixedcollapse = addPrefix(object_default18, prefix);
  addComponents({ ...prefixedcollapse });
};

// packages/lyxalui/components/countdown/object.ts
...
// packages/lyxalui/components/countdown/index.ts
var countdown_default = ({ addComponents, prefix = "" }) => {
  const prefixedcountdown = addPrefix(object_default19, prefix);
  addComponents({ ...prefixedcountdown });
};

// packages/lyxalui/components/diff/object.ts
  ...
  ".diff-item-2": {
    "@layer lyxalui.l1.l2.l3": {
      ...
      "&:after": {
        ...
        height: "1.8rem",
        border: [
          "2px solid var(--color-base-100)",
          "0.5px solid #0000001f"
        ],
        content: '""',
...
// packages/lyxalui/components/diff/index.ts
var diff_default = ({ addComponents, prefix = "" }) => {
  const prefixeddiff = addPrefix(object_default20, prefix);
  addComponents({ ...prefixeddiff });
};

// packages/lyxalui/components/divider/object.ts
...
// packages/lyxalui/components/divider/index.ts
var divider_default = ({ addComponents, prefix = "" }) => {
  const prefixeddivider = addPrefix(object_default21, prefix);
  addComponents({ ...prefixeddivider });
};

// packages/lyxalui/components/dock/object.ts
...
// packages/lyxalui/components/dock/index.ts
var dock_default = ({ addComponents, prefix = "" }) => {
  const prefixeddock = addPrefix(object_default22, prefix);
  addComponents({ ...prefixeddock });
};

// packages/lyxalui/components/drawer/object.ts
...
// packages/lyxalui/components/drawer/index.ts
var drawer_default = ({ addComponents, prefix = "" }) => {
  const prefixeddrawer = addPrefix(object_default23, prefix);
  addComponents({ ...prefixeddrawer });
};

// packages/lyxalui/components/dropdown/object.ts
...
// packages/lyxalui/components/dropdown/index.ts
var dropdown_default = ({ addComponents, prefix = "" }) => {
  const prefixeddropdown = addPrefix(object_default24, prefix);
  addComponents({ ...prefixeddropdown });
};

// packages/lyxalui/components/fab/object.ts
...
// packages/lyxalui/components/fab/index.ts
var fab_default = ({ addComponents, prefix = "" }) => {
  const prefixedfab = addPrefix(object_default25, prefix);
  addComponents({ ...prefixedfab });
};

// packages/lyxalui/components/fieldset/object.ts
...
// packages/lyxalui/components/fieldset/index.ts
var fieldset_default = ({ addComponents, prefix = "" }) => {
  const prefixedfieldset = addPrefix(object_default26, prefix);
  addComponents({ ...prefixedfieldset });
};

// packages/lyxalui/components/fileinput/object.ts
...
// packages/lyxalui/components/fileinput/index.ts
var fileinput_default = ({ addComponents, prefix = "" }) => {
  const prefixedfileinput = addPrefix(object_default27, prefix);
  addComponents({ ...prefixedfileinput });
};

// packages/lyxalui/components/filter/object.ts
...
// packages/lyxalui/components/filter/index.ts
var filter_default = ({ addComponents, prefix = "" }) => {
  const prefixedfilter = addPrefix(object_default28, prefix);
  addComponents({ ...prefixedfilter });
};

// packages/lyxalui/components/footer/object.ts
...
// packages/lyxalui/components/footer/index.ts
var footer_default = ({ addComponents, prefix = "" }) => {
  const prefixedfooter = addPrefix(object_default29, prefix);
  addComponents({ ...prefixedfooter });
};

// packages/lyxalui/components/hero/object.ts
...
// packages/lyxalui/components/hero/index.ts
var hero_default = ({ addComponents, prefix = "" }) => {
  const prefixedhero = addPrefix(object_default30, prefix);
  addComponents({ ...prefixedhero });
};

// packages/lyxalui/components/hover3d/object.ts
...
// packages/lyxalui/components/hover3d/index.ts
var hover3d_default = ({ addComponents, prefix = "" }) => {
  const prefixedhover3d = addPrefix(object_default31, prefix);
  addComponents({ ...prefixedhover3d });
};

// packages/lyxalui/components/hovergallery/object.ts
...
// packages/lyxalui/components/hovergallery/index.ts
var hovergallery_default = ({ addComponents, prefix = "" }) => {
  const prefixedhovergallery = addPrefix(object_default32, prefix);
  addComponents({ ...prefixedhovergallery });
};

// packages/lyxalui/components/indicator/object.ts
...
// packages/lyxalui/components/indicator/index.ts
...
// packages/lyxalui/components/input/object.ts
...
// packages/lyxalui/components/input/index.ts
var input_default = ({ addComponents, prefix = "" }) => {
  const prefixedinput = addPrefix(object_default34, prefix);
  addComponents({ ...prefixedinput });
};

// packages/lyxalui/components/kbd/object.ts
...
// packages/lyxalui/components/kbd/index.ts
var kbd_default = ({ addComponents, prefix = "" }) => {
  const prefixedkbd = addPrefix(object_default35, prefix);
  addComponents({ ...prefixedkbd });
};

// packages/lyxalui/components/label/object.ts
...
// packages/lyxalui/components/link/index.ts
var link_default = ({ addComponents, prefix = "" }) => {
  const prefixedlink = addPrefix(object_default37, prefix);
  addComponents({ ...prefixedlink });
};

// packages/lyxalui/components/list/object.ts
...
// packages/lyxalui/components/loading/index.ts
var loading_default = ({ addComponents, prefix = "" }) => {
  const prefixedloading = addPrefix(object_default39, prefix);
  addComponents({ ...prefixedloading });
};

// packages/lyxalui/components/mask/object.ts
...
// packages/lyxalui/components/mask/index.ts
var mask_default = ({ addComponents, prefix = "" }) => {
  const prefixedmask = addPrefix(object_default40, prefix);
  addComponents({ ...prefixedmask });
};

// packages/lyxalui/components/menu/object.ts
...
// packages/lyxalui/components/menu/index.ts
var menu_default = ({ addComponents, prefix = "" }) => {
  const prefixedmenu = addPrefix(object_default41, prefix);
  addComponents({ ...prefixedmenu });
};

// packages/lyxalui/components/mockup/object.ts
...
// packages/lyxalui/components/mockup/index.ts
var mockup_default = ({ addComponents, prefix = "" }) => {
  const prefixedmockup = addPrefix(object_default42, prefix);
  addComponents({ ...prefixedmockup });
};

// packages/lyxalui/components/modal/object.ts
...
// packages/lyxalui/components/modal/index.ts
var modal_default = ({ addComponents, prefix = "" }) => {
  const prefixedmodal = addPrefix(object_default43, prefix);
  addComponents({ ...prefixedmodal });
};

// packages/lyxalui/components/navbar/object.ts
...
// packages/lyxalui/components/navbar/index.ts
var navbar_default = ({ addComponents, prefix = "" }) => {
  const prefixednavbar = addPrefix(object_default44, prefix);
  addComponents({ ...prefixednavbar });
};

// packages/lyxalui/components/progress/object.ts
...
// packages/lyxalui/components/progress/index.ts
var progress_default = ({ addComponents, prefix = "" }) => {
  const prefixedprogress = addPrefix(object_default45, prefix);
  addComponents({ ...prefixedprogress });
};

// packages/lyxalui/components/radialprogress/object.ts
...
// packages/lyxalui/components/radialprogress/index.ts
var radialprogress_default = ({ addComponents, prefix = "" }) => {
  const prefixedradialprogress = addPrefix(object_default46, prefix);
  addComponents({ ...prefixedradialprogress });
};

// packages/lyxalui/components/radio/object.ts
...
// packages/lyxalui/components/range/index.ts
var range_default = ({ addComponents, prefix = "" }) => {
  const prefixedrange = addPrefix(object_default48, prefix);
  addComponents({ ...prefixedrange });
};

// packages/lyxalui/components/rating/object.ts
...
// packages/lyxalui/components/rating/index.ts
var rating_default = ({ addComponents, prefix = "" }) => {
  const prefixedrating = addPrefix(object_default49, prefix);
  addComponents({ ...prefixedrating });
};

// packages/lyxalui/components/select/object.ts
...
// packages/lyxalui/components/select/index.ts
var select_default = ({ addComponents, prefix = "" }) => {
  const prefixedselect = addPrefix(object_default50, prefix);
  addComponents({ ...prefixedselect });
};

// packages/lyxalui/components/skeleton/object.ts
...
// packages/lyxalui/components/skeleton/index.ts
var skeleton_default = ({ addComponents, prefix = "" }) => {
  const prefixedskeleton = addPrefix(object_default51, prefix);
  addComponents({ ...prefixedskeleton });
};

// packages/lyxalui/components/stack/object.ts
...
// packages/lyxalui/components/stack/index.ts
var stack_default = ({ addComponents, prefix = "" }) => {
  const prefixedstack = addPrefix(object_default52, prefix);
  addComponents({ ...prefixedstack });
};

// packages/lyxalui/components/stat/object.ts
...
// packages/lyxalui/components/status/index.ts
...
// packages/lyxalui/components/steps/object.ts
...
// packages/lyxalui/components/steps/index.ts
var steps_default = ({ addComponents, prefix = "" }) => {
  const prefixedsteps = addPrefix(object_default55, prefix);
  addComponents({ ...prefixedsteps });
};

// packages/lyxalui/components/swap/object.ts
...
// packages/lyxalui/components/swap/index.ts
var swap_default = ({ addComponents, prefix = "" }) => {
  const prefixedswap = addPrefix(object_default56, prefix);
  addComponents({ ...prefixedswap });
};

// packages/lyxalui/components/tab/object.ts
...
// packages/lyxalui/components/tab/index.ts
var tab_default = ({ addComponents, prefix = "" }) => {
  const prefixedtab = addPrefix(object_default57, prefix);
  addComponents({ ...prefixedtab });
};

// packages/lyxalui/components/table/object.ts
...
// packages/lyxalui/components/table/index.ts
var table_default = ({ addComponents, prefix = "" }) => {
  const prefixedtable = addPrefix(object_default58, prefix);
  addComponents({ ...prefixedtable });
};

// packages/lyxalui/components/textarea/object.ts
...
// packages/lyxalui/components/textarea/index.ts
var textarea_default = ({ addComponents, prefix = "" }) => {
  const prefixedtextarea = addPrefix(object_default59, prefix);
  addComponents({ ...prefixedtextarea });
};

// packages/lyxalui/components/textrotate/object.ts
...
// packages/lyxalui/components/textrotate/index.ts
var textrotate_default = ({ addComponents, prefix = "" }) => {
  const prefixedtextrotate = addPrefix(object_default60, prefix);
  addComponents({ ...prefixedtextrotate });
};

// packages/lyxalui/components/timeline/object.ts
...
// packages/lyxalui/components/timeline/index.ts
var timeline_default = ({ addComponents, prefix = "" }) => {
  const prefixedtimeline = addPrefix(object_default61, prefix);
  addComponents({ ...prefixedtimeline });
};

// packages/lyxalui/components/toast/object.ts
...
// packages/lyxalui/components/toast/index.ts
var toast_default = ({ addComponents, prefix = "" }) => {
  const prefixedtoast = addPrefix(object_default62, prefix);
  addComponents({ ...prefixedtoast });
};

// packages/lyxalui/components/toggle/object.ts
...
// packages/lyxalui/components/toggle/index.ts
var toggle_default = ({ addComponents, prefix = "" }) => {
  const prefixedtoggle = addPrefix(object_default63, prefix);
  addComponents({ ...prefixedtoggle });
};

// packages/lyxalui/components/tooltip/object.ts
...
// packages/lyxalui/components/tooltip/index.ts
var tooltip_default = ({ addComponents, prefix = "" }) => {
  const prefixedtooltip = addPrefix(object_default64, prefix);
  addComponents({ ...prefixedtooltip });
};

// packages/lyxalui/components/validator/object.ts
...
// packages/lyxalui/components/validator/index.ts
var validator_default = ({ addComponents, prefix = "" }) => {
  const prefixedvalidator = addPrefix(object_default65, prefix);
  addComponents({ ...prefixedvalidator });
};

// packages/lyxalui/utilities/glass/object.ts
...
// packages/lyxalui/utilities/join/index.ts
var join_default = ({ addUtilities, prefix = "" }) => {
  const prefixedjoin = addPrefix(object_default67, prefix);
  addUtilities({ ...prefixedjoin });
};

// packages/lyxalui/utilities/radius/object.ts
...
// packages/lyxalui/utilities/radius/index.ts
var radius_default = ({ addUtilities, prefix = "" }) => {
  const prefixedradius = addPrefix(object_default68, prefix);
  addUtilities({ ...prefixedradius });
};

// packages/lyxalui/utilities/typography/object.ts
...
// packages/lyxalui/utilities/typography/index.ts
var typography_default = ({ addUtilities, prefix = "" }) => {
  const prefixedtypography = addPrefix(object_default69, prefix);
  addUtilities({ ...prefixedtypography });
};

// packages/lyxalui/imports.ts
var base = { properties: properties_default, rootcolor: rootcolor_default, rootscrollgutter: rootscrollgutter_default, rootscrolllock: rootscrolllock_default, scrollbar: scrollbar_default, svg: svg_default };
var components = { alert: alert_default, avatar: avatar_default, badge: badge_default, breadcrumbs: breadcrumbs_default, button: button_default, calendar: calendar_default, card: card_default, carousel: carousel_default, chat: chat_default, checkbox: checkbox_default, collapse: collapse_default, countdown: countdown_default, diff: diff_default, divider: divider_default, dock: dock_default, drawer: drawer_default, dropdown: dropdown_default, fab: fab_default, fieldset: fieldset_default, fileinput: fileinput_default, filter: filter_default, footer: footer_default, hero: hero_default, hover3d: hover3d_default, hovergallery: hovergallery_default, indicator: indicator_default, input: input_default, kbd: kbd_default, label: label_default, link: link_default, list: list_default, loading: loading_default, mask: mask_default, menu: menu_default, mockup: mockup_default, modal: modal_default, navbar: navbar_default, progress: progress_default, radialprogress: radialprogress_default, radio: radio_default, range: range_default, rating: rating_default, select: select_default, skeleton: skeleton_default, stack: stack_default, stat: stat_default, status: status_default, steps: steps_default, swap: swap_default, tab: tab_default, table: table_default, textarea: textarea_default, textrotate: textrotate_default, timeline: timeline_default, toast: toast_default, toggle: toggle_default, tooltip: tooltip_default, validator: validator_default };
var utilities = { glass: glass_default, join: join_default, radius: radius_default, typography: typography_default };

// packages/lyxalui/index.ts
var version = "1.0.0";
var lyxalui_default = plugin.withOptions((options) => {
  return (helpers) => {
    ...
    addVariant(`${prefix}is-drawer-close`, `&:where(.${prefix}drawer-toggle:not(:checked) ~ .${prefix}drawer-side, .${prefix}drawer-toggle:not(:checked) ~ .${prefix}drawer-side *)`);
    addVariant(`${prefix}is-drawer-open`, `&:where(.${prefix}drawer-toggle:checked ~ .${prefix}drawer-side, .${prefix}drawer-toggle:checked ~ .${prefix}drawer-side *)`);
  };
}, () => ({
  theme: {
