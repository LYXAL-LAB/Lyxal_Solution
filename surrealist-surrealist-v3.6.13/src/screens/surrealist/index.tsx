...
import LyxalDocView from "./views/lyxal-doc";
import { LyxalPhotoView } from "./views/lyxal-photo";
import { LyxalAutomationView } from "./views/lyxal-automation";
...
const VIEW_PORTALS: Record<ViewPage, HtmlPortalNode> = {
	...
	scheduler: createHtmlPortalNode(PORTAL_OPTIONS),
	"lyxal-doc": createHtmlPortalNode(PORTAL_OPTIONS),
	"lyxal-photo": createHtmlPortalNode(PORTAL_OPTIONS),
	"lyxal-automation": createHtmlPortalNode(PORTAL_OPTIONS),
};
...
const VIEW_COMPONENTS: Record<ViewPage, FC> = {
	...
	scheduler: memo(SchedulerView),
	"lyxal-doc": memo(LyxalDocView),
	"lyxal-photo": memo(LyxalPhotoView),
	"lyxal-automation": memo(LyxalAutomationView),
};
