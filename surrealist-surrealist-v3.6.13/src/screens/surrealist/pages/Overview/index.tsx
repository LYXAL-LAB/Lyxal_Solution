				...
				{(style) => (
					...
					>
						...
						>
							...
							<Group>
								<PrimaryTitle fz={22}>Vos espaces de travail</PrimaryTitle>
									...
									<Menu.Dropdown miw={220}>
										...
										{knownLabels.length === 0 && (
											<Text
												...
												pb="sm"
											>
												Aucun label disponible. Ajoutez des labels à vos espaces
												pour les filtrer ici.
											</Text>
										)}
										...
										<Collapse in={selectedLabels.length > 0}>
											<Menu.Divider />
											<Menu.Label mt="sm">Visibilité</Menu.Label>
											<Menu.Item
											...
											<Menu.Divider />
											<Menu.Label mt="sm">Méthode</Menu.Label>
											<Menu.Item
							...
							{hasNoResults && (
								<Center mt={52}>
									<Text>Aucun espace ne correspond aux filtres</Text>
								</Center>
							)}
							...
							>
								...
								{showConnections && (
									<Box>
										<Group gap="xl">
											<Box>
												<Text>Configurés localement</Text>
												<PrimaryTitle
													fz={18}
													lh="h1"
													fw={600}
