...
> = phf_map! {
		...
		//
		UniCase::ascii("ical::parse") => (PathKind::Function, None),
		UniCase::ascii("ical::events") => (PathKind::Function, None),
		UniCase::ascii("ical::get") => (PathKind::Function, None),
		UniCase::ascii("ical::has") => (PathKind::Function, None),
		UniCase::ascii("ical::method") => (PathKind::Function, None),
		UniCase::ascii("ical::attendees") => (PathKind::Function, None),
		UniCase::ascii("ical::organizer") => (PathKind::Function, None),
		UniCase::ascii("ical::stringify") => (PathKind::Function, None),
		UniCase::ascii("ical::duration") => (PathKind::Function, None),
		UniCase::ascii("ical::timezone") => (PathKind::Function, None),
		UniCase::ascii("ical::occurrences") => (PathKind::Function, None),
		//
