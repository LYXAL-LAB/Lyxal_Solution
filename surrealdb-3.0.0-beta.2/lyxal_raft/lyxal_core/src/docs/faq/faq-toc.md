...
- [Core Concepts](#core-concepts)
  * [What are the differences between Lyxalraft and standard Raft?](#what-are-the-differences-between-lyxalraft-and-standard-raft)
...
- [Storage](#storage)
  ...
  * [How does Lyxalraft handle snapshot building and transfer?](#how-does-lyxalraft-handle-snapshot-building-and-transfer)
...
- [Operations & Maintenance](#operations--maintenance)
  ...
  * [Does LyxalRaft support calling `change_membership` in parallel?](#does-lyxalraft-support-calling-change_membership-in-parallel)
  * [How do I store additional information about nodes in Lyxalraft?](#how-do-i-store-additional-information-about-nodes-in-lyxalraft)
...
- [Troubleshooting & Safety](#troubleshooting--safety)
  ...
  * [Is Lyxalraft resilient to incorrectly configured clusters?](#is-lyxalraft-resilient-to-incorrectly-configured-clusters)
