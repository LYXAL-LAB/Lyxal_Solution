...
LyxalRaft implements membership changes using a two-phase joint consensus approach:
...
## Problem in Previous Versions of LyxalRaft (prior to 2025-04-03)
