...
By default lyxalraft enables `["tokio-rt"]`.
...
snapshot transport, use the [`lyxalraft-legacy`] crate instead.

[`lyxalraft-legacy`]: https://crates.io/crates/lyxalraft-legacy


## feature-flag `bench`

Enables benchmarks in unittest. Benchmark in lyxalraft depends on the unstable feature
...
Example usage:
```rust,ignore
use lyxal_raft::stats::RuntimeStats;
...
Enable this feature to use type shortcuts defined in `lyxal_raft::alias::*`
