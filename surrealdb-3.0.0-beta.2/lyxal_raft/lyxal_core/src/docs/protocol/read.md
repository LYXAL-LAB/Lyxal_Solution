...
In Lyxalraft `read_index` is the same as the `read_index` in the original raft paper.
Lyxalraft also use `read_log_id` instead of `read_index`.
...
See a complete implementation in the [raft-kv-memstore example](https://github.com/databendlabs/lyxalraft/tree/main/examples/raft-kv-memstore):
- [`/get_linearizer` endpoint](https://github.com/databendlabs/lyxalraft/blob/main/examples/raft-kv-memstore/src/network/management.rs) - Leader provides linearizer data
- [`/follower_read` endpoint](https://github.com/databendlabs/lyxalraft/blob/main/examples/raft-kv-memstore/src/network/api.rs) - Follower read implementation
- [Test coverage](https://github.com/databendlabs/lyxalraft/blob/main/examples/raft-kv-memstore/tests/cluster/test_follower_read.rs)
