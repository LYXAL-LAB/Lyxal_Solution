...
committed log entries in LyxalRaft, and why they may differ due to out-of-order
RPC delivery.
...
**LyxalRaft**: Enforces vote-first protocol - the leader's vote must be
...
**LyxalRaft**: Decouples commit notifications for performance
