//! Default implementations for common Lyxalraft traits.
//!
//! This module provides ready-to-use implementations of Lyxalraft traits and types,
...
#[deprecated(since = "0.10.0", note = "use `lyxal_raft_rt_tokio::TokioRuntime` directly")]
pub use lyxal_raft_rt_tokio::TokioRuntime;
