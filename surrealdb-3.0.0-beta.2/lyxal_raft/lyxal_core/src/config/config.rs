...
pub enum SnapshotPolicy {
	...
	/// Lyxalraft will never trigger a snapshot building.
...
pub struct Config {
	...
	///
	/// When multiple `AppendEntries` commands are queued, Lyxalraft can merge them into
