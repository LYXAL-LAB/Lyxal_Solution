...
where C: RaftTypeConfig
{
    ...
    /// Represents the Candidate state within Lyxalraft.
    ///
...
where C: RaftTypeConfig
{
    ...
    /// node_id=0)`. See: [Conditions for initialization](https://databendlabs.github.io/lyxalraft/cluster-formation.html#conditions-for-initialization)
