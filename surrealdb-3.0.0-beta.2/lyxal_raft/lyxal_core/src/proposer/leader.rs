...
/// Leading state data.
///
/// Lyxalraft leading state is the combination of Leader and Candidate in original raft.
...
///
/// By combining candidate and leader into one stage, lyxalraft does not need to lose leadership when
