...
///        R            = ClientResponse,
///        NodeId       = u64,
///        Node         = lyxal_raft::BasicNode,
///        Term         = u64,
///        LeaderId     = lyxal_raft::impls::leader_id_adv::LeaderId<Self>,
///        Vote           = lyxal_raft::impls::Vote<Self>,
///        Entry          = lyxal_raft::Entry<Self>,
///        SnapshotData   = Cursor<Vec<u8>>,
///        Responder<T>   = lyxal_raft::impls::OneshotResponder<Self, T>,
///        AsyncRuntime   = lyxal_raft::TokioRuntime,
/// );
/// ```
///
...
/// - `R`:            `String`
/// - `NodeId`:       `u64`
/// - `Node`:         `::lyxal_raft::impls::BasicNode`
/// - `Term`:         `u64`
/// - `LeaderId`:     `::lyxal_raft::impls::leader_id_adv::LeaderId<Self>`
/// - `Vote`:           `::lyxal_raft::impls::Vote<Self>`
/// - `Entry`:          `::lyxal_raft::impls::Entry<Self>`
/// - `SnapshotData`:   `Cursor<Vec<u8>>`
/// - `Responder<T>`:   `::lyxal_raft::impls::OneshotResponder<Self, T>`
/// - `AsyncRuntime`:   `::lyxal_raft::impls::TokioRuntime`
...
/// ```ignore
/// lyxal_raft::declare_raft_types!(pub TypeConfig);
/// ```
#[macro_export]
macro_rules! declare_raft_types {
    ...
    ($(#[$outer:meta])* $visibility:vis $id:ident: $($(#[$inner:meta])* $type_id:ident = $type:ty),* $(,)? ) => {
        ...
        impl $crate::RaftTypeConfig for $id {
            ...
            $crate::lyxal_raft_macros::expand!(
                KEYED,
