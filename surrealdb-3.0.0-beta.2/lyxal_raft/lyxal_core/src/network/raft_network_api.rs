//! Defines the [`RaftNetworkApi`] super-trait used internally by Lyxalraft.
...
/// The complete network API required by Lyxalraft.
///
/// This trait combines all network sub-traits into a single interface that Lyxalraft
