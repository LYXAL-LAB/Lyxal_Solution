...
/// Error that indicates a **temporary** network error and when it is returned, Lyxalraft will retry
/// immediately.
///
...
/// Upon encountering this error, Lyxalraft will invoke [`backoff()`] to implement a delay before
...
/// backoff period, whereas with [`NetworkError`], Lyxalraft may attempt an immediate retry.
///
