...
/// impl lyxal_raft::AsyncRuntime for MyCustomRuntime { /* omitted */ }
///
/// // Build a runtime
...
impl<Rt: AsyncRuntime> Suite<Rt> {
    ...
    /// Test the wait loop pattern that lyxalraft uses internally.
    ///
    /// This simulates the pattern used in lyxalraft's Wait::metrics() method,
