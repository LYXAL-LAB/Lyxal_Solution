...
use lyxal_raft::storage::SnapshotMeta;
...
/// [`Raft::with_state_machine()`](lyxal_raft::Raft::with_state_machine)
#[tracing::instrument]
...
/// Call [`Raft::with_state_machine()`](lyxal_raft::Raft::with_state_machine) with wrong type
/// [`RaftStateMachine`]
#[tracing::instrument]
#[test_harness::test(harness = ut_harness)]
