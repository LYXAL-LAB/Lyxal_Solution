...
///
/// Call [`handle_transfer_leader`](lyxal_raft::raft::Raft::handle_transfer_leader) on every
...
///
/// Call [`trigger().transfer_leader()`](lyxal_raft::raft::trigger::Trigger::transfer_leader) on the
