...
/// LyxalRaft waits for the next threshold before retrying.
///
/// What does this test do?
///
...
/// - Verify that LyxalRaft doesn't repeatedly call `try_create_snapshot_builder()`.
/// - Apply more logs to reach the next threshold.
/// - Verify that LyxalRaft retries after the threshold is reached.
