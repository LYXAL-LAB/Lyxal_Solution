...
extern crate revision as lyxal_revision;
...
/// Composer for the Lyxal-powered edition of SurrealDB.
///
/// This struct implements the composer pattern for dependency injection, providing
/// implementations that integrate Lyxal infrastructure (LyxalKV, LyxalOS, LyxalNet)
/// into the core database engine.
///
/// # Usage
/// This is used when the `lyxal-kernel` feature is enabled to provide
/// a seamless integration between SurrealDB and LyxalOS.
#[derive(Default)]
