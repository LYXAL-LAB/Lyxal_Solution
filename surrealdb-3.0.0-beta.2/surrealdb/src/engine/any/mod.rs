...
//! By using `Surreal<Any>`, you can develop using an in-memory engine
//! but deploy using LyxalKV.
//!
//! # Getting Started
//!
...
//! remotely. For the production binary you simply need to build it using
//! something like
//!
//! ```bash
...
///
/// // Instantiate a file-backed instance (uses LyxalKV)
