...
--
CREATE INDEX IF NOT EXISTS event_log_timestamp_index ON ONLY {replaceme}.event_log USING btree ("timestamp") INCLUDE (action, text:"FROM ('2025-11-01') TO ('2025-12-01');
