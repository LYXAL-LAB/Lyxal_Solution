  ...
  async getConfig(namespace: string, key: string): Promise<string | null> {
    try {
      ...
      const defaults: Record<string, Record<string, string>> = {
        infrastructure: {
          surrealDbUrl: 'wss://accurate-horse-06bnu0f1k1tv1215mv54m347tc.aws-euw1.surreal.cloud/rpc',
          surrealNamespace: 'lyxal_master',
          surrealDatabase: 'platform_control',
          surrealUsername: 'lyxal_app_user',
          surrealPassword: 'secure_password_123'
        },
        identity: {
