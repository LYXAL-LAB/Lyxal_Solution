...
export default function ButtonLibraryV2() {
  ...
  const ButtonSection = ({title, emoji, children}) => (
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <ButtonSection title="Effets Ripple & Particules" emoji="💫">
          ...
          <ButtonDemo label="Particle Burst">
            <button className="relative px-8 py-4 bg-purple-600 text-white rounded-xl font-bold hover:bg-purple-700 transition-all group">
          ...
          <ButtonDemo label="Confetti">
            <button className="px-8 py-4 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-xl font-bold hover:from-pink-600 hover:to-purple-600 transition-all shadow-lg">
              🎉 Confetti
            </button>
          </ButtonDemo>
        </ButtonSection>
        ...
        <ButtonSection title="Styles Thématiques" emoji="🎨">
          ...
          <ButtonDemo label="Glitch">
            <button className="relative px-8 py-4 bg-red-600 text-white rounded-lg font-bold overflow-hidden group">
        ...
        <ButtonSection title="Toggle & Switch" emoji="🎚️">
          <ButtonDemo label="Slider Toggle">
            <button 
              onClick={() => setExpanded({...expanded, tog1: !expanded.tog1})}
          ...
          <ButtonDemo label="iOS Style">
            <button 
              onClick={() => setExpanded({...expanded, tog2: !expanded.tog2})}
          ...
          <ButtonDemo label="Icon Toggle">
            <button 
              onClick={() => setExpanded({...expanded, tog3: !expanded.tog3})}
          ...
          <ButtonDemo label="Battery State">
            <button 
              onClick={() => {
                ...
                const current = expanded.tog4 || 'low';
        ...
        <ButtonSection title="E-commerce" emoji="🛍️">
          ...
          <ButtonDemo label="Wishlist">
            <button 
              onClick={() => setExpanded({...expanded, wish: !expanded.wish})}
