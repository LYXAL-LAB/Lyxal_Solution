//! CCITT Fax Decoder
//!
//! Group 3 and Group 4 decoders for bi-level images

use std::convert::Infallible;

use super::{BitReader, ByteReader, Color, Transitions};
use super::maps::{Mode, black, white, mode, EOL};
...
pub fn decode_g4(input: impl Iterator<Item=u8>, width: u16, height: Option<u16>, mut line_cb: impl FnMut(&[u16])) -> Option<()> {
    ...
    for _ in 0 .. height.unwrap_or(u16::MAX) {
